var uc=Object.defineProperty;var O=(e,a,s)=>()=>{if(s)throw s[0];try{return e&&(a=e(e=0)),a}catch(n){throw s=[n],n}};var Y=(e,a)=>{for(var s in a)uc(e,s,{get:a[s],enumerable:!0})};var so={};Y(so,{ApiError:()=>Je,api:()=>h,errorEn:()=>gc,errorMessage:()=>Cs,getCookie:()=>to,onLoading:()=>hc,withQuery:()=>ao});function to(e){let a=document.cookie.match(new RegExp("(?:^|; )"+e.replace(/[.$?*|{}()[\]\\/+^]/g,"\\$&")+"=([^;]*)"));return a?decodeURIComponent(a[1]):""}function Xn(e){Ue||(Ue=document.createElement("div"),Ue.className="bm-queue-overlay",Ue.setAttribute("role","status"),Ue.innerHTML='<div class="bm-q-card"><div class="bm-q-logo">\u{1F34F}</div><b class="bm-q-title"></b><p class="bm-q-pos"></p><div class="bm-q-bar"><i></i></div><span class="bm-q-note"></span></div>',document.documentElement.appendChild(Ue));let a=document.documentElement.lang==="en";Ue.querySelector(".bm-q-title").textContent=a?"Site is busy \u2014 you are in the queue":"\u0633\u0627\u06CC\u062A \u0634\u0644\u0648\u063A \u0627\u0633\u062A \u2014 \u062F\u0631 \u0635\u0641 \u0648\u0631\u0648\u062F \u0647\u0633\u062A\u06CC",Ue.querySelector(".bm-q-pos").textContent=a?`Your turn: ${e>0?e:"\u2026"}`:`\u0646\u0648\u0628\u062A \u0634\u0645\u0627: ${e>0?e:"\u2026"}`,Ue.querySelector(".bm-q-note").textContent=a?"Continues automatically when it is your turn\u2026":"\u0628\u0647\u200C\u0645\u062D\u0636 \u0631\u0633\u06CC\u062F\u0646 \u0646\u0648\u0628\u062A\u060C \u062E\u0648\u062F\u06A9\u0627\u0631 \u0627\u062F\u0627\u0645\u0647 \u067E\u06CC\u062F\u0627 \u0645\u06CC\u200C\u06A9\u0646\u062F\u2026"}function Zn(){Ue&&(Ue.remove(),Ue=null)}async function bc(e={}){return Ia||(Ia=(async()=>{Xn(Number(e.pos)||0);let a=Math.max(2,Math.min(20,Number(e.pollSec)||4))*1e3;for(let s=0;s<60;s++){await new Promise(n=>setTimeout(n,a));try{let o=await(await fetch("/api/queue/status",{credentials:"same-origin",headers:{Accept:"application/json"}})).json();if(o?.state==="pass")return Zn(),!0;o?.state==="queued"&&Xn(Number(o.pos)||0)}catch{}}return Zn(),!1})().finally(()=>{Ia=null})),Ia}function hc(e){return Ts.add(e),()=>Ts.delete(e)}function eo(e){Es=Math.max(0,Es+(e?1:-1));for(let a of Ts)try{a(Es>0)}catch{}}async function ft(e,a,s,n={}){if(typeof navigator<"u"&&!navigator.onLine&&e!=="GET")throw new Je(0,"offline","\u0627\u062A\u0635\u0627\u0644 \u0627\u06CC\u0646\u062A\u0631\u0646\u062A \u0628\u0631\u0642\u0631\u0627\u0631 \u0646\u06CC\u0633\u062A. \u0644\u0637\u0641\u0627\u064B \u0634\u0628\u06A9\u0647 \u0631\u0627 \u0628\u0631\u0631\u0633\u06CC \u06A9\u0646.","You are offline.");eo(!0);let o={...n.headers||{}};if(s!=null&&(o["Content-Type"]="application/json"),e!=="GET"){let m=to("bm_csrf");m&&(o["X-CSRF-Token"]=m)}let i=new AbortController,l=setTimeout(()=>i.abort(),n.timeout||25e3);try{let m=await fetch(a,{method:e,headers:o,signal:i.signal,credentials:"same-origin",body:s==null?void 0:JSON.stringify(s)}),u=null,f=await m.text();if(f)try{u=JSON.parse(f)}catch{u={raw:f.slice(0,300)}}if(m.status===403&&u?.code==="csrf_failed"&&!n._retried)return await fetch("/api/bootstrap",{credentials:"same-origin"}).catch(()=>{}),ft(e,a,s,{...n,_retried:!0});if(m.status===503&&u?.code==="queued"&&!n._queueRetried&&await bc(u?.details||{}))return ft(e,a,s,{...n,_queueRetried:!0});if(!m.ok||u?.ok===!1){let v=u?.code||"error";throw new Je(m.status||500,v,u?.message||qs[v]||"\u062E\u0637\u0627",qs[v])}return u}catch(m){throw m instanceof Je?m:m?.name==="AbortError"?new Je(408,"timeout","\u0632\u0645\u0627\u0646 \u062F\u0631\u062E\u0648\u0627\u0633\u062A \u0628\u0647 \u067E\u0627\u06CC\u0627\u0646 \u0631\u0633\u06CC\u062F. \u062F\u0648\u0628\u0627\u0631\u0647 \u062A\u0644\u0627\u0634 \u06A9\u0646.","Request timed out."):new Je(0,"network","\u0627\u0631\u062A\u0628\u0627\u0637 \u0628\u0627 \u0633\u0631\u0648\u0631 \u0628\u0631\u0642\u0631\u0627\u0631 \u0646\u0634\u062F. \u0627\u062A\u0635\u0627\u0644 \u0627\u06CC\u0646\u062A\u0631\u0646\u062A \u0631\u0627 \u0628\u0631\u0631\u0633\u06CC \u06A9\u0646.","Network error.")}finally{clearTimeout(l),eo(!1)}}function Cs(e){return e instanceof Je?e.message:String(e?.message||e||"\u062E\u0637\u0627")}function gc(e){return e?.details||qs[e?.code]||e?.message||"Error"}var Je,qs,Ue,Ia,Es,Ts,ao,h,K=O(()=>{Je=class extends Error{constructor(a,s,n,o){super(n||s||"error"),this.status=a,this.code=s,this.details=o}};qs={login_required:"Please sign in to continue.",store_asleep:"The store is temporarily turned off.",unauthorized:"Authentication failed.",forbidden:"You do not have access to this section.",csrf_failed:"Security token expired. Please refresh the page.",too_many_requests:"Too many requests. Please wait a moment.",not_found:"Not found.",product_not_found:"Product not found.",order_not_found:"Order not found.",invalid_credentials:"Incorrect username or password.",invalid_code:"The verification code is not valid.",invalid_phone:"Invalid mobile number.",invalid_email:"Invalid email address.",weak_password:"Password is too weak. Use upper/lower case letters, digits and symbols.",stock_limit:"Not enough stock for this quantity.",empty_cart:"Your cart is empty.",insufficient_balance:"Wallet balance is not enough.",account_exists:"This account already exists.",username_taken:"This username is taken.",phone_taken:"This phone number is already registered.",email_taken:"This email is already registered.",terms_required:"You must accept the terms and conditions.",rules_required:"You must accept the ticket rules.",address_required:"Please add a shipping address first.",already_submitted:"You have already submitted this.",payload_too_large:"The uploaded data is too large.",invalid_type:"Only image files are allowed.",server_error:"Internal server error. Please try again.",product_unavailable:"One of the items in your cart is no longer available.",cannot_cancel:"This order cannot be cancelled in its current state.",account_blocked:"This account is blocked. Please contact support.",disabled:"This feature is currently disabled.",queued:"The site is busy. You are in the entry queue\u2026",banned:"Access is blocked. Please contact support."},Ue=null,Ia=null;Es=0,Ts=new Set;ao=(e,a)=>{let s=new URLSearchParams;for(let[o,i]of Object.entries(a||{}))i==null||i===""||s.set(o,String(i));let n=s.toString();return n?`${e}${e.includes("?")?"&":"?"}${n}`:e},h={url:ao,get:(e,a)=>ft("GET",e,void 0,a),post:(e,a,s)=>ft("POST",e,a??{},s),patch:(e,a,s)=>ft("PATCH",e,a??{},s),del:(e,a,s)=>ft("DELETE",e,a,s),put:(e,a,s)=>ft("PUT",e,a??{},s),upload:e=>ft("POST","/api/upload",{data:e},{timeout:6e4})}});function oo(e){zt=e==="en"?"en":"fa",document.documentElement.lang=zt,document.documentElement.dir=zt==="fa"?"rtl":"ltr"}function t(e,a){let n=(vc[zt]||As)[e];if(n===void 0&&(n=As[e],n===void 0&&(no.has(e)||(no.add(e),(location.hostname==="localhost"||location.hostname==="127.0.0.1")&&console.warn("[i18n] missing key:",e)),n=e)),a)for(let[o,i]of Object.entries(a))n=n.replace(new RegExp(`\\{${o}\\}`,"g"),String(i));return n}function ua(e=document){e.querySelectorAll("[data-i18n]").forEach(a=>{a.textContent=t(a.dataset.i18n)}),e.querySelectorAll("[data-i18n-placeholder]").forEach(a=>{a.setAttribute("placeholder",t(a.dataset.i18nPlaceholder))}),e.querySelectorAll("[data-i18n-title]").forEach(a=>{a.setAttribute("title",t(a.dataset.i18nTitle)),a.setAttribute("aria-label",t(a.dataset.i18nTitle))}),e.querySelectorAll("[data-i18n-html]").forEach(a=>{a.innerHTML=t(a.dataset.i18nHtml)})}var As,fc,vc,zt,no,ve,k,_=O(()=>{As={"app.name":"\u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644","app.tagline":"\u0644\u0648\u0627\u0632\u0645 \u062C\u0627\u0646\u0628\u06CC \u0645\u0648\u0628\u0627\u06CC\u0644 \u0648 \u06AF\u062C\u062A","common.loading":"\u062F\u0631 \u062D\u0627\u0644 \u0628\u0627\u0631\u06AF\u0630\u0627\u0631\u06CC\u2026","common.save":"\u0630\u062E\u06CC\u0631\u0647","common.saving":"\u062F\u0631 \u062D\u0627\u0644 \u0630\u062E\u06CC\u0631\u0647\u2026","common.cancel":"\u0627\u0646\u0635\u0631\u0627\u0641","common.close":"\u0628\u0633\u062A\u0646","common.confirm":"\u062A\u0623\u06CC\u06CC\u062F","common.delete":"\u062D\u0630\u0641","common.edit":"\u0648\u06CC\u0631\u0627\u06CC\u0634","common.add":"\u0627\u0641\u0632\u0648\u062F\u0646","common.create":"\u0627\u06CC\u062C\u0627\u062F","common.update":"\u0628\u0647\u200C\u0631\u0648\u0632\u0631\u0633\u0627\u0646\u06CC","common.search":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648","common.filter":"\u0641\u06CC\u0644\u062A\u0631","common.filters":"\u0641\u06CC\u0644\u062A\u0631\u0647\u0627","common.sort":"\u0645\u0631\u062A\u0628\u200C\u0633\u0627\u0632\u06CC","common.all":"\u0647\u0645\u0647","common.none":"\u0647\u06CC\u0686","common.more":"\u0628\u06CC\u0634\u062A\u0631","common.less":"\u06A9\u0645\u062A\u0631","common.showAll":"\u0645\u0634\u0627\u0647\u062F\u0647\u200C\u06CC \u0647\u0645\u0647","common.back":"\u0628\u0627\u0632\u06AF\u0634\u062A","common.next":"\u0627\u062F\u0627\u0645\u0647","common.prev":"\u0642\u0628\u0644\u06CC","common.yes":"\u0628\u0644\u0647","common.no":"\u062E\u06CC\u0631","common.optional":"\u0627\u062E\u062A\u06CC\u0627\u0631\u06CC","common.required":"\u0627\u0644\u0632\u0627\u0645\u06CC","common.copy":"\u06A9\u067E\u06CC","common.copied":"\u06A9\u067E\u06CC \u0634\u062F","common.share":"\u0627\u0634\u062A\u0631\u0627\u06A9\u200C\u06AF\u0630\u0627\u0631\u06CC","common.download":"\u062F\u0627\u0646\u0644\u0648\u062F","common.upload":"\u0628\u0627\u0631\u06AF\u0630\u0627\u0631\u06CC","common.print":"\u0686\u0627\u067E","common.refresh":"\u062A\u0627\u0632\u0647\u200C\u0633\u0627\u0632\u06CC","common.retry":"\u062A\u0644\u0627\u0634 \u062F\u0648\u0628\u0627\u0631\u0647","common.send":"\u0627\u0631\u0633\u0627\u0644","common.sent":"\u0627\u0631\u0633\u0627\u0644 \u0634\u062F","common.submit":"\u062B\u0628\u062A","common.reply":"\u067E\u0627\u0633\u062E","common.view":"\u0645\u0634\u0627\u0647\u062F\u0647","common.details":"\u062C\u0632\u0626\u06CC\u0627\u062A","common.status":"\u0648\u0636\u0639\u06CC\u062A","common.date":"\u062A\u0627\u0631\u06CC\u062E","common.time":"\u0633\u0627\u0639\u062A","common.amount":"\u0645\u0628\u0644\u063A","common.count":"\u062A\u0639\u062F\u0627\u062F","common.total":"\u0645\u062C\u0645\u0648\u0639","common.price":"\u0642\u06CC\u0645\u062A","common.stock":"\u0645\u0648\u062C\u0648\u062F\u06CC","common.available":"\u0645\u0648\u062C\u0648\u062F","common.unavailable":"\u0646\u0627\u0645\u0648\u062C\u0648\u062F","common.inStock":"\u0645\u0648\u062C\u0648\u062F \u062F\u0631 \u0627\u0646\u0628\u0627\u0631","common.lowStock":"\u06A9\u0645\u062A\u0631 \u0627\u0632 \u06F3 \u0639\u062F\u062F \u0628\u0627\u0642\u06CC \u0645\u0627\u0646\u062F\u0647","common.notifyMe":"\u0645\u0648\u062C\u0648\u062F \u0634\u062F \u062E\u0628\u0631\u0645 \u06A9\u0646","common.notified":"\u0628\u0647 \u0645\u062D\u0636 \u0645\u0648\u062C\u0648\u062F \u0634\u062F\u0646 \u062E\u0628\u0631\u062A \u0645\u06CC\u200C\u06A9\u0646\u06CC\u0645","common.category":"\u062F\u0633\u062A\u0647\u200C\u0628\u0646\u062F\u06CC","common.brand":"\u0628\u0631\u0646\u062F","common.product":"\u06A9\u0627\u0644\u0627","common.products":"\u0645\u062D\u0635\u0648\u0644\u0627\u062A","common.order":"\u0633\u0641\u0627\u0631\u0634","common.orders":"\u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627","common.user":"\u06A9\u0627\u0631\u0628\u0631","common.users":"\u06A9\u0627\u0631\u0628\u0631\u0627\u0646","common.result":"\u0646\u062A\u06CC\u062C\u0647","common.results":"\u0646\u062A\u06CC\u062C\u0647","common.noResult":"\u0646\u062A\u06CC\u062C\u0647\u200C\u0627\u06CC \u067E\u06CC\u062F\u0627 \u0646\u0634\u062F","common.error":"\u062E\u0637\u0627","common.success":"\u0627\u0646\u062C\u0627\u0645 \u0634\u062F","common.warning":"\u062A\u0648\u062C\u0647","common.note":"\u06CC\u0627\u062F\u062F\u0627\u0634\u062A","common.notes":"\u062A\u0648\u0636\u06CC\u062D\u0627\u062A","common.description":"\u062A\u0648\u0636\u06CC\u062D\u0627\u062A","common.specs":"\u0645\u0634\u062E\u0635\u0627\u062A \u0641\u0646\u06CC","common.actions":"\u0639\u0645\u0644\u06CC\u0627\u062A","common.active":"\u0641\u0639\u0627\u0644","common.inactive":"\u063A\u06CC\u0631\u0641\u0639\u0627\u0644","common.enabled":"\u0631\u0648\u0634\u0646","common.disabled":"\u062E\u0627\u0645\u0648\u0634","common.on":"\u0631\u0648\u0634\u0646","common.off":"\u062E\u0627\u0645\u0648\u0634","common.from":"\u0627\u0632","common.to":"\u062A\u0627","common.and":"\u0648","common.or":"\u06CC\u0627","common.today":"\u0627\u0645\u0631\u0648\u0632","common.yesterday":"\u062F\u06CC\u0631\u0648\u0632","common.toman":"\u062A\u0648\u0645\u0627\u0646","common.rial":"\u0631\u06CC\u0627\u0644","common.page":"\u0635\u0641\u062D\u0647","common.of":"\u0627\u0632","common.items":"\u0642\u0644\u0645","common.new":"\u062C\u062F\u06CC\u062F","common.old":"\u0642\u062F\u06CC\u0645\u06CC","common.apply":"\u0627\u0639\u0645\u0627\u0644","common.reset":"\u0628\u0627\u0632\u0646\u0634\u0627\u0646\u06CC","common.clear":"\u067E\u0627\u06A9 \u06A9\u0631\u062F\u0646","common.select":"\u0627\u0646\u062A\u062E\u0627\u0628 \u06A9\u0646\u06CC\u062F","common.title":"\u0639\u0646\u0648\u0627\u0646","common.body":"\u0645\u062A\u0646","common.type":"\u0646\u0648\u0639","common.priority":"\u0627\u0648\u0644\u0648\u06CC\u062A","common.answer":"\u067E\u0627\u0633\u062E","common.message":"\u067E\u06CC\u0627\u0645","common.messages":"\u067E\u06CC\u0627\u0645\u200C\u0647\u0627","common.attach":"\u067E\u06CC\u0648\u0633\u062A","common.image":"\u062A\u0635\u0648\u06CC\u0631","common.images":"\u062A\u0635\u0627\u0648\u06CC\u0631","common.phone":"\u0634\u0645\u0627\u0631\u0647 \u0645\u0648\u0628\u0627\u06CC\u0644","common.email":"\u0627\u06CC\u0645\u06CC\u0644","common.address":"\u0622\u062F\u0631\u0633","common.city":"\u0634\u0647\u0631","common.province":"\u0627\u0633\u062A\u0627\u0646","common.postal":"\u06A9\u062F \u067E\u0633\u062A\u06CC","common.name":"\u0646\u0627\u0645","common.fullName":"\u0646\u0627\u0645 \u0648 \u0646\u0627\u0645 \u062E\u0627\u0646\u0648\u0627\u062F\u06AF\u06CC","common.username":"\u0646\u0627\u0645 \u06A9\u0627\u0631\u0628\u0631\u06CC","common.password":"\u0631\u0645\u0632 \u0639\u0628\u0648\u0631","common.passwordConfirm":"\u062A\u06A9\u0631\u0627\u0631 \u0631\u0645\u0632 \u0639\u0628\u0648\u0631","common.login":"\u0648\u0631\u0648\u062F","common.logout":"\u062E\u0631\u0648\u062C","common.register":"\u062B\u0628\u062A\u200C\u0646\u0627\u0645","common.guest":"\u0645\u0647\u0645\u0627\u0646","common.admin":"\u0645\u062F\u06CC\u0631","common.settings":"\u062A\u0646\u0638\u06CC\u0645\u0627\u062A","common.help":"\u0631\u0627\u0647\u0646\u0645\u0627","common.home":"\u062E\u0627\u0646\u0647","common.skip":"\u0631\u062F \u0634\u062F\u0646","common.done":"\u0627\u0646\u062C\u0627\u0645 \u0634\u062F","common.pending":"\u062F\u0631 \u0627\u0646\u062A\u0638\u0627\u0631","common.approved":"\u062A\u0623\u06CC\u06CC\u062F \u0634\u062F\u0647","common.rejected":"\u0631\u062F \u0634\u062F\u0647","common.open":"\u0628\u0627\u0632","common.closed":"\u0628\u0633\u062A\u0647","common.all2":"\u0647\u0645\u0647\u200C\u06CC \u0645\u0648\u0627\u0631\u062F","common.never":"\u0647\u0631\u06AF\u0632","common.empty":"\u062E\u0627\u0644\u06CC","common.secure":"\u0627\u0645\u0646","common.free":"\u0631\u0627\u06CC\u06AF\u0627\u0646","common.unit":"\u0639\u062F\u062F","common.day":"\u0631\u0648\u0632","common.hour":"\u0633\u0627\u0639\u062A","common.minute":"\u062F\u0642\u06CC\u0642\u0647","common.second":"\u062B\u0627\u0646\u06CC\u0647","common.percent":"\u062F\u0631\u0635\u062F","common.discount":"\u062A\u062E\u0641\u06CC\u0641","common.discountCode":"\u06A9\u062F \u062A\u062E\u0641\u06CC\u0641","common.shipping":"\u0647\u0632\u06CC\u0646\u0647\u200C\u06CC \u0627\u0631\u0633\u0627\u0644","common.insurance":"\u0628\u06CC\u0645\u0647\u200C\u06CC \u0645\u0631\u0633\u0648\u0644\u0647","common.subtotal":"\u062C\u0645\u0639 \u06A9\u0627\u0644\u0627\u0647\u0627","common.payable":"\u0645\u0628\u0644\u063A \u0642\u0627\u0628\u0644 \u067E\u0631\u062F\u0627\u062E\u062A","common.payment":"\u067E\u0631\u062F\u0627\u062E\u062A","common.cart":"\u0633\u0628\u062F \u062E\u0631\u06CC\u062F","common.wishlist":"\u0644\u06CC\u0633\u062A \u0645\u0646","common.compare":"\u0645\u0642\u0627\u06CC\u0633\u0647","common.profile":"\u067E\u0631\u0648\u0641\u0627\u06CC\u0644","common.wallet":"\u06A9\u06CC\u0641 \u067E\u0648\u0644","common.balance":"\u0645\u0648\u062C\u0648\u062F\u06CC","common.transactions":"\u062A\u0631\u0627\u06A9\u0646\u0634\u200C\u0647\u0627","common.deposit":"\u0634\u0627\u0631\u0698 \u06A9\u06CC\u0641 \u067E\u0648\u0644","common.points":"\u0627\u0645\u062A\u06CC\u0627\u0632","common.ticket":"\u062A\u06CC\u06A9\u062A","common.tickets":"\u062A\u06CC\u06A9\u062A\u200C\u0647\u0627","common.support":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC","common.review":"\u0646\u0638\u0631","common.reviews":"\u0646\u0638\u0631\u0627\u062A","common.question":"\u0633\u0624\u0627\u0644","common.questions":"\u0633\u0624\u0627\u0644\u0627\u062A \u06A9\u0627\u0631\u0628\u0631\u0627\u0646","common.rating":"\u0627\u0645\u062A\u06CC\u0627\u0632","common.notification":"\u0627\u0639\u0644\u0627\u0646","common.notifications":"\u0627\u0639\u0644\u0627\u0646\u200C\u0647\u0627","common.security":"\u0627\u0645\u0646\u06CC\u062A","common.history":"\u062A\u0627\u0631\u06CC\u062E\u0686\u0647","common.report":"\u06AF\u0632\u0627\u0631\u0634","common.bug":"\u06AF\u0632\u0627\u0631\u0634 \u062E\u0637\u0627","common.suggestion":"\u067E\u06CC\u0634\u0646\u0647\u0627\u062F","common.complaint":"\u0634\u06A9\u0627\u06CC\u062A","common.law":"\u0642\u0648\u0627\u0646\u06CC\u0646 \u0648 \u0645\u0642\u0631\u0631\u0627\u062A","common.privacy":"\u062D\u0631\u06CC\u0645 \u062E\u0635\u0648\u0635\u06CC","common.about":"\u062F\u0631\u0628\u0627\u0631\u0647\u200C\u06CC \u0645\u0627","common.contact":"\u062A\u0645\u0627\u0633 \u0628\u0627 \u0645\u0627","common.faq":"\u0633\u0624\u0627\u0644\u0627\u062A \u0645\u062A\u062F\u0627\u0648\u0644","common.guide":"\u0631\u0627\u0647\u0646\u0645\u0627\u06CC \u062E\u0631\u06CC\u062F","common.services":"\u062E\u062F\u0645\u0627\u062A \u0645\u0634\u062A\u0631\u06CC\u0627\u0646","common.stats":"\u0622\u0645\u0627\u0631 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","common.searchProducts":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u06A9\u0627\u0644\u0627\u2026","common.noData":"\u0645\u0648\u0631\u062F\u06CC \u0628\u0631\u0627\u06CC \u0646\u0645\u0627\u06CC\u0634 \u0648\u062C\u0648\u062F \u0646\u062F\u0627\u0631\u062F","common.tryAgain":"\u062F\u0648\u0628\u0627\u0631\u0647 \u062A\u0644\u0627\u0634 \u06A9\u0646","common.showMore":"\u0646\u0645\u0627\u06CC\u0634 \u0628\u06CC\u0634\u062A\u0631","common.perPage":"\u062F\u0631 \u0647\u0631 \u0635\u0641\u062D\u0647",skip:"\u067E\u0631\u0634 \u0628\u0647 \u0645\u062D\u062A\u0648\u0627\u06CC \u0627\u0635\u0644\u06CC","boot.loading":"\u062F\u0631 \u062D\u0627\u0644 \u0628\u0627\u0631\u06AF\u0630\u0627\u0631\u06CC \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644\u2026","boot.waking":"\u0633\u0631\u0648\u0631 \u0627\u0628\u0631\u06CC \u062F\u0631 \u062D\u0627\u0644 \u0628\u06CC\u062F\u0627\u0631\u0634\u062F\u0646 \u0627\u0633\u062A\u061B \u0686\u0646\u062F \u062B\u0627\u0646\u06CC\u0647\u0654 \u062F\u06CC\u06AF\u0631 \u062E\u0648\u062F\u06A9\u0627\u0631 \u062F\u0648\u0628\u0627\u0631\u0647 \u062A\u0644\u0627\u0634 \u0645\u06CC\u200C\u06A9\u0646\u06CC\u0645\u2026","boot.failed":"\u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u062F\u0631 \u062F\u0633\u062A\u0631\u0633 \u0646\u06CC\u0633\u062A\u061B \u0633\u0631\u0648\u0631 \u0627\u0628\u0631\u06CC \u062E\u0648\u0627\u0628\u06CC\u062F\u0647 \u06CC\u0627 \u0634\u0628\u06A9\u0647 \u0642\u0637\u0639 \u0627\u0633\u062A.","update.available":"\u0646\u0633\u062E\u0647\u0654 \u062C\u062F\u06CC\u062F \u0633\u0627\u06CC\u062A \u0622\u0645\u0627\u062F\u0647 \u0627\u0633\u062A\u061B \u0628\u0631\u0627\u06CC \u062F\u06CC\u062F\u0646 \u062A\u063A\u06CC\u06CC\u0631\u0627\u062A \u062F\u06A9\u0645\u0647 \u0631\u0627 \u0628\u0632\u0646.","update.reload":"\u062A\u0627\u0632\u0647\u200C\u0633\u0627\u0632\u06CC \u0635\u0641\u062D\u0647","boot.failedHint":"\u062F\u06A9\u0645\u0647\u0654 \xAB\u062A\u0644\u0627\u0634 \u062F\u0648\u0628\u0627\u0631\u0647\xBB \u0631\u0627 \u0628\u0632\u0646\u061B \u0627\u06AF\u0631 \u0628\u0627\u0632 \u0647\u0645 \u0646\u06CC\u0627\u0645\u062F\u060C \u0641\u0627\u06CC\u0644 \xAB\u0628\u06CC\u062F\u0627\u0631\u0633\u0627\u0632\xBB \u0631\u0627 \u0627\u0632 \u06AF\u0648\u0634\u06CC/\u06A9\u0627\u0645\u067E\u06CC\u0648\u062A\u0631\u062A \u0628\u0627\u0632 \u06A9\u0646 \u062A\u0627 \u0633\u0631\u0648\u0631 \u0631\u0627 \u0628\u06CC\u062F\u0627\u0631 \u06A9\u0646\u062F.","topbar.fastSend":"\u0627\u0631\u0633\u0627\u0644 \u0627\u0632 \u0628\u0646\u062F\u0631 \u0628\u0648\u0634\u0647\u0631 \u0628\u0647 \u0633\u0631\u0627\u0633\u0631 \u0627\u06CC\u0631\u0627\u0646","nav.home":"\u062E\u0627\u0646\u0647","nav.products":"\u0647\u0645\u0647\u200C\u06CC \u0645\u062D\u0635\u0648\u0644\u0627\u062A","nav.deals":"\u062A\u062E\u0641\u06CC\u0641\u200C\u0647\u0627","nav.new":"\u062C\u062F\u06CC\u062F\u062A\u0631\u06CC\u0646\u200C\u0647\u0627","nav.stats":"\u0622\u0645\u0627\u0631 \u0632\u0646\u062F\u0647","nav.about":"\u062F\u0631\u0628\u0627\u0631\u0647\u200C\u06CC \u0645\u0627","nav.contact":"\u062A\u0645\u0627\u0633 \u0628\u0627 \u0645\u0627","nav.login":"\u0648\u0631\u0648\u062F","nav.register":"\u062B\u0628\u062A\u200C\u0646\u0627\u0645","nav.cart":"\u0633\u0628\u062F \u062E\u0631\u06CC\u062F","nav.wishlist":"\u0644\u06CC\u0633\u062A \u0645\u0646","nav.notifications":"\u0627\u0639\u0644\u0627\u0646\u200C\u0647\u0627","nav.menu":"\u0645\u0646\u0648","nav.account":"\u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC","nav.admin":"\u067E\u0646\u0644 \u0645\u062F\u06CC\u0631\u06CC\u062A","nav.allCategories":"\u0647\u0645\u0647\u200C\u06CC \u062F\u0633\u062A\u0647\u200C\u0647\u0627","theme.toggle":"\u062A\u063A\u06CC\u06CC\u0631 \u067E\u0648\u0633\u062A\u0647 (\u0631\u0648\u0634\u0646/\u062A\u0627\u0631\u06CC\u06A9)","theme.dark":"\u062D\u0627\u0644\u062A \u062A\u0627\u0631\u06CC\u06A9","theme.light":"\u062D\u0627\u0644\u062A \u0631\u0648\u0634\u0646","theme.auto":"\u0647\u0645\u0627\u0647\u0646\u06AF \u0628\u0627 \u0633\u06CC\u0633\u062A\u0645","search.placeholder":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u06A9\u0627\u0644\u0627\u060C \u0628\u0631\u0646\u062F \u06CC\u0627 \u062F\u0633\u062A\u0647\u2026","search.go":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648","search.voice":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u0635\u0648\u062A\u06CC","search.byImage":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648 \u0628\u0627 \u0639\u06A9\u0633","search.listening":"\u062F\u0631 \u062D\u0627\u0644 \u06AF\u0648\u0634 \u062F\u0627\u062F\u0646\u2026 \u062D\u0631\u0641 \u0628\u0632\u0646","search.noVoice":"\u0645\u0631\u0648\u0631\u06AF\u0631 \u0634\u0645\u0627 \u0627\u0632 \u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u0635\u0648\u062A\u06CC \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0646\u0645\u06CC\u200C\u06A9\u0646\u062F.","search.micDenied":"\u062F\u0633\u062A\u0631\u0633\u06CC \u0645\u06CC\u06A9\u0631\u0648\u0641\u0646 \u0628\u0633\u062A\u0647 \u0627\u0633\u062A. \u0627\u0632 \u062A\u0646\u0638\u06CC\u0645\u0627\u062A \u0645\u0631\u0648\u0631\u06AF\u0631\u060C \u0627\u062C\u0627\u0632\u0647\u0654 \u0645\u06CC\u06A9\u0631\u0648\u0641\u0646 \u0631\u0627 \u0628\u0631\u0627\u06CC \u0633\u0627\u06CC\u062A \u0641\u0639\u0627\u0644 \u06A9\u0646.","search.voiceNetwork":"\u0633\u0631\u0648\u06CC\u0633 \u062A\u0634\u062E\u06CC\u0635 \u06AF\u0641\u062A\u0627\u0631 \u062F\u0631 \u062F\u0633\u062A\u0631\u0633 \u0646\u06CC\u0633\u062A\u061B \u0627\u06CC\u0646\u062A\u0631\u0646\u062A \u06CC\u0627 \u0641\u06CC\u0644\u062A\u0631\u0634\u06A9\u0646 \u0631\u0627 \u0628\u0631\u0631\u0633\u06CC \u06A9\u0646.","search.noSpeech":"\u0686\u06CC\u0632\u06CC \u0646\u0634\u0646\u06CC\u062F\u0645\u061B \u062F\u0648\u0628\u0627\u0631\u0647 \u062A\u0644\u0627\u0634 \u06A9\u0646 \u0648 \u0634\u0645\u0631\u062F\u0647 \u062D\u0631\u0641 \u0628\u0632\u0646.","search.noMic":"\u0645\u06CC\u06A9\u0631\u0648\u0641\u0646\u06CC \u0631\u0648\u06CC \u0627\u06CC\u0646 \u062F\u0633\u062A\u06AF\u0627\u0647 \u067E\u06CC\u062F\u0627 \u0646\u0634\u062F.","pwd.show":"\u0646\u0645\u0627\u06CC\u0634 \u0631\u0645\u0632 \u0639\u0628\u0648\u0631","pwd.hide":"\u067E\u0646\u0647\u0627\u0646 \u06A9\u0631\u062F\u0646 \u0631\u0645\u0632 \u0639\u0628\u0648\u0631","search.suggestions":"\u067E\u06CC\u0634\u0646\u0647\u0627\u062F\u0647\u0627","search.trending":"\u067E\u0631\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u0647\u0627","search.recent":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u0647\u0627\u06CC \u0627\u062E\u06CC\u0631 \u0634\u0645\u0627","search.resultsFor":"\u0646\u062A\u0627\u06CC\u062C \u062C\u0633\u062A\u200C\u0648\u062C\u0648 \u0628\u0631\u0627\u06CC","search.inProducts":"\u062F\u0631 \u0645\u062D\u0635\u0648\u0644\u0627\u062A","search.inCategories":"\u062F\u0633\u062A\u0647\u200C\u0647\u0627","search.inBrands":"\u0628\u0631\u0646\u062F\u0647\u0627","search.inPages":"\u0635\u0641\u062D\u0647\u200C\u0647\u0627","search.didYouMean":"\u0645\u0646\u0638\u0648\u0631\u062A \u0627\u06CC\u0646 \u0628\u0648\u062F\u061F","search.noResultTitle":"\u0686\u06CC\u0632\u06CC \u067E\u06CC\u062F\u0627 \u0646\u06A9\u0631\u062F\u06CC\u0645","search.noResultText":"\u0639\u0628\u0627\u0631\u062A \u062F\u06CC\u06AF\u0631\u06CC \u0631\u0627 \u0627\u0645\u062A\u062D\u0627\u0646 \u06A9\u0646 \u06CC\u0627 \u0627\u0632 \u0641\u06CC\u0644\u062A\u0631\u0647\u0627 \u0627\u0633\u062A\u0641\u0627\u062F\u0647 \u06A9\u0646. \u0627\u06AF\u0631 \u06A9\u0627\u0644\u0627\u06CC \u062E\u0627\u0635\u06CC \u0645\u06CC\u200C\u062E\u0648\u0627\u0647\u06CC\u060C \u0628\u0627 \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0628\u06AF\u0648 \u062A\u0627 \u0628\u0631\u0627\u06CC\u062A \u062A\u0647\u06CC\u0647 \u06A9\u0646\u06CC\u0645.","search.imageTitle":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648 \u0628\u0627 \u0639\u06A9\u0633","search.imageText":"\u0639\u06A9\u0633 \u06A9\u0627\u0644\u0627 \u0631\u0627 \u0628\u0627\u0631\u06AF\u0630\u0627\u0631\u06CC \u06A9\u0646 \u062A\u0627 \u0645\u0634\u0627\u0628\u0647 \u0622\u0646 \u0631\u0627 \u062F\u0631 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u067E\u06CC\u062F\u0627 \u06A9\u0646\u06CC\u0645.","search.imageHint":"\u0641\u0631\u0645\u062A JPG \u06CC\u0627 PNG\u060C \u062D\u062F\u0627\u06A9\u062B\u0631 \u06F4 \u0645\u06AF\u0627\u0628\u0627\u06CC\u062A","search.imageIndexing":"\u062F\u0631 \u062D\u0627\u0644 \u0622\u0645\u0627\u062F\u0647\u200C\u0633\u0627\u0632\u06CC \u0645\u0648\u062A\u0648\u0631 \u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u062A\u0635\u0648\u06CC\u0631\u06CC\u2026","search.imageNoIndex":"\u062A\u0635\u0627\u0648\u06CC\u0631 \u0645\u062D\u0635\u0648\u0644\u0627\u062A \u0647\u0646\u0648\u0632 \u0627\u06CC\u0646\u062F\u06A9\u0633 \u0646\u0634\u062F\u0647\u200C\u0627\u0646\u062F. \u0645\u062F\u06CC\u0631 \u0633\u0627\u06CC\u062A \u0627\u0632 \u067E\u0646\u0644 \u0645\u062F\u06CC\u0631\u06CC\u062A \u2190 \u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u062A\u0635\u0648\u06CC\u0631\u06CC \u0645\u06CC\u200C\u062A\u0648\u0627\u0646\u062F \u0627\u06CC\u0646\u062F\u06A9\u0633 \u0631\u0627 \u0628\u0633\u0627\u0632\u062F.","search.imageNoMatch":"\u06A9\u0627\u0644\u0627\u06CC \u0645\u0634\u0627\u0628\u0647\u06CC \u0628\u0627 \u0627\u06CC\u0646 \u0639\u06A9\u0633 \u067E\u06CC\u062F\u0627 \u0646\u0634\u062F. \u0645\u06CC\u200C\u062A\u0648\u0627\u0646\u06CC \u0646\u0627\u0645 \u06A9\u0627\u0644\u0627 \u0631\u0627 \u062C\u0633\u062A\u200C\u0648\u062C\u0648 \u06A9\u0646\u06CC.","search.dropHere":"\u0639\u06A9\u0633 \u0631\u0627 \u0627\u06CC\u0646\u062C\u0627 \u0631\u0647\u0627 \u06A9\u0646","search.pickFile":"\u0627\u0646\u062A\u062E\u0627\u0628 \u0639\u06A9\u0633","search.takePhoto":"\u06AF\u0631\u0641\u062A\u0646 \u0639\u06A9\u0633 \u0628\u0627 \u062F\u0648\u0631\u0628\u06CC\u0646","mnav.home":"\u062E\u0627\u0646\u0647","mnav.products":"\u062F\u0633\u062A\u0647\u200C\u0647\u0627","mnav.search":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648","mnav.cart":"\u0633\u0628\u062F","mnav.me":"\u062D\u0633\u0627\u0628 \u0645\u0646","footer.shopping":"\u062E\u0631\u06CC\u062F","footer.allProducts":"\u0647\u0645\u0647\u200C\u06CC \u0645\u062D\u0635\u0648\u0644\u0627\u062A","footer.deals":"\u062A\u062E\u0641\u06CC\u0641\u200C\u0647\u0627 \u0648 \u067E\u06CC\u0634\u0646\u0647\u0627\u062F\u0647\u0627","footer.inStock":"\u06A9\u0627\u0644\u0627\u0647\u0627\u06CC \u0645\u0648\u062C\u0648\u062F","footer.searchByImage":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u062A\u0635\u0648\u06CC\u0631\u06CC","footer.myList":"\u0644\u06CC\u0633\u062A \u0645\u0646","footer.stats":"\u0622\u0645\u0627\u0631 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","footer.services":"\u062E\u062F\u0645\u0627\u062A \u0645\u0634\u062A\u0631\u06CC\u0627\u0646","footer.guide":"\u0631\u0627\u0647\u0646\u0645\u0627\u06CC \u062E\u0631\u06CC\u062F","footer.service":"\u062E\u062F\u0645\u0627\u062A \u0645\u0634\u062A\u0631\u06CC\u0627\u0646","footer.faq":"\u0633\u0624\u0627\u0644\u0627\u062A \u0645\u062A\u062F\u0627\u0648\u0644","footer.insurance":"\u0628\u06CC\u0645\u0647\u200C\u06CC \u0645\u0631\u0633\u0648\u0644\u0647","footer.plus":"\u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633","footer.tickets":"\u062A\u06CC\u06A9\u062A \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC","footer.about":"\u062F\u0631\u0628\u0627\u0631\u0647 \u0648 \u0642\u0648\u0627\u0646\u06CC\u0646","footer.aboutUs":"\u062F\u0631\u0628\u0627\u0631\u0647\u200C\u06CC \u0645\u0627","footer.terms":"\u0642\u0648\u0627\u0646\u06CC\u0646 \u0648 \u0645\u0642\u0631\u0631\u0627\u062A","footer.privacy":"\u062D\u0631\u06CC\u0645 \u062E\u0635\u0648\u0635\u06CC","footer.bug":"\u06AF\u0632\u0627\u0631\u0634 \u062E\u0637\u0627","footer.contact":"\u062A\u0645\u0627\u0633 \u0628\u0627 \u0645\u0627","footer.suggest":"\u067E\u06CC\u0634\u0646\u0647\u0627\u062F\u0647\u0627 \u0648 \u0634\u06A9\u0627\u06CC\u0627\u062A","footer.contactUs":"\u0631\u0627\u0647\u200C\u0647\u0627\u06CC \u0627\u0631\u062A\u0628\u0627\u0637\u06CC","footer.install":"\u0646\u0635\u0628 \u0627\u067E\u0644\u06CC\u06A9\u06CC\u0634\u0646","footer.support":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0622\u0646\u0644\u0627\u06CC\u0646","footer.rights":"\u0647\u0645\u0647\u200C\u06CC \u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638 \u0627\u0633\u062A.","footer.workingHours":"\u0633\u0627\u0639\u062A \u06A9\u0627\u0631\u06CC","home.heroKicker":"\u0627\u0632 \u0628\u0646\u062F\u0631 \u0628\u0648\u0634\u0647\u0631\u060C \u0628\u0627 \u0636\u0645\u0627\u0646\u062A \u0627\u0635\u0627\u0644\u062A","home.heroTitle":"\u0644\u0648\u0627\u0632\u0645 \u062C\u0627\u0646\u0628\u06CC \u0645\u0648\u0628\u0627\u06CC\u0644 \u0648 \u06AF\u062C\u062A\u060C \u0628\u0627 \u0642\u06CC\u0645\u062A \u0628\u0646\u062F\u0631\u06CC","home.heroText":"\u06A9\u0627\u0628\u0644\u060C \u0634\u0627\u0631\u0698\u0631\u060C \u0642\u0627\u0628 \u0648 \u06AF\u0644\u0633 \u0622\u06CC\u0641\u0648\u0646 \u0648 \u0633\u0627\u0645\u0633\u0648\u0646\u06AF\u060C \u067E\u0627\u0648\u0631\u0628\u0627\u0646\u06A9\u060C \u0647\u0646\u062F\u0632\u0641\u0631\u06CC\u060C \u0627\u0633\u067E\u06CC\u06A9\u0631\u060C \u0633\u0627\u0639\u062A \u0648 \u0639\u06CC\u0646\u06A9 \u0647\u0648\u0634\u0645\u0646\u062F \u0648 \u0647\u0631 \u0686\u06CC\u0632\u06CC \u06A9\u0647 \u0628\u0631\u0627\u06CC \u06AF\u0648\u0634\u06CC \u0648 \u062A\u0648\u0644\u06CC\u062F \u0645\u062D\u062A\u0648\u0627 \u0644\u0627\u0632\u0645 \u062F\u0627\u0631\u06CC \u2014 \u0647\u0645\u0647 \u062F\u0631 \u06CC\u06A9 \u0645\u063A\u0627\u0632\u0647\u200C\u06CC \u06A9\u0648\u0686\u06A9 \u06A9\u0646\u0627\u0631 \u062E\u0644\u06CC\u062C \u0641\u0627\u0631\u0633.","home.ctaShop":"\u0634\u0631\u0648\u0639 \u062E\u0631\u06CC\u062F","home.ctaDeals":"\u062A\u062E\u0641\u06CC\u0641\u200C\u0647\u0627\u06CC \u0627\u0645\u0631\u0648\u0632","home.point1":"\u0636\u0645\u0627\u0646\u062A \u0627\u0635\u0627\u0644\u062A \u06A9\u0627\u0644\u0627","home.point2":"\u06F7 \u0631\u0648\u0632 \u0645\u0647\u0644\u062A \u0627\u0646\u0635\u0631\u0627\u0641","home.point3":"\u0627\u0631\u0633\u0627\u0644 \u0628\u0647 \u0633\u0631\u0627\u0633\u0631 \u0627\u06CC\u0631\u0627\u0646","home.point4":"\u062A\u062D\u0648\u06CC\u0644 \u062D\u0636\u0648\u0631\u06CC \u0631\u0627\u06CC\u06AF\u0627\u0646","home.point5":"\u062A\u0636\u0645\u06CC\u0646 \u0628\u0647\u062A\u0631\u06CC\u0646 \u0642\u06CC\u0645\u062A","home.categories":"\u062F\u0633\u062A\u0647\u200C\u0628\u0646\u062F\u06CC\u200C\u0647\u0627","home.categoriesSub":"\u0627\u0632 \u06A9\u0627\u0628\u0644 \u0648 \u0642\u0627\u0628 \u062A\u0627 \u06AF\u062C\u062A\u200C\u0647\u0627\u06CC \u067E\u0648\u0634\u06CC\u062F\u0646\u06CC","home.featured":"\u067E\u06CC\u0634\u0646\u0647\u0627\u062F \u0648\u06CC\u0698\u0647","home.featuredSub":"\u06A9\u0627\u0644\u0627\u0647\u0627\u06CC\u06CC \u06A9\u0647 \u062E\u0648\u062F\u0645\u0627\u0646 \u0627\u0633\u062A\u0641\u0627\u062F\u0647 \u0645\u06CC\u200C\u06A9\u0646\u06CC\u0645 \u0648 \u067E\u06CC\u0634\u0646\u0647\u0627\u062F \u0645\u06CC\u200C\u062F\u0647\u06CC\u0645","home.bestSellers":"\u067E\u0631\u0641\u0631\u0648\u0634\u200C\u062A\u0631\u06CC\u0646\u200C\u0647\u0627","home.bestSellersSub":"\u0627\u0646\u062A\u062E\u0627\u0628 \u0645\u0634\u062A\u0631\u06CC\u0627\u0646 \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644","home.newArrivals":"\u062A\u0627\u0632\u0647\u200C\u0647\u0627\u06CC \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","home.newArrivalsSub":"\u0622\u062E\u0631\u06CC\u0646 \u06A9\u0627\u0644\u0627\u0647\u0627\u06CC\u06CC \u06A9\u0647 \u0628\u0647 \u0642\u0641\u0633\u0647 \u0627\u0636\u0627\u0641\u0647 \u0634\u062F\u0647","home.deals":"\u062A\u062E\u0641\u06CC\u0641\u200C\u0647\u0627\u06CC \u0641\u0639\u0627\u0644","home.dealsSub":"\u0641\u0631\u0635\u062A \u0645\u062D\u062F\u0648\u062F \u0628\u0627 \u0642\u06CC\u0645\u062A \u0628\u0647\u062A\u0631","home.brands":"\u0628\u0631\u0646\u062F\u0647\u0627\u06CC \u0645\u0648\u062C\u0648\u062F","home.whyUs":"\u0686\u0631\u0627 \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644\u061F","home.whyUsSub":"\u0686\u06CC\u0632\u0647\u0627\u06CC\u06CC \u06A9\u0647 \u0645\u0627 \u0631\u0627 \u0627\u0632 \u0628\u0642\u06CC\u0647 \u062C\u062F\u0627 \u0645\u06CC\u200C\u06A9\u0646\u062F","home.reviews":"\u0646\u0638\u0631 \u0645\u0634\u062A\u0631\u06CC\u0627\u0646","home.reviewsSub":"\u062A\u062C\u0631\u0628\u0647\u200C\u06CC \u0648\u0627\u0642\u0639\u06CC \u062E\u0631\u06CC\u062F\u0627\u0631\u0627\u0646","home.visitStore":"\u0628\u0627\u0632\u062F\u06CC\u062F \u0627\u0632 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","home.visitStoreText":"\u06A9\u0646\u0627\u0631 \u0627\u0633\u06A9\u0644\u0647\u200C\u06CC \u0628\u0648\u0634\u0647\u0631\u060C \u067E\u0627\u0633\u0627\u0698 \u0645\u0631\u0648\u0627\u0631\u06CC\u062F \u062E\u0644\u06CC\u062C \u2014 \u0646\u0635\u0628 \u0631\u0627\u06CC\u06AF\u0627\u0646 \u06AF\u0644\u0633 \u0648 \u0645\u0634\u0627\u0648\u0631\u0647\u200C\u06CC \u062D\u0636\u0648\u0631\u06CC","home.openMap":"\u062F\u06CC\u062F\u0646 \u06A9\u0631\u0648\u06A9\u06CC \u0648 \u0646\u0642\u0634\u0647","home.statsTitle":"\u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u062F\u0631 \u06CC\u06A9 \u0646\u06AF\u0627\u0647","home.plusTitle":"\u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633 \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644","home.plusText":"\u0628\u0627 \u067E\u0631\u062F\u0627\u062E\u062A \u0645\u0627\u0647\u0627\u0646\u0647\u060C \u0627\u0631\u0633\u0627\u0644 \u0647\u0645\u0647\u200C\u06CC \u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627 \u0631\u0627\u06CC\u06AF\u0627\u0646\u060C \u0645\u0631\u0633\u0648\u0644\u0647\u200C\u0647\u0627 \u062E\u0648\u062F\u06A9\u0627\u0631 \u0628\u06CC\u0645\u0647 \u0648 \u06F3\u066A \u062A\u062E\u0641\u06CC\u0641 \u062F\u0627\u0626\u0645\u06CC \u0645\u06CC\u200C\u06AF\u06CC\u0631\u06CC.","home.plusCta":"\u062F\u06CC\u062F\u0646 \u0645\u0632\u0627\u06CC\u0627\u06CC \u067E\u0644\u0627\u0633","home.appTitle":"\u0627\u067E\u0644\u06CC\u06A9\u06CC\u0634\u0646 \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644","home.appText":"\u0647\u0645\u06CC\u0646 \u0633\u0627\u06CC\u062A \u06CC\u06A9 \u0627\u067E\u0644\u06CC\u06A9\u06CC\u0634\u0646 \u0646\u0635\u0628\u200C\u0634\u062F\u0646\u06CC (PWA) \u0627\u0633\u062A: \u0631\u0648\u06CC \u0627\u0646\u062F\u0631\u0648\u06CC\u062F\u060C \u0622\u06CC\u0641\u0648\u0646\u060C \u0648\u06CC\u0646\u062F\u0648\u0632\u060C \u0645\u06A9 \u0648 \u0644\u06CC\u0646\u0648\u06A9\u0633 \u0646\u0635\u0628 \u0645\u06CC\u200C\u0634\u0648\u062F \u0648 \u0628\u0647\u200C\u0635\u0648\u0631\u062A \u0622\u0641\u0644\u0627\u06CC\u0646 \u0647\u0645 \u06A9\u0627\u0631 \u0645\u06CC\u200C\u06A9\u0646\u062F.","home.installCta":"\u0646\u0635\u0628 \u0631\u0648\u06CC \u062F\u0633\u062A\u06AF\u0627\u0647 \u0645\u0646","home.appInstalled":"\u0627\u067E\u0644\u06CC\u06A9\u06CC\u0634\u0646 \u0646\u0635\u0628 \u0634\u062F\u0647 \u0627\u0633\u062A","home.liveStats":"\u0622\u0645\u0627\u0631 \u0632\u0646\u062F\u0647\u200C\u06CC \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","home.newsletter":"\u0627\u0632 \u062A\u062E\u0641\u06CC\u0641\u200C\u0647\u0627 \u0628\u0627\u062E\u0628\u0631 \u0634\u0648","home.newsletterText":"\u0634\u0645\u0627\u0631\u0647\u200C\u06CC \u0645\u0648\u0628\u0627\u06CC\u0644\u062A \u0631\u0627 \u0628\u062F\u0647 \u062A\u0627 \u0641\u0642\u0637 \u0628\u0631\u0627\u06CC \u062A\u062E\u0641\u06CC\u0641\u200C\u0647\u0627\u06CC \u0645\u0647\u0645 \u0648 \u0645\u0648\u062C\u0648\u062F \u0634\u062F\u0646 \u06A9\u0627\u0644\u0627\u0647\u0627\u06CC \u0644\u06CC\u0633\u062A\u062A \u067E\u06CC\u0627\u0645 \u0628\u0641\u0631\u0633\u062A\u06CC\u0645.","home.subscribe":"\u0639\u0636\u0648\u06CC\u062A","stats.products":"\u06A9\u0627\u0644\u0627\u06CC \u0641\u0639\u0627\u0644","stats.ordersTotal":"\u06A9\u0644 \u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627","stats.ordersToday":"\u0633\u0641\u0627\u0631\u0634 \u0627\u0645\u0631\u0648\u0632","stats.visitsToday":"\u0628\u0627\u0632\u062F\u06CC\u062F \u0627\u0645\u0631\u0648\u0632","stats.visitsTotal":"\u06A9\u0644 \u0628\u0627\u0632\u062F\u06CC\u062F\u0647\u0627","stats.pendingOrders":"\u0633\u0641\u0627\u0631\u0634 \u062F\u0631 \u062D\u0627\u0644 \u0628\u0631\u0631\u0633\u06CC","stats.delivered":"\u062A\u062D\u0648\u06CC\u0644 \u0645\u0648\u0641\u0642","stats.customers":"\u0645\u0634\u062A\u0631\u06CC \u062B\u0628\u062A\u200C\u0646\u0627\u0645\u200C\u0634\u062F\u0647","stats.plusMembers":"\u0639\u0636\u0648 \u067E\u0644\u0627\u0633","stats.categories":"\u062F\u0633\u062A\u0647\u200C\u0628\u0646\u062F\u06CC","stats.brands":"\u0628\u0631\u0646\u062F","stats.outOfStock":"\u06A9\u0627\u0644\u0627\u06CC \u0646\u0627\u0645\u0648\u062C\u0648\u062F","stats.years":"\u0633\u0627\u0644 \u0641\u0639\u0627\u0644\u06CC\u062A","stats.title":"\u0622\u0645\u0627\u0631 \u0639\u0645\u0648\u0645\u06CC \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","stats.sub":"\u0627\u06CC\u0646 \u0622\u0645\u0627\u0631 \u0628\u0647\u200C\u0635\u0648\u0631\u062A \u0632\u0646\u062F\u0647 \u0627\u0632 \u062F\u0627\u062F\u0647\u200C\u0647\u0627\u06CC \u0648\u0627\u0642\u0639\u06CC \u0633\u0627\u06CC\u062A \u06AF\u0631\u0641\u062A\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F.","stats.chartTitle":"\u0628\u0627\u0632\u062F\u06CC\u062F \u06F1\u06F4 \u0631\u0648\u0632 \u0627\u062E\u06CC\u0631","stats.topProducts":"\u067E\u0631\u0641\u0631\u0648\u0634\u200C\u062A\u0631\u06CC\u0646 \u06A9\u0627\u0644\u0627\u0647\u0627","stats.transparency":"\u0634\u0641\u0627\u0641\u06CC\u062A \u0628\u0631\u0627\u06CC \u0645\u0634\u062A\u0631\u06CC","stats.transparencyText":"\u0645\u0627 \u0645\u0648\u062C\u0648\u062F\u06CC \u0648 \u0642\u06CC\u0645\u062A \u0648\u0627\u0642\u0639\u06CC \u0631\u0627 \u0646\u0645\u0627\u06CC\u0634 \u0645\u06CC\u200C\u062F\u0647\u06CC\u0645 \u0648 \u0622\u0645\u0627\u0631 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u0631\u0627 \u0647\u0645 \u067E\u0646\u0647\u0627\u0646 \u0646\u0645\u06CC\u200C\u06A9\u0646\u06CC\u0645.","catalog.title":"\u0645\u062D\u0635\u0648\u0644\u0627\u062A","catalog.filters":"\u0641\u06CC\u0644\u062A\u0631\u0647\u0627","catalog.showFilters":"\u0646\u0645\u0627\u06CC\u0634 \u0641\u06CC\u0644\u062A\u0631\u0647\u0627","catalog.hideFilters":"\u0628\u0633\u062A\u0646 \u0641\u06CC\u0644\u062A\u0631\u0647\u0627","catalog.sort.relevant":"\u0645\u0631\u062A\u0628\u0637\u200C\u062A\u0631\u06CC\u0646","catalog.sort.newest":"\u062C\u062F\u06CC\u062F\u062A\u0631\u06CC\u0646","catalog.sort.oldest":"\u0642\u062F\u06CC\u0645\u06CC\u200C\u062A\u0631\u06CC\u0646","catalog.sort.cheapest":"\u0627\u0631\u0632\u0627\u0646\u200C\u062A\u0631\u06CC\u0646","catalog.sort.dearest":"\u06AF\u0631\u0627\u0646\u200C\u062A\u0631\u06CC\u0646","catalog.sort.popular":"\u067E\u0631\u0641\u0631\u0648\u0634\u200C\u062A\u0631\u06CC\u0646","catalog.sort.rating":"\u0628\u06CC\u0634\u062A\u0631\u06CC\u0646 \u0627\u0645\u062A\u06CC\u0627\u0632","catalog.sort.discount":"\u0628\u06CC\u0634\u062A\u0631\u06CC\u0646 \u062A\u062E\u0641\u06CC\u0641","catalog.sort.name":"\u062D\u0631\u0648\u0641 \u0627\u0644\u0641\u0628\u0627","catalog.f.category":"\u062F\u0633\u062A\u0647\u200C\u0628\u0646\u062F\u06CC","catalog.f.brand":"\u0628\u0631\u0646\u062F","catalog.f.price":"\u0645\u062D\u062F\u0648\u062F\u0647\u200C\u06CC \u0642\u06CC\u0645\u062A","catalog.f.availability":"\u0645\u0648\u062C\u0648\u062F\u06CC","catalog.f.inStock":"\u0641\u0642\u0637 \u06A9\u0627\u0644\u0627\u0647\u0627\u06CC \u0645\u0648\u062C\u0648\u062F","catalog.f.discountOnly":"\u0641\u0642\u0637 \u062A\u062E\u0641\u06CC\u0641\u200C\u062F\u0627\u0631","catalog.f.rating":"\u062D\u062F\u0627\u0642\u0644 \u0627\u0645\u062A\u06CC\u0627\u0632","catalog.f.authenticity":"\u0627\u0635\u0627\u0644\u062A \u06A9\u0627\u0644\u0627","catalog.f.clear":"\u062D\u0630\u0641 \u0647\u0645\u0647\u200C\u06CC \u0641\u06CC\u0644\u062A\u0631\u0647\u0627","catalog.count":"\u06A9\u0627\u0644\u0627","catalog.viewGrid":"\u0646\u0645\u0627\u06CC\u0634 \u0634\u0628\u06A9\u0647\u200C\u0627\u06CC","catalog.viewList":"\u0646\u0645\u0627\u06CC\u0634 \u0641\u0647\u0631\u0633\u062A\u06CC","auth.original":"\u0627\u0635\u0644 (\u0627\u0648\u0631\u062C\u06CC\u0646\u0627\u0644)","auth.highcopy":"\u0647\u0627\u06CC\u200C\u06A9\u067E\u06CC \u062F\u0631\u062C\u0647 \u06CC\u06A9","auth.generic":"\u0645\u062A\u0641\u0631\u0642\u0647","card.addToCart":"\u0627\u0641\u0632\u0648\u062F\u0646 \u0628\u0647 \u0633\u0628\u062F","card.added":"\u0628\u0647 \u0633\u0628\u062F \u0627\u0636\u0627\u0641\u0647 \u0634\u062F","card.quickView":"\u0645\u0634\u0627\u0647\u062F\u0647\u200C\u06CC \u0633\u0631\u06CC\u0639","card.wishlistAdd":"\u0627\u0641\u0632\u0648\u062F\u0646 \u0628\u0647 \u0644\u06CC\u0633\u062A \u0645\u0646","card.wishlistRemove":"\u062D\u0630\u0641 \u0627\u0632 \u0644\u06CC\u0633\u062A \u0645\u0646","card.compareAdd":"\u0627\u0641\u0632\u0648\u062F\u0646 \u0628\u0647 \u0645\u0642\u0627\u06CC\u0633\u0647","card.outOfStock":"\u0646\u0627\u0645\u0648\u062C\u0648\u062F","card.soldOut":"\u062A\u0645\u0627\u0645 \u0634\u062F","pdp.addToCart":"\u0627\u0641\u0632\u0648\u062F\u0646 \u0628\u0647 \u0633\u0628\u062F \u062E\u0631\u06CC\u062F","pdp.buyNow":"\u062E\u0631\u06CC\u062F \u0641\u0648\u0631\u06CC","pdp.pickup":"\u062A\u062D\u0648\u06CC\u0644 \u062D\u0636\u0648\u0631\u06CC \u0631\u0627\u06CC\u06AF\u0627\u0646 \u062F\u0631 \u0645\u063A\u0627\u0632\u0647","pdp.warranty":"\u06AF\u0627\u0631\u0627\u0646\u062A\u06CC","pdp.warrantyMonths":"{n} \u0645\u0627\u0647 \u06AF\u0627\u0631\u0627\u0646\u062A\u06CC \u062A\u0639\u0648\u06CC\u0636 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","pdp.noWarranty":"\u0628\u062F\u0648\u0646 \u06AF\u0627\u0631\u0627\u0646\u062A\u06CC","pdp.sku":"\u06A9\u062F \u06A9\u0627\u0644\u0627","pdp.barcode":"\u0628\u0627\u0631\u06A9\u062F","pdp.weight":"\u0648\u0632\u0646","pdp.gram":"\u06AF\u0631\u0645","pdp.zoomIn":"\u0628\u0632\u0631\u06AF\u200C\u0646\u0645\u0627\u06CC\u06CC","pdp.zoomOut":"\u06A9\u0648\u0686\u06A9\u200C\u0646\u0645\u0627\u06CC\u06CC","pdp.zoomReset":"\u0627\u0646\u062F\u0627\u0632\u0647\u0654 \u0627\u0635\u0644\u06CC","pdp.zoomHint":"\u0630\u0631\u0647\u200C\u0628\u06CC\u0646: \u0645\u0648\u0633 \u0631\u0627 \u0631\u0648\u06CC \u062A\u0635\u0648\u06CC\u0631 \u0628\u0628\u0631\u061B \u0628\u0632\u0631\u06AF\u200C\u0646\u0645\u0627\u06CC\u06CC \u06A9\u0627\u0645\u0644: \u06A9\u0644\u06CC\u06A9 \u06CC\u0627 \u062F\u0648\u0636\u0631\u0628\u0647","pdp.video":"\u0648\u06CC\u062F\u06CC\u0648","pdp.share":"\u0627\u0634\u062A\u0631\u0627\u06A9\u200C\u06AF\u0630\u0627\u0631\u06CC","pdp.specs":"\u0645\u0634\u062E\u0635\u0627\u062A \u0641\u0646\u06CC","pdp.description":"\u062A\u0648\u0636\u06CC\u062D\u0627\u062A","pdp.reviews":"\u0646\u0638\u0631\u0627\u062A \u0648 \u0627\u0645\u062A\u06CC\u0627\u0632\u0647\u0627","pdp.questions":"\u0633\u0624\u0627\u0644\u0627\u062A \u06A9\u0627\u0631\u0628\u0631\u0627\u0646","pdp.related":"\u06A9\u0627\u0644\u0627\u0647\u0627\u06CC \u0645\u0634\u0627\u0628\u0647","pdp.compatibility":"\u0633\u0627\u0632\u06AF\u0627\u0631\u06CC","pdp.writeReview":"\u062B\u0628\u062A \u0646\u0638\u0631 \u0648 \u0627\u0645\u062A\u06CC\u0627\u0632","pdp.askQuestion":"\u067E\u0631\u0633\u06CC\u062F\u0646 \u0633\u0624\u0627\u0644","pdp.loginToReview":"\u0628\u0631\u0627\u06CC \u062B\u0628\u062A \u0646\u0638\u0631 \u0648\u0627\u0631\u062F \u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC \u0634\u0648.","pdp.reviewSubmitted":"\u0646\u0638\u0631 \u0634\u0645\u0627 \u062B\u0628\u062A \u0634\u062F \u0648 \u067E\u0633 \u0627\u0632 \u062A\u0623\u06CC\u06CC\u062F \u0645\u062F\u06CC\u0631 \u0646\u0645\u0627\u06CC\u0634 \u062F\u0627\u062F\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F.","pdp.reviewPending":"\u0646\u0638\u0631 \u0634\u0645\u0627 \u067E\u0633 \u0627\u0632 \u062A\u0623\u06CC\u06CC\u062F \u0645\u062F\u06CC\u0631 \u0646\u0645\u0627\u06CC\u0634 \u062F\u0627\u062F\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F.","pdp.questionSubmitted":"\u0633\u0624\u0627\u0644 \u0634\u0645\u0627 \u062B\u0628\u062A \u0634\u062F\u061B \u067E\u0633 \u0627\u0632 \u062A\u0623\u06CC\u06CC\u062F\u060C \u0645\u062F\u06CC\u0631 \u0628\u0647 \u0622\u0646 \u067E\u0627\u0633\u062E \u0645\u06CC\u200C\u062F\u0647\u062F.","pdp.buyerBadge":"\u062E\u0631\u06CC\u062F\u0627\u0631 \u0627\u06CC\u0646 \u06A9\u0627\u0644\u0627","pdp.visitorBadge":"\u0628\u0627\u0632\u062F\u06CC\u062F\u06A9\u0646\u0646\u062F\u0647","pdp.helpful":"\u0645\u0641\u06CC\u062F \u0628\u0648\u062F","pdp.storeReply":"\u067E\u0627\u0633\u062E \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","pdp.noReviews":"\u0647\u0646\u0648\u0632 \u0646\u0638\u0631\u06CC \u062B\u0628\u062A \u0646\u0634\u062F\u0647. \u0627\u0648\u0644\u06CC\u0646 \u0646\u0641\u0631 \u0628\u0627\u0634!","pdp.noQuestions":"\u0633\u0624\u0627\u0644\u06CC \u062B\u0628\u062A \u0646\u0634\u062F\u0647. \u0627\u06AF\u0631 \u0633\u0624\u0627\u0644\u06CC \u062F\u0627\u0631\u06CC \u0628\u067E\u0631\u0633.","pdp.yourRating":"\u0627\u0645\u062A\u06CC\u0627\u0632 \u0634\u0645\u0627","pdp.viewed":"\u0628\u0627\u0632\u062F\u06CC\u062F","pdp.sold":"\u0641\u0631\u0648\u0634 \u0631\u0641\u062A\u0647","pdp.off":"\u062A\u062E\u0641\u06CC\u0641","pdp.save":"\u0633\u0648\u062F \u0634\u0645\u0627","pdp.lastPrice":"\u0642\u06CC\u0645\u062A \u0642\u0628\u0644\u06CC","pdp.stockCount":"\u0645\u0648\u062C\u0648\u062F\u06CC: {n} \u0639\u062F\u062F","pdp.fastSend":"\u0627\u0631\u0633\u0627\u0644 \u0633\u0631\u06CC\u0639 \u0627\u0632 \u0628\u0648\u0634\u0647\u0631","pdp.installment":"\u067E\u0631\u062F\u0627\u062E\u062A \u062F\u0631 \u0645\u062D\u0644 \u0628\u0631\u0627\u06CC \u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627\u06CC \u0648\u0627\u062C\u062F \u0634\u0631\u0627\u06CC\u0637","cart.title":"\u0633\u0628\u062F \u062E\u0631\u06CC\u062F","cart.empty":"\u0633\u0628\u062F \u062E\u0631\u06CC\u062F \u062E\u0627\u0644\u06CC \u0627\u0633\u062A","cart.emptyText":"\u0647\u0646\u0648\u0632 \u06A9\u0627\u0644\u0627\u06CC\u06CC \u0627\u0646\u062A\u062E\u0627\u0628 \u0646\u06A9\u0631\u062F\u0647\u200C\u0627\u06CC. \u0627\u0632 \u062F\u0633\u062A\u0647\u200C\u0628\u0646\u062F\u06CC\u200C\u0647\u0627 \u06CC\u0627 \u062C\u0633\u062A\u200C\u0648\u062C\u0648 \u0634\u0631\u0648\u0639 \u06A9\u0646.","cart.goShopping":"\u0628\u0631\u06CC\u0645 \u0633\u0631\u0627\u063A \u062E\u0631\u06CC\u062F","cart.item":"\u06A9\u0627\u0644\u0627","cart.qty":"\u062A\u0639\u062F\u0627\u062F","cart.remove":"\u062D\u0630\u0641","cart.clear":"\u062E\u0627\u0644\u06CC \u06A9\u0631\u062F\u0646 \u0633\u0628\u062F","cart.clearConfirm":"\u0647\u0645\u0647\u200C\u06CC \u06A9\u0627\u0644\u0627\u0647\u0627\u06CC \u0633\u0628\u062F \u062D\u0630\u0641 \u0634\u0648\u0646\u062F\u061F","cart.summary":"\u062E\u0644\u0627\u0635\u0647\u200C\u06CC \u0633\u0641\u0627\u0631\u0634","cart.continue":"\u0627\u062F\u0627\u0645\u0647\u200C\u06CC \u0641\u0631\u0622\u06CC\u0646\u062F \u062E\u0631\u06CC\u062F","cart.freeShipHint":"\u0627\u06AF\u0631 {amount} \u062A\u0648\u0645\u0627\u0646 \u062F\u06CC\u06AF\u0631 \u062E\u0631\u06CC\u062F \u06A9\u0646\u06CC\u060C \u0627\u0631\u0633\u0627\u0644 \u0631\u0627\u06CC\u06AF\u0627\u0646 \u0645\u06CC\u200C\u0634\u0648\u062F.","cart.freeShipDone":"\u0627\u0631\u0633\u0627\u0644 \u0627\u06CC\u0646 \u0633\u0641\u0627\u0631\u0634 \u0631\u0627\u06CC\u06AF\u0627\u0646 \u0627\u0633\u062A!","cart.couponApplied":"\u06A9\u062F \u062A\u062E\u0641\u06CC\u0641 \u0627\u0639\u0645\u0627\u0644 \u0634\u062F","cart.couponPlaceholder":"\u06A9\u062F \u062A\u062E\u0641\u06CC\u0641 \u062F\u0627\u0631\u06CC\u061F \u0648\u0627\u0631\u062F \u06A9\u0646","cart.applyCoupon":"\u0627\u0639\u0645\u0627\u0644 \u06A9\u062F","cart.removeCoupon":"\u062D\u0630\u0641 \u06A9\u062F","cart.updated":"\u0633\u0628\u062F \u0628\u0647\u200C\u0631\u0648\u0632\u0631\u0633\u0627\u0646\u06CC \u0634\u062F","checkout.title":"\u062A\u06A9\u0645\u06CC\u0644 \u0633\u0641\u0627\u0631\u0634","checkout.step1":"\u062A\u062D\u0648\u06CC\u0644","checkout.step2":"\u067E\u0631\u062F\u0627\u062E\u062A","checkout.step3":"\u062A\u0623\u06CC\u06CC\u062F","checkout.delivery":"\u0631\u0648\u0634 \u062A\u062D\u0648\u06CC\u0644","checkout.pickup":"\u062A\u062D\u0648\u06CC\u0644 \u062D\u0636\u0648\u0631\u06CC \u0627\u0632 \u0645\u063A\u0627\u0632\u0647","checkout.pickupDesc":"\u0631\u0627\u06CC\u06AF\u0627\u0646 \u2014 \u067E\u0633 \u0627\u0632 \u062A\u0623\u06CC\u06CC\u062F\u060C \u0627\u0639\u0644\u0627\u0646 \u0622\u0645\u0627\u062F\u0647\u200C\u0633\u0627\u0632\u06CC \u0645\u06CC\u200C\u06AF\u06CC\u0631\u06CC \u0648 \u062D\u0636\u0648\u0631\u06CC \u062A\u062D\u0648\u06CC\u0644 \u0645\u06CC\u200C\u06AF\u06CC\u0631\u06CC.","checkout.courier":"\u0627\u0631\u0633\u0627\u0644 \u0628\u0627 \u067E\u06CC\u06A9 / \u067E\u0633\u062A","checkout.courierDesc":"\u0627\u0631\u0633\u0627\u0644 \u0628\u0647 \u0622\u062F\u0631\u0633 \u062B\u0628\u062A\u200C\u0634\u062F\u0647 \u0628\u0627 \u0627\u0645\u06A9\u0627\u0646 \u0628\u06CC\u0645\u0647\u200C\u06CC \u0645\u0631\u0633\u0648\u0644\u0647.","checkout.zone":"\u0645\u0646\u0637\u0642\u0647\u200C\u06CC \u0627\u0631\u0633\u0627\u0644","checkout.express":"\u0627\u0631\u0633\u0627\u0644 \u0641\u0648\u0631\u06CC (\u0647\u0645\u0627\u0646 \u0631\u0648\u0632)","checkout.insuranceOpt":"\u0628\u06CC\u0645\u0647\u200C\u06CC \u0645\u0631\u0633\u0648\u0644\u0647","checkout.insuranceDesc":"\u062F\u0631 \u0635\u0648\u0631\u062A \u0622\u0633\u06CC\u0628 \u06CC\u0627 \u0645\u0641\u0642\u0648\u062F\u06CC \u062F\u0631 \u0645\u0633\u06CC\u0631\u060C \u0645\u0639\u0627\u062F\u0644 \u0627\u0631\u0632\u0634 \u06A9\u0627\u0644\u0627 \u062C\u0628\u0631\u0627\u0646 \u0645\u06CC\u200C\u0634\u0648\u062F.","checkout.insuranceAuto":"\u0628\u0631\u0627\u06CC \u0627\u0639\u0636\u0627\u06CC \u067E\u0644\u0627\u0633 \u0628\u0647\u200C\u0635\u0648\u0631\u062A \u062E\u0648\u062F\u06A9\u0627\u0631 \u0648 \u0631\u0627\u06CC\u06AF\u0627\u0646 \u0627\u0639\u0645\u0627\u0644 \u0634\u062F.","checkout.address":"\u0622\u062F\u0631\u0633 \u0627\u0631\u0633\u0627\u0644","checkout.addAddress":"\u0627\u0641\u0632\u0648\u062F\u0646 \u0622\u062F\u0631\u0633 \u062C\u062F\u06CC\u062F","checkout.noAddress":"\u0628\u0631\u0627\u06CC \u0627\u0631\u0633\u0627\u0644 \u067E\u0633\u062A\u06CC \u0628\u0627\u06CC\u062F \u062D\u062F\u0627\u0642\u0644 \u06CC\u06A9 \u0622\u062F\u0631\u0633 \u062B\u0628\u062A \u06A9\u0646\u06CC.","checkout.paymentMethod":"\u0631\u0648\u0634 \u067E\u0631\u062F\u0627\u062E\u062A","checkout.useWallet":"\u067E\u0631\u062F\u0627\u062E\u062A \u0627\u0632 \u06A9\u06CC\u0641 \u067E\u0648\u0644","checkout.walletBalance":"\u0645\u0648\u062C\u0648\u062F\u06CC \u06A9\u06CC\u0641 \u067E\u0648\u0644: {amount} \u062A\u0648\u0645\u0627\u0646","checkout.note":"\u062A\u0648\u0636\u06CC\u062D\u0627\u062A \u0633\u0641\u0627\u0631\u0634 (\u0627\u062E\u062A\u06CC\u0627\u0631\u06CC)","checkout.notePlaceholder":"\u0645\u062B\u0644\u0627\u064B: \u0644\u0637\u0641\u0627\u064B \u0642\u0628\u0644 \u0627\u0632 \u0627\u0631\u0633\u0627\u0644 \u062A\u0645\u0627\u0633 \u0628\u06AF\u06CC\u0631\u06CC\u062F.","checkout.acceptTerms":"\u0642\u0648\u0627\u0646\u06CC\u0646 \u0648 \u0645\u0642\u0631\u0631\u0627\u062A \u0648 \u062D\u0631\u06CC\u0645 \u062E\u0635\u0648\u0635\u06CC \u0631\u0627 \u062E\u0648\u0627\u0646\u062F\u0647\u200C\u0627\u0645 \u0648 \u0645\u06CC\u200C\u067E\u0630\u06CC\u0631\u0645.","checkout.placeOrder":"\u062B\u0628\u062A \u0648 \u067E\u0631\u062F\u0627\u062E\u062A \u0633\u0641\u0627\u0631\u0634","checkout.placing":"\u062F\u0631 \u062D\u0627\u0644 \u062B\u0628\u062A \u0633\u0641\u0627\u0631\u0634\u2026","checkout.loginRequired":"\u0628\u0631\u0627\u06CC \u062A\u06A9\u0645\u06CC\u0644 \u062E\u0631\u06CC\u062F \u0648\u0627\u0631\u062F \u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC \u0634\u0648.","checkout.successTitle":"\u0633\u0641\u0627\u0631\u0634 \u062B\u0628\u062A \u0634\u062F","checkout.successText":"\u06A9\u062F \u0633\u0641\u0627\u0631\u0634 \u062A\u0648 {code} \u0627\u0633\u062A. \u0648\u0636\u0639\u06CC\u062A \u0631\u0627 \u0627\u0632 \u0628\u062E\u0634 \xAB\u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627\u06CC \u0645\u0646\xBB \u067E\u06CC\u06AF\u06CC\u0631\u06CC \u06A9\u0646.","checkout.payNow":"\u067E\u0631\u062F\u0627\u062E\u062A \u0622\u0646\u0644\u0627\u06CC\u0646","checkout.payLater":"\u0628\u0639\u062F\u0627\u064B \u067E\u0631\u062F\u0627\u062E\u062A \u0645\u06CC\u200C\u06A9\u0646\u0645","checkout.gatewayDemo":"\u062F\u0631\u06AF\u0627\u0647 \u062F\u0631 \u062D\u0627\u0644\u062A \u0622\u0632\u0645\u0627\u06CC\u0634\u06CC \u0627\u0633\u062A\u061B \u0647\u06CC\u0686 \u0645\u0628\u0644\u063A\u06CC \u0648\u0627\u0642\u0639\u0627\u064B \u06A9\u0633\u0631 \u0646\u0645\u06CC\u200C\u0634\u0648\u062F.","checkout.paymentSuccess":"\u067E\u0631\u062F\u0627\u062E\u062A \u0645\u0648\u0641\u0642 \u0628\u0648\u062F","checkout.paymentFailed":"\u067E\u0631\u062F\u0627\u062E\u062A \u0646\u0627\u0645\u0648\u0641\u0642 \u0628\u0648\u062F","checkout.simulateSuccess":"\u067E\u0631\u062F\u0627\u062E\u062A \u0645\u0648\u0641\u0642 (\u0634\u0628\u06CC\u0647\u200C\u0633\u0627\u0632\u06CC \u062F\u0631\u06AF\u0627\u0647)","checkout.simulateFail":"\u0644\u063A\u0648 \u067E\u0631\u062F\u0627\u062E\u062A","checkout.concurrencyNote":"\u0645\u0648\u062C\u0648\u062F\u06CC \u062F\u0631 \u0644\u062D\u0638\u0647\u200C\u06CC \u062B\u0628\u062A \u0633\u0641\u0627\u0631\u0634 \u0642\u0641\u0644 \u0645\u06CC\u200C\u0634\u0648\u062F\u061B \u0627\u06AF\u0631 \u06A9\u0627\u0644\u0627\u06CC\u06CC \u0647\u0645\u200C\u0632\u0645\u0627\u0646 \u062A\u0645\u0627\u0645 \u0634\u0648\u062F\u060C \u0628\u0647 \u062A\u0648 \u0627\u0637\u0644\u0627\u0639 \u0645\u06CC\u200C\u062F\u0647\u06CC\u0645 \u0648 \u0648\u062C\u0647 \u0628\u0627\u0632 \u0645\u06CC\u200C\u06AF\u0631\u062F\u062F.","checkout.pickupReady":"\u0632\u0645\u0627\u0646 \u0622\u0645\u0627\u062F\u0647\u200C\u0633\u0627\u0632\u06CC: \u062D\u062F\u0648\u062F {h} \u0633\u0627\u0639\u062A \u06A9\u0627\u0631\u06CC","auth.title":"\u0648\u0631\u0648\u062F \u06CC\u0627 \u062B\u0628\u062A\u200C\u0646\u0627\u0645","auth.loginTitle":"\u0648\u0631\u0648\u062F \u0628\u0647 \u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC","auth.registerTitle":"\u0633\u0627\u062E\u062A \u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC","auth.methodPassword":"\u0646\u0627\u0645 \u06A9\u0627\u0631\u0628\u0631\u06CC \u0648 \u0631\u0645\u0632","auth.methodPhone":"\u0634\u0645\u0627\u0631\u0647 \u0645\u0648\u0628\u0627\u06CC\u0644","auth.methodEmail":"\u0627\u06CC\u0645\u06CC\u0644","auth.identifier":"\u0646\u0627\u0645 \u06A9\u0627\u0631\u0628\u0631\u06CC\u060C \u0645\u0648\u0628\u0627\u06CC\u0644 \u06CC\u0627 \u0627\u06CC\u0645\u06CC\u0644","auth.remember":"\u0645\u0631\u0627 \u0628\u0647 \u062E\u0627\u0637\u0631 \u0628\u0633\u067E\u0627\u0631","auth.forgot":"\u0641\u0631\u0627\u0645\u0648\u0634\u06CC \u0631\u0645\u0632 \u0639\u0628\u0648\u0631","auth.noAccount":"\u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC \u0646\u062F\u0627\u0631\u06CC\u061F","auth.haveAccount":"\u0642\u0628\u0644\u0627\u064B \u062B\u0628\u062A\u200C\u0646\u0627\u0645 \u06A9\u0631\u062F\u0647\u200C\u0627\u06CC\u061F","auth.sendCode":"\u0627\u0631\u0633\u0627\u0644 \u06A9\u062F \u062A\u0623\u06CC\u06CC\u062F","auth.codeSent":"\u06A9\u062F \u062A\u0623\u06CC\u06CC\u062F \u0627\u0631\u0633\u0627\u0644 \u0634\u062F","auth.codeSentTo":"\u06A9\u062F \u06F6 \u0631\u0642\u0645\u06CC \u0628\u0647 {target} \u0627\u0631\u0633\u0627\u0644 \u0634\u062F.","auth.enterCode":"\u06A9\u062F \u062A\u0623\u06CC\u06CC\u062F \u0631\u0627 \u0648\u0627\u0631\u062F \u06A9\u0646","auth.otpCode":"\u06A9\u062F \u062A\u0623\u06CC\u06CC\u062F","auth.resend":"\u0627\u0631\u0633\u0627\u0644 \u062F\u0648\u0628\u0627\u0631\u0647\u200C\u06CC \u06A9\u062F","auth.resendIn":"\u0627\u0631\u0633\u0627\u0644 \u062F\u0648\u0628\u0627\u0631\u0647 \u062A\u0627 {s} \u062B\u0627\u0646\u06CC\u0647","auth.demoCode":"\u062D\u0627\u0644\u062A \u0622\u0632\u0645\u0627\u06CC\u0634\u06CC: \u06A9\u062F \u062A\u0623\u06CC\u06CC\u062F {code}","auth.2faTitle":"\u0648\u0631\u0648\u062F \u062F\u0648\u0645\u0631\u062D\u0644\u0647\u200C\u0627\u06CC","auth.2faText":"\u06A9\u062F \u06F6 \u0631\u0642\u0645\u06CC \u0627\u0632 \u0627\u067E \u0627\u062D\u0631\u0627\u0632 \u0647\u0648\u06CC\u062A\u060C \u067E\u06CC\u0627\u0645\u06A9 \u06CC\u0627 \u0627\u06CC\u0645\u06CC\u0644 \u0631\u0627 \u0648\u0627\u0631\u062F \u06A9\u0646.","auth.2faTotp":"\u0627\u067E \u0627\u062D\u0631\u0627\u0632 \u0647\u0648\u06CC\u062A","auth.2faSms":"\u06A9\u062F \u067E\u06CC\u0627\u0645\u06A9\u06CC","auth.2faEmail":"\u06A9\u062F \u0627\u06CC\u0645\u06CC\u0644\u06CC","auth.2faBackup":"\u06A9\u062F \u067E\u0634\u062A\u06CC\u0628\u0627\u0646","auth.2faVerify":"\u062A\u0623\u06CC\u06CC\u062F \u0648 \u0648\u0631\u0648\u062F","auth.acceptTerms":"\u0642\u0648\u0627\u0646\u06CC\u0646 \u0648 \u0645\u0642\u0631\u0631\u0627\u062A \u0648 \u062D\u0631\u06CC\u0645 \u062E\u0635\u0648\u0635\u06CC \u0631\u0627 \u0645\u06CC\u200C\u067E\u0630\u06CC\u0631\u0645.","auth.referral":"\u06A9\u062F \u0645\u0639\u0631\u0641 (\u0627\u062E\u062A\u06CC\u0627\u0631\u06CC)","auth.registerDone":"\u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC \u0633\u0627\u062E\u062A\u0647 \u0634\u062F. \u062E\u0648\u0634 \u0622\u0645\u062F\u06CC!","auth.loginDone":"\u062E\u0648\u0634 \u0622\u0645\u062F\u06CC","auth.logoutDone":"\u0628\u0627 \u0645\u0648\u0641\u0642\u06CC\u062A \u062E\u0627\u0631\u062C \u0634\u062F\u06CC","auth.recoveryTitle":"\u0628\u0627\u0632\u06CC\u0627\u0628\u06CC \u0631\u0645\u0632 \u0639\u0628\u0648\u0631","auth.recoveryText":"\u0634\u0645\u0627\u0631\u0647\u200C\u06CC \u0645\u0648\u0628\u0627\u06CC\u0644 \u06CC\u0627 \u0627\u06CC\u0645\u06CC\u0644 \u062B\u0628\u062A\u200C\u0634\u062F\u0647 \u0631\u0627 \u0648\u0627\u0631\u062F \u06A9\u0646 \u062A\u0627 \u06A9\u062F \u0628\u0627\u0632\u06CC\u0627\u0628\u06CC \u0628\u0641\u0631\u0633\u062A\u06CC\u0645.","auth.newPassword":"\u0631\u0645\u0632 \u0639\u0628\u0648\u0631 \u062C\u062F\u06CC\u062F","auth.resetDone":"\u0631\u0645\u0632 \u0639\u0628\u0648\u0631 \u0628\u0627 \u0645\u0648\u0641\u0642\u06CC\u062A \u062A\u063A\u06CC\u06CC\u0631 \u06A9\u0631\u062F","auth.passwordRules":"\u062D\u062F\u0627\u0642\u0644 \u06F8 \u0646\u0648\u06CC\u0633\u0647 \u0634\u0627\u0645\u0644 \u062D\u0631\u0648\u0641 \u06A9\u0648\u0686\u06A9\u060C \u062D\u0631\u0648\u0641 \u0628\u0632\u0631\u06AF\u060C \u0639\u062F\u062F \u0648 \u0646\u0645\u0627\u062F","auth.orContinue":"\u06CC\u0627","auth.guestCheckout":"\u0627\u062F\u0627\u0645\u0647\u200C\u06CC \u062E\u0631\u06CC\u062F \u0628\u062F\u0648\u0646 \u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC","acc.title":"\u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC","acc.dashboard":"\u062F\u0627\u0634\u0628\u0648\u0631\u062F \u0645\u0646","acc.badges":"\u0627\u0641\u062A\u062E\u0627\u0631\u0627\u062A \u0645\u0646","badge.got":"\u062F\u0631\u06CC\u0627\u0641\u062A\u200C\u0634\u062F\u0647","badge.locked":"\u0647\u0646\u0648\u0632 \u0642\u0641\u0644","badge.first-buy":"\u0646\u062E\u0633\u062A\u06CC\u0646 \u062E\u0631\u06CC\u062F","badge.first-buy.d":"\u0627\u0648\u0644\u06CC\u0646 \u0633\u0641\u0627\u0631\u0634 \u0645\u0648\u0641\u0642 \u0631\u0627 \u062B\u0628\u062A \u06A9\u0631\u062F\u0647\u200C\u0627\u06CC\u062F.","badge.silver-buyer":"\u062E\u0631\u06CC\u062F\u0627\u0631 \u0646\u0642\u0631\u0647\u200C\u0627\u06CC","badge.silver-buyer.d":"\u06F5 \u062E\u0631\u06CC\u062F \u0645\u0648\u0641\u0642\u061B \u0627\u0639\u062A\u0628\u0627\u0631 \u0634\u0645\u0627 \u0646\u0632\u062F \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644.","badge.gold-buyer":"\u062E\u0631\u06CC\u062F\u0627\u0631 \u0637\u0644\u0627\u06CC\u06CC","badge.gold-buyer.d":"\u06F1\u06F5 \u062E\u0631\u06CC\u062F \u0645\u0648\u0641\u0642\u061B \u0645\u0634\u062A\u0631\u06CC \u0648\u06CC\u0698\u0647\u0654 \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644.","badge.big-spender":"\u062E\u0648\u0634\u200C\u062D\u0633\u0627\u0628","badge.big-spender.d":"\u0645\u062C\u0645\u0648\u0639 \u062E\u0631\u06CC\u062F \u0628\u0627\u0644\u0627\u06CC \u06F5\u06F0 \u0645\u06CC\u0644\u06CC\u0648\u0646 \u062A\u0648\u0645\u0627\u0646.","badge.early-bird":"\u067E\u06CC\u0634\u06AF\u0627\u0645","badge.early-bird.d":"\u062C\u0632\u0648 \u06F1\u06F0\u06F0 \u06A9\u0627\u0631\u0628\u0631 \u0646\u062E\u0633\u062A \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644 \u0628\u0648\u062F\u0647\u200C\u0627\u06CC\u062F.","badge.veteran":"\u0647\u0645\u0631\u0627\u0647 \u06A9\u0647\u0646\u0647\u200C\u06A9\u0627\u0631","badge.veteran.d":"\u0628\u06CC\u0634 \u0627\u0632 \u06CC\u06A9 \u0633\u0627\u0644 \u0647\u0645\u0631\u0627\u0647 \u0645\u0627 \u0647\u0633\u062A\u06CC\u062F.","badge.reviewer":"\u0646\u0642\u062F\u0646\u0648\u06CC\u0633","badge.reviewer.d":"\u06F3 \u062B\u0628\u062A \u062A\u062C\u0631\u0628\u0647\u0654 \u062E\u0631\u06CC\u062F\u061B \u06A9\u0645\u06A9 \u0628\u0647 \u0627\u0646\u062A\u062E\u0627\u0628 \u0628\u0642\u06CC\u0647.","badge.plus-member":"\u0639\u0636\u0648 \u067E\u0644\u0627\u0633","badge.plus-member.d":"\u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633 \u0641\u0639\u0627\u0644 \u062F\u0627\u0631\u06CC\u062F.","badge.wallet-user":"\u06A9\u06CC\u0641\u200C\u067E\u0648\u0644\u06CC","badge.wallet-user.d":"\u0627\u0632 \u06A9\u06CC\u0641 \u067E\u0648\u0644 \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644 \u0627\u0633\u062A\u0641\u0627\u062F\u0647 \u06A9\u0631\u062F\u0647\u200C\u0627\u06CC\u062F.","badge.supporter":"\u067E\u06CC\u06AF\u06CC\u0631","badge.supporter.d":"\u0627\u0648\u0644\u06CC\u0646 \u062A\u06CC\u06A9\u062A \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0631\u0627 \u062B\u0628\u062A \u06A9\u0631\u062F\u0647\u200C\u0627\u06CC\u062F.","acc.orders":"\u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627\u06CC \u0645\u0646","acc.wishlist":"\u0644\u06CC\u0633\u062A \u0645\u0646","acc.wallet":"\u06A9\u06CC\u0641 \u067E\u0648\u0644","acc.plus":"\u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633","acc.addresses":"\u0622\u062F\u0631\u0633\u200C\u0647\u0627","acc.notifications":"\u0627\u0639\u0644\u0627\u0646\u200C\u0647\u0627","acc.tickets":"\u062A\u06CC\u06A9\u062A\u200C\u0647\u0627\u06CC \u0645\u0646","acc.support":"\u0686\u062A \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC","acc.reviews":"\u0646\u0638\u0631\u0627\u062A \u0645\u0646","acc.feedback":"\u067E\u06CC\u0634\u0646\u0647\u0627\u062F\u0647\u0627 \u0648 \u0634\u06A9\u0627\u06CC\u0627\u062A","acc.profile":"\u0645\u0634\u062E\u0635\u0627\u062A \u067E\u0631\u0648\u0641\u0627\u06CC\u0644","acc.security":"\u0627\u0645\u0646\u06CC\u062A \u062D\u0633\u0627\u0628","acc.sessions":"\u0646\u0634\u0633\u062A\u200C\u0647\u0627\u06CC \u0641\u0639\u0627\u0644","acc.prefs":"\u062A\u0631\u062C\u06CC\u062D\u0627\u062A \u0646\u0645\u0627\u06CC\u0634","acc.data":"\u062F\u0627\u062F\u0647\u200C\u0647\u0627\u06CC \u0645\u0646","acc.hello":"\u0633\u0644\u0627\u0645 {name}","acc.memberSince":"\u0639\u0636\u0648 \u0627\u0632 {date}","acc.noOrders":"\u0647\u0646\u0648\u0632 \u0633\u0641\u0627\u0631\u0634\u06CC \u062B\u0628\u062A \u0646\u06A9\u0631\u062F\u0647\u200C\u0627\u06CC","acc.noOrdersText":"\u0627\u0648\u0644\u06CC\u0646 \u062E\u0631\u06CC\u062F\u062A \u0631\u0627 \u0628\u0627 \u062A\u062E\u0641\u06CC\u0641 \u062E\u0648\u0634\u200C\u0622\u0645\u062F\u06AF\u0648\u06CC\u06CC WELCOME10 \u0627\u0646\u062C\u0627\u0645 \u0628\u062F\u0647.","acc.orderCode":"\u06A9\u062F \u0633\u0641\u0627\u0631\u0634","acc.orderDate":"\u062A\u0627\u0631\u06CC\u062E \u0633\u0641\u0627\u0631\u0634","acc.orderItems":"\u0627\u0642\u0644\u0627\u0645","acc.orderTotal":"\u0645\u0628\u0644\u063A \u06A9\u0644","acc.trackOrder":"\u067E\u06CC\u06AF\u06CC\u0631\u06CC \u0633\u0641\u0627\u0631\u0634","acc.cancelOrder":"\u0644\u063A\u0648 \u0633\u0641\u0627\u0631\u0634","acc.cancelConfirm":"\u0627\u06CC\u0646 \u0633\u0641\u0627\u0631\u0634 \u0644\u063A\u0648 \u0634\u0648\u062F\u061F \u0645\u0628\u0644\u063A \u067E\u0631\u062F\u0627\u062E\u062A\u06CC \u0628\u0647 \u06A9\u06CC\u0641 \u067E\u0648\u0644 \u0628\u0631\u0645\u06CC\u200C\u06AF\u0631\u062F\u062F.","acc.cancelReason":"\u062F\u0644\u06CC\u0644 \u0644\u063A\u0648 (\u0627\u062E\u062A\u06CC\u0627\u0631\u06CC)","acc.orderCancelled":"\u0633\u0641\u0627\u0631\u0634 \u0644\u063A\u0648 \u0634\u062F","acc.reorder":"\u062E\u0631\u06CC\u062F \u062F\u0648\u0628\u0627\u0631\u0647","acc.invoice":"\u0641\u0627\u06A9\u062A\u0648\u0631","acc.printInvoice":"\u0686\u0627\u067E \u0641\u0627\u06A9\u062A\u0648\u0631","acc.timeline":"\u0631\u0648\u0646\u062F \u0633\u0641\u0627\u0631\u0634","acc.walletEmpty":"\u062A\u0631\u0627\u06A9\u0646\u0634\u06CC \u062B\u0628\u062A \u0646\u0634\u062F\u0647 \u0627\u0633\u062A","acc.walletDeposit":"\u0634\u0627\u0631\u0698 \u06A9\u06CC\u0641 \u067E\u0648\u0644","acc.walletAmount":"\u0645\u0628\u0644\u063A \u0634\u0627\u0631\u0698 (\u062A\u0648\u0645\u0627\u0646)","acc.walletDeposited":"\u06A9\u06CC\u0641 \u067E\u0648\u0644 \u0634\u0627\u0631\u0698 \u0634\u062F","acc.walletNote":"\u0645\u0648\u062C\u0648\u062F\u06CC \u06A9\u06CC\u0641 \u067E\u0648\u0644 \u0641\u0642\u0637 \u0628\u0631\u0627\u06CC \u062E\u0631\u06CC\u062F \u0627\u0632 \u0647\u0645\u06CC\u0646 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u0627\u0633\u062A \u0648 \u0633\u0648\u062F \u06CC\u0627 \u06A9\u0627\u0631\u0645\u0632\u062F\u06CC \u0628\u0647 \u0622\u0646 \u062A\u0639\u0644\u0642 \u0646\u0645\u06CC\u200C\u06AF\u06CC\u0631\u062F.","acc.tx.deposit":"\u0634\u0627\u0631\u0698","acc.tx.purchase":"\u062E\u0631\u06CC\u062F","acc.tx.refund":"\u0628\u0627\u0632\u06AF\u0634\u062A \u0648\u062C\u0647","acc.tx.adjust_in":"\u0627\u0641\u0632\u0627\u06CC\u0634 \u062A\u0648\u0633\u0637 \u0645\u062F\u06CC\u0631","acc.tx.adjust_out":"\u06A9\u0633\u0631 \u062A\u0648\u0633\u0637 \u0645\u062F\u06CC\u0631","acc.plusInactive":"\u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633 \u0646\u062F\u0627\u0631\u06CC","acc.plusActive":"\u067E\u0644\u0627\u0633 \u0641\u0639\u0627\u0644 \u062A\u0627 {date}","acc.plusSubscribe":"\u062E\u0631\u06CC\u062F \u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633","acc.plusRenew":"\u062A\u0645\u062F\u06CC\u062F \u0627\u0634\u062A\u0631\u0627\u06A9","acc.plusPrice":"{price} \u062A\u0648\u0645\u0627\u0646 \u0628\u0631\u0627\u06CC {days} \u0631\u0648\u0632","acc.plusPerks":"\u0645\u0632\u0627\u06CC\u0627\u06CC \u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633","acc.plusSubscribed":"\u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633 \u0641\u0639\u0627\u0644 \u0634\u062F","acc.plusPayWallet":"\u067E\u0631\u062F\u0627\u062E\u062A \u0627\u0632 \u06A9\u06CC\u0641 \u067E\u0648\u0644","acc.plusPayGateway":"\u067E\u0631\u062F\u0627\u062E\u062A \u0622\u0646\u0644\u0627\u06CC\u0646","acc.addAddress":"\u0627\u0641\u0632\u0648\u062F\u0646 \u0622\u062F\u0631\u0633","acc.editAddress":"\u0648\u06CC\u0631\u0627\u06CC\u0634 \u0622\u062F\u0631\u0633","acc.addrTitle":"\u0639\u0646\u0648\u0627\u0646 (\u0645\u062B\u0644\u0627\u064B \u062E\u0627\u0646\u0647\u060C \u0645\u062D\u0644 \u06A9\u0627\u0631)","acc.addrReceiver":"\u0646\u0627\u0645 \u06AF\u06CC\u0631\u0646\u062F\u0647","acc.addrPhone":"\u0634\u0645\u0627\u0631\u0647\u200C\u06CC \u062A\u0645\u0627\u0633 \u06AF\u06CC\u0631\u0646\u062F\u0647","acc.addrStreet":"\u0622\u062F\u0631\u0633 \u06A9\u0627\u0645\u0644 \u067E\u0633\u062A\u06CC","acc.addrDefault":"\u0622\u062F\u0631\u0633 \u067E\u06CC\u0634\u200C\u0641\u0631\u0636","acc.addrNote":"\u062A\u0648\u0636\u06CC\u062D\u0627\u062A \u0628\u0631\u0627\u06CC \u067E\u06CC\u06A9","acc.addrSaved":"\u0622\u062F\u0631\u0633 \u0630\u062E\u06CC\u0631\u0647 \u0634\u062F","acc.addrDeleted":"\u0622\u062F\u0631\u0633 \u062D\u0630\u0641 \u0634\u062F","acc.noAddress":"\u0622\u062F\u0631\u0633\u06CC \u062B\u0628\u062A \u0646\u0634\u062F\u0647 \u0627\u0633\u062A","acc.wishlistEmpty":"\u0644\u06CC\u0633\u062A \u0645\u0646 \u062E\u0627\u0644\u06CC \u0627\u0633\u062A","acc.wishlistEmptyText":"\u0631\u0648\u06CC \u0622\u06CC\u06A9\u0648\u0646 \u0642\u0644\u0628 \u0647\u0631 \u06A9\u0627\u0644\u0627 \u0628\u0632\u0646 \u062A\u0627 \u0627\u06CC\u0646\u062C\u0627 \u0630\u062E\u06CC\u0631\u0647 \u0634\u0648\u062F.","acc.notifEmpty":"\u0627\u0639\u0644\u0627\u0646\u06CC \u0646\u062F\u0627\u0631\u06CC","acc.markAllRead":"\u0647\u0645\u0647 \u062E\u0648\u0627\u0646\u062F\u0647 \u0634\u062F","acc.ticketNew":"\u062A\u06CC\u06A9\u062A \u062C\u062F\u06CC\u062F","acc.ticketSubject":"\u0645\u0648\u0636\u0648\u0639","acc.ticketCategory":"\u062F\u0633\u062A\u0647\u200C\u06CC \u062F\u0631\u062E\u0648\u0627\u0633\u062A","acc.ticketPriority":"\u0627\u0648\u0644\u0648\u06CC\u062A","acc.ticketBody":"\u0634\u0631\u062D \u062F\u0631\u062E\u0648\u0627\u0633\u062A","form.rulesRequired":"\u067E\u0630\u06CC\u0631\u0634 \u0642\u0648\u0627\u0646\u06CC\u0646 \u062A\u06CC\u06A9\u062A \u0644\u0627\u0632\u0645 \u0627\u0633\u062A.","form.termsRequired":"\u067E\u0630\u06CC\u0631\u0634 \u0642\u0648\u0627\u0646\u06CC\u0646 \u0648 \u0645\u0642\u0631\u0631\u0627\u062A \u0644\u0627\u0632\u0645 \u0627\u0633\u062A.","page.statsTitle":"\u0622\u0645\u0627\u0631 \u0632\u0646\u062F\u0647\u200C\u06CC \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","page.aboutCta":"\u0628\u06CC\u0627 \u0628\u0628\u06CC\u0646 \u0686\u0647 \u0686\u06CC\u0632\u0647\u0627\u06CC\u06CC \u0628\u0631\u0627\u06CC\u062A \u062F\u0627\u0631\u06CC\u0645","page.stepsTitle":"\u0645\u0631\u0627\u062D\u0644 \u062E\u0631\u06CC\u062F","page.tipsTitle":"\u0646\u06A9\u062A\u0647\u200C\u0647\u0627\u06CC \u062E\u0631\u06CC\u062F","page.hintsTitle":"\u0628\u0631\u0627\u06CC \u06AF\u0632\u0627\u0631\u0634\u06CC \u062F\u0642\u06CC\u0642\u200C\u062A\u0631","page.bugTitle":"\u06AF\u0632\u0627\u0631\u0634 \u062E\u0637\u0627","page.rulesTitle":"\u0642\u0648\u0627\u0646\u06CC\u0646","faq.all":"\u0647\u0645\u0647\u200C\u06CC \u0645\u0648\u0636\u0648\u0639\u0627\u062A","faq.search":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648 \u062F\u0631 \u0633\u0624\u0627\u0644\u0627\u062A\u2026","faq.results":"{n} \u0633\u0624\u0627\u0644","faq.notFound":"\u0633\u0624\u0627\u0644\u06CC \u0628\u0627 \u0627\u06CC\u0646 \u0639\u0628\u0627\u0631\u062A \u067E\u06CC\u062F\u0627 \u0646\u0634\u062F.","faq.askText":"\u0627\u0632 \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0622\u0646\u0644\u0627\u06CC\u0646 \u0628\u067E\u0631\u0633 \u06CC\u0627 \u062A\u06CC\u06A9\u062A \u0628\u0632\u0646.","faq.cat.orders":"\u0633\u0641\u0627\u0631\u0634 \u0648 \u067E\u06CC\u06AF\u06CC\u0631\u06CC","faq.cat.shipping":"\u0627\u0631\u0633\u0627\u0644 \u0648 \u062A\u062D\u0648\u06CC\u0644","faq.cat.returns":"\u0645\u0631\u062C\u0648\u0639\u06CC \u0648 \u0628\u0627\u0632\u06AF\u0634\u062A \u0648\u062C\u0647","faq.cat.product":"\u06A9\u0627\u0644\u0627 \u0648 \u0627\u0635\u0627\u0644\u062A","faq.cat.account":"\u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC","faq.cat.security":"\u0627\u0645\u0646\u06CC\u062A \u0648 \u067E\u0631\u062F\u0627\u062E\u062A","faq.cat.store":"\u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u0648 \u062A\u0645\u0627\u0633","faq.cat.other":"\u0633\u0627\u06CC\u0631","acc.ticketCloseConfirm":"\u062A\u06CC\u06A9\u062A \u0628\u0633\u062A\u0647 \u0634\u0648\u062F\u061F \u0628\u0639\u062F\u0627\u064B \u0628\u0627 \u0627\u0631\u0633\u0627\u0644 \u067E\u06CC\u0627\u0645 \u0645\u06CC\u200C\u062A\u0648\u0627\u0646\u06CC \u0628\u0627\u0632\u0634 \u06AF\u0631\u062F\u0627\u0646\u06CC.","acc.ticketClosedNote":"\u0627\u06CC\u0646 \u062A\u06CC\u06A9\u062A \u0628\u0633\u062A\u0647 \u0634\u062F\u0647 \u0627\u0633\u062A. \u0627\u0631\u0633\u0627\u0644 \u067E\u06CC\u0627\u0645 \u062C\u062F\u06CC\u062F\u060C \u0622\u0646 \u0631\u0627 \u062F\u0648\u0628\u0627\u0631\u0647 \u0628\u0627\u0632 \u0645\u06CC\u200C\u06A9\u0646\u062F.","acc.ticketBodyShort":"\u067E\u06CC\u0627\u0645 \u062E\u06CC\u0644\u06CC \u06A9\u0648\u062A\u0627\u0647 \u0627\u0633\u062A.","acc.attachHint":"\u062A\u0627 \u06F4 \u062A\u0635\u0648\u06CC\u0631\u060C \u0647\u0631 \u06A9\u062F\u0627\u0645 \u06A9\u0645\u062A\u0631 \u0627\u0632 \u06F4 \u0645\u06AF\u0627\u0628\u0627\u06CC\u062A.","err.tooLarge":"\u062D\u062C\u0645 \u0641\u0627\u06CC\u0644 \u0628\u06CC\u0634\u062A\u0631 \u0627\u0632 \u06F4 \u0645\u06AF\u0627\u0628\u0627\u06CC\u062A \u0627\u0633\u062A.","acc.ticketRules":"\u0642\u0648\u0627\u0646\u06CC\u0646 \u062A\u06CC\u06A9\u062A \u0631\u0627 \u062E\u0648\u0627\u0646\u062F\u0647\u200C\u0627\u0645 \u0648 \u0645\u06CC\u200C\u067E\u0630\u06CC\u0631\u0645.","acc.ticketViewRules":"\u0645\u0634\u0627\u0647\u062F\u0647\u200C\u06CC \u0642\u0648\u0627\u0646\u06CC\u0646 \u062A\u06CC\u06A9\u062A","acc.ticketCreated":"\u062A\u06CC\u06A9\u062A \u062B\u0628\u062A \u0634\u062F. \u06A9\u062F \u067E\u06CC\u06AF\u06CC\u0631\u06CC: {code}","acc.ticketWrite":"\u067E\u0627\u0633\u062E \u062E\u0648\u062F \u0631\u0627 \u0628\u0646\u0648\u06CC\u0633\u2026","acc.ticketClose":"\u0628\u0633\u062A\u0646 \u062A\u06CC\u06A9\u062A","acc.ticketReopen":"\u0628\u0627\u0632\u06AF\u0634\u0627\u06CC\u06CC","acc.ticketSla":"\u0632\u0645\u0627\u0646 \u067E\u0627\u0633\u062E\u200C\u06AF\u0648\u06CC\u06CC \u062A\u0642\u0631\u06CC\u0628\u06CC: {h} \u0633\u0627\u0639\u062A","acc.noTickets":"\u062A\u06CC\u06A9\u062A\u06CC \u062B\u0628\u062A \u0646\u06A9\u0631\u062F\u0647\u200C\u0627\u06CC","acc.chatTitle":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0622\u0646\u0644\u0627\u06CC\u0646","acc.chatPlaceholder":"\u067E\u06CC\u0627\u0645 \u062E\u0648\u062F \u0631\u0627 \u0628\u0646\u0648\u06CC\u0633\u2026","acc.chatWelcome":"\u0633\u0644\u0627\u0645! \u0633\u0624\u0627\u0644 \u06CC\u0627 \u0645\u0634\u06A9\u0644\u06CC \u062F\u0627\u0631\u06CC\u061F \u0647\u0645\u06CC\u0646\u200C\u062C\u0627 \u0628\u0646\u0648\u06CC\u0633 \u062A\u0627 \u067E\u0627\u0633\u062E \u062F\u0647\u06CC\u0645.","acc.chatOffline":"\u0627\u0644\u0627\u0646 \u062E\u0627\u0631\u062C \u0627\u0632 \u0633\u0627\u0639\u062A \u06A9\u0627\u0631\u06CC \u0647\u0633\u062A\u06CC\u0645\u061B \u067E\u06CC\u0627\u0645 \u0628\u06AF\u0630\u0627\u0631 \u062A\u0627 \u0627\u0648\u0644 \u0648\u0642\u062A \u067E\u0627\u0633\u062E \u062F\u0647\u06CC\u0645\u060C \u06CC\u0627 \u062A\u06CC\u06A9\u062A \u0628\u0632\u0646.","acc.chatOpenTicket":"\u062B\u0628\u062A \u062A\u06CC\u06A9\u062A","acc.reviewEmpty":"\u0646\u0638\u0631 \u06CC\u0627 \u0633\u0624\u0627\u0644\u06CC \u062B\u0628\u062A \u0646\u06A9\u0631\u062F\u0647\u200C\u0627\u06CC","acc.feedbackNew":"\u0627\u0631\u0633\u0627\u0644 \u067E\u06CC\u0634\u0646\u0647\u0627\u062F\u060C \u0634\u06A9\u0627\u06CC\u062A \u06CC\u0627 \u06AF\u0632\u0627\u0631\u0634 \u062E\u0637\u0627","acc.feedbackType":"\u0646\u0648\u0639 \u067E\u06CC\u0627\u0645","acc.feedbackContact":"\u0631\u0627\u0647 \u0627\u0631\u062A\u0628\u0627\u0637\u06CC (\u0627\u06CC\u0645\u06CC\u0644 \u06CC\u0627 \u0645\u0648\u0628\u0627\u06CC\u0644)","acc.feedbackContactHint":"\u062F\u0631 \u0635\u0648\u0631\u062A \u062B\u0628\u062A\u060C \u0646\u062A\u06CC\u062C\u0647 \u0631\u0627 \u0628\u0647 \u0627\u0637\u0644\u0627\u0639 \u062A\u0648 \u0645\u06CC\u200C\u0631\u0633\u0627\u0646\u06CC\u0645.","acc.feedbackSent":"\u067E\u06CC\u0627\u0645 \u062A\u0648 \u062B\u0628\u062A \u0634\u062F. \u0645\u0645\u0646\u0648\u0646 \u06A9\u0647 \u0628\u0647 \u0628\u0647\u062A\u0631 \u0634\u062F\u0646 \u0633\u0627\u06CC\u062A \u06A9\u0645\u06A9 \u0645\u06CC\u200C\u06A9\u0646\u06CC.","acc.noFeedback":"\u067E\u06CC\u0627\u0645\u06CC \u0627\u0631\u0633\u0627\u0644 \u0646\u06A9\u0631\u062F\u0647\u200C\u0627\u06CC","acc.profileSaved":"\u067E\u0631\u0648\u0641\u0627\u06CC\u0644 \u0630\u062E\u06CC\u0631\u0647 \u0634\u062F","acc.passwordChange":"\u062A\u063A\u06CC\u06CC\u0631 \u0631\u0645\u0632 \u0639\u0628\u0648\u0631","acc.currentPassword":"\u0631\u0645\u0632 \u0639\u0628\u0648\u0631 \u0641\u0639\u0644\u06CC","acc.newPassword2":"\u0631\u0645\u0632 \u0639\u0628\u0648\u0631 \u062C\u062F\u06CC\u062F","acc.passwordChanged":"\u0631\u0645\u0632 \u0639\u0628\u0648\u0631 \u062A\u063A\u06CC\u06CC\u0631 \u06A9\u0631\u062F","acc.2faSection":"\u0648\u0631\u0648\u062F \u062F\u0648\u0645\u0631\u062D\u0644\u0647\u200C\u0627\u06CC (2FA)","acc.2faOff":"\u063A\u06CC\u0631\u0641\u0639\u0627\u0644 \u2014 \u0628\u0631\u0627\u06CC \u0627\u0645\u0646\u06CC\u062A \u0628\u06CC\u0634\u062A\u0631 \u0631\u0648\u0634\u0646\u0634 \u06A9\u0646.","acc.2faOn":"\u0641\u0639\u0627\u0644","acc.2faEnable":"\u0641\u0639\u0627\u0644\u200C\u0633\u0627\u0632\u06CC \u0648\u0631\u0648\u062F \u062F\u0648\u0645\u0631\u062D\u0644\u0647\u200C\u0627\u06CC","acc.2faDisable":"\u063A\u06CC\u0631\u0641\u0639\u0627\u0644\u200C\u0633\u0627\u0632\u06CC","acc.2faScan":"\u0627\u06CC\u0646 \u06A9\u062F QR \u0631\u0627 \u0628\u0627 \u0627\u067E \u0627\u062D\u0631\u0627\u0632 \u0647\u0648\u06CC\u062A (\u0645\u062B\u0644 Google Authenticator) \u0627\u0633\u06A9\u0646 \u06A9\u0646 \u06CC\u0627 \u06A9\u0644\u06CC\u062F \u0631\u0627 \u062F\u0633\u062A\u06CC \u0648\u0627\u0631\u062F \u06A9\u0646.","acc.2faKey":"\u06A9\u0644\u06CC\u062F \u062F\u0633\u062A\u06CC","acc.2faEnterCode":"\u06A9\u062F \u06F6 \u0631\u0642\u0645\u06CC \u0627\u067E \u0631\u0627 \u0648\u0627\u0631\u062F \u06A9\u0646 \u062A\u0627 \u0641\u0639\u0627\u0644 \u0634\u0648\u062F","acc.2faEnabled":"\u0648\u0631\u0648\u062F \u062F\u0648\u0645\u0631\u062D\u0644\u0647\u200C\u0627\u06CC \u0641\u0639\u0627\u0644 \u0634\u062F","acc.2faDisabled":"\u0648\u0631\u0648\u062F \u062F\u0648\u0645\u0631\u062D\u0644\u0647\u200C\u0627\u06CC \u063A\u06CC\u0631\u0641\u0639\u0627\u0644 \u0634\u062F","acc.2faBackup":"\u06A9\u062F\u0647\u0627\u06CC \u067E\u0634\u062A\u06CC\u0628\u0627\u0646 (\u0646\u06AF\u0647\u0634\u0627\u0646 \u062F\u0627\u0631)","acc.2faBackupHint":"\u0627\u06AF\u0631 \u062F\u0633\u062A\u0631\u0633\u06CC \u0628\u0647 \u0627\u067E \u0631\u0627 \u0627\u0632 \u062F\u0633\u062A \u062F\u0627\u062F\u06CC\u060C \u0628\u0627 \u0627\u06CC\u0646 \u06A9\u062F\u0647\u0627 \u0648\u0627\u0631\u062F \u0634\u0648. \u0647\u0631 \u06A9\u062F \u0641\u0642\u0637 \u06CC\u06A9\u200C\u0628\u0627\u0631 \u0645\u0635\u0631\u0641 \u0627\u0633\u062A.","acc.2faMethods":"\u0631\u0648\u0634\u200C\u0647\u0627\u06CC \u062A\u0623\u06CC\u06CC\u062F","acc.sessionsText":"\u062F\u0633\u062A\u06AF\u0627\u0647\u200C\u0647\u0627\u06CC\u06CC \u06A9\u0647 \u0627\u06A9\u0646\u0648\u0646 \u0628\u0647 \u062D\u0633\u0627\u0628 \u062A\u0648 \u0648\u0627\u0631\u062F \u0647\u0633\u062A\u0646\u062F.","acc.revokeAll":"\u062E\u0631\u0648\u062C \u0627\u0632 \u0647\u0645\u0647\u200C\u06CC \u062F\u0633\u062A\u06AF\u0627\u0647\u200C\u0647\u0627","acc.revokeDone":"\u0646\u0634\u0633\u062A\u200C\u0647\u0627 \u0628\u0633\u062A\u0647 \u0634\u062F\u0646\u062F","acc.current":"\u0647\u0645\u06CC\u0646 \u062F\u0633\u062A\u06AF\u0627\u0647","acc.prefsText":"\u0627\u06CC\u0646 \u062A\u0646\u0638\u06CC\u0645\u0627\u062A \u0641\u0642\u0637 \u0631\u0648\u06CC \u0647\u0645\u06CC\u0646 \u062F\u0633\u062A\u06AF\u0627\u0647 \u0627\u0639\u0645\u0627\u0644 \u0645\u06CC\u200C\u0634\u0648\u062F.","acc.prefTheme":"\u067E\u0648\u0633\u062A\u0647","acc.prefLang":"\u0632\u0628\u0627\u0646","acc.prefDensity":"\u062A\u0631\u0627\u06A9\u0645 \u0646\u0645\u0627\u06CC\u0634","acc.prefMotion":"\u0627\u0646\u06CC\u0645\u06CC\u0634\u0646\u200C\u0647\u0627","acc.prefNotif":"\u0627\u0639\u0644\u0627\u0646\u200C\u0647\u0627","acc.notifMarketing":"\u062A\u062E\u0641\u06CC\u0641\u200C\u0647\u0627 \u0648 \u067E\u06CC\u0634\u0646\u0647\u0627\u062F\u0647\u0627","acc.notifOrders":"\u0648\u0636\u0639\u06CC\u062A \u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627","acc.notifRestock":"\u0645\u0648\u062C\u0648\u062F \u0634\u062F\u0646 \u06A9\u0627\u0644\u0627\u0647\u0627\u06CC \u0644\u06CC\u0633\u062A \u0645\u0646","acc.notifSupport":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0648 \u067E\u0627\u0633\u062E \u062A\u06CC\u06A9\u062A\u200C\u0647\u0627","acc.exportData":"\u062F\u0631\u06CC\u0627\u0641\u062A \u062F\u0627\u062F\u0647\u200C\u0647\u0627\u06CC \u0645\u0646","acc.exportHint":"\u0647\u0645\u0647\u200C\u06CC \u0627\u0637\u0644\u0627\u0639\u0627\u062A \u062D\u0633\u0627\u0628\u060C \u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627\u060C \u0646\u0638\u0631\u0627\u062A \u0648 \u062A\u06CC\u06A9\u062A\u200C\u0647\u0627 \u0631\u0627 \u0628\u0647\u200C\u0635\u0648\u0631\u062A JSON \u062F\u0627\u0646\u0644\u0648\u062F \u06A9\u0646.","acc.deleteAccount":"\u062D\u0630\u0641 \u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC","acc.deleteWarn":"\u0628\u0627 \u062D\u0630\u0641 \u062D\u0633\u0627\u0628\u060C \u062F\u0627\u062F\u0647\u200C\u0647\u0627\u06CC \u0634\u062E\u0635\u06CC \u067E\u0627\u06A9 \u0645\u06CC\u200C\u0634\u0648\u062F\u061B \u0633\u0648\u0627\u0628\u062F \u0645\u0627\u0644\u06CC \u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627 \u0637\u0628\u0642 \u0642\u0627\u0646\u0648\u0646 \u0646\u06AF\u0647 \u062F\u0627\u0634\u062A\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F.","acc.deleteConfirm":"\u0628\u0631\u0627\u06CC \u062D\u0630\u0641 \u062D\u0633\u0627\u0628\u060C \u0631\u0645\u0632 \u0639\u0628\u0648\u0631 \u0631\u0627 \u0648\u0627\u0631\u062F \u06A9\u0646","acc.pointsText":"\u0628\u0647 \u0627\u0632\u0627\u06CC \u0647\u0631 \u06F1\u06F0\u06F0\u066C\u06F0\u06F0\u06F0 \u062A\u0648\u0645\u0627\u0646 \u062E\u0631\u06CC\u062F\u060C \u06F1 \u0627\u0645\u062A\u06CC\u0627\u0632 \u0645\u06CC\u200C\u06AF\u06CC\u0631\u06CC.","acc.referralCode":"\u06A9\u062F \u0645\u0639\u0631\u0641 \u062A\u0648","acc.referralText":"\u0627\u06CC\u0646 \u06A9\u062F \u0631\u0627 \u0628\u0647 \u0627\u0634\u062A\u0631\u0627\u06A9 \u0628\u06AF\u0630\u0627\u0631\u061B \u0647\u0631 \u062F\u0648 \u06F5\u06F0 \u0627\u0645\u062A\u06CC\u0627\u0632 \u0645\u06CC\u200C\u06AF\u06CC\u0631\u06CC\u062F.","chat.title":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0622\u0646\u0644\u0627\u06CC\u0646 \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644","chat.online":"\u0645\u0639\u0645\u0648\u0644\u0627\u064B \u062F\u0631 \u0686\u0646\u062F \u062F\u0642\u06CC\u0642\u0647 \u067E\u0627\u0633\u062E \u0645\u06CC\u200C\u062F\u0647\u06CC\u0645","chat.open":"\u0634\u0631\u0648\u0639 \u06AF\u0641\u062A\u200C\u0648\u06AF\u0648","chat.minimize":"\u0628\u0633\u062A\u0646","chat.loginFirst":"\u0628\u0631\u0627\u06CC \u06AF\u0641\u062A\u200C\u0648\u06AF\u0648 \u0628\u0627 \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0648\u0627\u0631\u062F \u062D\u0633\u0627\u0628 \u0634\u0648.","chat.sent":"\u067E\u06CC\u0627\u0645 \u0627\u0631\u0633\u0627\u0644 \u0634\u062F","chat.typing":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u062F\u0631 \u062D\u0627\u0644 \u0646\u0648\u0634\u062A\u0646\u2026","chat.quick":"\u0633\u0624\u0627\u0644\u0627\u062A \u067E\u0631\u062A\u06A9\u0631\u0627\u0631","notif.new":"\u0627\u0639\u0644\u0627\u0646 \u062C\u062F\u06CC\u062F","notif.markRead":"\u062E\u0648\u0627\u0646\u062F\u0647 \u0634\u062F","notif.viewAll":"\u0645\u0634\u0627\u0647\u062F\u0647\u200C\u06CC \u0647\u0645\u0647\u200C\u06CC \u0627\u0639\u0644\u0627\u0646\u200C\u0647\u0627","notif.empty":"\u0627\u0639\u0644\u0627\u0646\u06CC \u0646\u062F\u0627\u0631\u06CC","notif.type.announcement":"\u0627\u0637\u0644\u0627\u0639\u06CC\u0647","notif.type.order":"\u0633\u0641\u0627\u0631\u0634","notif.type.restock":"\u0645\u0648\u062C\u0648\u062F \u0634\u062F\u0646 \u06A9\u0627\u0644\u0627","notif.type.ticket":"\u062A\u06CC\u06A9\u062A","notif.type.support":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC","notif.type.review":"\u0646\u0638\u0631","notif.type.plus":"\u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633","notif.type.wallet":"\u06A9\u06CC\u0641 \u067E\u0648\u0644","notif.type.account":"\u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC","notif.type.feedback":"\u0628\u0627\u0632\u062E\u0648\u0631\u062F","notif.type.admin_alert":"\u0647\u0634\u062F\u0627\u0631 \u0645\u062F\u06CC\u0631","notif.type.news":"\u062E\u0628\u0631","notif.type.offer":"\u067E\u06CC\u0634\u0646\u0647\u0627\u062F \u0648\u06CC\u0698\u0647","notif.type.system":"\u0633\u0627\u0645\u0627\u0646\u0647","notif.type.info":"\u0627\u0637\u0644\u0627\u0639\u200C\u0631\u0633\u0627\u0646\u06CC","notif.type.welcome":"\u062E\u0648\u0634\u200C\u0622\u0645\u062F\u06AF\u0648\u06CC\u06CC","consent.title":"\u0628\u0647 \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644 \u062E\u0648\u0634 \u0622\u0645\u062F\u06CC","consent.text":"\u0644\u0637\u0641\u0627\u064B \u067E\u06CC\u0634 \u0627\u0632 \u0627\u062F\u0627\u0645\u0647\u060C \u0645\u0648\u0627\u0631\u062F \u0632\u06CC\u0631 \u0631\u0627 \u0628\u062E\u0648\u0627\u0646 \u0648 \u0628\u067E\u0630\u06CC\u0631. \u0645\u0627 \u0627\u0632 \u062D\u0627\u0641\u0638\u0647\u200C\u06CC \u0645\u0631\u0648\u0631\u06AF\u0631 \u0628\u0631\u0627\u06CC \u0628\u0647\u062A\u0631 \u06A9\u0631\u062F\u0646 \u062A\u062C\u0631\u0628\u0647\u200C\u06CC \u062E\u0631\u06CC\u062F \u0627\u0633\u062A\u0641\u0627\u062F\u0647 \u0645\u06CC\u200C\u06A9\u0646\u06CC\u0645 \u0648 \u0637\u0628\u0642 \u062D\u0631\u06CC\u0645 \u062E\u0635\u0648\u0635\u06CC\u060C \u0645\u0631\u0627\u0642\u0628 \u062F\u0627\u062F\u0647\u200C\u0647\u0627\u06CC \u0634\u062E\u0635\u06CC \u062A\u0648 \u0647\u0633\u062A\u06CC\u0645.","consent.terms":"\u0642\u0648\u0627\u0646\u06CC\u0646 \u0648 \u0645\u0642\u0631\u0631\u0627\u062A \u0631\u0627 \u062E\u0648\u0627\u0646\u062F\u0647\u200C\u0627\u0645 \u0648 \u0645\u06CC\u200C\u067E\u0630\u06CC\u0631\u0645.","consent.privacy":"\u062D\u0631\u06CC\u0645 \u062E\u0635\u0648\u0635\u06CC \u0631\u0627 \u0645\u06CC\u200C\u067E\u0630\u06CC\u0631\u0645.","consent.marketing":"\u062F\u0648\u0633\u062A \u062F\u0627\u0631\u0645 \u0627\u0632 \u062A\u062E\u0641\u06CC\u0641\u200C\u0647\u0627 \u0648 \u06A9\u0627\u0644\u0627\u0647\u0627\u06CC \u062C\u062F\u06CC\u062F \u0628\u0627\u062E\u0628\u0631 \u0634\u0648\u0645 (\u0627\u062E\u062A\u06CC\u0627\u0631\u06CC).","consent.accept":"\u0645\u06CC\u200C\u067E\u0630\u06CC\u0631\u0645 \u0648 \u0648\u0627\u0631\u062F \u0633\u0627\u06CC\u062A \u0645\u06CC\u200C\u0634\u0648\u0645","consent.readTerms":"\u062E\u0648\u0627\u0646\u062F\u0646 \u0642\u0648\u0627\u0646\u06CC\u0646","consent.readPrivacy":"\u062E\u0648\u0627\u0646\u062F\u0646 \u062D\u0631\u06CC\u0645 \u062E\u0635\u0648\u0635\u06CC","consent.thanks":"\u0645\u0645\u0646\u0648\u0646! \u067E\u0630\u06CC\u0631\u0634 \u062A\u0648 \u062B\u0628\u062A \u0634\u062F.","consent.manage":"\u0645\u062F\u06CC\u0631\u06CC\u062A \u062A\u0648\u0627\u0641\u0642 \u06A9\u0648\u06A9\u06CC \u0648 \u062D\u0631\u06CC\u0645 \u062E\u0635\u0648\u0635\u06CC","social.instagram":"\u0627\u06CC\u0646\u0633\u062A\u0627\u06AF\u0631\u0627\u0645","home.partnersTitle":"\u0628\u0631\u0646\u062F\u0647\u0627\u06CC\u06CC \u06A9\u0647 \u0628\u0627 \u0622\u0646\u200C\u0647\u0627 \u06A9\u0627\u0631 \u0645\u06CC\u200C\u06A9\u0646\u06CC\u0645","stats.title":"\u0622\u0645\u0627\u0631 \u0632\u0646\u062F\u0647\u0654 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","stats.subtitle":"\u0639\u062F\u062F\u0647\u0627\u06CC \u0648\u0627\u0642\u0639\u06CC \u0641\u0631\u0648\u0634\u06AF\u0627\u0647\u060C \u0628\u0647\u200C\u0631\u0648\u0632 \u0648 \u0628\u062F\u0648\u0646 \u067E\u0631\u062F\u0647.","stats.chartTitle":"\u0628\u0627\u0632\u062F\u06CC\u062F \u06F1\u06F4 \u0631\u0648\u0632 \u0627\u062E\u06CC\u0631","stats.chartHint":"\u0627\u0631\u062A\u0641\u0627\u0639 \u0647\u0631 \u0633\u062A\u0648\u0646 \u06CC\u0639\u0646\u06CC \u062A\u0639\u062F\u0627\u062F \u0628\u0627\u0632\u062F\u06CC\u062F \u0647\u0645\u0627\u0646 \u0631\u0648\u0632.","stats.topTitle":"\u067E\u0631\u0641\u0631\u0648\u0634\u200C\u0647\u0627\u06CC \u0627\u062E\u06CC\u0631","adm.sPartners":"\u0628\u0631\u0646\u062F\u0647\u0627 \u0648 \u0634\u0631\u06A9\u0627","adm.ptFa":"\u0646\u0627\u0645 \u0641\u0627\u0631\u0633\u06CC","adm.ptEn":"Name (EN)","adm.ptAdd":"\u0627\u0641\u0632\u0648\u062F\u0646 \u0628\u0631\u0646\u062F","adm.ptHint":"\u0627\u06CC\u0646 \u0646\u0627\u0645\u200C\u0647\u0627 \u0628\u0647\u200C\u0635\u0648\u0631\u062A \u0646\u0648\u0627\u0631 \u0645\u062A\u062D\u0631\u06A9 \u062F\u0631 \u0635\u0641\u062D\u0647\u0654 \u0627\u0635\u0644\u06CC \u0646\u0645\u0627\u06CC\u0634 \u062F\u0627\u062F\u0647 \u0645\u06CC\u200C\u0634\u0648\u0646\u062F\u061B \u062A\u0631\u062A\u06CC\u0628 \u0631\u0627 \u062E\u0648\u062F\u062A \u0628\u0686\u06CC\u0646.","feat.partners":"\u0646\u0648\u0627\u0631 \u0628\u0631\u0646\u062F\u0647\u0627\u06CC \u0647\u0645\u06A9\u0627\u0631","auth.pwdLater":"\u0628\u0639\u062F\u0627\u064B \u062A\u063A\u06CC\u06CC\u0631 \u0645\u06CC\u200C\u062F\u0647\u0645","auth.pwdLaterToast":"\u0628\u0627\u0634\u0647\u061B \u0647\u0631 \u0648\u0642\u062A \u062E\u0648\u0627\u0633\u062A\u06CC \u0627\u0632 \xAB\u062D\u0633\u0627\u0628 \u0645\u0646 \u2192 \u062A\u063A\u06CC\u06CC\u0631 \u0631\u0645\u0632 \u0639\u0628\u0648\u0631\xBB \u0627\u0646\u062C\u0627\u0645\u0634 \u0628\u062F\u0647.","social.telegram":"\u062A\u0644\u06AF\u0631\u0627\u0645","social.eitaa":"\u0627\u06CC\u062A\u0627","social.whatsapp":"\u0648\u0627\u062A\u0633\u0627\u067E","consent.rejectOptional":"\u067E\u0630\u06CC\u0631\u0634 \u0641\u0642\u0637 \u0645\u0648\u0627\u0631\u062F \u0636\u0631\u0648\u0631\u06CC","consent.ttlNote":"\u0627\u0646\u062A\u062E\u0627\u0628 \u062A\u0648 \u062A\u0627 \u06F1\u06F8\u06F0 \u0631\u0648\u0632 \u0645\u0639\u062A\u0628\u0631 \u0627\u0633\u062A \u0648 \u067E\u0633 \u0627\u0632 \u0622\u0646 \u062F\u0648\u0628\u0627\u0631\u0647 \u067E\u0631\u0633\u06CC\u062F\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F.","contact.title":"\u062A\u0645\u0627\u0633 \u0628\u0627 \u0645\u0627","contact.mapTitle":"\u06A9\u0631\u0648\u06A9\u06CC \u0645\u062D\u0644 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","contact.mapHint":"\u0628\u0631\u0627\u06CC \u0628\u0627\u0632 \u0634\u062F\u0646 \u062F\u0631 \u0628\u0631\u0646\u0627\u0645\u0647\u200C\u06CC \u0646\u0642\u0634\u0647 \u06A9\u0644\u06CC\u06A9 \u06A9\u0646","contact.mapAsk":"\u06A9\u062F\u0627\u0645 \u0646\u0642\u0634\u0647 \u0628\u0627\u0632 \u0634\u0648\u062F\u061F","contact.mapPermission":"\u0627\u06AF\u0631 \u0627\u062C\u0627\u0632\u0647\u200C\u06CC \u0645\u0648\u0642\u0639\u06CC\u062A \u0628\u062F\u0647\u06CC\u060C \u0645\u0633\u06CC\u0631 \u062D\u0631\u06A9\u062A \u0627\u0632 \u062C\u0627\u06CC \u0641\u0639\u0644\u06CC\u200C\u0627\u062A \u062A\u0627 \u0645\u063A\u0627\u0632\u0647 \u0631\u0627 \u0646\u0634\u0627\u0646 \u0645\u06CC\u200C\u062F\u0647\u06CC\u0645.","contact.allowLocation":"\u0627\u062C\u0627\u0632\u0647\u200C\u06CC \u062F\u0633\u062A\u0631\u0633\u06CC \u0628\u0647 \u0645\u0648\u0642\u0639\u06CC\u062A","contact.denyLocation":"\u0627\u062F\u0627\u0645\u0647 \u0628\u062F\u0648\u0646 \u0645\u0648\u0642\u0639\u06CC\u062A","contact.openMaps":"\u0628\u0627\u0632 \u06A9\u0631\u062F\u0646 \u062F\u0631 \u0646\u0642\u0634\u0647","contact.copyAddress":"\u06A9\u067E\u06CC \u0622\u062F\u0631\u0633","contact.hours":"\u0633\u0627\u0639\u062A \u06A9\u0627\u0631\u06CC","contact.phone":"\u062A\u0644\u0641\u0646 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","contact.mobile":"\u0645\u0648\u0628\u0627\u06CC\u0644 \u0648 \u0648\u0627\u062A\u0633\u0627\u067E","contact.emailUs":"\u0627\u06CC\u0645\u06CC\u0644","contact.addressUs":"\u0622\u062F\u0631\u0633","contact.callNow":"\u062A\u0645\u0627\u0633 \u0628\u06AF\u06CC\u0631","contact.whatsapp":"\u067E\u06CC\u0627\u0645 \u062F\u0631 \u0648\u0627\u062A\u0633\u0627\u067E","contact.locationOn":"\u0645\u0648\u0642\u0639\u06CC\u062A \u062A\u0642\u0631\u06CC\u0628\u06CC \u062A\u0648 \u067E\u06CC\u062F\u0627 \u0634\u062F","contact.locationDenied":"\u062F\u0633\u062A\u0631\u0633\u06CC \u0628\u0647 \u0645\u0648\u0642\u0639\u06CC\u062A \u062F\u0627\u062F\u0647 \u0646\u0634\u062F\u061B \u0646\u0642\u0634\u0647 \u0628\u062F\u0648\u0646 \u0645\u0628\u062F\u0623 \u0628\u0627\u0632 \u0645\u06CC\u200C\u0634\u0648\u062F.","contact.formTitle":"\u0627\u0631\u0633\u0627\u0644 \u067E\u06CC\u0627\u0645 \u0633\u0631\u06CC\u0639","contact.formText":"\u062A\u0645\u0627\u0633 \u06AF\u0631\u0641\u062A\u0646 \u0631\u0627 \u062F\u0648\u0633\u062A \u0646\u062F\u0627\u0631\u06CC\u061F \u067E\u06CC\u0627\u0645 \u0628\u06AF\u0630\u0627\u0631 \u06CC\u0627 \u062A\u06CC\u06A9\u062A \u0628\u0632\u0646.","contact.neshan":"\u0646\u0634\u0627\u0646","contact.balad":"\u0628\u0644\u062F","contact.google":"\u06AF\u0648\u06AF\u0644 \u0645\u067E","contact.osm":"\u0627\u0648\u067E\u0646\u200C\u0627\u0633\u062A\u0631\u06CC\u062A\u200C\u0645\u067E","contact.tgBotTitle":"\u0631\u0628\u0627\u062A \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u062A\u0644\u06AF\u0631\u0627\u0645","contact.tgBotText":"\u067E\u06CC\u06AF\u06CC\u0631\u06CC \u0633\u0641\u0627\u0631\u0634\u060C \u062C\u0633\u062A\u062C\u0648\u06CC \u06A9\u0627\u0644\u0627 \u0648 \u06AF\u0641\u062A\u200C\u0648\u06AF\u0648 \u0628\u0627 \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u2014 \u0634\u0628\u0627\u0646\u0647\u200C\u0631\u0648\u0632 \u062F\u0631 \u062A\u0644\u06AF\u0631\u0627\u0645. \u06A9\u0627\u0641\u06CC \u0627\u0633\u062A /start \u0628\u0632\u0646\u06CC.","contact.tgBotBtn":"\u0628\u0627\u0632 \u06A9\u0631\u062F\u0646 \u0631\u0628\u0627\u062A \u062F\u0631 \u062A\u0644\u06AF\u0631\u0627\u0645","compare.title":"\u0645\u0642\u0627\u06CC\u0633\u0647\u200C\u06CC \u06A9\u0627\u0644\u0627\u0647\u0627","compare.empty":"\u06A9\u0627\u0644\u0627\u06CC\u06CC \u0628\u0631\u0627\u06CC \u0645\u0642\u0627\u06CC\u0633\u0647 \u0627\u0646\u062A\u062E\u0627\u0628 \u0646\u0634\u062F\u0647","compare.emptyText":"\u0627\u0632 \u062F\u06A9\u0645\u0647\u200C\u06CC \u0645\u0642\u0627\u06CC\u0633\u0647 \u0631\u0648\u06CC \u06A9\u0627\u0631\u062A \u06A9\u0627\u0644\u0627 \u0627\u0633\u062A\u0641\u0627\u062F\u0647 \u06A9\u0646 (\u062A\u0627 \u06F4 \u06A9\u0627\u0644\u0627).","compare.add":"\u0627\u0641\u0632\u0648\u062F\u0646 \u0628\u0647 \u0645\u0642\u0627\u06CC\u0633\u0647","compare.remove":"\u062D\u0630\u0641","priceCheck.title":"\u0627\u0633\u062A\u0639\u0644\u0627\u0645 \u0642\u06CC\u0645\u062A \u0628\u0627 \u0628\u0627\u0631\u06A9\u062F","priceCheck.sub":"\u0628\u0627\u0631\u06A9\u062F \u0631\u0627 \u0628\u0627 \u062F\u0633\u062A\u06AF\u0627\u0647 \u0627\u0633\u06A9\u0646 \u06A9\u0646 \u06CC\u0627 \u062F\u0633\u062A\u06CC \u0648\u0627\u0631\u062F \u06A9\u0646.","priceCheck.input":"\u0628\u0627\u0631\u06A9\u062F \u06CC\u0627 \u06A9\u062F \u06A9\u0627\u0644\u0627","priceCheck.scanCamera":"\u0627\u0633\u06A9\u0646 \u0628\u0627 \u062F\u0648\u0631\u0628\u06CC\u0646","priceCheck.stopCamera":"\u062A\u0648\u0642\u0641 \u062F\u0648\u0631\u0628\u06CC\u0646","priceCheck.waiting":"\u062F\u0631 \u0627\u0646\u062A\u0638\u0627\u0631 \u0627\u0633\u06A9\u0646\u2026","priceCheck.notFound":"\u06A9\u0627\u0644\u0627\u06CC\u06CC \u0628\u0627 \u0627\u06CC\u0646 \u0628\u0627\u0631\u06A9\u062F \u067E\u06CC\u062F\u0627 \u0646\u0634\u062F","priceCheck.found":"\u06A9\u0627\u0644\u0627 \u067E\u06CC\u062F\u0627 \u0634\u062F","priceCheck.cameraUnsupported":"\u062F\u0648\u0631\u0628\u06CC\u0646 \u062F\u0631 \u062F\u0633\u062A\u0631\u0633 \u0646\u06CC\u0633\u062A. \u0627\u0632 \u062F\u0633\u062A\u06AF\u0627\u0647 \u0628\u0627\u0631\u06A9\u062F\u062E\u0648\u0627\u0646 \u06CC\u0627 \u0648\u0631\u0648\u062F \u062F\u0633\u062A\u06CC \u0627\u0633\u062A\u0641\u0627\u062F\u0647 \u06A9\u0646.","priceCheck.cameraDenied":"\u062F\u0633\u062A\u0631\u0633\u06CC \u0628\u0647 \u062F\u0648\u0631\u0628\u06CC\u0646 \u062F\u0627\u062F\u0647 \u0646\u0634\u062F.","priceCheck.deviceMode":"\u062D\u0627\u0644\u062A \u06A9\u06CC\u0648\u0633\u06A9 (\u062A\u0645\u0627\u0645\u200C\u0635\u0641\u062D\u0647)","priceCheck.lastScan":"\u0622\u062E\u0631\u06CC\u0646 \u0627\u0633\u06A9\u0646","priceCheck.fullscreen":"\u062A\u0645\u0627\u0645\u200C\u0635\u0641\u062D\u0647","err.generic":"\u0645\u0634\u06A9\u0644\u06CC \u067E\u06CC\u0634 \u0622\u0645\u062F. \u062F\u0648\u0628\u0627\u0631\u0647 \u062A\u0644\u0627\u0634 \u06A9\u0646.","err.network":"\u0627\u062A\u0635\u0627\u0644 \u0628\u0647 \u0633\u0631\u0648\u0631 \u0628\u0631\u0642\u0631\u0627\u0631 \u0646\u0634\u062F.","err.notFound":"\u0635\u0641\u062D\u0647 \u067E\u06CC\u062F\u0627 \u0646\u0634\u062F","err.notFoundText":"\u0645\u0645\u06A9\u0646 \u0627\u0633\u062A \u0646\u0634\u0627\u0646\u06CC \u0627\u0634\u062A\u0628\u0627\u0647 \u0628\u0627\u0634\u062F \u06CC\u0627 \u0635\u0641\u062D\u0647 \u062D\u0630\u0641 \u0634\u062F\u0647 \u0628\u0627\u0634\u062F.","err.goHome":"\u0628\u0631\u0648 \u0628\u0647 \u0635\u0641\u062D\u0647\u200C\u06CC \u0627\u0635\u0644\u06CC","err.offline":"\u0622\u0641\u0644\u0627\u06CC\u0646 \u0647\u0633\u062A\u06CC. \u062F\u0627\u062F\u0647\u200C\u0647\u0627\u06CC \u0630\u062E\u06CC\u0631\u0647\u200C\u0634\u062F\u0647 \u0646\u0645\u0627\u06CC\u0634 \u062F\u0627\u062F\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F.","err.online":"\u062F\u0648\u0628\u0627\u0631\u0647 \u0622\u0646\u0644\u0627\u06CC\u0646 \u0634\u062F\u06CC","err.loginRequired":"\u0628\u0631\u0627\u06CC \u062F\u06CC\u062F\u0646 \u0627\u06CC\u0646 \u0628\u062E\u0634 \u0628\u0627\u06CC\u062F \u0648\u0627\u0631\u062F \u062D\u0633\u0627\u0628 \u0634\u0648\u06CC.","err.forbidden":"\u0628\u0647 \u0627\u06CC\u0646 \u0628\u062E\u0634 \u062F\u0633\u062A\u0631\u0633\u06CC \u0646\u062F\u0627\u0631\u06CC.","adm.title":"\u067E\u0646\u0644 \u0645\u062F\u06CC\u0631\u06CC\u062A","adm.dashboard":"\u062F\u0627\u0634\u0628\u0648\u0631\u062F","adm.products":"\u06A9\u0627\u0644\u0627\u0647\u0627","adm.productNew":"\u0627\u0641\u0632\u0648\u062F\u0646 \u06A9\u0627\u0644\u0627","adm.productEdit":"\u0648\u06CC\u0631\u0627\u06CC\u0634 \u06A9\u0627\u0644\u0627","adm.categories":"\u062F\u0633\u062A\u0647\u200C\u0647\u0627 \u0648 \u0628\u0631\u0646\u062F\u0647\u0627","adm.orders":"\u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627","adm.reviews":"\u0646\u0638\u0631\u0627\u062A \u0648 \u0633\u0624\u0627\u0644\u0627\u062A","adm.tickets":"\u062A\u06CC\u06A9\u062A\u200C\u0647\u0627","adm.supportChat":"\u0686\u062A \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC","adm.feedback":"\u0628\u0627\u0632\u062E\u0648\u0631\u062F\u0647\u0627 \u0648 \u062E\u0637\u0627\u0647\u0627","adm.users":"\u06A9\u0627\u0631\u0628\u0631\u0627\u0646 \u0648 \u062F\u0633\u062A\u0631\u0633\u06CC\u200C\u0647\u0627","adm.wallet":"\u06A9\u06CC\u0641 \u067E\u0648\u0644 \u06A9\u0627\u0631\u0628\u0631\u0627\u0646","adm.coupons":"\u06A9\u062F\u0647\u0627\u06CC \u062A\u062E\u0641\u06CC\u0641","adm.ads":"\u062A\u0628\u0644\u06CC\u063A\u0627\u062A","adm.notifications":"\u0627\u0639\u0644\u0627\u0646\u200C\u0647\u0627","adm.settings":"\u062A\u0646\u0638\u06CC\u0645\u0627\u062A \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","adm.theme":"\u067E\u0648\u0633\u062A\u0647 \u0648 \u0686\u06CC\u062F\u0645\u0627\u0646","adm.features":"\u0627\u0645\u06A9\u0627\u0646\u0627\u062A","adm.shipping":"\u0627\u0631\u0633\u0627\u0644 \u0648 \u0628\u06CC\u0645\u0647","adm.plus":"\u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633","adm.pages":"\u0645\u062D\u062A\u0648\u0627\u06CC \u0635\u0641\u062D\u0647\u200C\u0647\u0627","adm.barcode":"\u0628\u0627\u0631\u06A9\u062F \u0648 \u0628\u0631\u0686\u0633\u0628","adm.imageSearch":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u062A\u0635\u0648\u06CC\u0631\u06CC","adm.audit":"\u06AF\u0632\u0627\u0631\u0634 \u0631\u0648\u06CC\u062F\u0627\u062F\u0647\u0627","adm.stats":"\u0622\u0645\u0627\u0631","adm.export":"\u062E\u0631\u0648\u062C\u06CC \u0648 \u067E\u0634\u062A\u06CC\u0628\u0627\u0646","adm.maintenance":"\u0646\u06AF\u0647\u062F\u0627\u0631\u06CC","adm.backToSite":"\u0628\u0627\u0632\u06AF\u0634\u062A \u0628\u0647 \u0633\u0627\u06CC\u062A","adm.kpi.ordersToday":"\u0633\u0641\u0627\u0631\u0634 \u0627\u0645\u0631\u0648\u0632","adm.kpi.visits":"\u0628\u0627\u0632\u062F\u06CC\u062F \u0627\u0645\u0631\u0648\u0632","adm.kpi.pending":"\u062F\u0631 \u0627\u0646\u062A\u0638\u0627\u0631 \u0628\u0631\u0631\u0633\u06CC","adm.kpi.revenueTotal":"\u062F\u0631\u0622\u0645\u062F \u06A9\u0644","adm.kpi.users":"\u06A9\u0627\u0631\u0628\u0631\u0627\u0646","adm.kpi.products":"\u06A9\u0627\u0644\u0627\u0647\u0627","adm.kpi.lowStock":"\u0645\u0648\u062C\u0648\u062F\u06CC \u06A9\u0645","adm.awaiting":"\u06A9\u0627\u0631\u0647\u0627\u06CC \u062F\u0631 \u0627\u0646\u062A\u0638\u0627\u0631 \u0627\u0642\u062F\u0627\u0645","adm.awaiting.reviews":"\u0646\u0638\u0631\u0627\u062A \u062F\u0631 \u0627\u0646\u062A\u0638\u0627\u0631 \u062A\u0623\u06CC\u06CC\u062F","adm.awaiting.tickets":"\u062A\u06CC\u06A9\u062A\u200C\u0647\u0627\u06CC \u0628\u0627\u0632","adm.awaiting.orders":"\u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627\u06CC \u062F\u0631 \u0627\u0646\u062A\u0638\u0627\u0631","adm.awaiting.feedback":"\u0628\u0627\u0632\u062E\u0648\u0631\u062F \u062C\u062F\u06CC\u062F","adm.awaiting.chat":"\u067E\u06CC\u0627\u0645 \u062E\u0648\u0627\u0646\u062F\u0647\u200C\u0646\u0634\u062F\u0647\u200C\u06CC \u0686\u062A","adm.chart":"\u0631\u0648\u0646\u062F \u06F1\u06F4 \u0631\u0648\u0632 \u0627\u062E\u06CC\u0631","adm.topSelling":"\u067E\u0631\u0641\u0631\u0648\u0634\u200C\u062A\u0631\u06CC\u0646\u200C\u0647\u0627","adm.lowStockList":"\u06A9\u0627\u0644\u0627\u0647\u0627\u06CC \u0628\u0627 \u0645\u0648\u062C\u0648\u062F\u06CC \u06A9\u0645","adm.recentAudit":"\u0622\u062E\u0631\u06CC\u0646 \u0631\u0648\u06CC\u062F\u0627\u062F\u0647\u0627","adm.storage":"\u062D\u062C\u0645 \u062F\u0627\u062F\u0647\u200C\u0647\u0627","adm.pName":"\u0646\u0627\u0645 \u06A9\u0627\u0644\u0627","adm.pNameEn":"\u0646\u0627\u0645 \u0627\u0646\u06AF\u0644\u06CC\u0633\u06CC","adm.pCat":"\u062F\u0633\u062A\u0647\u200C\u0628\u0646\u062F\u06CC","adm.pBrand":"\u0628\u0631\u0646\u062F","adm.pPrice":"\u0642\u06CC\u0645\u062A (\u062A\u0648\u0645\u0627\u0646)","adm.pOldPrice":"\u0642\u06CC\u0645\u062A \u0642\u0628\u0644 \u0627\u0632 \u062A\u062E\u0641\u06CC\u0641","adm.pCost":"\u0642\u06CC\u0645\u062A \u062E\u0631\u06CC\u062F","adm.pStock":"\u0645\u0648\u062C\u0648\u062F\u06CC","adm.pSku":"\u06A9\u062F \u06A9\u0627\u0644\u0627","adm.pBarcode":"\u0628\u0627\u0631\u06A9\u062F","adm.pWeight":"\u0648\u0632\u0646 (\u06AF\u0631\u0645)","adm.pWarranty":"\u06AF\u0627\u0631\u0627\u0646\u062A\u06CC (\u0645\u0627\u0647)","adm.pAuth":"\u0627\u0635\u0627\u0644\u062A \u06A9\u0627\u0644\u0627","adm.pTags":"\u0628\u0631\u0686\u0633\u0628\u200C\u0647\u0627 (\u0628\u0627 Enter \u062C\u062F\u0627 \u06A9\u0646)","adm.pSpecs":"\u0645\u0634\u062E\u0635\u0627\u062A \u0641\u0646\u06CC","adm.pSpecKey":"\u0646\u0627\u0645 \u0645\u0634\u062E\u0635\u0647","adm.pSpecVal":"\u0645\u0642\u062F\u0627\u0631","adm.pAddSpec":"\u0627\u0641\u0632\u0648\u062F\u0646 \u0645\u0634\u062E\u0635\u0647","adm.pVideos":"\u0648\u06CC\u062F\u06CC\u0648\u0647\u0627\u06CC \u0645\u062D\u0635\u0648\u0644 (\u0647\u0631 \u062E\u0637 \u06CC\u06A9 \u0646\u0634\u0627\u0646\u06CC https \u06CC\u0627 /uploads)","adm.pVideosHint":"\u0648\u06CC\u062F\u06CC\u0648\u0647\u0627 \u062F\u0631 \u06AF\u0627\u0644\u0631\u06CC \u0645\u062D\u0635\u0648\u0644 \u0648 \u0644\u0627\u06CC\u062A\u200C\u0628\u0627\u06A9\u0633 \u067E\u062E\u0634 \u0645\u06CC\u200C\u0634\u0648\u0646\u062F.","adm.pImages":"\u062A\u0635\u0627\u0648\u06CC\u0631","adm.pFindImage":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u062E\u0648\u062F\u06A9\u0627\u0631 \u062A\u0635\u0648\u06CC\u0631","adm.pFindImageHint":"\u0645\u0646\u0627\u0628\u0639 \u0622\u0632\u0627\u062F \u062A\u0635\u0648\u06CC\u0631 (\u0648\u06CC\u06A9\u06CC\u200C\u0645\u062F\u06CC\u0627/\u0627\u0648\u067E\u0646\u200C\u0648\u0631\u0633) \u0631\u0627 \u0628\u0631\u0627\u06CC \u0627\u06CC\u0646 \u06A9\u0627\u0644\u0627 \u062C\u0633\u062A\u200C\u0648\u062C\u0648 \u0645\u06CC\u200C\u06A9\u0646\u06CC\u0645. \u06CC\u06A9\u06CC \u0631\u0627 \u0627\u0646\u062A\u062E\u0627\u0628 \u0648 \u062A\u0623\u06CC\u06CC\u062F \u06A9\u0646.","adm.pFindSearching":"\u062F\u0631 \u062D\u0627\u0644 \u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u062A\u0635\u0648\u06CC\u0631\u2026","adm.pFindEmpty":"\u062A\u0635\u0648\u06CC\u0631\u06CC \u067E\u06CC\u062F\u0627 \u0646\u0634\u062F. \u0645\u06CC\u200C\u062A\u0648\u0627\u0646\u06CC \u0639\u06A9\u0633 \u062E\u0648\u062F\u062A \u0631\u0627 \u0628\u0627\u0631\u06AF\u0630\u0627\u0631\u06CC \u06A9\u0646\u06CC.","adm.pUpload":"\u0628\u0627\u0631\u06AF\u0630\u0627\u0631\u06CC \u0639\u06A9\u0633","adm.pUseImage":"\u0627\u0633\u062A\u0641\u0627\u062F\u0647 \u0627\u0632 \u0627\u06CC\u0646 \u062A\u0635\u0648\u06CC\u0631","adm.pDefaultImage":"\u0628\u0627\u0632\u06AF\u0631\u062F\u0627\u0646\u062F\u0646 \u062A\u0635\u0648\u06CC\u0631 \u067E\u06CC\u0634\u200C\u0641\u0631\u0636","adm.pFeatured":"\u0646\u0645\u0627\u06CC\u0634 \u062F\u0631 \u067E\u06CC\u0634\u0646\u0647\u0627\u062F \u0648\u06CC\u0698\u0647","adm.pActive":"\u0641\u0639\u0627\u0644 (\u062F\u0631 \u0633\u0627\u06CC\u062A \u062F\u06CC\u062F\u0647 \u0634\u0648\u062F)","adm.pSaved":"\u06A9\u0627\u0644\u0627 \u0630\u062E\u06CC\u0631\u0647 \u0634\u062F","adm.pCreated":"\u06A9\u0627\u0644\u0627 \u0627\u06CC\u062C\u0627\u062F \u0634\u062F","adm.pDeleted":"\u06A9\u0627\u0644\u0627 \u062D\u0630\u0641 \u0634\u062F","adm.pDeleteConfirm":"\u0627\u06CC\u0646 \u06A9\u0627\u0644\u0627 \u0628\u0631\u0627\u06CC \u0647\u0645\u06CC\u0634\u0647 \u062D\u0630\u0641 \u0634\u0648\u062F\u061F","adm.pQuickEdit":"\u0648\u06CC\u0631\u0627\u06CC\u0634 \u0633\u0631\u06CC\u0639","adm.pBulkPrice":"\u062A\u063A\u06CC\u06CC\u0631 \u06AF\u0631\u0648\u0647\u06CC \u0642\u06CC\u0645\u062A","adm.catName":"\u0646\u0627\u0645 \u062F\u0633\u062A\u0647","adm.catParent":"\u062F\u0633\u062A\u0647\u200C\u06CC \u0648\u0627\u0644\u062F","adm.catGlyph":"\u0622\u06CC\u06A9\u0648\u0646","adm.catOrder":"\u062A\u0631\u062A\u06CC\u0628 \u0646\u0645\u0627\u06CC\u0634","adm.catNoParent":"\u0628\u062F\u0648\u0646 \u0648\u0627\u0644\u062F (\u0633\u0637\u062D \u0627\u0635\u0644\u06CC)","adm.brandName":"\u0646\u0627\u0645 \u0628\u0631\u0646\u062F","adm.brandNameEn":"\u0646\u0627\u0645 \u0627\u0646\u06AF\u0644\u06CC\u0633\u06CC \u0628\u0631\u0646\u062F","adm.oStatus":"\u062A\u063A\u06CC\u06CC\u0631 \u0648\u0636\u0639\u06CC\u062A","adm.oTracking":"\u06A9\u062F \u0631\u0647\u06AF\u06CC\u0631\u06CC","adm.oNote":"\u06CC\u0627\u062F\u062F\u0627\u0634\u062A \u062F\u0627\u062E\u0644\u06CC","adm.oCustomer":"\u0645\u0634\u062A\u0631\u06CC","adm.oDelivery":"\u062A\u062D\u0648\u06CC\u0644","adm.oPayment":"\u067E\u0631\u062F\u0627\u062E\u062A","adm.oSaved":"\u0633\u0641\u0627\u0631\u0634 \u0628\u0647\u200C\u0631\u0648\u0632\u0631\u0633\u0627\u0646\u06CC \u0634\u062F","adm.rApprove":"\u062A\u0623\u06CC\u06CC\u062F \u0648 \u0627\u0646\u062A\u0634\u0627\u0631","adm.rReject":"\u0631\u062F \u06A9\u0631\u062F\u0646","adm.rReply":"\u067E\u0627\u0633\u062E","adm.rReplySaved":"\u067E\u0627\u0633\u062E \u0630\u062E\u06CC\u0631\u0647 \u0634\u062F","adm.rModerated":"\u0648\u0636\u0639\u06CC\u062A \u0646\u0638\u0631 \u0628\u0647\u200C\u0631\u0648\u0632\u0631\u0633\u0627\u0646\u06CC \u0634\u062F","adm.rFilter":"\u0641\u06CC\u0644\u062A\u0631","adm.uRole":"\u0646\u0642\u0634","adm.uPerms":"\u062F\u0633\u062A\u0631\u0633\u06CC\u200C\u0647\u0627","adm.uPermsHint":"\u0647\u0631 \u062F\u0633\u062A\u0631\u0633\u06CC \u0631\u0627 \u062C\u062F\u0627\u06AF\u0627\u0646\u0647 \u0631\u0648\u0634\u0646 \u06CC\u0627 \u062E\u0627\u0645\u0648\u0634 \u06A9\u0646. \u062A\u063A\u06CC\u06CC\u0631\u0647\u0627 \u0641\u0648\u0631\u0627\u064B \u0627\u0639\u0645\u0627\u0644 \u0645\u06CC\u200C\u0634\u0648\u062F.","adm.uAll":"\u0641\u0639\u0627\u0644\u200C\u0633\u0627\u0632\u06CC \u0647\u0645\u0647","adm.uNone":"\u063A\u06CC\u0631\u0641\u0639\u0627\u0644\u200C\u0633\u0627\u0632\u06CC \u0647\u0645\u0647","adm.uWalletAdjust":"\u062A\u0646\u0638\u06CC\u0645 \u0645\u0648\u062C\u0648\u062F\u06CC \u06A9\u06CC\u0641 \u067E\u0648\u0644","adm.uWalletReason":"\u062F\u0644\u06CC\u0644","adm.uPlusDays":"\u0631\u0648\u0632\u0647\u0627\u06CC \u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633","adm.uResetPass":"\u0628\u0627\u0632\u0646\u0634\u0627\u0646\u06CC \u0631\u0645\u0632 \u0639\u0628\u0648\u0631","adm.uStatus":"\u0648\u0636\u0639\u06CC\u062A \u062D\u0633\u0627\u0628","adm.uBlocked":"\u0645\u0633\u062F\u0648\u062F","adm.uSaved":"\u062A\u063A\u06CC\u06CC\u0631\u0627\u062A \u06A9\u0627\u0631\u0628\u0631 \u0630\u062E\u06CC\u0631\u0647 \u0634\u062F","adm.uMakeStaff":"\u06A9\u0627\u0631\u0645\u0646\u062F \u06A9\u0631\u062F\u0646","adm.cCode":"\u06A9\u062F","adm.cType":"\u0646\u0648\u0639 \u062A\u062E\u0641\u06CC\u0641","adm.cValue":"\u0645\u0642\u062F\u0627\u0631","adm.cMax":"\u0633\u0642\u0641 \u062A\u062E\u0641\u06CC\u0641","adm.cMin":"\u062D\u062F\u0627\u0642\u0644 \u0645\u0628\u0644\u063A \u0633\u0641\u0627\u0631\u0634","adm.cLimit":"\u0633\u0642\u0641 \u0627\u0633\u062A\u0641\u0627\u062F\u0647\u200C\u06CC \u06A9\u0644","adm.cPerUser":"\u0633\u0642\u0641 \u0647\u0631 \u06A9\u0627\u0631\u0628\u0631","adm.cStart":"\u0634\u0631\u0648\u0639","adm.cEnd":"\u067E\u0627\u06CC\u0627\u0646","adm.cUsed":"\u0627\u0633\u062A\u0641\u0627\u062F\u0647\u200C\u0634\u062F\u0647","adm.aSlot":"\u0645\u062D\u0644 \u0646\u0645\u0627\u06CC\u0634","adm.aTitle":"\u0639\u0646\u0648\u0627\u0646","adm.aText":"\u0645\u062A\u0646","adm.aLink":"\u0644\u06CC\u0646\u06A9 \u0645\u0642\u0635\u062F","adm.aCta":"\u0645\u062A\u0646 \u062F\u06A9\u0645\u0647","adm.aActive":"\u0646\u0645\u0627\u06CC\u0634 \u062F\u0627\u062F\u0647 \u0634\u0648\u062F","adm.nTitle":"\u0639\u0646\u0648\u0627\u0646 \u0627\u0639\u0644\u0627\u0646","adm.nBody":"\u0645\u062A\u0646 \u0627\u0639\u0644\u0627\u0646","adm.nTarget":"\u06AF\u06CC\u0631\u0646\u062F\u0647","adm.nAll":"\u0647\u0645\u0647\u200C\u06CC \u06A9\u0627\u0631\u0628\u0631\u0627\u0646","adm.nOne":"\u06CC\u06A9 \u06A9\u0627\u0631\u0628\u0631 \u0645\u0634\u062E\u0635","adm.nLevel":"\u0633\u0637\u062D","adm.nSent":"\u0627\u0639\u0644\u0627\u0646 \u0627\u0631\u0633\u0627\u0644 \u0634\u062F","adm.nOutbox":"\u0635\u0646\u062F\u0648\u0642 \u062E\u0631\u0648\u062C\u06CC \u067E\u06CC\u0627\u0645\u06A9 \u0648 \u0627\u06CC\u0645\u06CC\u0644 (\u062D\u0627\u0644\u062A \u0622\u0632\u0645\u0627\u06CC\u0634\u06CC)","adm.sStore":"\u0627\u0637\u0644\u0627\u0639\u0627\u062A \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","adm.sTheme":"\u067E\u0648\u0633\u062A\u0647","adm.sUi":"\u0686\u06CC\u062F\u0645\u0627\u0646 \u0631\u0627\u0628\u0637","adm.mailsms":"\u0627\u06CC\u0645\u06CC\u0644 \u0648 \u067E\u06CC\u0627\u0645\u06A9","adm.mailCfg":"\u0633\u0631\u0648\u0631 \u0627\u06CC\u0645\u06CC\u0644 (SMTP)","adm.mailEnabled":"\u0627\u0631\u0633\u0627\u0644 \u0627\u06CC\u0645\u06CC\u0644 \u0641\u0639\u0627\u0644","adm.mailFrom":"\u0622\u062F\u0631\u0633 \u0641\u0631\u0633\u062A\u0646\u062F\u0647","adm.smsCfg":"\u067E\u0646\u0644 \u067E\u06CC\u0627\u0645\u06A9 (\u06A9\u0627\u0648\u0647\u200C\u0646\u06AF\u0627\u0631)","adm.smsEnabled":"\u0627\u0631\u0633\u0627\u0644 \u067E\u06CC\u0627\u0645\u06A9 \u0641\u0639\u0627\u0644","adm.smsKey":"\u06A9\u0644\u06CC\u062F API","adm.smsSender":"\u0634\u0645\u0627\u0631\u0647\u0654 \u0641\u0631\u0633\u062A\u0646\u062F\u0647","adm.console":"\u06A9\u0646\u0633\u0648\u0644 \u0633\u0627\u0645\u0627\u0646\u0647","adm.consoleHint":"\u0631\u06CC\u0633\u062A\u0627\u0631\u062A \u0633\u0631\u0648\u0631 \u0686\u0646\u062F \u062B\u0627\u0646\u06CC\u0647 \u0637\u0648\u0644 \u0645\u06CC\u200C\u06A9\u0634\u062F\u061B \u0635\u0641\u062D\u0647 \u062E\u0648\u062F\u06A9\u0627\u0631 \u062A\u0627\u0632\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F. \u0631\u06CC\u0633\u062A\u200C\u0647\u0627 \u063A\u06CC\u0631\u0642\u0627\u0628\u0644 \u0628\u0627\u0632\u06AF\u0634\u062A\u200C\u0627\u0646\u062F.","adm.sysRestart":"\u0631\u06CC\u0633\u062A\u0627\u0631\u062A \u0633\u0631\u0648\u0631","adm.sysRestartWarn":"\u0633\u0631\u0648\u0631 \u0647\u0645\u06CC\u0646 \u062D\u0627\u0644\u0627 \u0631\u06CC\u0633\u062A\u0627\u0631\u062A \u0634\u0648\u062F\u061F \u06A9\u0627\u0631\u0628\u0631\u0627\u0646 \u0686\u0646\u062F \u062B\u0627\u0646\u06CC\u0647 \u0642\u0637\u0639 \u0645\u06CC\u200C\u0634\u0648\u0646\u062F.","adm.sysRestarting":"\u062F\u0631 \u062D\u0627\u0644 \u0631\u06CC\u0633\u062A\u0627\u0631\u062A\u2026 \u0635\u0641\u062D\u0647 \u062A\u0627 \u0644\u062D\u0638\u0627\u062A\u06CC \u062F\u06CC\u06AF\u0631 \u062A\u0627\u0632\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F.","adm.sysResetLabel":"\u0631\u06CC\u0633\u062A \u0628\u062E\u0634\u200C\u0647\u0627 (\u063A\u06CC\u0631\u0642\u0627\u0628\u0644 \u0628\u0627\u0632\u06AF\u0634\u062A):","adm.sysReset.audit":"\u0644\u0627\u06AF \u0645\u0645\u06CC\u0632\u06CC","adm.sysReset.carts":"\u0633\u0628\u062F\u0647\u0627\u06CC \u0645\u0647\u0645\u0627\u0646","adm.sysReset.visits":"\u0634\u0645\u0627\u0631 \u0628\u0627\u0632\u062F\u06CC\u062F\u0647\u0627","adm.sysReset.visitors":"\u0628\u0627\u0632\u062F\u06CC\u062F\u06A9\u0646\u0646\u062F\u06AF\u0627\u0646","adm.secTitle":"\u067E\u062F\u0627\u0641\u0646\u062F \u0648 \u0635\u0641 \u0648\u0631\u0648\u062F","adm.secQueueEnabled":"\u0635\u0641\u200C\u0628\u0646\u062F\u06CC \u0647\u0646\u06AF\u0627\u0645 \u0634\u0644\u0648\u063A\u06CC","adm.secQueueDesc":"\u0648\u0642\u062A\u06CC \u0628\u0627\u0631 \u0633\u0627\u06CC\u062A \u0627\u0632 \u062D\u062F \u0628\u06AF\u0630\u0631\u062F\u060C \u0628\u0627\u0632\u062F\u06CC\u062F\u06A9\u0646\u0646\u062F\u06AF\u0627\u0646 \u0646\u0627\u0634\u0646\u0627\u0633 \u062F\u0627\u0646\u0647\u200C\u062F\u0627\u0646\u0647 \u0627\u0632 \u0635\u0641 \u0648\u0627\u0631\u062F \u0645\u06CC\u200C\u0634\u0648\u0646\u062F \u062A\u0627 \u0633\u0627\u06CC\u062A \u0628\u0631\u0627\u06CC \u0647\u0645\u0647 \u0628\u062F\u0648\u0646 \u062E\u0637\u0627 \u0628\u0645\u0627\u0646\u062F.","adm.secMaxConc":"\u0633\u0642\u0641 \u062F\u0631\u062E\u0648\u0627\u0633\u062A \u0647\u0645\u0632\u0645\u0627\u0646","adm.secTriggerRps":"\u0622\u0633\u062A\u0627\u0646\u0647\u0654 \u062F\u0631\u062E\u0648\u0627\u0633\u062A \u062F\u0631 \u062B\u0627\u0646\u06CC\u0647","adm.secPassTtl":"\u0627\u0639\u062A\u0628\u0627\u0631 \u06AF\u0630\u0631\u0646\u0627\u0645\u0647\u0654 \u0648\u0631\u0648\u062F (\u062F\u0642\u06CC\u0642\u0647)","adm.secPoll":"\u0641\u0627\u0635\u0644\u0647\u0654 \u0628\u0631\u0631\u0633\u06CC \u0646\u0648\u0628\u062A (\u062B\u0627\u0646\u06CC\u0647)","adm.secFloodBan":"\u0622\u0633\u062A\u0627\u0646\u0647\u0654 \u0645\u0633\u062F\u0648\u062F\u0633\u0627\u0632\u06CC \u062E\u0648\u062F\u06A9\u0627\u0631 (\u062F\u0631\u062E\u0648\u0627\u0633\u062A \u062F\u0631 \u062F\u0642\u06CC\u0642\u0647)","adm.secFloodMin":"\u0645\u062F\u062A \u0645\u0633\u062F\u0648\u062F\u0633\u0627\u0632\u06CC \u062E\u0648\u062F\u06A9\u0627\u0631 (\u062F\u0642\u06CC\u0642\u0647)","adm.secSaved":"\u062A\u0646\u0638\u06CC\u0645\u0627\u062A \u067E\u062F\u0627\u0641\u0646\u062F \u0630\u062E\u06CC\u0631\u0647 \u0634\u062F.","adm.secInflight":"\u062F\u0631\u062E\u0648\u0627\u0633\u062A \u0641\u0639\u0627\u0644","adm.secRps":"\u062F\u0631\u062E\u0648\u0627\u0633\u062A/\u062B\u0627\u0646\u06CC\u0647","adm.secQueued":"\u062F\u0631 \u0635\u0641","adm.secAutoBans":"\u0645\u0633\u062F\u0648\u062F \u062E\u0648\u062F\u06A9\u0627\u0631 \u0641\u0639\u0627\u0644","adm.secTop":"\u067E\u0631\u062D\u0631\u0641\u200C\u062A\u0631\u06CC\u0646 IP\u0647\u0627 (\u062F\u0642\u06CC\u0642\u0647\u0654 \u0627\u062E\u06CC\u0631)","adm.secPerMin":"\u062F\u0631\u062E\u0648\u0627\u0633\u062A/\u062F\u0642\u06CC\u0642\u0647","adm.secTopEmpty":"\u062A\u0631\u0627\u0641\u06CC\u06A9 \u063A\u06CC\u0631\u0639\u0627\u062F\u06CC \u062B\u0628\u062A \u0646\u0634\u062F\u0647 \u0627\u0633\u062A.","adm.secBusy":"\u0634\u0644\u0648\u063A \u2014 \u0635\u0641 \u0641\u0639\u0627\u0644","adm.secNormal":"\u0648\u0636\u0639\u06CC\u062A \u0639\u0627\u062F\u06CC","adm.banMinutes":"\u0645\u062F\u062A (\u062F\u0642\u06CC\u0642\u0647\u060C \u06F0 = \u062F\u0627\u0626\u0645)","adm.banUntil":"\u062A\u0627","adm.banAuto":"\u062E\u0648\u062F\u06A9\u0627\u0631","adm.resetAudit":"\u067E\u0627\u06A9\u200C\u06A9\u0631\u062F\u0646 \u0644\u0627\u06AF\u200C\u0647\u0627","adm.resetCarts":"\u062E\u0627\u0644\u06CC\u200C\u06A9\u0631\u062F\u0646 \u0633\u0628\u062F\u0647\u0627\u06CC \u0645\u0647\u0645\u0627\u0646","adm.resetVisitors":"\u067E\u0627\u06A9\u200C\u06A9\u0631\u062F\u0646 \u0628\u0627\u0632\u062F\u06CC\u062F\u06A9\u0646\u0646\u062F\u06AF\u0627\u0646","adm.resetDone":"\u0631\u06CC\u0633\u062A \u0627\u0646\u062C\u0627\u0645 \u0634\u062F.","adm.resetWarn.audit":"\u0647\u0645\u0647\u0654 \u0644\u0627\u06AF\u200C\u0647\u0627\u06CC \u0645\u0645\u06CC\u0632\u06CC \u067E\u0627\u06A9 \u0634\u0648\u0646\u062F\u061F","adm.resetWarn.carts":"\u0633\u0628\u062F\u0647\u0627\u06CC \u062E\u0631\u06CC\u062F \u06A9\u0627\u0631\u0628\u0631\u0627\u0646 \u0645\u0647\u0645\u0627\u0646 \u062E\u0627\u0644\u06CC \u0634\u0648\u062F\u061F","adm.resetWarn.visitors":"\u0641\u0647\u0631\u0633\u062A \u0628\u0627\u0632\u062F\u06CC\u062F\u06A9\u0646\u0646\u062F\u06AF\u0627\u0646 \u067E\u0627\u06A9 \u0634\u0648\u062F\u061F","adm.resetWarn.visits":"\u0634\u0645\u0627\u0631\u0646\u062F\u0647\u200C\u0647\u0627\u06CC \u0628\u0627\u0632\u062F\u06CC\u062F \u0635\u0641\u0631 \u0634\u0648\u0646\u062F\u061F","adm.visitors":"\u0628\u0627\u0632\u062F\u06CC\u062F\u06A9\u0646\u0646\u062F\u06AF\u0627\u0646","adm.uDevice":"\u062F\u0633\u062A\u06AF\u0627\u0647 / IP","adm.uBrowser":"\u0645\u0631\u0648\u0631\u06AF\u0631","adm.uRegion":"\u0645\u0646\u0637\u0642\u0647 / \u0632\u0645\u0627\u0646","adm.uPath":"\u0645\u0633\u06CC\u0631","adm.guest":"\u0645\u0647\u0645\u0627\u0646","adm.bans":"\u0645\u0633\u062F\u0648\u062F\u0633\u0627\u0632\u06CC (\u0628\u0646/\u0622\u0646\u200C\u0628\u0646)","adm.banType":"\u0646\u0648\u0639","adm.banValue":"\u0645\u0642\u062F\u0627\u0631 (IP / \u0634\u0645\u0627\u0631\u0647 / \u0627\u06CC\u0645\u06CC\u0644 / \u0646\u0627\u0645 \u06A9\u0627\u0631\u0628\u0631\u06CC)","adm.banReason":"\u062F\u0644\u06CC\u0644","adm.ban":"\u0645\u0633\u062F\u0648\u062F \u06A9\u0646","adm.unban":"\u0631\u0641\u0639 \u0645\u0633\u062F\u0648\u062F\u06CC","adm.banned":"\u0645\u0633\u062F\u0648\u062F","adm.banDone":"\u0645\u0633\u062F\u0648\u062F \u0634\u062F.","adm.unbanDone":"\u0645\u0633\u062F\u0648\u062F\u06CC \u0631\u0641\u0639 \u0634\u062F.","adm.bansEmpty":"\u0641\u0639\u0644\u0627\u064B \u06A9\u0633\u06CC \u0645\u0633\u062F\u0648\u062F \u0646\u06CC\u0633\u062A.","adm.banByAdmin":"\u062A\u0648\u0633\u0637 \u0645\u062F\u06CC\u0631","adm.channels":"\u06A9\u0627\u0646\u0627\u0644\u200C\u0647\u0627\u06CC \u0627\u0631\u0633\u0627\u0644","adm.chSite":"\u0627\u0639\u0644\u0627\u0646 \u062F\u0627\u062E\u0644 \u0633\u0627\u06CC\u062A","adm.chTelegram":"\u0628\u0627\u062A \u062A\u0644\u06AF\u0631\u0627\u0645","adm.chEmail":"\u0627\u06CC\u0645\u06CC\u0644","adm.chSms":"\u067E\u06CC\u0627\u0645\u06A9","adm.channelsHint":"\u0627\u06CC\u0645\u06CC\u0644/\u067E\u06CC\u0627\u0645\u06A9 \u0646\u06CC\u0627\u0632 \u0628\u0647 \u062A\u0646\u0638\u06CC\u0645\u0627\u062A \u067E\u0627\u06CC\u06CC\u0646 \u0647\u0645\u06CC\u0646 \u0628\u062E\u0634 \u062F\u0627\u0631\u0646\u062F\u061B \u0628\u062F\u0648\u0646 \u062A\u0646\u0638\u06CC\u0645\u060C \u0641\u0642\u0637 \u06A9\u0627\u0646\u0627\u0644\u200C\u0647\u0627\u06CC \u0622\u0645\u0627\u062F\u0647 \u0627\u0631\u0633\u0627\u0644 \u0645\u06CC\u200C\u0634\u0648\u0646\u062F.","adm.telegram":"\u0628\u0627\u062A \u062A\u0644\u06AF\u0631\u0627\u0645","adm.tgHint":"\u062A\u0648\u06A9\u0646 \u0631\u0627 \u0627\u0632 BotFather \u062A\u0644\u06AF\u0631\u0627\u0645 \u0628\u06AF\u06CC\u0631 \u0648 \u0627\u06CC\u0646\u062C\u0627 \u0628\u06AF\u0630\u0627\u0631\u061B \u0628\u0627\u062A \u0631\u0648\u06CC \u0633\u0631\u0648\u0631 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u0645\u06CC\u200C\u0686\u0631\u062E\u062F \u0648 \u0627\u0632 \u0647\u0645\u06CC\u0646 \u067E\u0646\u0644 \u0645\u062F\u06CC\u0631\u06CC\u062A \u0645\u06CC\u200C\u0634\u0648\u062F.","adm.tgEnabled":"\u0628\u0627\u062A \u0631\u0648\u0634\u0646","adm.tgToken":"\u062A\u0648\u06A9\u0646 \u0628\u0627\u062A","adm.tgTokenHint":"\u0645\u062B\u0644 123456:ABC-\u2026","adm.tgWelcome":"\u067E\u06CC\u0627\u0645 \u062E\u0648\u0634\u200C\u0622\u0645\u062F /start","adm.tgTest":"\u0627\u0631\u0633\u0627\u0644 \u0622\u0632\u0645\u0627\u06CC\u0634\u06CC","adm.tgInbox":"\u0635\u0646\u062F\u0648\u0642 \u067E\u06CC\u0627\u0645\u200C\u0647\u0627","adm.tgSubs":"\u0639\u0636\u0648\u0647\u0627","adm.tgReplyPh":"\u067E\u0627\u0633\u062E \u0628\u0647 \u0627\u06CC\u0646 \u06A9\u0627\u0631\u0628\u0631\u2026","adm.tgInboxEmpty":"\u067E\u06CC\u0627\u0645\u06CC \u0646\u0631\u0633\u06CC\u062F\u0647 \u0627\u0633\u062A.","adm.lottery":"\u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC","adm.lotteryNew":"\u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC \u062C\u062F\u06CC\u062F","adm.lotPrize":"\u062C\u0627\u06CC\u0632\u0647","adm.lotEnds":"\u067E\u0627\u06CC\u0627\u0646","adm.lotWinners":"\u062A\u0639\u062F\u0627\u062F \u0628\u0631\u0646\u062F\u0647","adm.lotWinnersList":"\u0628\u0631\u0646\u062F\u0647\u200C\u0647\u0627","adm.lotMode":"\u0631\u0648\u0634 \u0634\u0631\u06A9\u062A","adm.lotModeOrders":"\u062E\u0648\u062F\u06A9\u0627\u0631 \u0627\u0632 \u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627","adm.lotModeManual":"\u062F\u06A9\u0645\u0647\u0654 \u0634\u0631\u06A9\u062A \u062F\u0633\u062A\u06CC","adm.lotEntries":"\u0634\u0631\u06A9\u062A\u200C\u06A9\u0646\u0646\u062F\u06AF\u0627\u0646","adm.lotRun":"\u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC \u06A9\u0646","adm.lotRunWarn":"\u0628\u0631\u0646\u062F\u0647\u200C\u0647\u0627 \u0647\u0645\u06CC\u0646 \u062D\u0627\u0644\u0627 \u0628\u0647\u200C\u0635\u0648\u0631\u062A \u062A\u0635\u0627\u062F\u0641\u06CC \u0627\u0646\u062A\u062E\u0627\u0628 \u0648 \u0645\u0637\u0644\u0639 \u0645\u06CC\u200C\u0634\u0648\u0646\u062F. \u0627\u062F\u0627\u0645\u0647 \u0645\u06CC\u200C\u062F\u0647\u06CC\u061F","adm.lotDone":"\u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC \u0627\u0646\u062C\u0627\u0645 \u0634\u062F","adm.lotClose":"\u0628\u0633\u062A\u0646","adm.lotClosed":"\u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC \u0628\u0633\u062A\u0647 \u0634\u062F.","adm.lotEmpty":"\u0647\u0646\u0648\u0632 \u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC\u200C\u0627\u06CC \u0646\u0633\u0627\u062E\u062A\u0647\u200C\u0627\u06CC.","lot.title":"\u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC \u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644","lot.nav":"\u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC","lot.soon":"\u0628\u0647\u200C\u0632\u0648\u062F\u06CC \u0627\u0636\u0627\u0641\u0647 \u062E\u0648\u0627\u0647\u062F \u0634\u062F\u061B \u0645\u0646\u062A\u0638\u0631 \u062E\u0628\u0631\u0647\u0627\u06CC \u062E\u0648\u0628 \u0628\u0627\u0634!","lot.done":"\u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC\u200C\u0647\u0627\u06CC \u06AF\u0630\u0634\u062A\u0647","lot.winners":"\u0628\u0631\u0646\u062F\u0647\u200C\u0647\u0627","lot.active":"\u0641\u0639\u0627\u0644","lot.prize":"\u062C\u0627\u06CC\u0632\u0647","lot.ends":"\u067E\u0627\u06CC\u0627\u0646","lot.entries":"\u0634\u0631\u06A9\u062A\u200C\u06A9\u0646\u0646\u062F\u06AF\u0627\u0646","lot.joined":"\u062F\u0631 \u0627\u06CC\u0646 \u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC \u0634\u0631\u06A9\u062A \u06A9\u0631\u062F\u0647\u200C\u0627\u06CC.","lot.join":"\u0634\u0631\u06A9\u062A \u062F\u0631 \u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC","lot.joinDone":"\u0634\u0631\u06A9\u062A\u062A \u062B\u0628\u062A \u0634\u062F\u061B \u0628\u0647 \u0627\u0645\u06CC\u062F \u0628\u0631\u062F!","lot.autoEntry":"\u0647\u0631 \u062E\u0631\u06CC\u062F \u0645\u0639\u062A\u0628\u0631 \u062F\u0631 \u0628\u0627\u0632\u0647\u0654 \u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC\u060C \u062E\u0648\u062F\u06A9\u0627\u0631 \u06CC\u06A9 \u0634\u0631\u06A9\u062A \u0627\u0633\u062A.","contact.phone3":"\u0634\u0645\u0627\u0631\u0647\u0654 \u0633\u0648\u0645","adm.sBackups":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u200C\u06AF\u06CC\u0631\u06CC \u0648 \u062F\u0627\u0645\u067E","adm.backupNow":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646 \u0647\u0645\u06CC\u0646 \u062D\u0627\u0644\u0627","adm.backupsHint":"\u0647\u0631 {hours} \u0633\u0627\u0639\u062A \u06CC\u06A9\u200C\u0628\u0627\u0631 \u062E\u0648\u062F\u06A9\u0627\u0631 \u0646\u0633\u062E\u0647\u0654 \u06A9\u0627\u0645\u0644 \u06AF\u0631\u0641\u062A\u0647 \u0648 {keep} \u0646\u0633\u062E\u0647\u0654 \u0622\u062E\u0631 \u0646\u06AF\u0647 \u062F\u0627\u0634\u062A\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F.","adm.backupsEmpty":"\u0647\u0646\u0648\u0632 \u0646\u0633\u062E\u0647\u200C\u0627\u06CC \u0633\u0627\u062E\u062A\u0647 \u0646\u0634\u062F\u0647\u061B \u062F\u06A9\u0645\u0647\u0654 \xAB\u067E\u0634\u062A\u06CC\u0628\u0627\u0646 \u0647\u0645\u06CC\u0646 \u062D\u0627\u0644\u0627\xBB \u0631\u0627 \u0628\u0632\u0646.","adm.backupSize":"\u062D\u062C\u0645","adm.backupRestore":"\u0628\u0627\u0632\u06AF\u0631\u062F\u0627\u0646\u06CC","adm.backupRestoreWarn":"\u0647\u0645\u0647\u0654 \u062F\u0627\u062F\u0647\u200C\u0647\u0627\u06CC \u0641\u0639\u0644\u06CC \u0628\u0627 \u0627\u06CC\u0646 \u0646\u0633\u062E\u0647 \u062C\u0627\u06CC\u06AF\u0632\u06CC\u0646 \u0645\u06CC\u200C\u0634\u0648\u062F. \u0645\u0637\u0645\u0626\u0646\u06CC\u061F","adm.backupDone":"\u0646\u0633\u062E\u0647\u0654 \u067E\u0634\u062A\u06CC\u0628\u0627\u0646 \u0633\u0627\u062E\u062A\u0647 \u0634\u062F.","adm.backupRestored":"\u0628\u0627\u0632\u06AF\u0631\u062F\u0627\u0646\u06CC \u0627\u0646\u062C\u0627\u0645 \u0634\u062F\u061B \u0635\u0641\u062D\u0647 \u062A\u0627\u0632\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F.","adm.dumpFull":"\u062F\u0627\u0645\u067E \u06A9\u0627\u0645\u0644 \u0633\u0627\u06CC\u062A","adm.sFeatures":"\u0627\u0645\u06A9\u0627\u0646\u0627\u062A","adm.sShipping":"\u0627\u0631\u0633\u0627\u0644","adm.sPlus":"\u067E\u0644\u0627\u0633","adm.sOrders":"\u0633\u0641\u0627\u0631\u0634 \u0648 \u067E\u0631\u062F\u0627\u062E\u062A","adm.sSeo":"\u0633\u0626\u0648","adm.sAuth":"\u0627\u062D\u0631\u0627\u0632 \u0647\u0648\u06CC\u062A","adm.sSaved":"\u062A\u0646\u0638\u06CC\u0645\u0627\u062A \u0630\u062E\u06CC\u0631\u0647 \u0634\u062F","adm.tAccent":"\u0631\u0646\u06AF \u0627\u0635\u0644\u06CC","adm.tVariant":"\u067E\u0648\u0633\u062A\u0647\u0654 \u0638\u0627\u0647\u0631\u06CC","adm.tVariantHint":"\u0627\u06AF\u0631 \u067E\u0648\u0633\u062A\u0647\u0654 \u062A\u0627\u0632\u0647 \u0631\u0627 \u062F\u0648\u0633\u062A \u0646\u062F\u0627\u0634\u062A\u06CC\u062F\u060C \xAB\u06A9\u0644\u0627\u0633\u06CC\u06A9\xBB \u062F\u0642\u06CC\u0642\u0627\u064B \u0647\u0645\u0627\u0646 \u062A\u0645 \u0642\u0628\u0644\u06CC \u0627\u0633\u062A.","hdr.refresh":"\u062A\u0627\u0632\u0647\u200C\u0633\u0627\u0632\u06CC \u0635\u0641\u062D\u0647","adm.errTitle":"\u062E\u0637\u0627\u0647\u0627\u06CC \u0632\u0646\u062F\u0647\u0654 \u06A9\u0644\u0627\u06CC\u0646\u062A","adm.errEmpty":"\u0647\u06CC\u0686 \u062E\u0637\u0627\u06CC \u06A9\u0644\u0627\u06CC\u0646\u062A\u06CC \u062B\u0628\u062A \u0646\u0634\u062F\u0647 \u2014 \u0633\u0627\u06CC\u062A \u0633\u0627\u0644\u0645 \u0627\u0633\u062A.","adm.tVariant":"Visual skin","adm.tVariantHint":"If you do not like the fresh skin, \u201CClassic\u201D is exactly the previous theme.","hdr.refresh":"Refresh page","adm.errTitle":"Live client errors","adm.errEmpty":"No client errors recorded \u2014 the site is healthy.","adm.tPort":"\u067E\u0648\u0633\u062A\u0647\u200C\u06CC \u0628\u0646\u062F\u0631\u06CC (\u0645\u0648\u062C\u060C \u0644\u0646\u062C \u0648 \u0646\u062E\u0644 \u062F\u0631 \u067E\u0633\u200C\u0632\u0645\u06CC\u0646\u0647)","adm.tPortHint":"\u0628\u0631\u0627\u06CC \u067E\u0633\u200C\u0632\u0645\u06CC\u0646\u0647\u200C\u06CC \u0633\u0627\u062F\u0647 \u0648 \u062E\u0646\u062B\u06CC\u060C \u062E\u0627\u0645\u0648\u0634\u0634 \u06A9\u0646.","adm.tMode":"\u067E\u0648\u0633\u062A\u0647\u200C\u06CC \u067E\u06CC\u0634\u200C\u0641\u0631\u0636","adm.tRadius":"\u06AF\u0631\u062F\u06CC \u06AF\u0648\u0634\u0647\u200C\u0647\u0627","adm.tDensity":"\u062A\u0631\u0627\u06A9\u0645","adm.tBg":"\u0633\u0628\u06A9 \u067E\u0633\u200C\u0632\u0645\u06CC\u0646\u0647","adm.tContrast":"\u06A9\u0646\u062A\u0631\u0627\u0633\u062A","adm.tAnim":"\u0627\u0646\u06CC\u0645\u06CC\u0634\u0646\u200C\u0647\u0627","adm.uSearchPos":"\u0645\u062D\u0644 \u06A9\u0627\u062F\u0631 \u062C\u0633\u062A\u200C\u0648\u062C\u0648","adm.uHeader":"\u0686\u06CC\u062F\u0645\u0627\u0646 \u0633\u0631\u0628\u0631\u06AF","adm.uNav":"\u0633\u0628\u06A9 \u0645\u0646\u0648","adm.uCards":"\u0633\u0628\u06A9 \u06A9\u0627\u0631\u062A \u06A9\u0627\u0644\u0627","adm.uSticky":"\u0633\u0631\u0628\u0631\u06AF \u0686\u0633\u0628\u0627\u0646","adm.uTicker":"\u0646\u0648\u0627\u0631 \u062E\u0628\u0631\u06CC \u0628\u0627\u0644\u0627","adm.uTickerItems":"\u0645\u062A\u0646\u200C\u0647\u0627\u06CC \u0646\u0648\u0627\u0631 \u062E\u0628\u0631\u06CC","adm.uTickerSpeed":"\u0633\u0631\u0639\u062A \u0646\u0648\u0627\u0631 \u062E\u0628\u0631\u06CC","adm.uQuick":"\u0645\u0634\u0627\u0647\u062F\u0647\u200C\u06CC \u0633\u0631\u06CC\u0639 \u06A9\u0627\u0644\u0627","adm.uChat":"\u062F\u06A9\u0645\u0647\u200C\u06CC \u0634\u0646\u0627\u0648\u0631 \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC","adm.uCrumb":"\u0646\u0645\u0627\u06CC\u0634 \u0645\u0633\u06CC\u0631 \u0635\u0641\u062D\u0647","adm.uCols":"\u0633\u062A\u0648\u0646\u200C\u0647\u0627\u06CC \u06A9\u0627\u0644\u0627","adm.uColsMobile":"\u0645\u0648\u0628\u0627\u06CC\u0644","adm.uColsTablet":"\u062A\u0628\u0644\u062A","adm.uColsDesktop":"\u062F\u0633\u06A9\u062A\u0627\u067E","adm.uColsWide":"\u0635\u0641\u062D\u0647\u200C\u06CC \u0639\u0631\u06CC\u0636","adm.uCardInfo":"\u0627\u0637\u0644\u0627\u0639\u0627\u062A \u0631\u0648\u06CC \u06A9\u0627\u0631\u062A \u06A9\u0627\u0644\u0627","adm.uPosStart":"\u0631\u0627\u0633\u062A (\u0622\u063A\u0627\u0632)","adm.uPosCenter":"\u0648\u0633\u0637","adm.uPosEnd":"\u0686\u067E (\u067E\u0627\u06CC\u0627\u0646)","adm.uLayoutLogoStart":"\u0644\u0648\u06AF\u0648 \u062F\u0631 \u0622\u063A\u0627\u0632","adm.uLayoutSplit":"\u0644\u0648\u06AF\u0648 \u0622\u063A\u0627\u0632 / \u062C\u0633\u062A\u200C\u0648\u062C\u0648 \u0648\u0633\u0637 / \u06A9\u0646\u0634\u200C\u0647\u0627 \u067E\u0627\u06CC\u0627\u0646","adm.uLayoutCentered":"\u0644\u0648\u06AF\u0648 \u062F\u0631 \u0648\u0633\u0637","adm.fHint":"\u0647\u0631 \u0627\u0645\u06A9\u0627\u0646\u06CC \u0631\u0627 \u06A9\u0647 \u0644\u0627\u0632\u0645 \u0646\u062F\u0627\u0631\u06CC \u062E\u0627\u0645\u0648\u0634 \u06A9\u0646\u061B \u0628\u062E\u0634 \u0645\u0631\u0628\u0648\u0637\u0647 \u0627\u0632 \u0633\u0627\u06CC\u062A \u0648 \u067E\u0646\u0644 \u062D\u0630\u0641 \u0645\u06CC\u200C\u0634\u0648\u062F.","adm.bLabel":"\u0686\u0627\u067E \u0628\u0631\u0686\u0633\u0628","adm.bSelect":"\u0627\u0646\u062A\u062E\u0627\u0628 \u06A9\u0627\u0644\u0627\u0647\u0627","adm.bSize":"\u0627\u0646\u062F\u0627\u0632\u0647\u200C\u06CC \u0628\u0631\u0686\u0633\u0628","adm.bCopies":"\u062A\u0639\u062F\u0627\u062F \u0646\u0633\u062E\u0647 \u0628\u0631\u0627\u06CC \u0647\u0631 \u06A9\u0627\u0644\u0627","adm.bShowName":"\u0646\u0627\u0645 \u06A9\u0627\u0644\u0627","adm.bShowPrice":"\u0642\u06CC\u0645\u062A","adm.bShowBrand":"\u0628\u0631\u0646\u062F","adm.bShowSku":"\u06A9\u062F \u06A9\u0627\u0644\u0627","adm.bShowQr":"\u06A9\u062F QR \u0635\u0641\u062D\u0647\u200C\u06CC \u06A9\u0627\u0644\u0627","adm.bType":"\u0646\u0648\u0639 \u0628\u0627\u0631\u06A9\u062F","adm.bPrint":"\u0686\u0627\u067E \u0628\u0631\u0686\u0633\u0628\u200C\u0647\u0627","adm.bGenerate":"\u0633\u0627\u062E\u062A \u0628\u0627\u0631\u06A9\u062F \u062C\u062F\u06CC\u062F","adm.igPack":"\u0628\u0633\u062A\u0647\u0654 \u067E\u0633\u062A \u0627\u06CC\u0646\u0633\u062A\u0627\u06AF\u0631\u0627\u0645","adm.igCap":"\u0645\u062A\u0646 \u067E\u0633\u062A (\u0642\u0627\u0628\u0644 \u0648\u06CC\u0631\u0627\u06CC\u0634 \u0642\u0628\u0644 \u0627\u0632 \u06A9\u067E\u06CC)","adm.igTags":"\u0647\u0634\u062A\u06AF\u200C\u0647\u0627","adm.igImgHint":"\u062A\u0635\u0648\u06CC\u0631 \u067E\u0633\u062A\u061B \u062F\u0627\u0646\u0644\u0648\u062F\u0634 \u06A9\u0646 \u0648 \u0628\u0627 \u0645\u062A\u0646 \u06A9\u0646\u0627\u0631\u0634 \u062F\u0631 \u0627\u06CC\u0646\u0633\u062A\u0627\u06AF\u0631\u0627\u0645 \u0645\u0646\u062A\u0634\u0631 \u06A9\u0646.","adm.igDl":"\u062F\u0627\u0646\u0644\u0648\u062F \u062A\u0635\u0648\u06CC\u0631","adm.igNoImg":"\u0627\u06CC\u0646 \u06A9\u0627\u0644\u0627 \u062A\u0635\u0648\u06CC\u0631 \u0646\u062F\u0627\u0631\u062F\u061B \u0627\u0648\u0644 \u0627\u0632 \u0628\u062E\u0634 \xAB\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u062A\u0635\u0648\u06CC\u0631\xBB \u06CC\u0627 \u0628\u0627\u0631\u06AF\u0630\u0627\u0631\u06CC\u060C \u0639\u06A9\u0633 \u0628\u06AF\u0630\u0627\u0631.","adm.igCopyCap":"\u06A9\u067E\u06CC \u0645\u062A\u0646","adm.igCopyTags":"\u06A9\u067E\u06CC \u0647\u0634\u062A\u06AF\u200C\u0647\u0627","adm.igCopyAll":"\u06A9\u067E\u06CC \u0645\u062A\u0646 + \u0647\u0634\u062A\u06AF","adm.bGenerated":"\u0628\u0627\u0631\u06A9\u062F \u0633\u0627\u062E\u062A\u0647 \u0648 \u062B\u0628\u062A \u0634\u062F","adm.bScan":"\u0627\u0633\u06A9\u0646 \u0628\u0627\u0631\u06A9\u062F","adm.bScanMode":"\u062D\u0627\u0644\u062A \u0627\u0633\u06A9\u0646\u0631 (\u0647\u0645\u06AF\u0627\u0645\u200C\u0633\u0627\u0632\u06CC \u062F\u0633\u062A\u06AF\u0627\u0647)","adm.bScanHint":"\u062F\u0633\u062A\u06AF\u0627\u0647 \u0628\u0627\u0631\u06A9\u062F\u062E\u0648\u0627\u0646 \u0631\u0627 \u0645\u062B\u0644 \u06A9\u06CC\u0628\u0648\u0631\u062F \u0648\u0635\u0644 \u06A9\u0646\u061B \u0631\u0648\u06CC \u06A9\u0627\u062F\u0631 \u0632\u06CC\u0631 \u06A9\u0644\u06CC\u06A9 \u06A9\u0646 \u0648 \u0627\u0633\u06A9\u0646 \u06A9\u0646. \u0627\u0633\u06A9\u0646 \u0628\u0627 \u062F\u0648\u0631\u0628\u06CC\u0646 \u0647\u0645 \u06A9\u0627\u0631 \u0645\u06CC\u200C\u06A9\u0646\u062F.","adm.bConnected":"\u062F\u0633\u062A\u06AF\u0627\u0647 \u0645\u062A\u0635\u0644 \u0634\u062F \u2014 \u0622\u0645\u0627\u062F\u0647\u200C\u06CC \u0627\u0633\u06A9\u0646","adm.bSerial":"\u0627\u062A\u0635\u0627\u0644 \u0645\u0633\u062A\u0642\u06CC\u0645 \u0628\u0627 Web Serial","adm.bSerialHint":"\u0627\u06AF\u0631 \u062F\u0633\u062A\u06AF\u0627\u0647\u062A \u067E\u0648\u0631\u062A \u0633\u0631\u06CC\u0627\u0644 \u06CC\u0627 USB \u062F\u0627\u0631\u062F\u060C \u0627\u0632 \u0627\u06CC\u0646\u062C\u0627 \u0648\u0635\u0644 \u0634\u0648 (\u0641\u0642\u0637 \u06A9\u0631\u0648\u0645 \u0648 \u0627\u062C \u062F\u0633\u06A9\u062A\u0627\u067E).","adm.bSerialUnsupported":"\u0645\u0631\u0648\u0631\u06AF\u0631 \u062A\u0648 \u0627\u0632 Web Serial \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0646\u0645\u06CC\u200C\u06A9\u0646\u062F\u061B \u0627\u0632 \u062D\u0627\u0644\u062A \u06A9\u06CC\u0628\u0648\u0631\u062F \u06CC\u0627 \u062F\u0648\u0631\u0628\u06CC\u0646 \u0627\u0633\u062A\u0641\u0627\u062F\u0647 \u06A9\u0646.","adm.bSerialConnected":"\u0645\u062A\u0635\u0644 \u0634\u062F","adm.bSerialClosed":"\u0627\u062A\u0635\u0627\u0644 \u0628\u0633\u062A\u0647 \u0634\u062F","adm.bHistory":"\u0627\u0633\u06A9\u0646\u200C\u0647\u0627\u06CC \u0627\u062E\u06CC\u0631","adm.isTitle":"\u0627\u06CC\u0646\u062F\u06A9\u0633 \u062A\u0635\u0648\u06CC\u0631 \u0628\u0631\u0627\u06CC \u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u062A\u0635\u0648\u06CC\u0631\u06CC","adm.isHint":"\u06CC\u06A9\u200C\u0628\u0627\u0631 \u0627\u06CC\u0646\u062F\u06A9\u0633 \u0631\u0627 \u0628\u0633\u0627\u0632 \u062A\u0627 \u0645\u0634\u062A\u0631\u06CC\u200C\u0647\u0627 \u0628\u062A\u0648\u0627\u0646\u0646\u062F \u0628\u0627 \u0639\u06A9\u0633 \u062C\u0633\u062A\u200C\u0648\u062C\u0648 \u06A9\u0646\u0646\u062F. \u062F\u0631 \u0645\u0631\u0648\u0631\u06AF\u0631 \u062E\u0648\u062F\u062A \u0627\u062C\u0631\u0627 \u0645\u06CC\u200C\u0634\u0648\u062F \u0648 \u0628\u0627\u0631\u06CC \u0631\u0648\u06CC \u0633\u0631\u0648\u0631 \u0646\u062F\u0627\u0631\u062F.","adm.isBuild":"\u0633\u0627\u062E\u062A \u0627\u06CC\u0646\u062F\u06A9\u0633","adm.isBuilding":"\u062F\u0631 \u062D\u0627\u0644 \u0627\u06CC\u0646\u062F\u06A9\u0633\u200C\u0633\u0627\u0632\u06CC\u2026","adm.isDone":"\u0627\u06CC\u0646\u062F\u06A9\u0633 \u0633\u0627\u062E\u062A\u0647 \u0634\u062F","adm.isCount":"\u062A\u0635\u0648\u06CC\u0631\u0647\u0627\u06CC \u0627\u06CC\u0646\u062F\u06A9\u0633\u200C\u0634\u062F\u0647","adm.auditAction":"\u0631\u0648\u06CC\u062F\u0627\u062F","adm.auditActor":"\u06A9\u0627\u0631\u0628\u0631","adm.auditTarget":"\u0645\u0648\u0636\u0648\u0639","adm.auditMeta":"\u062C\u0632\u0626\u06CC\u0627\u062A","adm.statsRevenue":"\u062F\u0631\u0622\u0645\u062F","adm.statsVisits":"\u0628\u0627\u0632\u062F\u06CC\u062F","adm.statsOrders":"\u0633\u0641\u0627\u0631\u0634","adm.statsByCat":"\u0639\u0645\u0644\u06A9\u0631\u062F \u062F\u0633\u062A\u0647\u200C\u0647\u0627","adm.statsByBrand":"\u0641\u0631\u0648\u0634 \u0628\u0631 \u0627\u0633\u0627\u0633 \u0628\u0631\u0646\u062F","adm.statsStockValue":"\u0627\u0631\u0632\u0634 \u0645\u0648\u062C\u0648\u062F\u06CC","adm.statsAvgOrder":"\u0645\u06CC\u0627\u0646\u06AF\u06CC\u0646 \u0633\u0628\u062F \u062E\u0631\u06CC\u062F","adm.exportProducts":"\u062E\u0631\u0648\u062C\u06CC \u06A9\u0627\u0644\u0627\u0647\u0627","adm.exportOrders":"\u062E\u0631\u0648\u062C\u06CC \u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627","adm.exportUsers":"\u062E\u0631\u0648\u062C\u06CC \u06A9\u0627\u0631\u0628\u0631\u0627\u0646","adm.exportReviews":"\u062E\u0631\u0648\u062C\u06CC \u0646\u0638\u0631\u0627\u062A","adm.exportTickets":"\u062E\u0631\u0648\u062C\u06CC \u062A\u06CC\u06A9\u062A\u200C\u0647\u0627","adm.exportAudit":"\u062E\u0631\u0648\u062C\u06CC \u0631\u0648\u06CC\u062F\u0627\u062F\u0647\u0627","adm.exportAll":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646 \u06A9\u0627\u0645\u0644 (JSON)","adm.backup":"\u0633\u0627\u062E\u062A \u067E\u0634\u062A\u06CC\u0628\u0627\u0646","adm.backupDone":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646 \u0633\u0627\u062E\u062A\u0647 \u0634\u062F","adm.cleanup":"\u067E\u0627\u06A9\u200C\u0633\u0627\u0632\u06CC \u062F\u0627\u062F\u0647\u200C\u0647\u0627\u06CC \u0642\u062F\u06CC\u0645\u06CC","adm.cleanupDone":"\u067E\u0627\u06A9\u200C\u0633\u0627\u0632\u06CC \u0627\u0646\u062C\u0627\u0645 \u0634\u062F","adm.pageEditHint":"\u0645\u062A\u0646 \u0635\u0641\u062D\u0647\u200C\u0647\u0627 \u0631\u0627 \u0627\u06CC\u0646\u062C\u0627 \u0648\u06CC\u0631\u0627\u06CC\u0634 \u06A9\u0646\u061B \u062A\u063A\u06CC\u06CC\u0631\u0647\u0627 \u0641\u0648\u0631\u0627\u064B \u062F\u0631 \u0633\u0627\u06CC\u062A \u0627\u0639\u0645\u0627\u0644 \u0645\u06CC\u200C\u0634\u0648\u062F.","adm.noPermission":"\u0628\u0631\u0627\u06CC \u0627\u06CC\u0646 \u0628\u062E\u0634 \u062F\u0633\u062A\u0631\u0633\u06CC \u0646\u062F\u0627\u0631\u06CC. \u0627\u0632 \u0645\u0627\u0644\u06A9 \u0628\u062E\u0648\u0627\u0647 \u0622\u0646 \u0631\u0627 \u0641\u0639\u0627\u0644 \u06A9\u0646\u062F.","adm.liveView":"\u067E\u06CC\u0634\u200C\u0646\u0645\u0627\u06CC\u0634 \u0632\u0646\u062F\u0647\u200C\u06CC \u062A\u063A\u06CC\u06CC\u0631\u0627\u062A","adm.saved":"\u0630\u062E\u06CC\u0631\u0647 \u0634\u062F","st.pending_payment":"\u062F\u0631 \u0627\u0646\u062A\u0638\u0627\u0631 \u067E\u0631\u062F\u0627\u062E\u062A","st.pending_review":"\u062F\u0631 \u0627\u0646\u062A\u0638\u0627\u0631 \u0628\u0631\u0631\u0633\u06CC","st.confirmed":"\u062A\u0623\u06CC\u06CC\u062F \u0634\u062F\u0647","st.preparing":"\u062F\u0631 \u062D\u0627\u0644 \u0622\u0645\u0627\u062F\u0647\u200C\u0633\u0627\u0632\u06CC","st.ready_pickup":"\u0622\u0645\u0627\u062F\u0647\u200C\u06CC \u062A\u062D\u0648\u06CC\u0644 \u062D\u0636\u0648\u0631\u06CC","st.shipped":"\u0627\u0631\u0633\u0627\u0644 \u0634\u062F\u0647","st.delivered":"\u062A\u062D\u0648\u06CC\u0644 \u0634\u062F\u0647","st.cancelled":"\u0644\u063A\u0648 \u0634\u062F\u0647","st.refunded":"\u0628\u0627\u0632\u06AF\u0634\u062A \u0648\u062C\u0647","st.returned":"\u0645\u0631\u062C\u0648\u0639 \u0634\u062F\u0647","dl.pickup":"\u062A\u062D\u0648\u06CC\u0644 \u062D\u0636\u0648\u0631\u06CC","dl.courier":"\u0627\u0631\u0633\u0627\u0644 \u067E\u0633\u062A\u06CC","pm.wallet":"\u06A9\u06CC\u0641 \u067E\u0648\u0644","pm.gateway":"\u062F\u0631\u06AF\u0627\u0647 \u0628\u0627\u0646\u06A9\u06CC","pm.cod":"\u067E\u0631\u062F\u0627\u062E\u062A \u062F\u0631 \u0645\u062D\u0644","ps.unpaid":"\u067E\u0631\u062F\u0627\u062E\u062A\u200C\u0646\u0634\u062F\u0647","ps.paid":"\u067E\u0631\u062F\u0627\u062E\u062A\u200C\u0634\u062F\u0647","ps.pending":"\u062F\u0631 \u0627\u0646\u062A\u0638\u0627\u0631","ps.refunded":"\u0628\u0627\u0632\u06AF\u0634\u062A \u062F\u0627\u062F\u0647 \u0634\u062F","ps.failed":"\u0646\u0627\u0645\u0648\u0641\u0642","ps.cancelled":"\u0644\u063A\u0648 \u0634\u062F\u0647","tc.order":"\u067E\u06CC\u06AF\u06CC\u0631\u06CC \u0633\u0641\u0627\u0631\u0634","tc.return":"\u0645\u0631\u062C\u0648\u0639\u06CC \u0648 \u0628\u0627\u0632\u06AF\u0634\u062A \u0648\u062C\u0647","tc.product":"\u0633\u0624\u0627\u0644 \u062F\u0631\u0628\u0627\u0631\u0647\u200C\u06CC \u06A9\u0627\u0644\u0627","tc.technical":"\u0645\u0634\u06A9\u0644 \u0641\u0646\u06CC \u0633\u0627\u06CC\u062A","tc.complaint":"\u0634\u06A9\u0627\u06CC\u062A","tc.partnership":"\u0647\u0645\u06A9\u0627\u0631\u06CC \u0648 \u062A\u0628\u0644\u06CC\u063A\u0627\u062A","tc.account":"\u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC \u0648 \u0627\u0645\u0646\u06CC\u062A","tc.other":"\u0633\u0627\u06CC\u0631 \u0645\u0648\u0627\u0631\u062F","tp.critical":"\u0628\u062D\u0631\u0627\u0646\u06CC","tp.high":"\u0632\u06CC\u0627\u062F","tp.normal":"\u0645\u0639\u0645\u0648\u0644\u06CC","tp.low":"\u06A9\u0645","ft.suggestion":"\u067E\u06CC\u0634\u0646\u0647\u0627\u062F","ft.complaint":"\u0634\u06A9\u0627\u06CC\u062A","ft.bug":"\u06AF\u0632\u0627\u0631\u0634 \u062E\u0637\u0627","fs.new":"\u062C\u062F\u06CC\u062F","fs.seen":"\u062F\u06CC\u062F\u0647 \u0634\u062F\u0647","fs.in_progress":"\u062F\u0631 \u062D\u0627\u0644 \u067E\u06CC\u06AF\u06CC\u0631\u06CC","fs.done":"\u0627\u0646\u062C\u0627\u0645 \u0634\u062F\u0647","fs.rejected":"\u0631\u062F \u0634\u062F\u0647","tk.open":"\u0628\u0627\u0632","tk.answered":"\u067E\u0627\u0633\u062E \u062F\u0627\u062F\u0647 \u0634\u062F\u0647","tk.closed":"\u0628\u0633\u062A\u0647","feat.wallet":"\u06A9\u06CC\u0641 \u067E\u0648\u0644","feat.plus":"\u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633","feat.insurance":"\u0628\u06CC\u0645\u0647\u200C\u06CC \u0645\u0631\u0633\u0648\u0644\u0647","feat.tickets":"\u0633\u0627\u0645\u0627\u0646\u0647\u200C\u06CC \u062A\u06CC\u06A9\u062A","feat.reviews":"\u0646\u0638\u0631\u0627\u062A \u0645\u0634\u062A\u0631\u06CC\u0627\u0646","feat.questions":"\u0633\u0624\u0627\u0644\u0627\u062A \u0645\u0634\u062A\u0631\u06CC\u0627\u0646","feat.ads":"\u062A\u0628\u0644\u06CC\u063A\u0627\u062A \u062F\u0627\u062E\u0644 \u0633\u0627\u06CC\u062A","feat.imageSearch":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u062A\u0635\u0648\u06CC\u0631\u06CC","feat.barcode":"\u0628\u0627\u0631\u06A9\u062F \u0648 \u0628\u0631\u0686\u0633\u0628","feat.priceCheckDevice":"\u062D\u0627\u0644\u062A \u0646\u0645\u0627\u06CC\u0634 \u0642\u06CC\u0645\u062A","feat.publicStats":"\u0622\u0645\u0627\u0631 \u0639\u0645\u0648\u0645\u06CC","feat.coupons":"\u06A9\u062F\u0647\u0627\u06CC \u062A\u062E\u0641\u06CC\u0641","feat.consent":"\u0645\u0648\u062F\u0627\u0644 \u062A\u0648\u0627\u0641\u0642 \u06A9\u0648\u06A9\u06CC (\u0627\u0648\u0644\u06CC\u0646 \u0628\u0627\u0632\u062F\u06CC\u062F)","feat.liveSupport":"\u0686\u062A \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0622\u0646\u0644\u0627\u06CC\u0646","feat.announcements":"\u0627\u0639\u0644\u0627\u0646\u200C\u0647\u0627","feat.wishlist":"\u0644\u06CC\u0633\u062A \u0645\u0646","feat.compare":"\u0645\u0642\u0627\u06CC\u0633\u0647\u200C\u06CC \u06A9\u0627\u0644\u0627","feat.recentlyViewed":"\u06A9\u0627\u0644\u0627\u0647\u0627\u06CC \u062F\u06CC\u062F\u0647\u200C\u0634\u062F\u0647","feat.guestCheckout":"\u062E\u0631\u06CC\u062F \u0628\u062F\u0648\u0646 \u062D\u0633\u0627\u0628 \u06A9\u0627\u0631\u0628\u0631\u06CC","feat.priceAlerts":"\u0627\u0639\u0644\u0627\u0646 \u0645\u0648\u062C\u0648\u062F \u0634\u062F\u0646 \u06A9\u0627\u0644\u0627","feat.twoFactor":"\u0648\u0631\u0648\u062F \u062F\u0648\u0645\u0631\u062D\u0644\u0647\u200C\u0627\u06CC","feat.referrals":"\u06A9\u062F \u0645\u0639\u0631\u0641","feat.voiceSearch":"\u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u0635\u0648\u062A\u06CC","feat.offlineMode":"\u062D\u0627\u0644\u062A \u0622\u0641\u0644\u0627\u06CC\u0646","feat.captcha":"\u06A9\u067E\u0686\u0627 (\u0645\u0646 \u0631\u0628\u0627\u062A \u0646\u06CC\u0633\u062A\u0645)","captcha.required":"\u0628\u0631\u0627\u06CC \u0648\u0631\u0648\u062F\u060C \u0627\u0648\u0644 \u062A\u0623\u06CC\u06CC\u062F \u06A9\u0646 \u06A9\u0647 \u0631\u0628\u0627\u062A \u0646\u06CC\u0633\u062A\u06CC: \u062A\u06CC\u06A9 \u0628\u0632\u0646 \u0648 \u062D\u0627\u0635\u0644 \u0639\u0628\u0627\u0631\u062A \u0631\u0627 \u0628\u0646\u0648\u06CC\u0633.","captcha.label":"\u0645\u0646 \u0631\u0628\u0627\u062A \u0646\u06CC\u0633\u062A\u0645","captcha.hint":"\u062A\u06CC\u06A9 \u0628\u0632\u0646\u060C \u0628\u0639\u062F \u062D\u0627\u0635\u0644 \u0639\u0628\u0627\u0631\u062A \u062A\u0635\u0648\u06CC\u0631 \u0631\u0627 \u0628\u0646\u0648\u06CC\u0633","captcha.placeholder":"\u062D\u0627\u0635\u0644 \u0639\u0628\u0627\u0631\u062A","captcha.solved":"\u062A\u0623\u06CC\u06CC\u062F \u0634\u062F \u06A9\u0647 \u0631\u0628\u0627\u062A \u0646\u06CC\u0633\u062A\u06CC \u2714","captcha.refresh":"\u0633\u0624\u0627\u0644 \u062A\u0627\u0632\u0647","perm.dashboard.view":"\u0645\u0634\u0627\u0647\u062F\u0647\u200C\u06CC \u062F\u0627\u0634\u0628\u0648\u0631\u062F","perm.products.view":"\u0645\u0634\u0627\u0647\u062F\u0647\u200C\u06CC \u06A9\u0627\u0644\u0627\u0647\u0627","perm.products.create":"\u0627\u06CC\u062C\u0627\u062F \u06A9\u0627\u0644\u0627","perm.products.edit":"\u0648\u06CC\u0631\u0627\u06CC\u0634 \u06A9\u0627\u0644\u0627","perm.products.delete":"\u062D\u0630\u0641 \u06A9\u0627\u0644\u0627","perm.products.price":"\u062A\u063A\u06CC\u06CC\u0631 \u0642\u06CC\u0645\u062A \u0648 \u062A\u062E\u0641\u06CC\u0641","perm.products.stock":"\u062A\u063A\u06CC\u06CC\u0631 \u0645\u0648\u062C\u0648\u062F\u06CC","perm.categories.manage":"\u0645\u062F\u06CC\u0631\u06CC\u062A \u062F\u0633\u062A\u0647\u200C\u0647\u0627 \u0648 \u0628\u0631\u0646\u062F\u0647\u0627","perm.orders.view":"\u0645\u0634\u0627\u0647\u062F\u0647\u200C\u06CC \u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627","perm.orders.manage":"\u062A\u063A\u06CC\u06CC\u0631 \u0648\u0636\u0639\u06CC\u062A \u0633\u0641\u0627\u0631\u0634","perm.refunds.manage":"\u0645\u0631\u062C\u0648\u0639\u06CC \u0648 \u0644\u063A\u0648 \u0633\u0641\u0627\u0631\u0634","perm.reviews.moderate":"\u062A\u0623\u06CC\u06CC\u062F \u0648 \u0645\u062F\u06CC\u0631\u06CC\u062A \u0646\u0638\u0631\u0627\u062A","perm.reviews.reply":"\u067E\u0627\u0633\u062E \u0628\u0647 \u0646\u0638\u0631\u0627\u062A","perm.tickets.manage":"\u0645\u062F\u06CC\u0631\u06CC\u062A \u062A\u06CC\u06A9\u062A\u200C\u0647\u0627","perm.feedback.manage":"\u0628\u0627\u0632\u062E\u0648\u0631\u062F\u0647\u0627 \u0648 \u062E\u0637\u0627\u0647\u0627","perm.users.view":"\u0645\u0634\u0627\u0647\u062F\u0647\u200C\u06CC \u06A9\u0627\u0631\u0628\u0631\u0627\u0646","perm.users.manage":"\u0645\u062F\u06CC\u0631\u06CC\u062A \u06A9\u0627\u0631\u0628\u0631\u0627\u0646","perm.users.permissions":"\u062A\u0639\u06CC\u06CC\u0646 \u062F\u0633\u062A\u0631\u0633\u06CC\u200C\u0647\u0627","perm.wallet.manage":"\u0645\u062F\u06CC\u0631\u06CC\u062A \u06A9\u06CC\u0641 \u067E\u0648\u0644","perm.plus.manage":"\u0645\u062F\u06CC\u0631\u06CC\u062A \u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633","perm.coupons.manage":"\u0645\u062F\u06CC\u0631\u06CC\u062A \u06A9\u062F\u0647\u0627\u06CC \u062A\u062E\u0641\u06CC\u0641","perm.ads.manage":"\u0645\u062F\u06CC\u0631\u06CC\u062A \u062A\u0628\u0644\u06CC\u063A\u0627\u062A","perm.notifications.send":"\u0627\u0631\u0633\u0627\u0644 \u0627\u0639\u0644\u0627\u0646","perm.settings.edit":"\u062A\u0646\u0638\u06CC\u0645\u0627\u062A \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","perm.theme.edit":"\u067E\u0648\u0633\u062A\u0647 \u0648 \u0686\u06CC\u062F\u0645\u0627\u0646","perm.pages.edit":"\u0648\u06CC\u0631\u0627\u06CC\u0634 \u0645\u062D\u062A\u0648\u0627\u06CC \u0635\u0641\u062D\u0647\u200C\u0647\u0627","perm.barcode.print":"\u0686\u0627\u067E \u0628\u0631\u0686\u0633\u0628","perm.barcode.scan":"\u0627\u0633\u06A9\u0646 \u0648 \u0646\u0645\u0627\u06CC\u0634 \u0642\u06CC\u0645\u062A","perm.imagesearch.index":"\u0627\u06CC\u0646\u062F\u06A9\u0633 \u062A\u0635\u0648\u06CC\u0631\u06CC","perm.audit.view":"\u06AF\u0632\u0627\u0631\u0634 \u0631\u0648\u06CC\u062F\u0627\u062F\u0647\u0627","perm.stats.view":"\u0622\u0645\u0627\u0631","perm.data.export":"\u062E\u0631\u0648\u062C\u06CC \u062F\u0627\u062F\u0647\u200C\u0647\u0627","misc.quickView":"\u0645\u0634\u0627\u0647\u062F\u0647\u200C\u06CC \u0633\u0631\u06CC\u0639","misc.addToHome":"\u0627\u0641\u0632\u0648\u062F\u0646 \u0628\u0647 \u0635\u0641\u062D\u0647\u200C\u06CC \u0627\u0635\u0644\u06CC","misc.installHint":"\u062F\u0631 \u0645\u0646\u0648\u06CC \u0645\u0631\u0648\u0631\u06AF\u0631\u060C \u06AF\u0632\u06CC\u0646\u0647\u200C\u06CC \xABAdd to Home screen\xBB \u06CC\u0627 \xABInstall\xBB \u0631\u0627 \u0628\u0632\u0646.","misc.printBlocked":"\u067E\u0646\u062C\u0631\u0647\u200C\u06CC \u0686\u0627\u067E \u0628\u0627\u0632 \u0646\u0634\u062F\u061B \u0644\u0637\u0641\u0627\u064B \u067E\u0627\u067E\u200C\u0622\u067E \u0631\u0627 \u0645\u062C\u0627\u0632 \u06A9\u0646.","misc.saved":"\u0630\u062E\u06CC\u0631\u0647 \u0634\u062F","misc.deleted":"\u062D\u0630\u0641 \u0634\u062F","misc.updated":"\u0628\u0647\u200C\u0631\u0648\u0632\u0631\u0633\u0627\u0646\u06CC \u0634\u062F","misc.confirmDelete":"\u0627\u06CC\u0646 \u0645\u0648\u0631\u062F \u062D\u0630\u0641 \u0634\u0648\u062F\u061F","misc.loadingMore":"\u062F\u0631 \u062D\u0627\u0644 \u0628\u0627\u0631\u06AF\u0630\u0627\u0631\u06CC\u2026","misc.recentlyViewed":"\u06A9\u0627\u0644\u0627\u0647\u0627\u06CC \u062F\u06CC\u062F\u0647\u200C\u0634\u062F\u0647","misc.uiSound":"\u0635\u062F\u0627\u06CC \u06A9\u0644\u06CC\u06A9 \u0631\u0627\u0628\u0637","misc.uiSoundOn":"\u0635\u062F\u0627\u06CC \u06A9\u0644\u06CC\u06A9 \u0631\u0648\u0634\u0646 \u0634\u062F","misc.uiSoundOff":"\u0635\u062F\u0627\u06CC \u06A9\u0644\u06CC\u06A9 \u062E\u0627\u0645\u0648\u0634 \u0634\u062F","misc.shareDone":"\u0644\u06CC\u0646\u06A9 \u06A9\u067E\u06CC \u0634\u062F","misc.shareNative":"\u0627\u0634\u062A\u0631\u0627\u06A9\u200C\u06AF\u0630\u0627\u0631\u06CC","img.alt":"\u062A\u0635\u0648\u06CC\u0631 \u06A9\u0627\u0644\u0627","adm.view":"\u0645\u0634\u0627\u0647\u062F\u0647","adm.support":"\u0686\u062A \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC","adm.supSelect":"\u06CC\u06A9 \u06AF\u0641\u062A\u200C\u0648\u06AF\u0648 \u0631\u0627 \u0627\u0646\u062A\u062E\u0627\u0628 \u06A9\u0646","adm.supSelectHint":"\u0627\u0632 \u0641\u0647\u0631\u0633\u062A \u06A9\u0646\u0627\u0631\u060C \u06AF\u0641\u062A\u200C\u0648\u06AF\u0648\u06CC \u06A9\u0627\u0631\u0628\u0631 \u0631\u0627 \u0628\u0627\u0632 \u06A9\u0646 \u062A\u0627 \u067E\u0627\u0633\u062E \u0628\u062F\u0647\u06CC.","adm.tkReply":"\u067E\u0627\u0633\u062E \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC","adm.tkManage":"\u0645\u062F\u06CC\u0631\u06CC\u062A \u062A\u06CC\u06A9\u062A","common.updated":"\u0628\u0647\u200C\u0631\u0648\u0632\u0631\u0633\u0627\u0646\u06CC","common.link":"\u0644\u06CC\u0646\u06A9","common.text":"\u0645\u062A\u0646","cart.coupon":"\u06A9\u062F \u062A\u062E\u0641\u06CC\u0641","misc.sent":"\u0627\u0631\u0633\u0627\u0644 \u0634\u062F","misc.copied":"\u06A9\u067E\u06CC \u0634\u062F","adm.revPending":"\u062F\u0631 \u0627\u0646\u062A\u0638\u0627\u0631 \u0628\u0631\u0631\u0633\u06CC","adm.revApproved":"\u0645\u0646\u062A\u0634\u0631\u0634\u062F\u0647","adm.revRejected":"\u0631\u062F\u0634\u062F\u0647","adm.revApprove":"\u0627\u0646\u062A\u0634\u0627\u0631","adm.revReject":"\u0631\u062F","adm.revReply":"\u067E\u0627\u0633\u062E \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","adm.revEmpty":"\u0645\u0648\u0631\u062F\u06CC \u062F\u0631 \u0627\u06CC\u0646 \u0648\u0636\u0639\u06CC\u062A \u0646\u06CC\u0633\u062A","adm.revEmptyHint":"\u0646\u0638\u0631 \u06CC\u0627 \u067E\u0631\u0633\u0634 \u062A\u0627\u0632\u0647\u200C\u0627\u06CC \u0628\u0631\u0627\u06CC \u0628\u0631\u0631\u0633\u06CC \u0648\u062C\u0648\u062F \u0646\u062F\u0627\u0631\u062F.","rev.buyer":"\u062E\u0631\u06CC\u062F\u0627\u0631","rev.visitor":"\u0628\u0627\u0632\u062F\u06CC\u062F\u06A9\u0646\u0646\u062F\u0647","rev.shopReply":"\u067E\u0627\u0633\u062E \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","fb.new":"\u062C\u062F\u06CC\u062F","fb.seen":"\u062F\u06CC\u062F\u0647 \u0634\u062F","fb.inProgress":"\u062F\u0631 \u062D\u0627\u0644 \u0628\u0631\u0631\u0633\u06CC","fb.done":"\u0627\u0646\u062C\u0627\u0645 \u0634\u062F","fb.rejected":"\u0631\u062F \u0634\u062F","feedback.suggestion":"\u067E\u06CC\u0634\u0646\u0647\u0627\u062F","feedback.complaint":"\u0634\u06A9\u0627\u06CC\u062A","feedback.bug":"\u06AF\u0632\u0627\u0631\u0634 \u062E\u0637\u0627","adm.fbEmptyHint":"\u067E\u06CC\u0634\u0646\u0647\u0627\u062F\u060C \u0634\u06A9\u0627\u06CC\u062A \u06CC\u0627 \u06AF\u0632\u0627\u0631\u0634 \u062E\u0637\u0627\u06CC\u06CC \u062B\u0628\u062A \u0646\u0634\u062F\u0647 \u0627\u0633\u062A.","adm.cpNew":"\u06A9\u062F \u062A\u062E\u0641\u06CC\u0641 \u062C\u062F\u06CC\u062F","adm.cpPercent":"\u062F\u0631\u0635\u062F\u06CC","adm.cpAmount":"\u0645\u0628\u0644\u063A\u06CC","adm.cpValue":"\u0645\u0642\u062F\u0627\u0631","adm.cpUsage":"\u0627\u0633\u062A\u0641\u0627\u062F\u0647","adm.cpDates":"\u0628\u0627\u0632\u0647\u200C\u06CC \u0627\u0639\u062A\u0628\u0627\u0631","adm.cpStart":"\u0634\u0631\u0648\u0639","adm.cpEnd":"\u067E\u0627\u06CC\u0627\u0646","adm.cpExpired":"\u0645\u0646\u0642\u0636\u06CC","adm.adNew":"\u0628\u0646\u0631 \u062C\u062F\u06CC\u062F","adm.adSlot":"\u062C\u0627\u06CC\u06AF\u0627\u0647 \u0646\u0645\u0627\u06CC\u0634","adm.adsHint":"\u0628\u0646\u0631\u0647\u0627 \u0631\u0627 \u062F\u0631 \u0647\u0631 \u062C\u0627\u06CC \u0633\u0627\u06CC\u062A \u0632\u0645\u0627\u0646\u200C\u0628\u0646\u062F\u06CC\u060C \u0641\u0639\u0627\u0644 \u06CC\u0627 \u063A\u06CC\u0631\u0641\u0639\u0627\u0644 \u06A9\u0646.","adm.notifNew":"\u0627\u0639\u0644\u0627\u0646 \u062C\u062F\u06CC\u062F","adm.notifHint":"\u0627\u0639\u0644\u0627\u0646 \u0631\u0627 \u0628\u0631\u0627\u06CC \u0647\u0645\u0647\u200C\u06CC \u06A9\u0627\u0631\u0628\u0631\u0627\u0646 \u06CC\u0627 \u06CC\u06A9 \u06A9\u0627\u0631\u0628\u0631 \u062E\u0627\u0635 \u0628\u0641\u0631\u0633\u062A.","adm.notifLevel":"\u0633\u0637\u062D","adm.notifRecent":"\u0627\u0639\u0644\u0627\u0646\u200C\u0647\u0627\u06CC \u0627\u062E\u06CC\u0631","notif.level.info":"\u0627\u0637\u0644\u0627\u0639","notif.level.success":"\u0645\u0648\u0641\u0642","notif.level.warning":"\u0647\u0634\u062F\u0627\u0631","notif.level.error":"\u062E\u0637\u0627","adm.pagesPick":"\u06CC\u06A9 \u0635\u0641\u062D\u0647 \u0631\u0627 \u0627\u0646\u062A\u062E\u0627\u0628 \u06A9\u0646","adm.pagesPickHint":"\u0627\u0632 \u0641\u0647\u0631\u0633\u062A \u06A9\u0646\u0627\u0631\u060C \u0635\u0641\u062D\u0647\u200C\u0627\u06CC \u0631\u0627 \u06A9\u0647 \u0645\u06CC\u200C\u062E\u0648\u0627\u0647\u06CC \u0648\u06CC\u0631\u0627\u06CC\u0634 \u06A9\u0646\u06CC \u0627\u0646\u062A\u062E\u0627\u0628 \u06A9\u0646.","adm.pgHint":"\u062A\u063A\u06CC\u06CC\u0631\u0647\u0627 \u0641\u0642\u0637 \u0645\u062A\u0646\u200C\u0627\u0646\u062F \u0648 \u0628\u0644\u0627\u0641\u0627\u0635\u0644\u0647 \u0631\u0648\u06CC \u0635\u0641\u062D\u0647 \u0627\u0639\u0645\u0627\u0644 \u0645\u06CC\u200C\u0634\u0648\u0646\u062F.","adm.bPrinter":"\u0686\u0627\u067E\u06AF\u0631 \u0628\u0631\u0686\u0633\u0628","adm.bPrinterHint":"\u0628\u0631\u0686\u0633\u0628\u200C\u0647\u0627 \u0627\u0632 \u0631\u0627\u0647 \u06AF\u0641\u062A\u200C\u0648\u06AF\u0648\u06CC \u0686\u0627\u067E \u0645\u0631\u0648\u0631\u06AF\u0631 \u0628\u0647 \u0686\u0627\u067E\u06AF\u0631 \u0641\u0631\u0633\u062A\u0627\u062F\u0647 \u0645\u06CC\u200C\u0634\u0648\u0646\u062F.","adm.bScanner":"\u0628\u0627\u0631\u06A9\u062F\u062E\u0648\u0627\u0646","adm.bLabels":"\u0633\u0627\u062E\u062A \u0648 \u0686\u0627\u067E \u0628\u0631\u0686\u0633\u0628","adm.bPreview":"\u067E\u06CC\u0634\u200C\u0646\u0645\u0627\u06CC\u0634 \u0628\u0631\u0686\u0633\u0628","adm.bPriceMode":"\u062D\u0627\u0644\u062A \u0646\u0645\u0627\u06CC\u0634 \u0642\u06CC\u0645\u062A","adm.bFound":"\u06A9\u0627\u0644\u0627 \u067E\u06CC\u062F\u0627 \u0634\u062F","adm.bNotFound":"\u06A9\u0627\u0644\u0627\u06CC\u06CC \u0628\u0627 \u0627\u06CC\u0646 \u0628\u0627\u0631\u06A9\u062F \u067E\u06CC\u062F\u0627 \u0646\u0634\u062F.","adm.bPickFirst":"\u0627\u0648\u0644 \u062F\u0633\u062A\u200C\u06A9\u0645 \u06CC\u06A9 \u06A9\u0627\u0644\u0627 \u0631\u0627 \u0627\u0646\u062A\u062E\u0627\u0628 \u06A9\u0646.","adm.ixHint":"\u0627\u062B\u0631\u0627\u0646\u06AF\u0634\u062A \u062A\u0635\u0648\u06CC\u0631 \u0647\u0631 \u06A9\u0627\u0644\u0627 \u062F\u0631 \u0645\u0631\u0648\u0631\u06AF\u0631 \u0645\u062D\u0627\u0633\u0628\u0647 \u0648 \u0630\u062E\u06CC\u0631\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F \u062A\u0627 \u062C\u0633\u062A\u200C\u0648\u062C\u0648\u06CC \u062A\u0635\u0648\u06CC\u0631\u06CC \u06A9\u0627\u0631 \u06A9\u0646\u062F.","adm.ixIndex":"\u0627\u06CC\u0646\u062F\u06A9\u0633 \u062A\u0635\u0627\u0648\u06CC\u0631 \u0628\u0627\u0642\u06CC\u200C\u0645\u0627\u0646\u062F\u0647","adm.ixReindex":"\u0627\u06CC\u0646\u062F\u06A9\u0633 \u062F\u0648\u0628\u0627\u0631\u0647\u200C\u06CC \u0647\u0645\u0647","adm.ixDone":"\u0627\u06CC\u0646\u062F\u06A9\u0633 \u0627\u0646\u062C\u0627\u0645 \u0634\u062F","adm.audActor":"\u06A9\u0627\u0631\u0628\u0631","adm.audAction":"\u0631\u0648\u06CC\u062F\u0627\u062F","adm.audTarget":"\u0647\u062F\u0641","adm.audMeta":"\u062C\u0632\u0626\u06CC\u0627\u062A","adm.stOrders":"\u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627","adm.stRevenue":"\u062F\u0631\u0622\u0645\u062F","adm.stVisits":"\u0628\u0627\u0632\u062F\u06CC\u062F\u0647\u0627","adm.stUsers":"\u06A9\u0627\u0631\u0628\u0631\u0627\u0646","adm.stProducts":"\u06A9\u0627\u0644\u0627\u0647\u0627","adm.stAvg":"\u0645\u06CC\u0627\u0646\u06AF\u06CC\u0646 \u0633\u0641\u0627\u0631\u0634","adm.stByCat":"\u0639\u0645\u0644\u06A9\u0631\u062F \u062F\u0633\u062A\u0647\u200C\u0647\u0627","adm.stByBrand":"\u067E\u0631\u0641\u0631\u0648\u0634\u200C\u062A\u0631\u06CC\u0646 \u0628\u0631\u0646\u062F\u0647\u0627","adm.data":"\u062F\u0627\u062F\u0647\u200C\u0647\u0627","adm.dataHint":"\u062E\u0631\u0648\u062C\u06CC \u06AF\u0631\u0641\u062A\u0646\u060C \u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u200C\u06AF\u06CC\u0631\u06CC \u0648 \u067E\u0627\u06A9\u200C\u0633\u0627\u0632\u06CC \u062F\u0627\u062F\u0647\u200C\u0647\u0627.","adm.dExport":"\u062E\u0631\u0648\u062C\u06CC","adm.dBackup":"\u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u200C\u06AF\u06CC\u0631\u06CC","adm.dBackupHint":"\u06CC\u06A9 \u0646\u0633\u062E\u0647\u200C\u06CC \u06A9\u0627\u0645\u0644 \u0627\u0632 \u067E\u0627\u06CC\u06AF\u0627\u0647\u200C\u062F\u0627\u062F\u0647 \u062F\u0631 \u067E\u0648\u0634\u0647\u200C\u06CC data \u0630\u062E\u06CC\u0631\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F.","adm.dCleanup":"\u067E\u0627\u06A9\u200C\u0633\u0627\u0632\u06CC","adm.dCleanupHint":"\u0631\u0648\u06CC\u062F\u0627\u062F\u0647\u0627\u06CC \u0642\u062F\u06CC\u0645\u06CC\u200C\u062A\u0631 \u0627\u0632 \u06F9\u06F0 \u0631\u0648\u0632 \u0648 \u0646\u0634\u0633\u062A\u200C\u0647\u0627\u06CC \u0645\u0646\u0642\u0636\u06CC \u062D\u0630\u0641 \u0645\u06CC\u200C\u0634\u0648\u0646\u062F.","sys.turnOn":"\u0631\u0648\u0634\u0646 \u06A9\u0631\u062F\u0646 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","sys.turnOff":"\u062E\u0627\u0645\u0648\u0634 \u06A9\u0631\u062F\u0646 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647","sys.offConfirm":"\u0645\u0637\u0645\u0626\u0646\u06CC\u061F \u062A\u0627 \u0648\u0642\u062A\u06CC \u062E\u0648\u062F\u062A \u0631\u0648\u0634\u0646\u0634 \u0646\u06A9\u0646\u06CC \u0647\u06CC\u0686\u200C\u06A9\u0633 \u0646\u0645\u06CC\u200C\u062A\u0648\u0627\u0646\u062F \u062E\u0631\u06CC\u062F \u06A9\u0646\u062F.","sys.autoWakeMins":"\u0631\u0648\u0634\u0646 \u0634\u062F\u0646 \u062E\u0648\u062F\u06A9\u0627\u0631 \u0628\u0639\u062F \u0627\u0632 \u0686\u0646\u062F \u062F\u0642\u06CC\u0642\u0647 (\u06F0 = \u0647\u06CC\u0686\u200C\u0648\u0642\u062A)","sys.asleep":"\u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u062E\u0627\u0645\u0648\u0634 \u0634\u062F.","sys.asleepTimed":"\u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u062E\u0627\u0645\u0648\u0634 \u0634\u062F\u061B {n} \u062F\u0642\u06CC\u0642\u0647 \u062F\u06CC\u06AF\u0631 \u062E\u0648\u062F\u06A9\u0627\u0631 \u0631\u0648\u0634\u0646 \u0645\u06CC\u200C\u0634\u0648\u062F.","sys.awake":"\u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u0631\u0648\u0634\u0646 \u0634\u062F.","sys.sleepBanner":"\u0641\u0631\u0648\u0634\u06AF\u0627\u0647 \u0627\u0644\u0627\u0646 \u062E\u0627\u0645\u0648\u0634 \u0627\u0633\u062A. \u0628\u0627 \u062F\u06A9\u0645\u0647\u200C\u06CC \xAB\u0631\u0648\u0634\u0646 \u06A9\u0631\u062F\u0646 \u0641\u0631\u0648\u0634\u06AF\u0627\u0647\xBB \u0628\u0627\u0644\u0627\u06CC \u0647\u0645\u06CC\u0646 \u0635\u0641\u062D\u0647 \u062F\u0648\u0628\u0627\u0631\u0647 \u0631\u0648\u0634\u0646\u0634 \u06A9\u0646.","sys.keepAlive":"\u0646\u06AF\u0647\u200C\u062F\u0627\u0634\u062A\u0646 \u0633\u0631\u0648\u06CC\u0633 \u0641\u0639\u0627\u0644","checkout.guestInfo":"\u0627\u0637\u0644\u0627\u0639\u0627\u062A \u062A\u0645\u0627\u0633 \u0645\u0647\u0645\u0627\u0646","checkout.guestHint":"\u0628\u062F\u0648\u0646 \u0633\u0627\u062E\u062A \u062D\u0633\u0627\u0628 \u062E\u0631\u06CC\u062F \u0645\u06CC\u200C\u06A9\u0646\u06CC\u061B \u0641\u0642\u0637 \u0628\u0631\u0627\u06CC \u0647\u0645\u0627\u0647\u0646\u06AF\u06CC \u062A\u062D\u0648\u06CC\u0644 \u0628\u0647 \u0627\u06CC\u0646 \u0627\u0637\u0644\u0627\u0639\u0627\u062A \u0646\u06CC\u0627\u0632 \u062F\u0627\u0631\u06CC\u0645.","checkout.guestName":"\u0646\u0627\u0645 \u0648 \u0646\u0627\u0645 \u062E\u0627\u0646\u0648\u0627\u062F\u06AF\u06CC","checkout.guestPhone":"\u0634\u0645\u0627\u0631\u0647\u200C\u06CC \u0645\u0648\u0628\u0627\u06CC\u0644","checkout.guestPhoneHint":"\u0645\u062B\u0644\u0627\u064B \u06F0\u06F9\u06F1\u06F2\u06F3\u06F4\u06F5\u06F6\u06F7\u06F8\u06F9","checkout.guestNameRequired":"\u0646\u0627\u0645 \u062E\u0648\u062F \u0631\u0627 \u0628\u0646\u0648\u06CC\u0633.","checkout.guestPhoneInvalid":"\u0634\u0645\u0627\u0631\u0647\u200C\u06CC \u0645\u0648\u0628\u0627\u06CC\u0644 \u0628\u0627\u06CC\u062F \u06F1\u06F1 \u0631\u0642\u0645 \u0648 \u0628\u0627 \u06F0\u06F9 \u0634\u0631\u0648\u0639 \u0634\u0648\u062F.","checkout.guestCodPickup":"\u067E\u0631\u062F\u0627\u062E\u062A \u062F\u0631 \u0645\u062D\u0644 \u0641\u0642\u0637 \u0628\u0631\u0627\u06CC \u0627\u0631\u0633\u0627\u0644 \u067E\u0633\u062A\u06CC \u0645\u0645\u06A9\u0646 \u0627\u0633\u062A\u061B \u0628\u0631\u0627\u06CC \u062A\u062D\u0648\u06CC\u0644 \u062D\u0636\u0648\u0631\u06CC\u060C \u0622\u0646\u0644\u0627\u06CC\u0646 \u067E\u0631\u062F\u0627\u062E\u062A \u06A9\u0646 \u06CC\u0627 \u0648\u0627\u0631\u062F \u062D\u0633\u0627\u0628 \u0634\u0648.","home.recent":"\u0627\u062F\u0627\u0645\u0647\u200C\u06CC \u0628\u0627\u0632\u062F\u06CC\u062F\u0647\u0627\u06CC \u0634\u0645\u0627","home.recentSub":"\u06A9\u0627\u0644\u0627\u0647\u0627\u06CC\u06CC \u06A9\u0647 \u0627\u062E\u06CC\u0631\u0627\u064B \u062F\u06CC\u062F\u0647\u200C\u0627\u06CC","checkout.guestCourierNote":"\u0628\u0631\u0627\u06CC \u0627\u0631\u0633\u0627\u0644 \u067E\u0633\u062A\u06CC \u0648\u0627\u0631\u062F \u062D\u0633\u0627\u0628 \u0634\u0648"},fc={"app.name":"Green Apple","app.tagline":"Mobile accessories & gadgets","common.loading":"Loading\u2026","common.save":"Save","common.saving":"Saving\u2026","common.cancel":"Cancel","common.close":"Close","common.confirm":"Confirm","common.delete":"Delete","common.edit":"Edit","common.add":"Add","common.create":"Create","common.update":"Update","common.search":"Search","common.filter":"Filter","common.filters":"Filters","common.sort":"Sort","common.all":"All","common.none":"None","common.more":"More","common.less":"Less","common.showAll":"View all","common.back":"Back","common.next":"Next","common.prev":"Previous","common.yes":"Yes","common.no":"No","common.optional":"Optional","common.required":"Required","common.copy":"Copy","common.copied":"Copied","common.share":"Share","common.download":"Download","common.upload":"Upload","common.print":"Print","common.refresh":"Refresh","common.retry":"Try again","common.send":"Send","common.sent":"Sent","common.submit":"Submit","common.reply":"Reply","common.view":"View","common.details":"Details","common.status":"Status","common.date":"Date","common.time":"Time","common.amount":"Amount","common.count":"Quantity","common.total":"Total","common.price":"Price","common.stock":"Stock","common.available":"In stock","common.unavailable":"Out of stock","common.inStock":"Available in stock","common.lowStock":"Fewer than 3 left","common.notifyMe":"Notify me when available","common.notified":"We will let you know as soon as it is back","common.category":"Category","common.brand":"Brand","common.product":"Product","common.products":"Products","common.order":"Order","common.orders":"Orders","common.user":"User","common.users":"Users","common.result":"Result","common.results":"Results","common.noResult":"No results found","common.error":"Error","common.success":"Done","common.warning":"Notice","common.note":"Note","common.notes":"Notes","common.description":"Description","common.specs":"Specifications","common.actions":"Actions","common.active":"Active","common.inactive":"Inactive","common.enabled":"On","common.disabled":"Off","common.on":"On","common.off":"Off","common.from":"From","common.to":"To","common.and":"and","common.or":"or","common.today":"Today","common.yesterday":"Yesterday","common.toman":"Toman","common.rial":"Rial","common.page":"Page","common.of":"of","common.items":"items","common.new":"New","common.old":"Old","common.apply":"Apply","common.reset":"Reset","common.clear":"Clear","common.select":"Please select","common.title":"Title","common.body":"Message","common.type":"Type","common.priority":"Priority","common.answer":"Answer","common.message":"Message","common.messages":"Messages","common.attach":"Attachment","common.image":"Image","common.images":"Images","common.phone":"Mobile number","common.email":"Email","common.address":"Address","common.city":"City","common.province":"Province","common.postal":"Postal code","common.name":"Name","common.fullName":"Full name","common.username":"Username","common.password":"Password","common.passwordConfirm":"Repeat password","common.login":"Sign in","common.logout":"Sign out","common.register":"Register","common.guest":"Guest","common.admin":"Admin","common.settings":"Settings","common.help":"Help","common.home":"Home","common.skip":"Skip","common.done":"Done","common.pending":"Pending","common.approved":"Approved","common.rejected":"Rejected","common.open":"Open","common.closed":"Closed","common.all2":"All items","common.never":"Never","common.empty":"Empty","common.secure":"Secure","common.free":"Free","common.unit":"pcs","common.day":"day","common.hour":"hour","common.minute":"minute","common.second":"second","common.percent":"percent","common.discount":"Discount","common.discountCode":"Discount code","common.shipping":"Shipping cost","common.insurance":"Shipment insurance","common.subtotal":"Items subtotal","common.payable":"Amount payable","common.payment":"Payment","common.cart":"Cart","common.wishlist":"My list","common.compare":"Compare","common.profile":"Profile","common.wallet":"Wallet","common.balance":"Balance","common.transactions":"Transactions","common.deposit":"Top up wallet","common.points":"Points","common.ticket":"Ticket","common.tickets":"Tickets","common.support":"Support","common.review":"Review","common.reviews":"Reviews","common.question":"Question","common.questions":"Customer questions","common.rating":"Rating","common.notification":"Notification","common.notifications":"Notifications","common.security":"Security","common.history":"History","common.report":"Report","common.bug":"Bug report","common.suggestion":"Suggestion","common.complaint":"Complaint","common.law":"Terms & conditions","common.privacy":"Privacy policy","common.about":"About us","common.contact":"Contact us","common.faq":"FAQ","common.guide":"Buying guide","common.services":"Customer services","common.stats":"Store statistics","common.searchProducts":"Search products\u2026","common.noData":"Nothing to show","common.tryAgain":"Try again","common.showMore":"Show more","common.perPage":"Per page",skip:"Skip to main content","boot.loading":"Loading Green Apple\u2026","boot.waking":"The cloud server is waking up; we will retry automatically in a few seconds\u2026","boot.failed":"Store unreachable; the cloud server is asleep or the network is down.","update.available":"A new version is ready \u2014 tap to see the changes.","update.reload":"Refresh now","boot.failedHint":"Tap Retry; if it still fails, open your saved Wake-Up file to wake the server.","topbar.fastSend":"Shipping from Bushehr port to all of Iran","nav.home":"Home","nav.products":"All products","nav.deals":"Deals","nav.new":"New arrivals","nav.stats":"Live stats","nav.about":"About us","nav.contact":"Contact us","nav.login":"Sign in","nav.register":"Register","nav.cart":"Cart","nav.wishlist":"My list","nav.notifications":"Notifications","nav.menu":"Menu","nav.account":"My account","nav.admin":"Admin panel","nav.allCategories":"All categories","theme.toggle":"Toggle theme (light/dark)","theme.dark":"Dark mode","theme.light":"Light mode","theme.auto":"Match system","search.placeholder":"Search products, brands or categories\u2026","search.go":"Search","search.voice":"Voice search","search.byImage":"Search by photo","search.listening":"Listening\u2026 go ahead and speak","search.noVoice":"Your browser does not support voice search.","search.micDenied":"Microphone access is blocked. Allow microphone permission for this site in browser settings.","search.voiceNetwork":"Speech service unreachable; check your internet connection.","search.noSpeech":"I didn't catch that; try again and speak clearly.","search.noMic":"No microphone found on this device.","pwd.show":"Show password","pwd.hide":"Hide password","search.suggestions":"Suggestions","search.trending":"Trending searches","search.recent":"Your recent searches","search.resultsFor":"Search results for","search.inProducts":"In products","search.inCategories":"Categories","search.inBrands":"Brands","search.inPages":"Pages","search.didYouMean":"Did you mean?","search.noResultTitle":"We found nothing","search.noResultText":"Try another phrase or use the filters. If you want a specific item, tell support and we will source it for you.","search.imageTitle":"Search by photo","search.imageText":"Upload a photo of the product and we will find similar items in the store.","search.imageHint":"JPG or PNG, up to 4 MB","search.imageIndexing":"Preparing the visual search engine\u2026","search.imageNoIndex":"Product images are not indexed yet. The site admin can build the index from Admin panel \u2190 Image search.","search.imageNoMatch":"No similar product found for this photo. You can search by product name instead.","search.dropHere":"Drop the photo here","search.pickFile":"Choose a photo","search.takePhoto":"Take a photo with the camera","mnav.home":"Home","mnav.products":"Categories","mnav.search":"Search","mnav.cart":"Cart","mnav.me":"Account","footer.shopping":"Shopping","footer.allProducts":"All products","footer.deals":"Deals & offers","footer.inStock":"In-stock items","footer.searchByImage":"Visual search","footer.myList":"My list","footer.stats":"Store statistics","footer.services":"Customer services","footer.guide":"Buying guide","footer.service":"Customer services","footer.faq":"FAQ","footer.insurance":"Shipment insurance","footer.plus":"Plus membership","footer.tickets":"Support tickets","footer.about":"About & legal","footer.aboutUs":"About us","footer.terms":"Terms & conditions","footer.privacy":"Privacy policy","footer.bug":"Report a bug","footer.contact":"Contact us","footer.suggest":"Suggestions & complaints","footer.contactUs":"Ways to reach us","footer.install":"Install the app","footer.support":"Live support","footer.rights":"All rights reserved.","footer.workingHours":"Working hours","home.heroKicker":"From Bushehr port, with an authenticity guarantee","home.heroTitle":"Mobile accessories & gadgets at port prices","home.heroText":"Cables, chargers, iPhone and Samsung cases and screen guards, power banks, hands-free kits, speakers, smart watches and glasses \u2014 everything your phone or your content creation needs, all in one small shop by the Persian Gulf.","home.ctaShop":"Start shopping","home.ctaDeals":"Today's deals","home.point1":"Authenticity guarantee","home.point2":"7-day withdrawal right","home.point3":"Shipping across Iran","home.point4":"Free in-store pickup","home.point5":"Best Price Guarantee","home.categories":"Categories","home.categoriesSub":"From cables and cases to wearables","home.featured":"Featured picks","home.featuredSub":"Items we use and recommend ourselves","home.bestSellers":"Best sellers","home.bestSellersSub":"Chosen by Green Apple customers","home.newArrivals":"New in store","home.newArrivalsSub":"The latest items added to the shelf","home.deals":"Active discounts","home.dealsSub":"Limited-time offers at better prices","home.brands":"Brands in stock","home.whyUs":"Why Green Apple?","home.whyUsSub":"The things that set us apart","home.reviews":"Customer reviews","home.reviewsSub":"Real buyer experiences","home.visitStore":"Visit the store","home.visitStoreText":"By the Bushehr dock, Pearls of the Gulf Passage \u2014 free screen-guard fitting and in-person advice","home.openMap":"See the sketch and map","home.statsTitle":"The store at a glance","home.plusTitle":"Green Apple Plus membership","home.plusText":"With a monthly fee you get free shipping on all orders, automatic shipment insurance and a permanent 3% discount.","home.plusCta":"See Plus benefits","home.appTitle":"The Green Apple app","home.appText":"This site is an installable app (PWA): it installs on Android, iPhone, Windows, Mac and Linux, and it works offline too.","home.installCta":"Install on my device","home.appInstalled":"The app is installed","home.liveStats":"Live store statistics","home.newsletter":"Stay posted on deals","home.newsletterText":"Leave your mobile number and we will only message you about important deals and when items on your list come back in stock.","home.subscribe":"Subscribe","stats.products":"Active products","stats.ordersTotal":"Total orders","stats.ordersToday":"Orders today","stats.visitsToday":"Visits today","stats.visitsTotal":"Total visits","stats.pendingOrders":"Orders under review","stats.delivered":"Successful deliveries","stats.customers":"Registered customers","stats.plusMembers":"Plus members","stats.categories":"Categories","stats.brands":"Brands","stats.outOfStock":"Out-of-stock items","stats.years":"Years active","stats.title":"Public store statistics","stats.sub":"These figures are taken live from the site's real data.","stats.chartTitle":"Visits over the last 14 days","stats.topProducts":"Best-selling products","stats.transparency":"Transparency for customers","stats.transparencyText":"We show real stock and real prices, and we do not hide the store's statistics either.","catalog.title":"Products","catalog.filters":"Filters","catalog.showFilters":"Show filters","catalog.hideFilters":"Hide filters","catalog.sort.relevant":"Most relevant","catalog.sort.newest":"Newest","catalog.sort.oldest":"Oldest","catalog.sort.cheapest":"Cheapest","catalog.sort.dearest":"Most expensive","catalog.sort.popular":"Best selling","catalog.sort.rating":"Highest rated","catalog.sort.discount":"Biggest discount","catalog.sort.name":"Alphabetical","catalog.f.category":"Category","catalog.f.brand":"Brand","catalog.f.price":"Price range","catalog.f.availability":"Availability","catalog.f.inStock":"In-stock items only","catalog.f.discountOnly":"Discounted only","catalog.f.rating":"Minimum rating","catalog.f.authenticity":"Authenticity","catalog.f.clear":"Clear all filters","catalog.count":"products","catalog.viewGrid":"Grid view","catalog.viewList":"List view","auth.original":"Original","auth.highcopy":"High copy (grade 1)","auth.generic":"Generic","card.addToCart":"Add to cart","card.added":"Added to cart","card.quickView":"Quick view","card.wishlistAdd":"Add to my list","card.wishlistRemove":"Remove from my list","card.compareAdd":"Add to compare","card.outOfStock":"Out of stock","card.soldOut":"Sold out","pdp.addToCart":"Add to cart","pdp.buyNow":"Buy now","pdp.pickup":"Free in-store pickup","pdp.warranty":"Warranty","pdp.warrantyMonths":"{n}-month store replacement warranty","pdp.noWarranty":"No warranty","pdp.sku":"Product code","pdp.barcode":"Barcode","pdp.weight":"Weight","pdp.gram":"grams","pdp.zoomIn":"Zoom in","pdp.zoomOut":"Zoom out","pdp.zoomReset":"Actual size","pdp.zoomHint":"Hover for magnifier; click or double-tap for full zoom","pdp.video":"Video","pdp.share":"Share","pdp.specs":"Specifications","pdp.description":"Description","pdp.reviews":"Reviews & ratings","pdp.questions":"Customer questions","pdp.related":"Similar products","pdp.compatibility":"Compatibility","pdp.writeReview":"Write a review & rating","pdp.askQuestion":"Ask a question","pdp.loginToReview":"Sign in to write a review.","pdp.reviewSubmitted":"Your review was submitted and will appear once the admin approves it.","pdp.reviewPending":"Your review will appear after the admin approves it.","pdp.questionSubmitted":"Your question was submitted; once approved, the admin will answer it.","pdp.buyerBadge":"Buyer of this product","pdp.visitorBadge":"Visitor","pdp.helpful":"Was helpful","pdp.storeReply":"Store reply","pdp.noReviews":"No reviews yet. Be the first!","pdp.noQuestions":"No questions yet. Ask if you have one.","pdp.yourRating":"Your rating","pdp.viewed":"views","pdp.sold":"sold","pdp.off":"off","pdp.save":"You save","pdp.lastPrice":"Previous price","pdp.stockCount":"In stock: {n}","pdp.fastSend":"Fast shipping from Bushehr","pdp.installment":"Cash on delivery for eligible orders","cart.title":"Cart","cart.empty":"Your cart is empty","cart.emptyText":"You have not picked anything yet. Start from the categories or the search box.","cart.goShopping":"Let's go shopping","cart.item":"Product","cart.qty":"Quantity","cart.remove":"Remove","cart.clear":"Empty the cart","cart.clearConfirm":"Remove all items from the cart?","cart.summary":"Order summary","cart.continue":"Continue to checkout","cart.freeShipHint":"Spend {amount} Toman more to get free shipping.","cart.freeShipDone":"Shipping is free for this order!","cart.couponApplied":"Discount code applied","cart.couponPlaceholder":"Have a discount code? Enter it","cart.applyCoupon":"Apply code","cart.removeCoupon":"Remove code","cart.updated":"Cart updated","checkout.title":"Checkout","checkout.step1":"Delivery","checkout.step2":"Payment","checkout.step3":"Confirm","checkout.delivery":"Delivery method","checkout.pickup":"Pickup from the store","checkout.pickupDesc":"Free \u2014 once confirmed you get a ready-for-pickup notification and collect it in person.","checkout.courier":"Courier / postal shipping","checkout.courierDesc":"Shipped to a saved address, with optional shipment insurance.","checkout.zone":"Shipping zone","checkout.express":"Express shipping (same day)","checkout.insuranceOpt":"Shipment insurance","checkout.insuranceDesc":"If the parcel is damaged or lost in transit, the goods value is compensated.","checkout.insuranceAuto":"Applied automatically and free for Plus members.","checkout.address":"Delivery address","checkout.addAddress":"Add a new address","checkout.noAddress":"You must save at least one address for postal shipping.","checkout.paymentMethod":"Payment method","checkout.useWallet":"Pay from wallet","checkout.walletBalance":"Wallet balance: {amount} Toman","checkout.note":"Order note (optional)","checkout.notePlaceholder":"e.g. please call before delivery.","checkout.acceptTerms":"I have read and accept the Terms & Conditions and the Privacy Policy.","checkout.placeOrder":"Place & pay for the order","checkout.placing":"Placing your order\u2026","checkout.loginRequired":"Sign in to complete your purchase.","checkout.successTitle":"Order placed","checkout.successText":"Your order code is {code}. Track its status under My Orders.","checkout.payNow":"Pay online","checkout.payLater":"I will pay later","checkout.gatewayDemo":"The gateway is in demo mode; no real money is deducted.","checkout.paymentSuccess":"Payment was successful","checkout.paymentFailed":"Payment failed","checkout.simulateSuccess":"Successful payment (gateway simulation)","checkout.simulateFail":"Cancel payment","checkout.concurrencyNote":"Stock is locked the moment you place the order; if an item sells out at the same time we will tell you and refund the amount.","checkout.pickupReady":"Preparation time: about {h} working hours","auth.title":"Sign in or register","auth.loginTitle":"Sign in to your account","auth.registerTitle":"Create an account","auth.methodPassword":"Username & password","auth.methodPhone":"Mobile number","auth.methodEmail":"Email","auth.identifier":"Username, mobile or email","auth.remember":"Remember me","auth.forgot":"Forgot password","auth.noAccount":"Do not have an account?","auth.haveAccount":"Already registered?","auth.sendCode":"Send verification code","auth.codeSent":"Verification code sent","auth.codeSentTo":"A 6-digit code was sent to {target}.","auth.enterCode":"Enter the verification code","auth.otpCode":"Verification code","auth.resend":"Resend code","auth.resendIn":"Resend in {s} seconds","auth.demoCode":"Demo mode: verification code {code}","auth.2faTitle":"Two-step sign-in","auth.2faText":"Enter the 6-digit code from your authenticator app, SMS or email.","auth.2faTotp":"Authenticator app","auth.2faSms":"SMS code","auth.2faEmail":"Email code","auth.2faBackup":"Backup code","auth.2faVerify":"Verify & sign in","auth.acceptTerms":"I accept the Terms & Conditions and the Privacy Policy.","auth.referral":"Referral code (optional)","auth.registerDone":"Your account was created. Welcome!","auth.loginDone":"Welcome","auth.logoutDone":"You signed out successfully","auth.recoveryTitle":"Password recovery","auth.recoveryText":"Enter your registered mobile number or email and we will send a recovery code.","auth.newPassword":"New password","auth.resetDone":"Password changed successfully","auth.passwordRules":"At least 8 characters including lowercase, uppercase, a digit and a symbol","auth.orContinue":"or","auth.guestCheckout":"Continue shopping without an account","acc.title":"My account","acc.dashboard":"My dashboard","acc.badges":"My achievements","badge.got":"Earned","badge.locked":"Locked","badge.first-buy":"First purchase","badge.first-buy.d":"You placed your first successful order.","badge.silver-buyer":"Silver buyer","badge.silver-buyer.d":"5 successful orders at Green Apple.","badge.gold-buyer":"Gold buyer","badge.gold-buyer.d":"15 successful orders; a Green Apple VIP.","badge.big-spender":"Big spender","badge.big-spender.d":"Over 50,000,000 Toman in purchases.","badge.early-bird":"Early bird","badge.early-bird.d":"Among the first 100 Green Apple users.","badge.veteran":"Veteran","badge.veteran.d":"With us for more than a year.","badge.reviewer":"Reviewer","badge.reviewer.d":"3 posted reviews helping others choose.","badge.plus-member":"Plus member","badge.plus-member.d":"You have an active Plus subscription.","badge.wallet-user":"Wallet user","badge.wallet-user.d":"You have used the Green Apple wallet.","badge.supporter":"Supporter","badge.supporter.d":"You opened your first support ticket.","acc.orders":"My orders","acc.wishlist":"My list","acc.wallet":"Wallet","acc.plus":"Plus membership","acc.addresses":"Addresses","acc.notifications":"Notifications","acc.tickets":"My tickets","acc.support":"Support chat","acc.reviews":"My reviews","acc.feedback":"Suggestions & complaints","acc.profile":"Profile details","acc.security":"Account security","acc.sessions":"Active sessions","acc.prefs":"Display preferences","acc.data":"My data","acc.hello":"Hi {name}","acc.memberSince":"Member since {date}","acc.noOrders":"You have not placed an order yet","acc.noOrdersText":"Make your first purchase with the welcome discount WELCOME10.","acc.orderCode":"Order code","acc.orderDate":"Order date","acc.orderItems":"Items","acc.orderTotal":"Total amount","acc.trackOrder":"Track order","acc.cancelOrder":"Cancel order","acc.cancelConfirm":"Cancel this order? The paid amount returns to your wallet.","acc.cancelReason":"Reason for cancellation (optional)","acc.orderCancelled":"Order cancelled","acc.reorder":"Buy again","acc.invoice":"Invoice","acc.printInvoice":"Print invoice","acc.timeline":"Order progress","acc.walletEmpty":"No transactions recorded yet","acc.walletDeposit":"Top up wallet","acc.walletAmount":"Top-up amount (Toman)","acc.walletDeposited":"Wallet topped up","acc.walletNote":"The wallet balance can only be used to buy from this store; no interest or fee applies to it.","acc.tx.deposit":"Top-up","acc.tx.purchase":"Purchase","acc.tx.refund":"Refund","acc.tx.adjust_in":"Increase by admin","acc.tx.adjust_out":"Deduction by admin","acc.plusInactive":"You do not have a Plus membership","acc.plusActive":"Plus active until {date}","acc.plusSubscribe":"Buy Plus membership","acc.plusRenew":"Renew membership","acc.plusPrice":"{price} Toman for {days} days","acc.plusPerks":"Plus membership benefits","acc.plusSubscribed":"Plus membership activated","acc.plusPayWallet":"Pay from wallet","acc.plusPayGateway":"Pay online","acc.addAddress":"Add address","acc.editAddress":"Edit address","acc.addrTitle":"Label (e.g. home, work)","acc.addrReceiver":"Recipient name","acc.addrPhone":"Recipient phone number","acc.addrStreet":"Full postal address","acc.addrDefault":"Default address","acc.addrNote":"Note for the courier","acc.addrSaved":"Address saved","acc.addrDeleted":"Address deleted","acc.noAddress":"No address saved yet","acc.wishlistEmpty":"Your list is empty","acc.wishlistEmptyText":"Tap the heart icon on any product to save it here.","acc.notifEmpty":"You have no notifications","acc.markAllRead":"Mark all as read","acc.ticketNew":"New ticket","acc.ticketSubject":"Subject","acc.ticketCategory":"Request category","acc.ticketPriority":"Priority","acc.ticketBody":"Request details","form.rulesRequired":"You must accept the ticket rules first.","form.termsRequired":"You must accept the terms and conditions first.","page.statsTitle":"Live store stats","page.aboutCta":"Come and see what we have in store for you","page.stepsTitle":"How to buy","page.tipsTitle":"Buying tips","page.hintsTitle":"For a more precise report","page.bugTitle":"Report a bug","page.rulesTitle":"Rules","faq.all":"All topics","faq.search":"Search questions\u2026","faq.results":"{n} questions","faq.notFound":"No question matched your search.","faq.askText":"Ask live support or open a ticket.","faq.cat.orders":"Orders & tracking","faq.cat.shipping":"Shipping & delivery","faq.cat.returns":"Returns & refunds","faq.cat.product":"Products & authenticity","faq.cat.account":"Account","faq.cat.security":"Security & payment","faq.cat.store":"Store & contact","faq.cat.other":"Other","acc.ticketCloseConfirm":"Close this ticket? You can reopen it later by sending a message.","acc.ticketClosedNote":"This ticket is closed. Sending a new message reopens it.","acc.ticketBodyShort":"The message is too short.","acc.attachHint":"Up to 4 images, each below 4 MB.","err.tooLarge":"The file is larger than 4 MB.","acc.ticketRules":"I have read and accept the ticket rules.","acc.ticketViewRules":"Read ticket rules","acc.ticketCreated":"Ticket created. Tracking code: {code}","acc.ticketWrite":"Write your reply\u2026","acc.ticketClose":"Close ticket","acc.ticketReopen":"Reopen","acc.ticketSla":"Estimated reply time: {h} hours","acc.noTickets":"You have no tickets","acc.chatTitle":"Live support","acc.chatPlaceholder":"Write your message\u2026","acc.chatWelcome":"Hi! Any question or issue? Write it here and we will answer.","acc.chatOffline":"We are outside working hours right now; leave a message and we reply first thing, or open a ticket.","acc.chatOpenTicket":"Open a ticket","acc.reviewEmpty":"You have not posted a review or question","acc.feedbackNew":"Send a suggestion, complaint or bug report","acc.feedbackType":"Message type","acc.feedbackContact":"Contact (email or mobile)","acc.feedbackContactHint":"If provided, we will inform you of the outcome.","acc.feedbackSent":"Your message was submitted. Thanks for helping us improve.","acc.noFeedback":"You have not sent any message","acc.profileSaved":"Profile saved","acc.passwordChange":"Change password","acc.currentPassword":"Current password","acc.newPassword2":"New password","acc.passwordChanged":"Password changed","acc.2faSection":"Two-factor authentication (2FA)","acc.2faOff":"Disabled \u2014 turn it on for extra security.","acc.2faOn":"Enabled","acc.2faEnable":"Enable two-factor","acc.2faDisable":"Disable","acc.2faScan":"Scan this QR code with an authenticator app (e.g. Google Authenticator) or enter the key manually.","acc.2faKey":"Manual key","acc.2faEnterCode":"Enter the 6-digit code from the app to enable","acc.2faEnabled":"Two-factor enabled","acc.2faDisabled":"Two-factor disabled","acc.2faBackup":"Backup codes (keep them safe)","acc.2faBackupHint":"If you lose access to the app, sign in with these. Each code works once.","acc.2faMethods":"Verification methods","acc.sessionsText":"Devices currently signed in to your account.","acc.revokeAll":"Sign out everywhere","acc.revokeDone":"Sessions revoked","acc.current":"This device","acc.prefsText":"These settings apply only to this device.","acc.prefTheme":"Theme","acc.prefLang":"Language","acc.prefDensity":"Density","acc.prefMotion":"Animations","acc.prefNotif":"Notifications","acc.notifMarketing":"Offers and discounts","acc.notifOrders":"Order status","acc.notifRestock":"Restock of my saved items","acc.notifSupport":"Support and ticket replies","acc.exportData":"Export my data","acc.exportHint":"Download all your account info, orders, reviews and tickets as JSON.","acc.deleteAccount":"Delete account","acc.deleteWarn":"Deleting removes your personal data, while financial order records are kept as required by law.","acc.deleteConfirm":"Enter your password to delete the account","acc.pointsText":"You earn 1 point per 100,000 Toman of purchase.","acc.referralCode":"Your referral code","acc.referralText":"Share this code; you both get 50 points.","chat.title":"Green Apple live support","chat.online":"We usually reply within minutes","chat.open":"Start chat","chat.minimize":"Close","chat.loginFirst":"Sign in to chat with support.","chat.sent":"Message sent","chat.typing":"Support is typing\u2026","chat.quick":"Frequent questions","notif.new":"New notification","notif.markRead":"Mark as read","notif.viewAll":"View all notifications","notif.empty":"No notifications","notif.type.announcement":"Announcement","notif.type.order":"Order","notif.type.restock":"Back in stock","notif.type.ticket":"Ticket","notif.type.support":"Support","notif.type.review":"Review","notif.type.plus":"Plus membership","notif.type.wallet":"Wallet","notif.type.account":"Account","notif.type.feedback":"Feedback","notif.type.admin_alert":"Admin alert","notif.type.news":"News","notif.type.offer":"Special offer","notif.type.system":"System","notif.type.info":"Info","notif.type.welcome":"Welcome","consent.title":"Welcome to Green Apple","consent.text":"Please read and accept the following before continuing. We use browser storage to improve your shopping experience and protect your personal data per the Privacy Policy.","consent.terms":"I have read and accept the Terms & Conditions.","consent.privacy":"I accept the Privacy Policy.","consent.marketing":"I would like to hear about deals and new arrivals (optional).","consent.accept":"Accept & enter the site","consent.readTerms":"Read terms","consent.readPrivacy":"Read privacy","consent.thanks":"Thanks! Your acceptance was recorded.","consent.manage":"Cookie & privacy choices","social.instagram":"Instagram","home.partnersTitle":"Brands we work with","stats.title":"Live store stats","stats.subtitle":"Real store numbers, updated live.","stats.chartTitle":"Visits \u2014 last 14 days","stats.chartHint":"Each column height is that day visit count.","stats.topTitle":"Recent best sellers","adm.sPartners":"Partners & brands","adm.ptFa":"Persian name","adm.ptEn":"Name (EN)","adm.ptAdd":"Add brand","adm.ptHint":"These names scroll as a marquee on the home page; order is yours to set.","feat.partners":"Partner brands strip","auth.pwdLater":"I'll change it later","auth.pwdLaterToast":"OK; you can change it anytime from Account \u2192 Change password.","social.telegram":"Telegram","social.eitaa":"Eitaa","social.whatsapp":"WhatsApp","consent.rejectOptional":"Accept necessary only","consent.ttlNote":"Your choice stays valid for 180 days; after that we ask again.","contact.title":"Contact us","contact.mapTitle":"Shop location sketch","contact.mapHint":"Click to open in a map app","contact.mapAsk":"Which map would you like to open?","contact.mapPermission":"If you allow location access, we will show the route from your current position to the shop.","contact.allowLocation":"Allow location access","contact.denyLocation":"Continue without location","contact.openMaps":"Open in maps","contact.copyAddress":"Copy address","contact.hours":"Working hours","contact.phone":"Store phone","contact.mobile":"Mobile & WhatsApp","contact.emailUs":"Email","contact.addressUs":"Address","contact.callNow":"Call now","contact.whatsapp":"Message on WhatsApp","contact.locationOn":"Your approximate location was found","contact.locationDenied":"Location denied; the map opens without an origin.","contact.formTitle":"Send a quick message","contact.formText":"Prefer not to call? Leave a message or open a ticket.","contact.neshan":"Neshan","contact.balad":"Balad","contact.google":"Google Maps","contact.osm":"OpenStreetMap","contact.tgBotTitle":"Telegram support bot","contact.tgBotText":"Track orders, search products and chat with support \u2014 24/7 on Telegram. Just send /start.","contact.tgBotBtn":"Open the bot on Telegram","compare.title":"Compare products","compare.empty":"No products selected for comparison","compare.emptyText":"Use the Compare button on product cards (up to 4 items).","compare.add":"Add to compare","compare.remove":"Remove","priceCheck.title":"Price check by barcode","priceCheck.sub":"Scan the barcode with your device or type it manually.","priceCheck.input":"Barcode or SKU","priceCheck.scanCamera":"Scan with camera","priceCheck.stopCamera":"Stop camera","priceCheck.waiting":"Waiting for a scan\u2026","priceCheck.notFound":"No product found for this barcode","priceCheck.found":"Product found","priceCheck.cameraUnsupported":"Camera unavailable. Use a barcode device or manual entry.","priceCheck.cameraDenied":"Camera access denied.","priceCheck.deviceMode":"Kiosk mode (full screen)","priceCheck.lastScan":"Last scan","priceCheck.fullscreen":"Full screen","err.generic":"Something went wrong. Please try again.","err.network":"Could not reach the server.","err.notFound":"Page not found","err.notFoundText":"The address may be wrong or the page has been removed.","err.goHome":"Go to homepage","err.offline":"You are offline. Cached data is shown.","err.online":"Back online","err.loginRequired":"You must sign in to view this section.","err.forbidden":"You do not have access to this section.","adm.title":"Admin panel","adm.dashboard":"Dashboard","adm.products":"Products","adm.productNew":"Add product","adm.productEdit":"Edit product","adm.categories":"Categories & brands","adm.orders":"Orders","adm.reviews":"Reviews & questions","adm.tickets":"Tickets","adm.supportChat":"Support chat","adm.feedback":"Feedback & bugs","adm.users":"Users & permissions","adm.wallet":"User wallets","adm.coupons":"Coupons","adm.ads":"Advertisements","adm.notifications":"Notifications","adm.settings":"Store settings","adm.theme":"Theme & layout","adm.features":"Features","adm.shipping":"Shipping & insurance","adm.plus":"Plus membership","adm.pages":"Page content","adm.barcode":"Barcode & labels","adm.imageSearch":"Image search","adm.audit":"Audit log","adm.stats":"Statistics","adm.export":"Export & backup","adm.maintenance":"Maintenance","adm.backToSite":"Back to site","adm.kpi.ordersToday":"Orders today","adm.kpi.visits":"Visits today","adm.kpi.pending":"Pending review","adm.kpi.revenueTotal":"Total revenue","adm.kpi.users":"Users","adm.kpi.products":"Products","adm.kpi.lowStock":"Low stock","adm.awaiting":"Tasks awaiting action","adm.awaiting.reviews":"Reviews to approve","adm.awaiting.tickets":"Open tickets","adm.awaiting.orders":"Pending orders","adm.awaiting.feedback":"New feedback","adm.awaiting.chat":"Unread chat messages","adm.chart":"Last 14 days trend","adm.topSelling":"Best sellers","adm.lowStockList":"Low-stock items","adm.recentAudit":"Latest events","adm.storage":"Data size","adm.pName":"Product name","adm.pNameEn":"English name","adm.pCat":"Category","adm.pBrand":"Brand","adm.pPrice":"Price (Toman)","adm.pOldPrice":"Price before discount","adm.pCost":"Purchase cost","adm.pStock":"Stock","adm.pSku":"SKU","adm.pBarcode":"Barcode","adm.pWeight":"Weight (grams)","adm.pWarranty":"Warranty (months)","adm.pAuth":"Authenticity","adm.pTags":"Tags (separate with Enter)","adm.pSpecs":"Specifications","adm.pSpecKey":"Spec name","adm.pSpecVal":"Value","adm.pAddSpec":"Add spec","adm.pVideos":"Product videos (one https or /uploads URL per line)","adm.pVideosHint":"Videos play in the product gallery and lightbox.","adm.pImages":"Images","adm.pFindImage":"Auto image search","adm.pFindImageHint":"We search free image sources (Wikimedia/Openverse) for this product. Pick one and approve it.","adm.pFindSearching":"Searching for images\u2026","adm.pFindEmpty":"No images found. You can upload your own photo.","adm.pUpload":"Upload photo","adm.pUseImage":"Use this image","adm.pDefaultImage":"Restore default image","adm.pFeatured":"Show in featured picks","adm.pActive":"Active (visible on site)","adm.pSaved":"Product saved","adm.pCreated":"Product created","adm.pDeleted":"Product deleted","adm.pDeleteConfirm":"Delete this product permanently?","adm.pQuickEdit":"Quick edit","adm.pBulkPrice":"Bulk price change","adm.catName":"Category name","adm.catParent":"Parent category","adm.catGlyph":"Icon","adm.catOrder":"Display order","adm.catNoParent":"No parent (top level)","adm.brandName":"Brand name","adm.brandNameEn":"Brand English name","adm.oStatus":"Change status","adm.oTracking":"Tracking code","adm.oNote":"Internal note","adm.oCustomer":"Customer","adm.oDelivery":"Delivery","adm.oPayment":"Payment","adm.oSaved":"Order updated","adm.rApprove":"Approve & publish","adm.rReject":"Reject","adm.rReply":"Reply","adm.rReplySaved":"Reply saved","adm.rModerated":"Review status updated","adm.rFilter":"Filter","adm.uRole":"Role","adm.uPerms":"Permissions","adm.uPermsHint":"Toggle each permission separately. Changes apply immediately.","adm.uAll":"Enable all","adm.uNone":"Disable all","adm.uWalletAdjust":"Adjust wallet balance","adm.uWalletReason":"Reason","adm.uPlusDays":"Plus membership days","adm.uResetPass":"Reset password","adm.uStatus":"Account status","adm.uBlocked":"Blocked","adm.uSaved":"User changes saved","adm.uMakeStaff":"Make staff","adm.cCode":"Code","adm.cType":"Discount type","adm.cValue":"Value","adm.cMax":"Max discount","adm.cMin":"Minimum order","adm.cLimit":"Total usage limit","adm.cPerUser":"Per-user limit","adm.cStart":"Starts","adm.cEnd":"Ends","adm.cUsed":"Used","adm.aSlot":"Placement","adm.aTitle":"Title","adm.aText":"Text","adm.aLink":"Target link","adm.aCta":"Button text","adm.aActive":"Visible","adm.nTitle":"Notification title","adm.nBody":"Notification body","adm.nTarget":"Recipient","adm.nAll":"All users","adm.nOne":"A specific user","adm.nLevel":"Level","adm.nSent":"Notification sent","adm.nOutbox":"SMS & email outbox (demo mode)","adm.sStore":"Store information","adm.sTheme":"Theme","adm.sUi":"Interface layout","adm.mailsms":"Email & SMS","adm.mailCfg":"Mail server (SMTP)","adm.mailEnabled":"Email sending on","adm.mailFrom":"From address","adm.smsCfg":"SMS panel (Kavenegar)","adm.smsEnabled":"SMS sending on","adm.smsKey":"API key","adm.smsSender":"Sender number","adm.console":"System console","adm.consoleHint":"Restart takes a few seconds; the page reloads itself. Resets are irreversible.","adm.sysRestart":"Restart server","adm.sysRestartWarn":"Restart the server now? Users will be disconnected for a few seconds.","adm.sysRestarting":"Restarting\u2026 the page will reload shortly.","adm.sysResetLabel":"Reset sections (irreversible):","adm.sysReset.audit":"Audit log","adm.sysReset.carts":"Guest carts","adm.sysReset.visits":"Visit counters","adm.sysReset.visitors":"Visitors list","adm.secTitle":"Defense & entry queue","adm.secQueueEnabled":"Queue visitors when busy","adm.secQueueDesc":"When load exceeds the limits, anonymous visitors are admitted one by one through a queue so the site stays error-free for everyone.","adm.secMaxConc":"Max concurrent requests","adm.secTriggerRps":"Requests-per-second trigger","adm.secPassTtl":"Entry pass TTL (minutes)","adm.secPoll":"Queue poll interval (seconds)","adm.secFloodBan":"Auto-ban threshold (requests/minute)","adm.secFloodMin":"Auto-ban duration (minutes)","adm.secSaved":"Defense settings saved.","adm.secInflight":"Active requests","adm.secRps":"Req/sec","adm.secQueued":"In queue","adm.secAutoBans":"Active auto-bans","adm.secTop":"Top talker IPs (last minute)","adm.secPerMin":"Req/min","adm.secTopEmpty":"No unusual traffic recorded.","adm.secBusy":"Busy \u2014 queue active","adm.secNormal":"Normal","adm.banMinutes":"Duration (minutes, 0 = permanent)","adm.banUntil":"Until","adm.banAuto":"auto","adm.resetAudit":"Clear audit logs","adm.resetCarts":"Clear guest carts","adm.resetVisitors":"Clear visitors","adm.resetDone":"Reset done.","adm.resetWarn.audit":"Delete all audit logs?","adm.resetWarn.carts":"Empty all guest carts?","adm.resetWarn.visitors":"Delete the visitors list?","adm.resetWarn.visits":"Zero the visit counters?","adm.visitors":"Visitors","adm.uDevice":"Device / IP","adm.uBrowser":"Browser","adm.uRegion":"Region / time","adm.uPath":"Path","adm.guest":"Guest","adm.bans":"Bans (block / unblock)","adm.banType":"Type","adm.banValue":"Value (IP / phone / email / username)","adm.banReason":"Reason","adm.ban":"Ban","adm.unban":"Unban","adm.banned":"Banned","adm.banDone":"Banned.","adm.unbanDone":"Unbanned.","adm.bansEmpty":"Nobody is banned right now.","adm.banByAdmin":"By admin","adm.channels":"Channels","adm.chSite":"In-site notification","adm.chTelegram":"Telegram bot","adm.chEmail":"Email","adm.chSms":"SMS","adm.channelsHint":"Email/SMS need settings below; without them only ready channels send.","adm.telegram":"Telegram bot","adm.tgHint":"Get a token from Telegram BotFather; the bot runs on the store server and is managed from this panel.","adm.tgEnabled":"Bot on","adm.tgToken":"Bot token","adm.tgTokenHint":"Like 123456:ABC-\u2026","adm.tgWelcome":"/start welcome message","adm.tgTest":"Test send","adm.tgInbox":"Inbox","adm.tgSubs":"Subscribers","adm.tgReplyPh":"Reply to this user\u2026","adm.tgInboxEmpty":"No messages yet.","adm.lottery":"Lottery","adm.lotteryNew":"New draw","adm.lotPrize":"Prize","adm.lotEnds":"Ends","adm.lotWinners":"Winners count","adm.lotWinnersList":"Winners","adm.lotMode":"Entry mode","adm.lotModeOrders":"Automatic from orders","adm.lotModeManual":"Manual join button","adm.lotEntries":"Entries","adm.lotRun":"Draw now","adm.lotRunWarn":"Winners are picked randomly and notified now. Continue?","adm.lotDone":"Draw done","adm.lotClose":"Close","adm.lotClosed":"Draw closed.","adm.lotEmpty":"No draws yet.","lot.title":"Green Apple lottery","lot.nav":"Lottery","lot.soon":"Coming soon \u2014 stay tuned!","lot.done":"Past draws","lot.winners":"Winners","lot.active":"Active","lot.prize":"Prize","lot.ends":"Ends","lot.entries":"Entries","lot.joined":"You are in this draw.","lot.join":"Join draw","lot.joinDone":"Entry recorded \u2014 good luck!","lot.autoEntry":"Every valid order in the draw window counts automatically.","contact.phone3":"Third phone","adm.sBackups":"Backups & dump","adm.backupNow":"Backup now","adm.backupsHint":"A full snapshot is taken automatically every {hours} hours; the last {keep} are kept.","adm.backupsEmpty":'No snapshot yet; hit "Backup now".',"adm.backupSize":"Size","adm.backupRestore":"Restore","adm.backupRestoreWarn":"All current data will be replaced by this snapshot. Sure?","adm.backupDone":"Backup created.","adm.backupRestored":"Restore done; reloading.","adm.dumpFull":"Full site dump","adm.sFeatures":"Features","adm.sShipping":"Shipping","adm.sPlus":"Plus","adm.sOrders":"Orders & payment","adm.sSeo":"SEO","adm.sAuth":"Authentication","adm.sSaved":"Settings saved","adm.tAccent":"Primary colour","adm.tPort":"Port theme (waves, boat and palm in the background)","adm.tPortHint":"Turn it off for a plain neutral background.","adm.tMode":"Default theme","adm.tRadius":"Corner radius","adm.tDensity":"Density","adm.tBg":"Background style","adm.tContrast":"Contrast","adm.tAnim":"Animations","adm.uSearchPos":"Search box position","adm.uHeader":"Header layout","adm.uNav":"Menu style","adm.uCards":"Product card style","adm.uSticky":"Sticky header","adm.uTicker":"Top ticker bar","adm.uTickerItems":"Ticker messages","adm.uTickerSpeed":"Ticker speed","adm.uQuick":"Product quick view","adm.uChat":"Floating support button","adm.uCrumb":"Show breadcrumbs","adm.uCols":"Product columns","adm.uColsMobile":"Mobile","adm.uColsTablet":"Tablet","adm.uColsDesktop":"Desktop","adm.uColsWide":"Wide screen","adm.uCardInfo":"Info shown on product cards","adm.uPosStart":"Right (start)","adm.uPosCenter":"Center","adm.uPosEnd":"Left (end)","adm.uLayoutLogoStart":"Logo at start","adm.uLayoutSplit":"Logo start / search center / actions end","adm.uLayoutCentered":"Logo centered","adm.fHint":"Turn off any feature you do not need; its section disappears from the site and panel.","adm.bLabel":"Label printing","adm.bSelect":"Select products","adm.bSize":"Label size","adm.bCopies":"Copies per product","adm.bShowName":"Product name","adm.bShowPrice":"Price","adm.bShowBrand":"Brand","adm.bShowSku":"SKU","adm.bShowQr":"Product page QR code","adm.bType":"Barcode type","adm.bPrint":"Print labels","adm.bGenerate":"Generate new barcode","adm.igPack":"Instagram post pack","adm.igCap":"Caption (editable before copy)","adm.igTags":"Hashtags","adm.igImgHint":"Post image; download it and publish with the caption.","adm.igDl":"Download image","adm.igNoImg":"This product has no image yet; add one via upload or image search first.","adm.igCopyCap":"Copy caption","adm.igCopyTags":"Copy hashtags","adm.igCopyAll":"Copy caption + tags","adm.bGenerated":"Barcode generated and assigned","adm.bScan":"Scan barcode","adm.bScanMode":"Scanner mode (device sync)","adm.bScanHint":"Connect your barcode device like a keyboard; click the box below and scan. Camera scanning also works.","adm.bConnected":"Device connected \u2014 ready to scan","adm.bSerial":"Direct connection via Web Serial","adm.bSerialHint":"If your device has a serial/USB port, connect here (desktop Chrome/Edge only).","adm.bSerialUnsupported":"Your browser does not support Web Serial; use keyboard or camera mode.","adm.bSerialConnected":"Connected","adm.bSerialClosed":"Connection closed","adm.bHistory":"Recent scans","adm.isTitle":"Image index for visual search","adm.isHint":"Build the index once so customers can search by photo. It runs in your browser and adds no server load.","adm.isBuild":"Build index","adm.isBuilding":"Indexing\u2026","adm.isDone":"Index built","adm.isCount":"Indexed images","adm.auditAction":"Event","adm.auditActor":"User","adm.auditTarget":"Target","adm.auditMeta":"Details","adm.statsRevenue":"Revenue","adm.statsVisits":"Visits","adm.statsOrders":"Orders","adm.statsByCat":"Category performance","adm.statsByBrand":"Sales by brand","adm.statsStockValue":"Inventory value","adm.statsAvgOrder":"Average basket","adm.exportProducts":"Export products","adm.exportOrders":"Export orders","adm.exportUsers":"Export users","adm.exportReviews":"Export reviews","adm.exportTickets":"Export tickets","adm.exportAudit":"Export events","adm.exportAll":"Full backup (JSON)","adm.backup":"Create backup now","adm.backupDone":"Backup created","adm.cleanup":"Clean old data","adm.cleanupDone":"Cleanup done","adm.pageEditHint":"Edit page texts here; changes apply to the site immediately.","adm.noPermission":"You do not have permission for this section. Ask the owner to grant it.","adm.liveView":"Live preview of changes","adm.saved":"Saved","st.pending_payment":"Pending payment","st.pending_review":"Pending review","st.confirmed":"Confirmed","st.preparing":"Preparing","st.ready_pickup":"Ready for pickup","st.shipped":"Shipped","st.delivered":"Delivered","st.cancelled":"Cancelled","st.refunded":"Refunded","st.returned":"Returned","dl.pickup":"In-store pickup","dl.courier":"Postal shipping","pm.wallet":"Wallet","pm.gateway":"Bank gateway","pm.cod":"Cash on delivery","ps.unpaid":"Unpaid","ps.paid":"Paid","ps.pending":"Pending","ps.refunded":"Refunded","ps.failed":"Failed","ps.cancelled":"Cancelled","tc.order":"Order tracking","tc.return":"Return & refund","tc.product":"Product question","tc.technical":"Technical issue","tc.complaint":"Complaint","tc.partnership":"Partnership & advertising","tc.account":"Account & security","tc.other":"Other","tp.critical":"Critical","tp.high":"High","tp.normal":"Normal","tp.low":"Low","ft.suggestion":"Suggestion","ft.complaint":"Complaint","ft.bug":"Bug report","fs.new":"New","fs.seen":"Seen","fs.in_progress":"In progress","fs.done":"Done","fs.rejected":"Rejected","tk.open":"Open","tk.answered":"Answered","tk.closed":"Closed","feat.wallet":"Wallet","feat.plus":"Plus membership","feat.insurance":"Shipment insurance","feat.tickets":"Ticket system","feat.reviews":"Customer reviews","feat.questions":"Customer questions","feat.ads":"On-site ads","feat.imageSearch":"Image search","feat.barcode":"Barcode & labels","feat.priceCheckDevice":"Price display mode","feat.publicStats":"Public statistics","feat.coupons":"Coupons","feat.consent":"Cookie consent modal (first visit)","feat.liveSupport":"Live chat support","feat.announcements":"Notifications","feat.wishlist":"My list","feat.compare":"Product comparison","feat.recentlyViewed":"Recently viewed","feat.guestCheckout":"Guest checkout","feat.priceAlerts":"Restock alerts","feat.twoFactor":"Two-factor login","feat.referrals":"Referral codes","feat.voiceSearch":"Voice search","feat.offlineMode":"Offline mode","feat.captcha":"Captcha (I'm not a robot)","captcha.required":"Prove you are human first: tick the box and solve the math.","captcha.label":"I'm not a robot","captcha.hint":"Tick it, then solve the tiny math image","captcha.placeholder":"Answer","captcha.solved":"Human verified \u2714","captcha.refresh":"New challenge","perm.dashboard.view":"View dashboard","perm.products.view":"View products","perm.products.create":"Create product","perm.products.edit":"Edit product","perm.products.delete":"Delete product","perm.products.price":"Change price & discount","perm.products.stock":"Change stock","perm.categories.manage":"Manage categories & brands","perm.orders.view":"View orders","perm.orders.manage":"Change order status","perm.refunds.manage":"Refunds & cancellation","perm.reviews.moderate":"Moderate reviews","perm.reviews.reply":"Reply to reviews","perm.tickets.manage":"Manage tickets","perm.feedback.manage":"Feedback & bugs","perm.users.view":"View users","perm.users.manage":"Manage users","perm.users.permissions":"Assign permissions","perm.wallet.manage":"Wallet management","perm.plus.manage":"Plus membership","perm.coupons.manage":"Coupons","perm.ads.manage":"Manage ads","perm.notifications.send":"Send notifications","perm.settings.edit":"Store settings","perm.theme.edit":"Theme & layout","perm.pages.edit":"Edit page content","perm.barcode.print":"Print labels","perm.barcode.scan":"Scan & price display","perm.imagesearch.index":"Image index","perm.audit.view":"Audit log","perm.stats.view":"Statistics","perm.data.export":"Export data","misc.quickView":"Quick view","misc.addToHome":"Add to home screen","misc.installHint":'In your browser menu, choose "Add to Home screen" or "Install".',"misc.printBlocked":"The print dialog did not open; please allow pop-ups.","misc.saved":"Saved","misc.deleted":"Deleted","misc.updated":"Updated","misc.confirmDelete":"Delete this item?","misc.loadingMore":"Loading\u2026","misc.recentlyViewed":"Recently viewed","misc.uiSound":"UI click sound","misc.uiSoundOn":"Click sound on","misc.uiSoundOff":"Click sound off","misc.shareDone":"Link copied","misc.shareNative":"Share","img.alt":"Product image","adm.view":"View","adm.support":"Support chat","adm.supSelect":"Select a conversation","adm.supSelectHint":"Pick a thread from the list to reply.","adm.tkReply":"Support reply","adm.tkManage":"Ticket management","common.updated":"Updated","common.link":"Link","common.text":"Text","cart.coupon":"Coupon code","misc.sent":"Sent","misc.copied":"Copied","adm.revPending":"Pending","adm.revApproved":"Approved","adm.revRejected":"Rejected","adm.revApprove":"Approve","adm.revReject":"Reject","adm.revReply":"Shop reply","adm.revEmpty":"Nothing in this state","adm.revEmptyHint":"No new reviews or questions to moderate.","rev.buyer":"Buyer","rev.visitor":"Visitor","rev.shopReply":"Shop reply","fb.new":"New","fb.seen":"Seen","fb.inProgress":"In progress","fb.done":"Done","fb.rejected":"Rejected","feedback.suggestion":"Suggestion","feedback.complaint":"Complaint","feedback.bug":"Bug report","adm.fbEmptyHint":"No suggestions, complaints or bug reports yet.","adm.cpNew":"New coupon","adm.cpPercent":"Percent","adm.cpAmount":"Fixed amount","adm.cpValue":"Value","adm.cpUsage":"Usage","adm.cpDates":"Validity","adm.cpStart":"Starts","adm.cpEnd":"Ends","adm.cpExpired":"Expired","adm.adNew":"New banner","adm.adSlot":"Placement slot","adm.adsHint":"Schedule, enable or disable banners anywhere on the site.","adm.notifNew":"New notification","adm.notifHint":"Send a notification to everyone or to one user.","adm.notifLevel":"Level","adm.notifRecent":"Recent notifications","notif.level.info":"Info","notif.level.success":"Success","notif.level.warning":"Warning","notif.level.error":"Error","adm.pagesPick":"Pick a page","adm.pagesPickHint":"Choose a page from the list to edit its content.","adm.pgHint":"Changes are text-only and apply immediately.","adm.bPrinter":"Label printer","adm.bPrinterHint":"Labels go to the printer through the browser print dialog.","adm.bScanner":"Barcode scanner","adm.bLabels":"Build & print labels","adm.bPreview":"Label preview","adm.bPriceMode":"Price display mode","adm.bFound":"Product found","adm.bNotFound":"No product with this barcode.","adm.bPickFirst":"Select at least one product first.","adm.ixHint":"Image fingerprints are computed in the browser so visual search works.","adm.ixIndex":"Index remaining images","adm.ixReindex":"Re-index all","adm.ixDone":"Indexing done","adm.audActor":"Actor","adm.audAction":"Action","adm.audTarget":"Target","adm.audMeta":"Details","adm.stOrders":"Orders","adm.stRevenue":"Revenue","adm.stVisits":"Visits","adm.stUsers":"Users","adm.stProducts":"Products","adm.stAvg":"Average order","adm.stByCat":"Category performance","adm.stByBrand":"Top brands","adm.data":"Data","adm.dataHint":"Export, back up and clean up data.","adm.dExport":"Export","adm.dBackup":"Backup","adm.dBackupHint":"A full copy of the database is saved in the data folder.","adm.dCleanup":"Cleanup","adm.dCleanupHint":"Audit entries older than 90 days and expired sessions are removed.","sys.turnOn":"Turn the store on","sys.turnOff":"Turn the store off","sys.offConfirm":"Are you sure? Nobody can buy until you turn it back on.","sys.autoWakeMins":"Auto turn-on after minutes (0 = never)","sys.asleep":"The store is now off.","sys.asleepTimed":"The store is off; it turns back on automatically in {n} minutes.","sys.awake":"The store is on.","sys.sleepBanner":"The store is currently off. Use the \u201CTurn the store on\u201D button at the top of this page.","sys.keepAlive":"Keep the service warm","checkout.guestInfo":"Guest contact details","checkout.guestHint":"You can buy without an account; we only need this to coordinate delivery.","checkout.guestName":"Full name","checkout.guestPhone":"Mobile number","checkout.guestPhoneHint":"e.g. 09123456789","checkout.guestNameRequired":"Please enter your name.","checkout.guestPhoneInvalid":"Mobile number must be 11 digits starting with 09.","checkout.guestCodPickup":"Cash on delivery is only available for courier shipping. For pickup, pay online or sign in.","home.recent":"Continue where you left off","home.recentSub":"Products you viewed recently","checkout.guestCourierNote":"Sign in for courier delivery"},vc={fa:As,en:fc},zt="fa",no=new Set;ve=()=>zt,k=()=>zt==="fa"});var Oa={};Y(Oa,{applyDyn:()=>L,byId:()=>wc,catIcon:()=>vt,copyText:()=>Ls,countdown:()=>Tc,debounce:()=>Vt,el:()=>We,esc:()=>p,faDigits:()=>Xe,fileToDataURL:()=>At,fmtDate:()=>B,fmtDay:()=>qc,fmtMoney:()=>C,fmtMoneyPlain:()=>Ec,fmtNum:()=>b,fmtTel:()=>se,html:()=>r,icon:()=>c,latinDigits:()=>Sc,linkify:()=>Ms,locale:()=>xc,pct:()=>Cc,qs:()=>N,qsa:()=>$c,raw:()=>me,safeHref:()=>_e,scrollTop:()=>Dc,setLocale:()=>Ps,stars:()=>Me,throttle:()=>Ac,timeAgo:()=>fe});function Fa(e){return Ra+Ha(String(e??""))+Ba}function p(e){if(e==null||e===!1)return Fa("");if(typeof e=="object"&&e!==null&&e[ro]!==void 0)return e[ro];let a=String(e);return a.includes(Ra)||a.includes(Ba)?Ha(a):Fa(a.replace(/[&<>"'`]/g,s=>yc[s]))}function r(e,...a){let s=e[0];for(let n=0;n<a.length;n++){let o=a[n];Array.isArray(o)?s+=o.map(i=>p(i)).join(""):s+=p(o),s+=e[n+1]}return Fa(s)}function We(e,a={},s=[]){let n=document.createElement(e);for(let[o,i]of Object.entries(a))i==null||i===!1||(o==="class"?n.className=i:o==="text"?n.textContent=i:o.startsWith("on")&&typeof i=="function"?n.addEventListener(o.slice(2).toLowerCase(),i):o==="style"&&typeof i=="object"?Object.assign(n.style,i):n.setAttribute(o,i));for(let o of[].concat(s))o==null||o===!1||n.appendChild(typeof o=="string"?document.createTextNode(o):o);return n}function c(e,a=""){return me(`<svg class="ic ${a}" viewBox="0 0 24 24" aria-hidden="true"><use href="#i-${e}"/></svg>`)}function Xe(e){return String(e).replace(/[0-9]/g,a=>Ds[+a])}function Sc(e){return String(e).replace(/[۰-۹]/g,a=>Ds.indexOf(a)).replace(/[٠-٩]/g,a=>"\u0660\u0661\u0662\u0663\u0664\u0665\u0666\u0667\u0668\u0669".indexOf(a))}function Ps(e){Ee=e==="en"?"en":"fa"}function b(e){let a=Number(e)||0;return new Intl.NumberFormat(Ee==="fa"?"fa-IR":"en-US").format(a)}function _e(e){let a=String(e||"").trim();return/^https?:\/\//i.test(a)?a:""}function se(e){let a=String(e??"").trim();return a?Ee==="fa"?a.replace(/\d/g,s=>Ds[+s]):a:""}function C(e,{withUnit:a=!0}={}){let s=Math.round(Number(e)||0),n=new Intl.NumberFormat(Ee==="fa"?"fa-IR":"en-US").format(s);return a?me(`${n} <span class="pc-cur">${Ee==="fa"?"\u062A\u0648\u0645\u0627\u0646":"Toman"}</span>`):n}function Ec(e){return new Intl.NumberFormat(Ee==="fa"?"fa-IR":"en-US").format(Math.round(Number(e)||0))}function B(e,{time:a=!0,short:s=!1}={}){if(!e)return"\u2014";let n=new Date(e);if(Number.isNaN(n.getTime()))return"\u2014";try{let o={calendar:Ee==="fa"?"persian":"gregory"};if(s)return n.toLocaleDateString(Ee==="fa"?"fa-IR":"en-GB",{year:"numeric",month:"short",day:"numeric",...o});let i=n.toLocaleDateString(Ee==="fa"?"fa-IR":"en-GB",{year:"numeric",month:"long",day:"numeric",...o});if(!a)return i;let l=n.toLocaleTimeString(Ee==="fa"?"fa-IR":"en-GB",{hour:"2-digit",minute:"2-digit"});return`${i} \xB7 ${l}`}catch{return n.toISOString().slice(0,16).replace("T"," ")}}function qc(e){let a=new Date(e);if(Number.isNaN(a.getTime()))return"\u2014";try{return a.toLocaleDateString(Ee==="fa"?"fa-IR":"en-GB",{year:"numeric",month:"short",day:"numeric",calendar:Ee==="fa"?"persian":"gregory"})}catch{return e.slice(0,10)}}function fe(e){let a=new Date(e).getTime();if(Number.isNaN(a))return"\u2014";let s=Math.max(1,Math.floor((Date.now()-a)/1e3)),n=(o,i)=>{try{return new Intl.RelativeTimeFormat(Ee==="fa"?"fa":"en",{numeric:"auto"}).format(-o,i)}catch{return`${o} ${i}`}};return s<60?n(s,"second"):s<3600?n(Math.floor(s/60),"minute"):s<86400?n(Math.floor(s/3600),"hour"):s<2592e3?n(Math.floor(s/86400),"day"):s<31536e3?n(Math.floor(s/2592e3),"month"):n(Math.floor(s/31536e3),"year")}function Tc(e){let a=new Date(e).getTime()-Date.now();if(Number.isNaN(a))return"";if(a<=0)return Ee==="fa"?"\u067E\u0627\u06CC\u0627\u0646 \u06CC\u0627\u0641\u062A":"Expired";let s=Math.floor(a/864e5),n=Math.floor(a%864e5/36e5),o=Math.floor(a%36e5/6e4),i=Math.floor(a%6e4/1e3);if(s>0)return Ee==="fa"?`${Xe(s)} \u0631\u0648\u0632 \u0648 ${Xe(n)} \u0633\u0627\u0639\u062A`:`${s}d ${n}h`;let l=u=>String(u).padStart(2,"0"),m=`${l(n)}:${l(o)}:${l(i)}`;return Ee==="fa"?Xe(m):m}function Me(e,a=""){let s=Math.round(Number(e)||0),n='<span class="pc-stars">';for(let o=1;o<=5;o++)n+=`<svg class="ic ${o<=s?"":"off"} ${a}" aria-hidden="true"><use href="#i-star"/></svg>`;return me(n+"</span>")}function Cc(e){return`${b(Math.round(Number(e)||0))}\u066A`}function Ms(e){let a=p(e);return me(a.replace(/(https?:\/\/[^\s<]+)/g,s=>`<a href="${s}" target="_blank" rel="noopener noreferrer nofollow">${s}</a>`))}function Vt(e,a=260){let s;return(...n)=>{clearTimeout(s),s=setTimeout(()=>e(...n),a)}}function Ac(e,a=200){let s=0,n=null;return(...o)=>{let i=Date.now(),l=a-(i-s);l<=0?(s=i,e(...o)):(clearTimeout(n),n=setTimeout(()=>{s=Date.now(),e(...o)},l))}}function At(e){return new Promise((a,s)=>{let n=new FileReader;n.onload=()=>a(String(n.result)),n.onerror=()=>s(new Error("read-failed")),n.readAsDataURL(e)})}function Ls(e){return navigator.clipboard?.writeText?navigator.clipboard.writeText(e):new Promise((a,s)=>{try{let n=document.createElement("textarea");n.value=e,n.setAttribute("readonly",""),n.style.position="fixed",n.style.opacity="0",document.body.appendChild(n),n.select(),document.execCommand("copy"),document.body.removeChild(n),a()}catch(n){s(n)}})}function L(e=document){e.querySelectorAll("[data-w]").forEach(a=>{a.style.width=a.dataset.w}),e.querySelectorAll("[data-h]").forEach(a=>{a.style.height=a.dataset.h}),e.querySelectorAll("[data-maxw]").forEach(a=>{a.style.maxWidth=a.dataset.maxw})}function Dc(e=!0){window.scrollTo({top:0,behavior:e?"smooth":"auto"})}var ro,Ra,Ba,Ha,me,yc,N,$c,wc,kc,vt,Ds,Ee,xc,H=O(()=>{ro=Symbol("raw"),Ra="",Ba="",Ha=e=>e.replace(/[\u0001\u0002]/g,"");try{if(typeof Element<"u"){let e=Object.getOwnPropertyDescriptor(Element.prototype,"innerHTML");e&&e.set&&e.configurable!==!1&&Object.defineProperty(Element.prototype,"innerHTML",{configurable:!0,enumerable:e.enumerable,get(){return e.get.call(this)},set(s){e.set.call(this,typeof s=="string"&&(s.includes(Ra)||s.includes(Ba))?Ha(s):s)}});let a=Element.prototype.insertAdjacentHTML;a&&(Element.prototype.insertAdjacentHTML=function(s,n){return a.call(this,s,typeof n=="string"&&(n.includes(Ra)||n.includes(Ba))?Ha(n):n)})}}catch{}me=e=>Fa(e),yc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","`":"&#96;"};N=(e,a=document)=>a.querySelector(e),$c=(e,a=document)=>[...a.querySelectorAll(e)],wc=e=>document.getElementById(e);kc={cable:"cable",adapter:"plug",case:"shield",glass:"layers",powerbank:"battery",battery:"battery",dongle:"plug",speaker:"speaker",audio:"headset",wearable:"watch",content:"camera",gaming:"zap",car:"truck",light:"light",mics:"mic",misc:"box",watch:"watch",phone:"phone"},vt=e=>kc[e]||"box",Ds=["\u06F0","\u06F1","\u06F2","\u06F3","\u06F4","\u06F5","\u06F6","\u06F7","\u06F8","\u06F9"];Ee="fa";xc=()=>Ee});var va={};Y(va,{BUILD:()=>Ns,CONSENT_TTL_DAYS:()=>po,CONSENT_VERSION:()=>Ks,S:()=>d,adInSlot:()=>nt,addSearch:()=>Ys,addToCart:()=>Wa,applyCoupon:()=>_a,applyPrefs:()=>kt,boot:()=>Bs,brandById:()=>Pc,brandName:()=>Fe,can:()=>V,cartCount:()=>Nc,catById:()=>yt,catName:()=>ke,clearCart:()=>Os,clearSearches:()=>Ic,connectEvents:()=>Js,deleteNotification:()=>Vs,emit:()=>Z,feat:()=>I,getImgIndex:()=>Rc,hasAlert:()=>Va,hasConsent:()=>Qs,inCompare:()=>_s,inWishlist:()=>za,isAdmin:()=>Mc,isPlus:()=>Ve,loadCart:()=>Te,loadNotifications:()=>ut,loadPrefs:()=>mo,markNotificationsRead:()=>Ga,mergeGuestData:()=>zs,on:()=>Le,ordersCfg:()=>Rs,plusCfg:()=>ga,prodName:()=>ue,promptInstall:()=>fa,pushRecent:()=>Gs,refreshBootstrap:()=>Ne,refreshMe:()=>Ge,removeFromCart:()=>Fs,setConsent:()=>Ya,setImgIndex:()=>Bc,setPref:()=>wt,setQty:()=>Hs,settings:()=>Is,ship:()=>pt,store:()=>ze,themeCfg:()=>lo,toggleAlert:()=>Ws,toggleCompare:()=>Us,toggleWishlist:()=>js,ui:()=>Ze,watchInstall:()=>Zs,watchNetwork:()=>Xs});function Le(e,a){return ba.has(e)||ba.set(e,new Set),ba.get(e).add(a),()=>ba.get(e)?.delete(a)}function Z(e,a){for(let s of ba.get(e)||[])try{s(a)}catch(n){console.error("[state]",e,n)}}function mt(e,a){try{let s=localStorage.getItem(e);return s?JSON.parse(s):a}catch{return a}}function $t(e,a){try{localStorage.setItem(e,JSON.stringify(a))}catch{}}function mo(){let e=mt(qe.prefs,{});if(d.prefs={...d.prefs,...e},d.me?.prefs){let a=d.me.prefs;a.theme&&(d.prefs.theme=a.theme),a.locale&&(d.prefs.locale=a.locale),a.density&&a.density!=="normal"&&(d.prefs.density=a.density),a.reduceMotion!==void 0&&(d.prefs.reduceMotion=!!a.reduceMotion),a.uiSound!==void 0&&(d.prefs.uiSound=!!a.uiSound)}return d.prefs}function wt(e,a,{sync:s=!0}={}){if(d.prefs[e]=a,$t(qe.prefs,d.prefs),kt(),Z("prefs",{key:e,value:a}),s&&d.me&&["theme","locale","density","reduceMotion","uiSound"].includes(e)){let n={theme:d.prefs.theme,locale:d.prefs.locale,density:d.prefs.density,reduceMotion:d.prefs.reduceMotion,uiSound:!!d.prefs.uiSound};h.patch("/api/me",{prefs:n}).then(o=>{o?.me&&(d.me=o.me,Z("me",d.me))}).catch(()=>{})}}function kt(){let e=document.documentElement,a=lo(),s=d.prefs,n=s.locale||"fa";oo(n),Ps(n),e.setAttribute("data-lang",n);let o=s.theme||a.mode||"dark";o==="auto"&&(o=window.matchMedia?.("(prefers-color-scheme: light)").matches?"light":"dark"),e.setAttribute("data-mode",o),e.setAttribute("data-theme",a.theme||"default"),e.setAttribute("color-scheme",o),e.setAttribute("data-port",a.portTheme===!1?"off":"on"),e.setAttribute("data-bg",a.bgStyle||"waves"),e.setAttribute("data-variant",a.variant==="classic"?"classic":"fresh");let i=Math.max(0,Math.min(28,Number(a.radius??16)));e.style.setProperty("--radius",`${i}px`),e.style.setProperty("--radius-sm",`${Math.max(4,Math.round(i*.68))}px`),e.style.setProperty("--radius-lg",`${Math.round(i*1.5)}px`);let l=s.density==="compact"||s.density==="comfy"?s.density:a.density||"normal";e.setAttribute("data-density",l),e.setAttribute("data-contrast",a.contrast==="high"?"high":"normal");let m=s.reduceMotion===!0||a.animations===!1;e.setAttribute("data-motion",m?"off":"on");let u=/^#[0-9a-f]{6}$/i.test(String(a.accent||"").trim())?a.accent.trim():"#f59e0b",[f,v,x]=Lc(u).split(",").map(J=>parseInt(J,10));e.style.setProperty("--accent",u),e.style.setProperty("--accent-rgb",`${f}, ${v}, ${x}`),e.style.setProperty("--accent-2",co(u,-34)),e.style.setProperty("--accent-3",co(u,52)),e.style.setProperty("--accent-soft",`rgba(${f}, ${v}, ${x}, .14)`);let w=Ze();e.setAttribute("data-nav",w.navStyle==="underline"?"underline":"pills"),e.setAttribute("data-cards",w.cardStyle==="list"?"list":"grid"),e.style.setProperty("--cols-m",String(ja(w.columns?.mobile,2,1,3))),e.style.setProperty("--cols-t",String(ja(w.columns?.tablet,3,2,4))),e.style.setProperty("--cols-d",String(ja(w.columns?.desktop,4,3,6))),e.style.setProperty("--cols-w",String(ja(w.columns?.wide,5,3,7))),e.style.setProperty("--ticker-dur",`${Math.max(8,Number(w.tickerSpeed)||30)}s`);let E=document.getElementById("headerGrid");E&&(E.setAttribute("data-search-position",["start","center","end"].includes(w.searchPosition)?w.searchPosition:"center"),E.setAttribute("data-header-layout",["logoStart","split","centered"].includes(w.headerLayout)?w.headerLayout:"split"));let M=document.getElementById("siteHeader");M&&M.setAttribute("data-sticky",w.stickyHeader===!1?"off":"on");let q=document.getElementById("topbar");q&&(q.hidden=w.showTicker===!1&&!d.ticker.length),Z("theme",{mode:o,loc:n})}function ja(e,a,s,n){let o=Number(e);return Number.isFinite(o)?Math.max(s,Math.min(n,Math.round(o))):a}function Lc(e){let a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(String(e).trim());return a?`${parseInt(a[1],16)}, ${parseInt(a[2],16)}, ${parseInt(a[3],16)}`:"49, 175, 212"}function co(e,a){let s=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(String(e).trim());if(!s)return e;let n=o=>Math.max(0,Math.min(255,o+a)).toString(16).padStart(2,"0");return`#${n(parseInt(s[1],16))}${n(parseInt(s[2],16))}${n(parseInt(s[3],16))}`}async function Bs(){d.recent=mt(qe.recent,[]),d.searches=mt(qe.search,[]),d.consent=mt(qe.consent,null),d.wishlist=mt(qe.wish,[]),d.compare=mt(qe.cmp,[]),d.installed=window.matchMedia?.("(display-mode: standalone)").matches||typeof navigator<"u"&&navigator.standalone===!0;let e=null,a=Date.now();for(let s=0;s<10&&!e;s++){s&&await new Promise(n=>setTimeout(n,5e3));try{e=await h.get("/api/bootstrap")}catch(n){console.warn("[state] bootstrap failed",n)}!e&&Date.now()-a>6e3&&Z("boot-slow")}return e&&(d.serverTime=e.serverTime,d.sleeping=!!e.sleeping,d.sleepSince=e.sleepSince||null,d.settings=e.settings||{},d.categories=e.categories||[],d.brands=e.brands||[],d.me=e.me||null,d.stats=e.stats||null,d.ads=e.ads||[],d.ticker=e.ticker||[],d.orderStatuses=e.orderStatuses||[],d.ticketCategories=e.ticketCategories||[],d.ticketPriorities=e.ticketPriorities||[]),e||Z("boot-failed"),mo(),kt(),d.me&&(d.wishlist=d.me.wishlist||[],d.compare=d.me.compare||[],d.alerts=d.me.alerts||[],d.unread=d.me.unreadNotifications||0),await Promise.all([Te().catch(()=>{}),d.me?ut(!0).catch(()=>{}):Promise.resolve()]),d.ready=!0,Js(),Z("ready",d),d}async function Ne({silent:e=!1}={}){try{let a=await h.get("/api/bootstrap");return d.settings=a.settings||d.settings,d.sleeping=!!a.sleeping,d.sleepSince=a.sleepSince||null,d.categories=a.categories||d.categories,d.brands=a.brands||d.brands,d.stats=a.stats||null,d.ads=a.ads||[],d.ticker=a.ticker||[],a.me!==void 0&&(d.me=a.me||null,Z("me",d.me)),kt(),Z("settings",d.settings),d}catch(a){if(!e)throw a;return d}}async function Ge(){if(!d.me)return null;try{let e=await h.get("/api/me");return d.me=e.me||null,d.me&&(d.wishlist=d.me.wishlist||[],d.compare=d.me.compare||[],d.alerts=d.me.alerts||[],d.unread=d.me.unreadNotifications||0),Z("me",d.me),d.me}catch{return d.me}}async function Te(){try{let e=await h.get("/api/cart");d.cart=e.cart||d.cart,e.quote?.freeOver!==void 0&&(d.freeOver=e.quote.freeOver),e.quote?.plus!==void 0&&(d.cartPlus=e.quote.plus)}catch{d.cart={items:[],count:0,subtotal:0,weight:0,coupon:null}}return Z("cart",d.cart),d.cart}async function Wa(e,a=1){let s=await h.post("/api/cart/add",{productId:e,qty:a});return d.cart=s.cart,Z("cart",d.cart),s}async function Hs(e,a){let s=await h.patch("/api/cart/item",{productId:e,qty:a});return d.cart=s.cart,Z("cart",d.cart),s}async function Fs(e){let a=await h.del(`/api/cart/item/${encodeURIComponent(e)}`);return d.cart=a.cart,Z("cart",d.cart),a}async function Os(){let e=await h.post("/api/cart/clear");return d.cart=e.cart||{items:[],count:0,subtotal:0,weight:0,coupon:null},Z("cart",d.cart),e}async function _a(e){let a=await h.post("/api/cart/coupon",{code:e});return d.cart=a.cart,Z("cart",d.cart),a}async function ha(e,a){let s=await h.post(`/api/me/${e}/${encodeURIComponent(a)}`);return e==="wishlist"&&(d.wishlist=s.wishlist||d.wishlist),e==="compare"&&(d.compare=s.compare||d.compare),e==="alerts"&&(d.alerts=s.alerts||d.alerts),s}async function js(e){if(!d.me){let s=d.wishlist.indexOf(e);return s>=0?d.wishlist.splice(s,1):d.wishlist.push(e),$t(qe.wish,d.wishlist),Z("wishlist",d.wishlist),{in:d.wishlist.includes(e)}}let a=await ha("wishlist",e);return Z("wishlist",d.wishlist),a}async function Us(e){if(!d.me){let s=d.compare.indexOf(e);return s>=0?d.compare.splice(s,1):(d.compare.length>=4&&d.compare.shift(),d.compare.push(e)),$t(qe.cmp,d.compare),Z("compare",d.compare),{in:d.compare.includes(e)}}let a=await ha("compare",e);return Z("compare",d.compare),a}async function Ws(e){if(!d.me)throw new Error("login_required");let a=await ha("alerts",e);return Z("alerts",d.alerts),a}async function zs(){if(!d.me)return;let e=mt(qe.wish,[]),a=mt(qe.cmp,[]),s=[];for(let n of e)d.wishlist.includes(n)||s.push(ha("wishlist",n).catch(()=>{}));for(let n of a)!d.compare.includes(n)&&d.compare.length<4&&s.push(ha("compare",n).catch(()=>{}));await Promise.all(s),Z("wishlist",d.wishlist),Z("compare",d.compare)}async function ut(e=!1){if(!d.me)return d.notifications=[],d.unread=0,[];try{let a=await h.get("/api/me/notifications");d.notifications=a.items||[],d.unread=d.notifications.filter(s=>!s.read).length,d.me&&(d.me.unreadNotifications=d.unread),Z("notifications",d.notifications)}catch(a){if(!e)throw a}return d.notifications}async function Ga(e,a=!1){let s=await h.post("/api/me/notifications/read",{ids:e||[],all:a});return await ut(!0),s}async function Vs(e){await h.del(`/api/me/notifications/${encodeURIComponent(e)}`),await ut(!0)}function Gs(e){I("recentlyViewed")&&(d.recent=[e,...d.recent.filter(a=>a!==e)].slice(0,12),$t(qe.recent,d.recent),Z("recent",d.recent))}function Ys(e){let a=String(e||"").trim();a&&(d.searches=[a,...d.searches.filter(s=>s!==a)].slice(0,8),$t(qe.search,d.searches))}function Ic(){d.searches=[],$t(qe.search,[])}function Ya(e){d.consent={...e,v:Ks,at:new Date().toISOString()},$t(qe.consent,d.consent),d.me&&h.patch("/api/me",{consent:!0}).catch(()=>{}),Z("consent",d.consent)}function Js(){if(st)try{st.close()}catch{}if(!(typeof EventSource>"u")){try{st=new EventSource("/api/events",{withCredentials:!0})}catch{return}st.addEventListener("ready",()=>{d.online=!0}),st.addEventListener("support",e=>{Z("sse:support",Ua(e.data))}),st.addEventListener("ticket",e=>{Z("sse:ticket",Ua(e.data)),Z("notif",Ua(e.data))}),st.addEventListener("notif",e=>{Z("sse:notif",Ua(e.data)),ut(!0)}),st.addEventListener("settings",()=>Ne({silent:!0})),st.onerror=()=>{try{st.close()}catch{}clearTimeout(io),io=setTimeout(Js,8e3)}}}function Ua(e){try{return JSON.parse(e)}catch{return null}}function Xs(){window.addEventListener("online",()=>{d.online=!0,Z("online",!0),Te().catch(()=>{})}),window.addEventListener("offline",()=>{d.online=!1,Z("online",!1)})}function Zs(){window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),d.installPrompt=e,Z("install",e)}),window.addEventListener("appinstalled",()=>{d.installed=!0,d.installPrompt=null,Z("installed")})}async function fa(){if(!d.installPrompt)return!1;d.installPrompt.prompt();let e=await d.installPrompt.userChoice;return d.installPrompt=null,e?.outcome==="accepted"}function Rc(){return mt(qe.imgIdx,null)}function Bc(e){$t(qe.imgIdx,e)}var qe,d,ba,Ns,Is,ze,Ze,lo,I,pt,ga,Rs,yt,Pc,Ve,Mc,V,ke,Fe,ue,nt,Nc,za,_s,Va,Ks,po,Qs,st,io,z=O(()=>{K();_();H();qe={prefs:"bm_prefs_v1",cart:"bm_cart_local_v1",wish:"bm_wish_v1",cmp:"bm_cmp_v1",recent:"bm_recent_v1",search:"bm_search_v1",consent:"bm_consent_v1",imgIdx:"bm_img_index_v1"},d={ready:!1,serverTime:null,sleeping:!1,sleepSince:null,settings:null,categories:[],brands:[],me:null,stats:null,ads:[],ticker:[],orderStatuses:[],ticketCategories:[],ticketPriorities:[],cart:{items:[],count:0,subtotal:0,weight:0,coupon:null},wishlist:[],compare:[],alerts:[],notifications:[],unread:0,recent:[],searches:[],prefs:{theme:"dark",locale:"fa",density:"normal",reduceMotion:!1,view:"grid"},consent:null,online:typeof navigator<"u"?navigator.onLine:!0,installPrompt:null,installed:!1},ba=new Map;Ns="bm-v44",Is=()=>d.settings||{},ze=()=>d.settings?.store||{},Ze=()=>d.settings?.ui||{},lo=()=>d.settings?.theme||{},I=e=>d.settings?.features?.[e]!==!1,pt=()=>d.settings?.shipping||{},ga=()=>d.settings?.plus||{},Rs=()=>d.settings?.orders||{},yt=e=>d.categories.find(a=>a.id===e)||null,Pc=e=>d.brands.find(a=>a.id===e)||null,Ve=()=>!!(d.me?.plus?.active&&d.me?.plus?.until&&new Date(d.me.plus.until)>new Date),Mc=()=>!!d.me?.isAdmin,V=e=>d.me?d.me.role==="owner"?!0:d.me.permissions?.[e]===!0:!1,ke=e=>ve()==="fa"?e?.name||"":e?.nameEn||e?.name||"",Fe=e=>ve()==="fa"?e?.name||"":e?.nameEn||e?.name||"",ue=e=>ve()==="fa"?e?.name||"":e?.nameEn||e?.name||"",nt=e=>I("ads")?d.ads.filter(a=>a.slot===e&&a.active!==!1):[];Nc=()=>d.cart?.count||0;za=e=>d.wishlist.includes(e),_s=e=>d.compare.includes(e),Va=e=>d.alerts.includes(e);Ks=2,po=180,Qs=()=>{let e=d.consent;if(!e?.at||(e.v||1)!==Ks)return!1;let a=Date.now()-Date.parse(e.at);return Number.isFinite(a)&&a>=0&&a<po*864e5};st=null,io=null});var on={};Y(on,{adaptive:()=>Gc,clearInvalid:()=>Ka,confirmDelete:()=>Oe,confirmDialog:()=>ge,copyWithToast:()=>ei,drawer:()=>en,emptyState:()=>P,errorState:()=>F,fillSelect:()=>Zc,installHintModal:()=>Lt,lightbox:()=>Mt,listSkeleton:()=>Kc,loadingBar:()=>wa,markInvalid:()=>Xc,modal:()=>ce,notice:()=>$a,productSkeleton:()=>Yc,promptDialog:()=>ot,readForm:()=>Jc,sheet:()=>Vc,spinner:()=>ya,tableSkeleton:()=>Qc,toast:()=>re,toastApiError:()=>y,toastError:()=>j,toastSuccess:()=>$,toastWarn:()=>zc,uiClickSound:()=>Qa,uiSoundEnabled:()=>nn,updateSleepScreen:()=>sn,wireAccordions:()=>tn,wireTabs:()=>an,withBusy:()=>A});function re(e,{type:a="info",title:s="",timeout:n=3800,action:o=null}={}){let i=Oc();if(!i)return null;let l=`t${++_c}`,m=Uc[a]||"info",u=We("div",{class:`toast ${m}`,id:l,role:a==="error"?"alert":"status"});for(u.innerHTML=r`
    ...
    <button type="button" class="toast-x" aria-label="${t("common.close")}" data-close="${l}">${c("close")}</button>`,i.appendChild(u);i.children.length>4;)i.firstElementChild.remove();let f=()=>{u.isConnected&&(u.classList.add("out"),setTimeout(()=>u.remove(),220))},v=n>0?setTimeout(f,n):null;return u.addEventListener("click",x=>{if(x.target.closest("[data-close]")){clearTimeout(v),f();return}if(o&&x.target.closest("[data-tid]")){clearTimeout(v),f();try{o.onClick()}catch(w){console.error(w)}}}),{close:()=>{clearTimeout(v),f()}}}function y(e,a="err.generic"){let s=e instanceof Je?ve()==="en"&&e.details||e.message:Cs(e);j(s||t(a))}function uo(e){e?document.body.classList.add("locked"):Dt.length||document.body.classList.remove("locked")}function Pt(e){let{kind:a="modal",title:s="",subtitle:n="",size:o="md",body:i="",footer:l="",onMount:m=null,onClose:u=null,closeBtn:f=!0,dismissible:v=!0}=e,x=a==="modal"?Hc():Fc();if(!x)return{close:()=>{}};let w=document.activeElement,E=window.innerWidth<760,M=a==="drawer"&&E?"sheet":a,q=We("div",{class:`overlay${M==="drawer"?" overlay-drawer":""}${M==="sheet"?" overlay-sheet":""}`}),J=M==="modal"?`modal ${jc[o]??""}`.trim():M,pe=We("div",{class:J,role:"dialog","aria-modal":"true"});s&&pe.setAttribute("aria-label",s);let Se=M==="modal"?"modal-h":"drawer-h",Qe=M==="modal"?"modal-b":"drawer-b";pe.innerHTML=r`
    ${s?r`<header class="${Se}">
    ...
    <div class="${Qe}">${i}</div>
    ${l?r`<footer class="modal-f">${l}</footer>`:""}`,q.appendChild(pe),x.appendChild(q),uo(!0);let ae=!1,$e={panel:pe,overlay:q,result:void 0,dismissible:v,close(R){if(!ae){ae=!0,$e.result=R,q.classList.add("out"),pe.classList.add("out"),setTimeout(()=>{q.remove();let He=Dt.indexOf($e);He>=0&&Dt.splice(He,1),uo(!1);try{w?.focus?.({preventScroll:!0})}catch{}},190);try{u?.(R)}catch(He){console.error(He)}}}};Dt.push($e),q.addEventListener("click",R=>{if(f&&R.target.closest("[data-lx]")){$e.close(null);return}R.target===q&&v&&$e.close(null)}),pe.addEventListener("keydown",R=>{if(R.key!=="Tab")return;let je=[...pe.querySelectorAll('a[href], button:not([disabled]), textarea, input:not([type=hidden]), select, [tabindex]:not([tabindex="-1"])')].filter(at=>at.offsetParent!==null);if(!je.length)return;let Q=je[0],we=je[je.length-1];R.shiftKey&&document.activeElement===Q?(R.preventDefault(),we.focus()):!R.shiftKey&&document.activeElement===we&&(R.preventDefault(),Q.focus())}),setTimeout(()=>{let R=pe.querySelector("[data-autofocus], input:not([type=hidden]), textarea, select");try{R?.focus({preventScroll:!0})}catch{}},70);try{m?.(pe,$e)}catch(R){console.error(R)}return $e}function ge({title:e="",text:a="",okText:s="",cancelText:n="",danger:o=!1,icon:i="alert"}={}){return new Promise(l=>{let m=!1;Pt({kind:"modal",title:e||t("common.warning"),size:"sm",body:r`
        ...
        <button type="button" class="btn btn-primary" data-yes>${i||t("common.confirm")}</button>`,onClose:()=>u(f),onMount:(v,x)=>{let w=v.querySelector("[name=v]"),E=()=>{let M=String(w.value||"").trim();if(l&&!M){w.classList.add("invalid"),w.focus();return}f=M,x.close()};v.querySelector("[data-no]").addEventListener("click",()=>{f=null,x.close()}),v.querySelector("[data-yes]").addEventListener("click",E),v.querySelector("[data-pf]").addEventListener("submit",M=>{M.preventDefault(),E()}),w.addEventListener("keydown",M=>{M.key==="Enter"&&o!=="textarea"&&(M.preventDefault(),E())})}})})}function Mt(e,a=0,s=""){let n=E=>typeof E=="string"?{url:E,kind:"image"}:E,o=(Array.isArray(e)?e:[e]).filter(Boolean).map(n).filter(E=>E.url);if(!o.length)return null;let i=Math.max(0,Math.min(a,o.length-1)),l=null,m=1,u=0,f=0,v=E=>{let M=E?.querySelector(".lb-img");M&&(M.style.transform=`translate(${u.toFixed(0)}px, ${f.toFixed(0)}px) scale(${m.toFixed(2)})`),E?.classList.toggle("zoomed",m>1.01)},x=()=>{m=1,u=0,f=0},w=()=>{let E=o[i],M=E.kind==="video"?`<video class="lb-img lb-video" src="${E.url}" controls playsinline autoplay preload="metadata"></video>`:`<img class="lb-img" src="${E.url}" alt="${s||t("img.alt")}" decoding="async" draggable="false">`;return r`
    <figure class="lb-figure">
      ...
      <button type="button" class="btn btn-ghost" data-next>${t("common.next")} ${c("chevron-left")}</button>`:"",onClose:()=>{l&&document.removeEventListener("keydown",l),l=null},onMount:E=>{let M=E.querySelector("[data-lb]"),q=()=>M.querySelector(".lb-figure"),J=R=>{i=(i+R+o.length)%o.length,x(),M.innerHTML=w(),$e()};E.querySelector("[data-prev]")?.addEventListener("click",()=>J(-1)),E.querySelector("[data-next]")?.addEventListener("click",()=>J(1));let pe=(R,He,je)=>{let Q=Math.max(1,Math.min(4,m*R));Q===1?(u=0,f=0):He!=null&&(u=He-(He-u)*(Q/m),f=je-(je-f)*(Q/m)),m=Q,v(q())},Se=new Map,Qe=0,ae=1,$e=()=>{let R=q();if(!R)return;let He=R.querySelector(".lb-img");R.addEventListener("wheel",Q=>{if(o[i].kind==="video")return;Q.preventDefault();let we=R.getBoundingClientRect();pe(Q.deltaY<0?1.18:1/1.18,Q.clientX-we.left-we.width/2,Q.clientY-we.top-we.height/2)},{passive:!1}),R.addEventListener("dblclick",Q=>{if(o[i].kind==="video")return;let we=R.getBoundingClientRect();m>1.01?x():pe(2.5,Q.clientX-we.left-we.width/2,Q.clientY-we.top-we.height/2),v(R)}),R.addEventListener("pointerdown",Q=>{if(o[i].kind!=="video"){if(Se.set(Q.pointerId,[Q.clientX,Q.clientY]),Se.size===2){let[we,at]=[...Se.values()];Qe=Math.hypot(we[0]-at[0],we[1]-at[1]),ae=m}R.setPointerCapture?.(Q.pointerId)}}),R.addEventListener("pointermove",Q=>{if(!Se.has(Q.pointerId))return;let we=Se.get(Q.pointerId);if(Se.set(Q.pointerId,[Q.clientX,Q.clientY]),Se.size===2&&Qe){let[at,Ct]=[...Se.values()],_t=Math.hypot(at[0]-Ct[0],at[1]-Ct[1]);m=Math.max(1,Math.min(4,ae*(_t/Qe))),m===1&&(u=0,f=0),v(R)}else m>1.01&&(u+=Q.clientX-we[0],f+=Q.clientY-we[1],v(R))});let je=Q=>{Se.delete(Q.pointerId),Se.size<2&&(Qe=0)};R.addEventListener("pointerup",je),R.addEventListener("pointercancel",je),R.querySelector("[data-zin]")?.addEventListener("click",()=>pe(1.3)),R.querySelector("[data-zout]")?.addEventListener("click",()=>pe(1/1.3)),R.querySelector("[data-zreset]")?.addEventListener("click",()=>{x(),v(R)}),v(R)};$e(),l=R=>{R.key==="ArrowLeft"?J(1):R.key==="ArrowRight"?J(-1):R.key==="+"||R.key==="="?pe(1.3):R.key==="-"?pe(1/1.3):R.key==="0"&&(x(),v(q()))},document.addEventListener("keydown",l)}})}function Yc(e=8){let a="";for(let s=0;s<e;s++)a+='<div class="sk sk-card"></div>';return me(`<div class="pgrid">${a}</div>`)}function Kc(e=5,a=3){let s="";for(let n=0;n<e;n++){let o="";for(let i=0;i<a;i++)o+=`<div class="sk sk-line w${[70,40,55,80][i%4]}"></div>`;s+=r`<div class="card row-card">${o}</div>`}return s}function Qc(e=6,a=4){let s="";for(let n=0;n<e;n++){let o="";for(let i=0;i<a;i++)o+=`<td><div class="sk sk-line w${[80,55,40,70][i%4]}"></div></td>`;s+=`<tr>${o}</tr>`}return me(`<div class="table-wrap"><table class="table"><tbody>${s}</tbody></table></div>`)}function P({icon:e="box",title:a="",text:s="",action:n=null,act:o=null}={}){return r`
    <div class="empty">
    ...
    </div>`}function F({title:e="",text:a="",retryAct:s="ui-retry"}={}){return r`
    <div class="empty">
    ...
    </div>`,l.querySelector("[data-sleep-wake]")?.addEventListener("click",async x=>{let w=x.currentTarget;w.disabled=!0;try{await n?.()}finally{w.disabled=!1}}),l.querySelector("[data-sleep-reload]")?.addEventListener("click",()=>location.reload()),l.querySelector("[data-sleep-login]")?.addEventListener("click",()=>o?.())}function ho(e){e.querySelectorAll?.('input[type="password"]')?.forEach(a=>{if(a.dataset.pwdDone)return;a.dataset.pwdDone="1";let s=document.createElement("span");s.className="pwd-wrap",a.parentNode.insertBefore(s,a),s.appendChild(a);let n=document.createElement("button");n.type="button",n.className="pwd-eye",n.dataset.eye="1",n.setAttribute("aria-label",t("pwd.show")),n.title=t("pwd.show"),n.innerHTML=c("eye"),s.appendChild(n)})}function Qa(e=!1){if(!(!e&&!nn()))try{xt=xt||new(window.AudioContext||window.webkitSoundContext||window.webkitAudioContext),xt.state==="suspended"&&xt.resume();let a=xt.currentTime,s=xt.createOscillator(),n=xt.createGain();s.type="sine",s.frequency.setValueAtTime(1560,a),s.frequency.exponentialRampToValueAtTime(1180,a+.06),n.gain.setValueAtTime(1e-4,a),n.gain.exponentialRampToValueAtTime(.045,a+.008),n.gain.exponentialRampToValueAtTime(1e-4,a+.075),s.connect(n).connect(xt.destination),s.start(a),s.stop(a+.09)}catch{}}function nn(){try{return!!JSON.parse(localStorage.getItem("bm_prefs_v1")||"{}").uiSound}catch{return!1}}var Hc,Fc,Oc,jc,Uc,Wc,_c,$,j,zc,Dt,ce,en,Vc,Gc,Oe,ya,$a,St,bo,xt,X=O(()=>{H();_();K();Hc=()=>N("#modalRoot"),Fc=()=>N("#drawerRoot"),Oc=()=>N("#toastRoot"),jc={sm:"narrow",md:"",lg:"wide",xl:"wide"},Uc={success:"success",error:"error",warn:"warning",warning:"warning",info:"info"},Wc={success:"check-circle",error:"alert",warn:"alert",warning:"alert",info:"info"},_c=0;$=(e,a)=>re(e,{type:"success",...a}),j=(e,a)=>re(e,{type:"error",timeout:5600,...a}),zc=(e,a)=>re(e,{type:"warn",...a});Dt=[];document.addEventListener("keydown",e=>{if(e.key==="Escape"&&Dt.length){let a=Dt[Dt.length-1];a.dismissible!==!1&&(e.preventDefault(),a.close(null))}});ce=e=>Pt({kind:"modal",...e}),en=e=>Pt({kind:"drawer",...e}),Vc=e=>Pt({kind:"sheet",...e}),Gc=e=>Pt({kind:window.innerWidth<760?"sheet":"modal",...e});Oe=e=>ge({title:t("common.delete"),text:e||t("misc.confirmDelete"),okText:t("common.delete"),danger:!0,icon:"trash"});ya=(e="")=>r`<div class="row center mt-l" role="status"><span class="spinner"></span>${e?r`<span class="muted small">${e}</span>`:""}</div>`;$a=(e,a)=>r`
  <div class="notice notice-${e}">${c(e==="success"?"check-circle":e==="danger"?"alert":"info")}<div class="grow">${a}</div></div>`,St=null,bo=null;document.addEventListener("click",e=>{let a=e.target.closest?.("[data-eye]");if(!a)return;let s=a.parentElement?.querySelector("input");if(!s)return;let n=s.type==="password";s.type=n?"text":"password",a.innerHTML=c(n?"eye-off":"eye");let o=n?t("pwd.hide"):t("pwd.show");a.setAttribute("aria-label",o),a.title=o,s.focus({preventScroll:!0})},!0);new MutationObserver(e=>{for(let a of e)a.addedNodes.forEach(s=>{s.nodeType===1&&ho(s)})}).observe(document.documentElement,{childList:!0,subtree:!0});ho(document);xt=null;document.addEventListener("pointerdown",e=>{nn()&&e.target.closest?.('button, a, [role="button"], .pcard, .chip, .gal-thumb')&&Qa(!0)},!0)});function Nt(e,a=""){let s=e.images&&e.images[0]||"",n=ue(e)||t("img.alt");return s?r`<img class="${a}" src="${s}" alt="${n}" loading="lazy" decoding="async" data-glyph="${e.glyph||"misc"}">`:me(`<svg class="ic ph-img ${a}" data-glyph="${p(e.glyph||"misc")}" role="img" aria-label="${p(n)}"><use href="#i-${vt(e.glyph||"misc")}"/></svg>`)}function ti(e,{quick:a=null}={}){let s=(Ze().productCardInfo||[]).includes("brand"),n=(Ze().productCardInfo||[]).includes("stock"),o=(Ze().productCardInfo||[]).includes("rating"),i=a!==null?a:I("compare")||Ze().quickView!==!1,l=e.stock??0,m=l<=0?"out":l<=3?"low":"";return r`
  <article class="pcard" data-pid="${e.id}">
    <div class="pc-media">
      ...
      <div class="pc-quick">
        ...
        ${I("wishlist")?r`<button type="button" class="pc-qbtn" data-act="wish-toggle" data-id="${e.id}" title="${t("card.wishlistAdd")}" aria-label="${t("card.wishlistAdd")}">${c("heart")}</button>`:""}
        ${I("compare")?r`<button type="button" class="pc-qbtn" data-act="compare-toggle" data-id="${e.id}" title="${t("card.compareAdd")}" aria-label="${t("card.compareAdd")}">${c("compare")}</button>`:""}
      </div>
    </div>
    <div class="pc-body">
      ...
      <div class="pc-price">
        ${e.oldPrice>e.price?r`<span class="pc-old">${C(e.oldPrice)}</span>`:""}
        <span class="pc-now">${C(e.price)}</span>
      </div>
      <div class="pc-actions">
        <button type="button" class="btn btn-primary" data-act="add-cart" data-id="${e.id}" ${l<=0?"disabled":""}>${c("cart")} ${t("card.addToCart")}</button>
      </div>
    </div>
  </article>`}function go(e,a=null){return r`
    ...
    <a class="pg ${v}" href="${x?"#":s(u)}" ${x?'aria-disabled="true" tabindex="-1"':""} ${u===e?'aria-current="page"':""}>${f}</a>`,o=[],i=u=>{u>=1&&u<=a&&!o.includes(u)&&o.push(u)};i(1),i(2);for(let u=e-1;u<=e+1;u++)i(u);i(a-1),i(a),o.sort((u,f)=>u-f);let l=[n(e-1,c("chevron-right"),"",e<=1)],m=0;for(let u of o)m&&u-m>1&&l.push(r`<span class="pg pg-gap" aria-hidden="true">…</span>`),l.push(n(u,b(u),u===e?"active":"")),m=u;return l.push(n(e+1,c("chevron-left"),"",e>=a)),r`<nav class="pagination" aria-label="${t("common.page")}">${me(l.join(""))}</nav>`}function bt(e){return r`<span class="badge-pill ${si[e]||"bp-muted"}">${t(`st.${e}`)}</span>`}function Rt(e){return r`<span class="badge-pill ${{paid:"bp-success",unpaid:"bp-warn",pending:"bp-warn",refunded:"bp-muted",failed:"bp-danger",cancelled:"bp-muted"}[e?.status]||"bp-muted"}">${t(`ps.${e?.status||"unpaid"}`)}</span>`}function Gt(e){let a=e.timeline||[];return a.length?r`
    <div class="timeline">
      ${a.map(s=>r`
        <div class="tl-item">
    ...
    <div class="chart-x">${e.map(n=>r`<span>${n.short||""}</span>`)}</div>`}function ne(e,a,{emptyText:s=null}={}){return a.length?r`
    <div class="table-wrap">
      <table class="table">
        <thead><tr>${e.map(n=>r`<th class="${n.cls||""}">${n.label}</th>`)}</tr></thead>
        <tbody>${me(a.join(""))}</tbody>
      </table>
    </div>`:me(`<div class="empty"><h4>${p(s||t("common.noData"))}</h4></div>`)}function S({label:e="",name:a,type:s="text",value:n="",placeholder:o="",required:i=!1,hint:l="",attrs:m="",span2:u=!1,autocomplete:f=""}){return r`
    ...
    </label>`}function U({label:e="",name:a,options:s=[],value:n="",required:o=!1,hint:i="",span2:l=!1,placeholder:m=""}){return r`
    <label class="field ${l?"span-2":""}">
      ...
      ${i?r`<span class="hint">${i}</span>`:""}
    </label>`}function Yt({label:e="",name:a,checked:s=!1,hint:n=""}){return r`
    <label class="check">
    ...
    </div>`}function rn(e,{showPlus:a=!0}={}){let s=[];return s.push(r`<div class="sum-row"><span>${t("common.subtotal")}</span><span class="v">${C(e.subtotal)}</span></div>`),a&&e.plusDiscount>0&&s.push(r`<div class="sum-row discount"><span>${t("acc.plus")} (${b(e.plusDiscountPct||3)}٪)</span><span class="v">−${C(e.plusDiscount)}</span></div>`),e.couponDiscount>0&&s.push(r`<div class="sum-row discount"><span>${t("common.discountCode")}: ${e.coupon?.code||""}</span><span class="v">−${C(e.couponDiscount)}</span></div>`),s.push(r`<div class="sum-row"><span>${t("common.shipping")}${e.shippingLabel?r` <span class="muted tiny">(${e.shippingLabel})</span>`:""}</span><span class="v">${e.shipping===0?t("common.free"):C(e.shipping)}</span></div>`),e.insured&&s.push(r`<div class="sum-row"><span>${t("common.insurance")}</span><span class="v">${e.insuranceFee===0?t("common.free"):C(e.insuranceFee)}</span></div>`),s.push(r`<div class="sum-row total"><span>${t("common.payable")}</span><span class="v">${C(e.total)}</span></div>`),me(s.join(""))}function fo(e){let a=Number(pt().freeOver??0);if(!a||e>=a)return r`<div class="notice notice-success mt-s">${c("truck")}<div>${t("cart.freeShipDone")}</div></div>`;let s=Math.min(100,Math.round(e/a*100));return r`
    <div class="mt-s">
      <div class="progress"><i data-w="${s}%"></i></div>
      <p class="hint mt-s">${t("cart.freeShipHint",{amount:C(a-e,{withUnit:!0}).replace(/<[^>]+>/g,"")})}</p>
    ...
    <svg viewBox="0 0 640 360" preserveAspectRatio="xMidYMid slice" role="img" aria-label="${t("contact.mapTitle")}">
      ...
      <g>
        ...
        <text class="mm-txt mm-txt-b" x="313" y="205" text-anchor="middle">${e?"\u067E\u0627\u0633\u0627\u0698 \u0645\u0631\u0648\u0627\u0631\u06CC\u062F \u062E\u0644\u06CC\u062C":"Gulf Pearl Passage"}</text>
      ...
      <text class="mm-txt" x="446" y="140">${e?"\u06A9\u0648\u0686\u0647\u0654 \u0644\u0646\u062C\u200C\u0633\u0627\u0632\u0627\u0646":"Boat-makers Alley"}</text>
      <text class="mm-txt mm-vert" x="196" y="60" transform="rotate(90 196 60)">${e?"\u0628\u0644\u0648\u0627\u0631 \u0628\u0646\u062F\u0631":"Port Blvd."}</text>
      <!-- نشان مغازه -->
  ...
  <div class="captcha" data-captcha ${e?"hidden":""}>
  ...
  </div>`}var Ie,It,si,oe=O(()=>{H();_();z();H();X();Ie=(e,a)=>r`<div class="pgrid">${e.map(s=>ti(s,a))}</div>`;It=(e,a,s="")=>{let n=(a||[]).filter(o=>o.slot===e);return n.length?r`<div class="${s} banner-grid mt">${n.map(ai)}</div>`:""};si={pending_payment:"bp-warn",pending_review:"bp-warn",confirmed:"bp-info",preparing:"bp-info",ready_pickup:"bp-accent",shipped:"bp-violet",delivered:"bp-success",cancelled:"bp-danger",refunded:"bp-muted",returned:"bp-muted"}});var vo={};Y(vo,{mount:()=>oi,render:()=>ni,title:()=>ri});async function ni(){let e=ze(),a=[];if(I("recentlyViewed")&&(d.recent||[]).length)try{a=(await h.get(`/api/products?ids=${d.recent.slice(0,8).join(",")}&limit=8`)).items||[]}catch{a=[]}let s=[],n=d.categories,o=d.brands,i=d.stats;try{let[w,E,M]=await Promise.all([h.get("/api/products?limit=48&sort=popular"),d.categories.length?Promise.resolve(null):h.get("/api/categories"),d.brands.length?Promise.resolve(null):h.get("/api/brands")]);if(s=w.items||[],E&&(n=E.items||[]),M&&(o=M.items||[]),I("publicStats"))try{i=(await h.get("/api/stats/public")).stats||i}catch{}}catch{}let l=s.filter(w=>w.featured).slice(0,8),m=[...s].sort((w,E)=>(E.sold||0)-(w.sold||0)).slice(0,8),u=[...s].sort((w,E)=>String(E.createdAt||"").localeCompare(String(w.createdAt||""))).slice(0,8),f=s.filter(w=>w.discountPct>0).sort((w,E)=>E.discountPct-w.discountPct).slice(0,8),v=n.filter(w=>!w.parentId).slice(0,12),x=l.length?l:m.slice(0,8);return r`
    ${It("home_hero",nt("home_hero"))}
    ${I("partners")&&d.settings.partners?.items?.length?r`
    <section class="partners-sec partners-top">
      ...
      <div class="marquee" aria-label="${t("home.partnersTitle")}">
        <div class="marquee-track">
          ${[...d.settings.partners.items,...d.settings.partners.items].map(w=>{let E=(d.brands||[]).find(q=>q.name===w.fa||w.en&&(q.nameEn===w.en||q.nameEn?.toLowerCase()===w.en.toLowerCase())),M=E?`#/products?brand=${E.id}`:`#/search?q=${encodeURIComponent(w.fa)}`;return r`<a class="partner-chip" href="${M}" title="${k()?w.fa:w.en||w.fa}">
    ...
    <section class="hero">
      ...
      <div class="hero-inner">
        <span class="hero-kicker">${c("anchor")} ${t("home.heroKicker")}</span>
    ...
    <section class="section">
      ...
      <div class="cat-grid">${v.map(w=>go(w,w.count??null))}</div>
    </section>
    ...
    <section class="section">
      ...
      <div class="pwa-grid">
        ...
        <div class="pwa-card"><span class="pwa-ic">${c("truck")}</span><div><div class="b">${t("home.point3")}</div><div class="muted small">${k()?"\u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627 \u0647\u0631 \u0631\u0648\u0632 \u06A9\u0627\u0631\u06CC \u0627\u0632 \u0628\u0648\u0634\u0647\u0631 \u0631\u0627\u0647\u06CC \u0645\u06CC\u200C\u0634\u0648\u0646\u062F\u061B \u062F\u0627\u062E\u0644 \u0634\u0647\u0631 \u0628\u0627 \u067E\u06CC\u06A9 \u0648 \u0628\u0642\u06CC\u0647\u0654 \u0627\u06CC\u0631\u0627\u0646 \u0628\u0627 \u067E\u0633\u062A.":"Orders leave Bushehr every working day \u2014 by courier in the city and by post nationwide."}</div></div></div>
      ...
      <div class="catalog" >
        <div class="card">
          ...
          <div class="row row-wrap">
            ...
            <a class="btn btn-ghost" href="tel:${e.phone}">${c("phone")} ${se(e.phone||"")}</a>
          </div>
        </div>
        <div class="card">
  ...
  `}function oi(){let e=document.querySelector(".marquee"),a=e?.querySelector(".marquee-track");if(!e||!a)return null;let s=0,n=!1,o=0,i=!1,l=0,m=performance.now(),u=0,f=42,v=()=>{let ae=parseFloat(getComputedStyle(a).gap||"10")||10;return(a.scrollWidth+ae)/2||1},x=()=>{let ae=parseFloat(getComputedStyle(a).gap||"10")||10,$e=[...a.children];if(!$e.length)return;let R=a.dataset.base?Number(a.dataset.base):$e.length/2,He=$e.slice(0,R),je=He.reduce((Ct,_t)=>Ct+_t.offsetWidth+ae,0),Q=1;for(;je*Q<innerWidth*1.6&&Q<4;)Q++;a.dataset.base=String(R);let we=R*Q*2;if($e.length===we)return;let at=document.createDocumentFragment();for(let Ct=0;Ct<2;Ct++)for(let _t=0;_t<Q;_t++)He.forEach(pc=>at.appendChild(pc.cloneNode(!0)));a.innerHTML="",a.appendChild(at)};x(),addEventListener("resize",x,{passive:!0});let w=()=>getComputedStyle(a).direction==="rtl"?1:-1,E=()=>{let ae=v();w()>0?(s>=ae&&(s-=ae),s<0&&(s+=ae)):(s<=-ae&&(s+=ae),s>0&&(s-=ae))},M=ae=>{let $e=Math.min(.05,(ae-m)/1e3);m=ae,!n&&!document.documentElement.classList.contains("eco")&&(s+=w()*f*$e),E(),a.style.transform=`translateX(${s.toFixed(1)}px)`,u=requestAnimationFrame(M)};u=requestAnimationFrame(M);let q=ae=>{ae.pointerType==="mouse"&&ae.button!==0||(i=!1,n=!0,o=0,l=ae.clientX,e.classList.add("grabbing"),window.addEventListener("pointermove",J),window.addEventListener("pointerup",pe),window.addEventListener("pointercancel",pe))},J=ae=>{if(!n)return;let $e=ae.clientX-l;s+=$e,o+=Math.abs($e),l=ae.clientX},pe=()=>{n=!1,e.classList.remove("grabbing"),o>8&&(i=!0),window.removeEventListener("pointermove",J),window.removeEventListener("pointerup",pe),window.removeEventListener("pointercancel",pe)},Se=ae=>{i&&(i=!1,ae.preventDefault(),ae.stopPropagation())},Qe=ae=>ae.preventDefault();return e.addEventListener("dragstart",Qe),e.addEventListener("click",Se,!0),e.addEventListener("pointerdown",q),()=>{cancelAnimationFrame(u),e.removeEventListener("pointerdown",q),e.removeEventListener("dragstart",Qe),e.removeEventListener("click",Se,!0),window.removeEventListener("pointermove",J),window.removeEventListener("pointerup",pe),window.removeEventListener("pointercancel",pe)}}var ri,yo=O(()=>{H();_();K();z();oe();ri=()=>t("nav.home")});var cn={};Y(cn,{mount:()=>ii,render:()=>ci});function Sa(e,a){let s=new URLSearchParams(e.query);for(let[o,i]of Object.entries(a))i===null||i===""||i===void 0?s.delete(o):s.set(o,i);return s.delete("page"),`#${e.params.id?`/category/${e.params.id}`:"/products"}${s.toString()?`?${s}`:""}`}async function ci(e){let a=new URLSearchParams(e.query);e.params.id&&a.set("cat",e.params.id);let s=a,n=new URLSearchParams;for(let q of["q","cat","sort","min","max","rating","authenticity","page"])s.get(q)&&n.set(q,s.get(q));s.get("brand")&&n.set("brand",s.get("brand")),s.get("inStock")==="1"&&n.set("inStock","1"),s.get("discount")==="1"&&n.set("discount","1"),n.set("limit","24");let o={items:[],total:0,pages:1,page:1,facets:{}};try{o=await h.get(`/api/products?${n}`)}catch{}let i=o.items||[],l=o.facets||{},m=d.categories,u=d.brands,f=e.params.id?yt(e.params.id):s.get("cat")?yt(s.get("cat")):null,v=(s.get("brand")||"").split(",").filter(Boolean),x=$o.includes(s.get("sort"))?s.get("sort"):"relevant",w=Number(s.get("page"))||1,E=[];if(f){let q=[],J=f;for(;J;)q.unshift(J),J=J.parentId?yt(J.parentId):null;for(let pe of q)E.push({label:ke(pe),href:`#/category/${pe.id}`})}else s.get("q")?E.push({label:`${t("search.resultsFor")} \xAB${s.get("q")}\xBB`}):E.push({label:t("catalog.title")});let M=(q,J,pe,Se,Qe)=>r`
    <label class="fopt">
      <input type="checkbox" data-f="${q}" value="${J}" ${Qe?"checked":""}>
    ...
    <div class="catalog">
      <aside class="filters card" id="filtersBox" hidden>
        ...
        <div class="fgroup">
          ...
          <div class="acc-b fgroup-b" >
            ${m.filter(q=>!q.parentId).map(q=>M("cat",q.id,ke(q),l.categories?.[q.id],(s.get("cat")||e.params.id)===q.id))}
          </div>
        </div>
        ...
        <div class="fgroup">
          ...
          <div class="acc-b fgroup-b">
            ${u.slice(0,20).map(q=>M("brand",q.id,Fe(q),l.brands?.[q.id],v.includes(q.id)))}
          </div>
        </div>
        ...
        <div class="fgroup">
          ...
          <div class="fgroup-b">
            ${M("flag","inStock",t("catalog.f.inStock"),void 0,s.get("inStock")==="1")}
            ${M("flag","discount",t("catalog.f.discountOnly"),void 0,s.get("discount")==="1")}
          </div>
        </div>
        ...
        <div class="fgroup">
          ...
          <div class="fgroup-b">
            ${[4,3,2].map(q=>M("rating",q,`${b(q)}\u2605 ${t("common.and")} ${t("common.more")}`,void 0,s.get("rating")===String(q)))}
          </div>
        </div>
        ...
        <div class="fgroup">
          ...
          <div class="fgroup-b">
            ${["original","highcopy","generic"].map(q=>M("authenticity",q,t(`auth.${q}`),l.authenticity?.[q],s.get("authenticity")===q))}
          </div>
        </div>
      </aside>
      ...
      <div>
        <div class="toolbar">
          ...
          <label class="row" >
            ...
            <select class="select" data-sort>
              ${$o.map(q=>r`<option value="${q}" ${q===x?"selected":""}>${t(`catalog.sort.${q}`)}</option>`)}
            </select>
          </label>
          <div class="btn-group">
        ...
        <div class="active-filters" data-activef>
          ...
          ${v.map(q=>r`<span class="chip active" data-unf="brand" data-v="${q}">${Fe({id:q,...d.brands.find(J=>J.id===q)||{}})} <span class="chip-close">${c("close")}</span></span>`)}
        ...
        ${i.length?me(Ie(i)):P({icon:"search",title:t("search.noResultTitle"),text:t("search.noResultText"),action:{href:"#/products",label:t("cart.goShopping")}})}

        ${rt(w,o.pages||1,q=>Sa(e,{page:q>1?q:null}))}
      </div>
    </div>
  `}function ii(e,a){L(e);let s=e.querySelector("#filtersBox");window.innerWidth>=980&&(s.hidden=!1);let n=i=>{location.hash=i.replace(/^#/,"")};e.querySelector("[data-sort]")?.addEventListener("change",i=>n(Sa(a,{sort:i.target.value==="relevant"?null:i.target.value}))),e.querySelectorAll("[data-view]").forEach(i=>i.addEventListener("click",()=>{wt("view",i.dataset.view,{sync:!1}),document.documentElement.setAttribute("data-cards",i.dataset.view==="list"?"list":"grid"),i.closest(".btn-group").querySelectorAll("button").forEach(l=>l.classList.toggle("active",l===i))}));let o=()=>{let i=new URLSearchParams(a.query);a.params.id&&i.delete("cat");let l=[...e.querySelectorAll('[data-f="cat"]:checked')].map(M=>M.value),m=[...e.querySelectorAll('[data-f="brand"]:checked')].map(M=>M.value),u=e.querySelector('[data-f="rating"]:checked')?.value||"",f=e.querySelector('[data-f="authenticity"]:checked')?.value||"",v=e.querySelector('[data-f="flag"][value="inStock"]:checked')?"1":"",x=e.querySelector('[data-f="flag"][value="discount"]:checked')?"1":"",w=new URLSearchParams;for(let[M,q]of i.entries())["cat","brand","rating","authenticity","inStock","discount","page"].includes(M)||w.set(M,q);l.length&&w.set("cat",l[l.length-1]),m.length&&w.set("brand",m.join(",")),u&&w.set("rating",u),f&&w.set("authenticity",f),v&&w.set("inStock","1"),x&&w.set("discount","1");let E=a.params.id&&!l.length?`/category/${a.params.id}`:"/products";n(`#${E}${w.toString()?`?${w}`:""}`)};return e.querySelectorAll("[data-f]").forEach(i=>i.addEventListener("change",o)),e.querySelector("[data-price-form]")?.addEventListener("submit",i=>{i.preventDefault();let l=new FormData(i.target);n(Sa(a,{min:l.get("min")||null,max:l.get("max")||null}))}),e.querySelectorAll("[data-unf]").forEach(i=>i.addEventListener("click",()=>{let l=i.dataset.unf,m={};if(l==="cat"&&(m.cat=null,a.params.id)){location.hash=`#/products${a.query.toString()?`?${new URLSearchParams([...a.query.entries()].filter(([u])=>u!=="cat"))}`:""}`;return}if(l==="brand"){let u=(a.query.get("brand")||"").split(",").filter(f=>f&&f!==i.dataset.v);m.brand=u.length?u.join(","):null}l==="flag"&&(m[i.dataset.v]=null),l==="price"&&(m.min=null,m.max=null),l==="rating"&&(m.rating=null),l==="authenticity"&&(m.authenticity=null),n(Sa(a,m))})),null}var $o,ln=O(()=>{H();_();K();z();oe();ee();ie();$o=["relevant","newest","oldest","cheapest","dearest","popular","rating","discount","name"];g("cat-filters",(e,a)=>{let s=document.getElementById("filtersBox");s&&(s.hidden=!s.hidden,a.textContent=s.hidden?t("catalog.showFilters"):t("catalog.hideFilters"),s.hidden||s.scrollIntoView({behavior:"smooth",block:"start"}))});g("cat-clear",()=>{let e=location.hash.includes("/category/")?"#/products":location.hash.split("?")[0];location.hash=e})});var ko={};Y(ko,{mount:()=>pi,render:()=>li,title:()=>ui});async function li(e){let a=e.params.id,s=null;try{s=await h.get(`/api/products/${encodeURIComponent(a)}`)}catch{return P({icon:"alert",title:t("err.notFound"),text:t("err.notFoundText"),action:{href:"#/products",label:t("err.goHome")}})}let n=s.product,o=s.reviews||[],i=o.filter(q=>q.type!=="question"),l=o.filter(q=>q.type==="question"),m=s.reviewStats||{count:0,avg:0,dist:[0,0,0,0,0],questions:0},u=s.related||[],f=[],v=yt(n.categoryId);for(;v;)f.unshift(v),v=v.parentId?yt(v.parentId):null;let x=(n.images&&n.images.length?n.images:[]).slice(0,6),w=[...x.map(q=>({url:q,kind:"image"})),...(n.videos||[]).slice(0,4).map(q=>({url:q,kind:"video",poster:x[0]||""}))],E=n.stock??0,M=pt().zones||[];return r`
    ${Ja([...f.map(q=>({label:ke(q),href:`#/category/${q.id}`})),{label:ue(n)}])}
    <div class="pdp">
      <div class="gallery">
        <div class="gal-main" data-act="lightbox" data-imgs='${p(JSON.stringify(w))}' data-i="0" role="button" tabindex="0" aria-label="${t("pdp.zoomHint")}">
          ${w[0]?.kind==="video"?r`<video src="${w[0].url}" poster="${w[0].poster}" controls playsinline preload="metadata" class="gal-video"></video>`:x[0]?r`<img src="${x[0]}" alt="${ue(n)}" data-glyph="${n.glyph}">`:me(`<svg class="ic"><use href="#i-${n.glyph||"box"}"/></svg>`)}
          <span class="gal-zoom-hint" aria-hidden="true">${c("search")} ${t("pdp.zoomHint")}</span>
        </div>
        ${w.length>1?r`<div class="gal-thumbs">${w.map((q,J)=>r`
          <button type="button" class="gal-thumb ${J===0?"active":""}" data-thumb="${J}" aria-label="${J+1}">
            ${q.kind==="video"?me(`<span class="gt-video">${q.poster?`<img src="${q.poster}" alt="" loading="lazy">`:""}<svg class="ic"><use href="#i-play"/></svg></span>`):r`<img src="${q.url}" alt="" loading="lazy">`}
          </button>`)}</div>`:""}
        <div class="row row-wrap">
          ${I("wishlist")?r`<button type="button" class="btn btn-ghost btn-sm ${za(n.id)?"btn-danger":""}" data-act="wish-toggle" data-id="${n.id}">${c("heart")} ${za(n.id)?t("card.wishlistRemove"):t("card.wishlistAdd")}</button>`:""}
          ${I("compare")?r`<button type="button" class="btn btn-ghost btn-sm ${_s(n.id)?"active":""}" data-act="compare-toggle" data-id="${n.id}">${c("scale")} ${t("compare.add")}</button>`:""}
      ...
      <div class="buy-box">
        ...
        <div class="buy-price">
          ${n.oldPrice>n.price?r`<span class="pc-old">${C(n.oldPrice)}</span>`:""}
          <span class="buy-now">${C(n.price)}</span>
          ${n.discountPct>0?r`<span class="pc-off">${b(n.discountPct)}٪</span>`:""}
        </div>
        ${n.oldPrice>n.price?r`<p class="hint">${t("pdp.save")}: ${C(n.oldPrice-n.price)}</p>`:""}
        ...
        <button type="button" class="btn btn-outline btn-block mt-s" data-act="pdp-buy" data-id="${n.id}" ${E<=0?"disabled":""}>${c("zap")} ${t("pdp.buyNow")}</button>
        ...
        <ul class="col">
          ...
          <li class="row"><span class="stat-ic" data-h="30px" data-w="30px">${c("truck")}</span><span class="small">${t("checkout.courier")}: ${M.map(q=>`${k()?q.name:q.nameEn} ${b(q.fee)}`).join(" \xB7 ")}</span></li>
          ${I("insurance")?r`<li class="row"><span class="stat-ic" data-h="30px" data-w="30px">${c("scale")}</span><span class="small">${t("checkout.insuranceDesc")}</span></li>`:""}
    ...
    <section class="section card">
      <div class="tabs" role="tablist">
        ...
        ${I("reviews")?r`<button type="button" class="tab" data-tab="reviews" role="tab">${t("pdp.reviews")} (${b(m.count)})</button>`:""}
        ${I("questions")?r`<button type="button" class="tab" data-tab="questions" role="tab">${t("pdp.questions")} (${b(m.questions||l.length)})</button>`:""}
      </div>

      <div class="tab-panel" data-panel="specs">
        ${Object.keys(n.specs||{}).length?r`
          <table class="spec-table">
            <tbody>${Object.entries(n.specs).map(([q,J])=>r`<tr><th>${p(q)}</th><td>${p(J)}</td></tr>`)}</tbody>
        ...
        ${(n.tags||[]).length?r`<div class="row row-wrap mt">${n.tags.map(q=>r`<a class="tag" href="#/products?q=${encodeURIComponent(q)}">#${q}</a>`)}</div>`:""}
      </div>
      ...
      <div class="tab-panel" data-panel="reviews" hidden>
        <div class="rev-summary mb">
          ...
          <div class="rev-bars">
            ${[5,4,3,2,1].map(q=>r`
              <div class="rev-bar"><span>${b(q)}★</span><span class="track"><span class="fill" data-w="${m.count?Math.round((m.dist?.[q-1]||0)/m.count*100):0}%"></span></span><span>${b(m.dist?.[q-1]||0)}</span></div>`)}
          </div>
        </div>
        <div data-reviews>
          ${i.length?i.map(wo).join(""):r`<p class="muted">${t("pdp.noReviews")}</p>`}
        </div>
        <div class="divider"></div>
        ${d.me?r`
      ...
      <div class="tab-panel" data-panel="questions" hidden>
        <div data-questions>
          ${l.length?l.map(wo).join(""):r`<p class="muted">${t("pdp.noQuestions")}</p>`}
        </div>
        <div class="divider"></div>
        ${d.me?r`
    ...
    ${d.recent.filter(q=>q!==n.id).length?r`
    <section class="section">
    ...
    <div class="pdp-bar no-print">
      <div class="pdp-bar-p">
        <div class="b">${C(n.price)}</div>
        ${(n.oldPrice||0)>n.price?r`<div class="tiny muted del">${C(n.oldPrice)}</div>`:""}
      </div>
      ${(n.stock||0)>0?r`<button class="btn btn-primary" data-act="pdp-add" data-id="${n.id}">${c("cart")} ${t("pdp.addToCart")}</button>`:r`<button class="btn btn-ghost" data-act="notify-me" data-id="${n.id}">${c("bell")} ${t("common.notifyMe")}</button>`}
    </div>
  `}function di(e){return{cable:"cable",adapter:"plug",case:"shield",glass:"layers",powerbank:"battery",battery:"battery",dongle:"plug",speaker:"speaker",audio:"headset",wearable:"watch",content:"camera",gaming:"zap",car:"truck",light:"light",mics:"mic",misc:"box"}[e]||"box"}function wo(e){return r`
    ...
    </div>`}function mi(e){let a=e.querySelector(".gal-main");if(!a||!window.matchMedia?.("(hover: hover) and (pointer: fine)")?.matches)return;let s=2.6,n=null,o=null,i=()=>{n&&(n.style.display="none")};a.addEventListener("mousemove",l=>{let m=a.querySelector("img");if(!m||!m.currentSrc){i();return}let u=a.getBoundingClientRect(),f=l.clientX-u.left,v=l.clientY-u.top;if(f<0||v<0||f>u.width||v>u.height){i();return}n||(n=document.createElement("div"),n.className="gal-lens",n.setAttribute("aria-hidden","true"),o=document.createElement("img"),o.alt="",n.appendChild(o),a.appendChild(n));let x=Math.max(120,Math.min(190,Math.round(u.width*.46)));n.style.width=`${x}px`,n.style.height=`${x}px`,n.style.display="block",n.style.left=`${Math.max(-x*.15,Math.min(u.width-x*.85,f-x/2))}px`,n.style.top=`${Math.max(-x*.15,Math.min(u.height-x*.85,v-x/2))}px`;let w=u.width*s,E=u.height*s;o.src=m.currentSrc,o.style.width=`${w}px`,o.style.height=`${E}px`;let M=Math.max(x/2,Math.min(w-x/2,f/u.width*w)),q=Math.max(x/2,Math.min(E-x/2,v/u.height*E));o.style.left=`${x/2-M}px`,o.style.top=`${x/2-q}px`}),a.addEventListener("mouseleave",i),a.addEventListener("click",i)}function pi(e,a){L(e),Gs(a.params.id),an(e),mi(e);let s=e.querySelector(".gal-main");if(s){let o=null,i=!1;s.addEventListener("click",l=>{i&&(i=!1,l.stopPropagation(),l.preventDefault())},!0),s.addEventListener("pointerdown",l=>{l.pointerType==="touch"&&(o=l.clientX)},{passive:!0}),s.addEventListener("pointerup",l=>{if(o==null||l.pointerType!=="touch")return;let m=l.clientX-o;if(o=null,Math.abs(m)<48)return;i=!0;let u=JSON.parse(e.querySelector("[data-imgs]")?.dataset.imgs||"[]");if(u.length<2)return;let f=Number(e.querySelector("[data-imgs]").dataset.i||0);f=(f+(m<0?1:-1)+u.length)%u.length,e.querySelector(`[data-thumb="${f}"]`)?.click()},{passive:!0})}e.querySelectorAll("[data-thumb]").forEach(o=>o.addEventListener("click",()=>{let i=Number(o.dataset.thumb),l=JSON.parse(e.querySelector("[data-imgs]").dataset.imgs||"[]"),m=e.querySelector(".gal-main"),u=l[i];if(m&&u)if(m.querySelector("img, video")?.remove(),u.kind==="video"){let f=document.createElement("video");f.src=u.url,f.controls=!0,f.playsInline=!0,f.preload="metadata",f.className="gal-video",u.poster&&(f.poster=u.poster),m.prepend(f)}else{let f=document.createElement("img");f.src=u.url,f.alt="",m.prepend(f)}e.querySelectorAll("[data-thumb]").forEach(f=>f.classList.toggle("active",f===o)),e.querySelector("[data-imgs]").dataset.i=String(i)})),g("pdp-add",async(o,i)=>{let l=Number(e.querySelector(".qty input")?.value||1);await A(i,async()=>{try{let{addToCart:m}=await Promise.resolve().then(()=>(z(),va));await m(i.dataset.id,l),$(t("card.added"),{timeout:2400})}catch(m){y(m)}})}),g("pdp-buy",async(o,i)=>{let l=Number(e.querySelector(".qty input")?.value||1);try{let{addToCart:m}=await Promise.resolve().then(()=>(z(),va));await m(i.dataset.id,l),le("#/checkout")}catch(m){y(m)}}),g("review-like",async(o,i)=>{if(!d.me){le("#/auth");return}try{let l=await h.post(`/api/reviews/${i.dataset.id}/like`);i.innerHTML=r`${c("heart")} ${t("pdp.helpful")} (${b(l.likes)})`}catch(l){y(l)}}),g("review-submit",async(o,i)=>{o.preventDefault();let l=new FormData(i);await A(i.querySelector("button[type=submit]"),async()=>{try{let m=await h.post("/api/reviews",{productId:i.dataset.pid,type:"review",rating:Number(l.get("rating")||0),title:l.get("title"),body:l.get("body")});$(m.message||t("pdp.reviewSubmitted"),{timeout:5e3}),i.reset()}catch(m){y(m)}})}),g("question-submit",async(o,i)=>{o.preventDefault();let l=new FormData(i);await A(i.querySelector("button[type=submit]"),async()=>{try{let m=await h.post("/api/reviews",{productId:i.dataset.pid,type:"question",title:l.get("title"),body:l.get("body")});$(m.message||t("pdp.questionSubmitted"),{timeout:5e3}),i.reset()}catch(m){y(m)}})});let n=e.querySelector("[data-recent]");return n&&d.recent.length&&h.get("/api/products?limit=60").then(o=>{let l=d.recent.filter(m=>m!==a.params.id).slice(0,5).map(m=>o.items.find(u=>u.id===m)).filter(Boolean);n.innerHTML=Ie(l),L(n)}).catch(()=>{}),()=>{}}var ui,So=O(()=>{H();_();K();z();oe();X();ie();ee();ui=e=>e.params.id});function bi(e){return new Promise((a,s)=>{let n=new Image;n.onload=()=>a(n),n.onerror=()=>s(new Error("image-load")),n.src=e})}async function ts(e){let a=await bi(e),s=document.createElement("canvas");s.width=9,s.height=8;let n=s.getContext("2d",{willReadFrequently:!0});n.drawImage(a,0,0,9,8);let o=n.getImageData(0,0,9,8).data,i=E=>.299*o[E]+.587*o[E+1]+.114*o[E+2],l="";for(let E=0;E<8;E++)for(let M=0;M<8;M++){let q=i((E*9+M)*4),J=i((E*9+M+1)*4);l+=q>J?"1":"0"}let m="";for(let E=0;E<64;E+=4)m+=parseInt(l.slice(E,E+4),2).toString(16);let u=document.createElement("canvas");u.width=8,u.height=8;let f=u.getContext("2d",{willReadFrequently:!0});f.drawImage(a,0,0,8,8);let v=f.getImageData(0,0,8,8).data,x=new Array(64).fill(0);for(let E=0;E<64;E++){let M=v[E*4]>>6,q=v[E*4+1]>>6,J=v[E*4+2]>>6;x[M<<4|q<<2|J]++}let w=x.reduce((E,M)=>E+M,0)||1;return{dhash:m,hist:x.map(E=>Math.round(E/w*1e3)/1e3)}}var dn=O(()=>{});var xo={};Y(xo,{mount:()=>gi,render:()=>hi,title:()=>fi});async function hi(){return r`
    ...
    <section class="section" data-results hidden></section>`}function gi(e){L(e);let a=e.querySelector("[data-drop]"),s=e.querySelector("[data-results]"),n=async o=>{if(!o)return;if(!/^image\//.test(o.type)){y({code:"invalid_type",message:t("err.generic")});return}if(o.size>4*1024*1024){y({code:"payload_too_large",message:t("err.generic")});return}let i=await At(o),l=e.querySelector("[data-preview]");l.hidden=!1,e.querySelector("[data-pimg]").src=i,s.hidden=!1,s.innerHTML=r`<div class="row center">${c("refresh")} ${t("search.imageIndexing")}</div>`,await A(null,async()=>{try{let m=await ts(i),u=await h.post("/api/search/image",m);if(!u.indexed){s.innerHTML=P({icon:"image",title:t("search.imageNoIndex"),text:t("adm.isHint")});return}if(!u.items?.length){s.innerHTML=P({icon:"search",title:t("search.imageNoMatch"),action:{href:"#/products",label:t("cart.goShopping")}});return}s.innerHTML=r`
          ...
          <div class="row row-wrap mt-s">${u.items.map(f=>r`<span class="chip">${f.name?.slice(0,24)}… ${b(f.matchScore)}٪</span>`)}</div>`}catch(m){s.innerHTML=P({icon:"alert",title:t("err.generic")}),y(m)}})};return e.querySelectorAll("[data-file]").forEach(o=>o.addEventListener("change",()=>n(o.files?.[0]))),["dragover","dragenter"].forEach(o=>a.addEventListener(o,i=>{i.preventDefault(),a.classList.add("drag")})),["dragleave","drop"].forEach(o=>a.addEventListener(o,i=>{i.preventDefault(),a.classList.remove("drag")})),a.addEventListener("drop",o=>n(o.dataTransfer?.files?.[0])),null}var fi,Eo=O(()=>{H();_();K();dn();X();oe();fi=()=>t("search.imageTitle")});var qo={};Y(qo,{mount:()=>$i,render:()=>vi,title:()=>wi});async function vi(){await Te().catch(()=>{});let e=d.cart;return e.items?.length?r`
    <div class="section-head">
    ...
    <div class="cart-grid">
      ...
      <aside class="summary card">
        ...
        <div class="sum-row"><span>${t("common.subtotal")}</span><span class="v">${C(e.subtotal)}</span></div>
        <div data-coupon-row>
        ...
        <div data-shipbar>${fo(e.subtotal)}</div>
        ${e.coupon?"":r`
        ...
        <div class="sum-row total"><span>${t("common.payable")}</span><span class="v" data-total>${C(e.subtotal-(e.couponDiscount||0))}</span></div>
      ...
      ${P({icon:"cart",title:t("cart.empty"),text:t("cart.emptyText"),action:{href:"#/products",label:t("cart.goShopping")}})}`}function yi(e){let a=e.product;return r`
    <div class="cart-line" data-line="${a.id}">
      ...
      <div class="cl-body">
        ...
        <div class="cl-meta">${a.brandName?`${a.brandName} \xB7 `:""}${C(a.price)} / ${t("common.unit")}</div>
        ...
        <div class="cl-foot">
          ...
          <span class="cl-price">${C(e.lineTotal)}</span>
        </div>
      </div>
    </div>`}function $i(e){return L(e),e.querySelectorAll(".qty input").forEach(a=>{a.addEventListener("change",async()=>{let n=a.closest("[data-line]").dataset.line,o=Math.max(1,Number(a.value)||1);try{await Hs(n,o),re(t("cart.updated"),{timeout:1500}),Promise.resolve().then(()=>(ee(),ct)).then(i=>i.refresh(!0))}catch(i){y(i),Promise.resolve().then(()=>(ee(),ct)).then(l=>l.refresh(!0))}})}),g("cart-remove",async(a,s)=>{try{await Fs(s.dataset.id),Promise.resolve().then(()=>(ee(),ct)).then(n=>n.refresh(!0))}catch(n){y(n)}}),g("cart-clear",async()=>{if(await ge({text:t("cart.clearConfirm"),danger:!0,okText:t("cart.clear")}))try{await Os(),Promise.resolve().then(()=>(ee(),ct)).then(s=>s.refresh(!0))}catch(s){y(s)}}),g("coupon-apply",async(a,s)=>{a.preventDefault();let n=s.querySelector("[name=code]").value.trim();n&&await A(s.querySelector("button"),async()=>{try{await _a(n),$(t("cart.couponApplied")),Promise.resolve().then(()=>(ee(),ct)).then(o=>o.refresh(!0))}catch(o){y(o)}})}),g("coupon-remove",async()=>{try{await _a(""),Promise.resolve().then(()=>(ee(),ct)).then(a=>a.refresh(!0))}catch(a){y(a)}}),null}var wi,To=O(()=>{H();_();K();z();oe();X();ie();ee();wi=()=>t("cart.title")});var Do={};Y(Do,{mount:()=>Si,render:()=>ki,title:()=>Ei});async function ki(e){if(await Te().catch(()=>{}),!d.cart.items?.length)return P({icon:"cart",title:t("cart.empty"),text:t("cart.emptyText"),action:{href:"#/products",label:t("cart.goShopping")}});if(!d.me)return P({icon:"user",title:t("checkout.loginRequired"),action:{href:"#/auth?next=checkout",label:t("nav.login")}});if(d.me.kycStatus!=="approved")return P({icon:"shield-alert",title:"\u0627\u062D\u0631\u0627\u0632 \u0647\u0648\u06CC\u062A \u0646\u0627\u0642\u0635 \u0627\u0633\u062A",text:"\u062C\u0647\u062A \u062C\u0644\u0648\u06AF\u06CC\u0631\u06CC \u0627\u0632 \u062A\u0642\u0644\u0628 \u0648 \u0628\u0627 \u062A\u0648\u062C\u0647 \u0628\u0647 \u0627\u0644\u0632\u0627\u0645\u0627\u062A \u0642\u0627\u0646\u0648\u0646\u06CC\u060C \u062B\u0628\u062A \u0633\u0641\u0627\u0631\u0634 \u0646\u06CC\u0627\u0632\u0645\u0646\u062F \u062A\u0623\u06CC\u06CC\u062F \u0647\u0648\u06CC\u062A \u0627\u0633\u062A.",action:{href:"#/account/kyc",label:"\u062A\u06A9\u0645\u06CC\u0644 \u0627\u062D\u0631\u0627\u0632 \u0647\u0648\u06CC\u062A"}});let a=pt(),s=a.zones||[],n=d.me?.addresses||[];try{let o=await h.post("/api/checkout/quote",{delivery:"courier",zone:s[0]?.id||"country",express:!1,insurance:!1});Qt=o.quote,xa=(o.paymentMethods||[]).filter(i=>d.me?!0:i.id==="cod"||i.id==="gateway"),xa.length||(xa=[{id:"cod",fa:"\u067E\u0631\u062F\u0627\u062E\u062A \u062F\u0631 \u0645\u062D\u0644",en:"Cash on delivery",note:""}])}catch{Qt=null}return r`
    ...
    <form class="cart-grid" data-act="checkout-submit" novalidate>
      <div class="col">
        <section class="card">
          ...
          <div data-courier-opts class="mt">
            ...
            ${I("insurance")?he({label:t("checkout.insuranceOpt"),desc:Ve()&&d.settings?.plus?.autoInsurance?t("checkout.insuranceAuto"):t("checkout.insuranceDesc"),name:"insurance",checked:Ve()}):""}
                ...
                ${n.map((o,i)=>r`
                  <label class="addr-card">
                    ...
                    <span>
                      ...
                      <span class="hint">${p(o.receiver||"")} · ${se(o.phone||"")}<br>${p(o.street||"")}${o.city?`\u060C ${p(o.city)}`:""}${o.postal?` \xB7 ${p(o.postal)}`:""}</span>
                    </span>
                  </label>`)}
              </div>
          ...
          <div class="col" data-paymethods>
            ${(xa.length?xa:[{id:"gateway",fa:"\u062F\u0631\u06AF\u0627\u0647 \u0628\u0627\u0646\u06A9\u06CC",en:"Bank gateway",note:""}]).map((o,i)=>r`
              <label class="radio-card">
                ...
                <span class="dot"></span>
                <span><span class="b">${k()?o.fa:o.en}</span><span class="hint">${p(o.note||"")}${o.id==="gateway"&&Rs().gatewayMode==="demo"?` \u2014 ${t("checkout.gatewayDemo")}`:""}${["snapppay","azki","digipay"].includes(o.id)&&(!d.me||d.me.kycStatus!=="approved")?' <span style="color:var(--danger)">(\u0646\u06CC\u0627\u0632\u0645\u0646\u062F \u0627\u062D\u0631\u0627\u0632 \u0647\u0648\u06CC\u062A)</span>':""}</span></span>
              </label>`)}
          </div>
          ${d.me?"":r`<p class="hint mt-s" data-guest-cod-note hidden>${t("checkout.guestCodPickup")}</p>`}
          ${d.me&&I("wallet")&&(d.me.wallet?.balance||0)>0?he({label:t("checkout.useWallet"),desc:t("checkout.walletBalance",{amount:b(d.me.wallet.balance)}),name:"useWallet",checked:!0}):""}
        ...
        <section class="card">
          ${Yt({label:r`${t("checkout.acceptTerms")} <a class="section-link" href="#/pages/terms">${t("consent.readTerms")}</a>`,name:"acceptTerms",checked:!0})}
      ...
      <aside class="summary card">
        <strong>${t("cart.summary")}</strong>
        <div data-quote>${Qt?rn(Qt):r`<div class="sk sk-line w100"></div>`}</div>
    ...
    </form>`}async function Co(e){let a=new FormData(e);try{Qt=(await h.post("/api/checkout/quote",{delivery:a.get("delivery")||"courier",zone:a.get("zone")||"country",express:a.get("express")==="on",insurance:a.get("insurance")==="on"})).quote;let n=e.querySelector("[data-quote]");n&&(n.innerHTML=rn(Qt));let o=e.querySelector("[data-courier-opts]"),i=a.get("delivery");if(o&&(o.hidden=i!=="courier"),!d.me){let l=e.querySelector('input[name="paymentMethod"][value="cod"]');if(l){l.disabled=i==="pickup",l.closest(".radio-card")?.classList.toggle("disabled",i==="pickup");let m=e.querySelector("[data-guest-cod-note]");if(m&&(m.hidden=i!=="pickup"),l.disabled&&l.checked){let u=e.querySelector('input[name="paymentMethod"][value="gateway"]');u&&(u.checked=!0)}}}}catch{}}function Si(e){L(e);let a=e.querySelector('form[data-act="checkout-submit"]');if(!a)return null;let s=Vt(()=>Co(a),220);return a.addEventListener("change",s),Co(a),g("addr-add",()=>xi()),g("checkout-submit",async(n,o)=>{n.preventDefault();let i=new FormData(o);if(!i.get("acceptTerms")){j(t("form.termsRequired"));return}if(d.me&&i.get("delivery")==="courier"&&!i.get("addressId")){j(t("checkout.noAddress"));return}if(!d.me&&i.get("delivery")==="courier"&&(!i.get("guestProvince")||!i.get("guestCity")||!i.get("guestAddress"))){j(k()?"\u0644\u0637\u0641\u0627\u064B \u0622\u062F\u0631\u0633 \u067E\u0633\u062A\u06CC \u0631\u0627 \u06A9\u0627\u0645\u0644 \u0648\u0627\u0631\u062F \u06A9\u0646\u06CC\u062F.":"Please enter your shipping address.");return}if(!d.me){if(!String(i.get("guestName")||"").trim()){j(t("checkout.guestNameRequired"));return}if(!/^09\d{9}$/.test(String(i.get("guestPhone")||"").replace(/[\s-]/g,""))){j(t("checkout.guestPhoneInvalid"));return}}await A(o.querySelector("button[type=submit]"),async()=>{try{let l=await h.post("/api/checkout",{delivery:i.get("delivery"),zone:i.get("zone"),express:i.get("express")==="on",insurance:i.get("insurance")==="on",paymentMethod:i.get("paymentMethod")||"gateway",useWallet:i.get("useWallet")==="on",note:i.get("note")||"",addressId:i.get("addressId")||"",guestName:d.me?"":String(i.get("guestName")||"").trim(),guestPhone:d.me?"":String(i.get("guestPhone")||"").replace(/[\s-]/g,""),acceptTerms:!0});l.me&&(d.me=l.me,Ge());try{sessionStorage.setItem("bm_last_order",JSON.stringify(l.order))}catch{}await Te(),l.needsPayment&&["gateway","snapppay","azki","digipay"].includes(l.paymentMethod)?le(`#/pay/${l.order.id}`):le(`#/checkout/done/${l.order.id}`)}catch(l){y(l),(l?.code==="stock_limit"||l?.code==="product_unavailable")&&T(!0)}})}),null}function xi(){if(!d.me){le("#/auth?next=checkout");return}Ao=ce({title:t("acc.addAddress"),body:r`
      ...
      </form>`})}var Qt,xa,Ao,Ei,Po=O(()=>{H();_();K();z();oe();X();ie();ee();Qt=null,xa=[];Ao=null;g("addr-save",async(e,a)=>{e.preventDefault();let s=new FormData(a),n=Object.fromEntries(s.entries());n.isDefault=s.get("isDefault")==="on";try{let o=await h.post("/api/me/addresses",n);o.addresses&&d.me&&(d.me.addresses=o.addresses),$(t("acc.addrSaved")),Ao?.close(),T(!0)}catch(o){y(o)}});Ei=()=>t("checkout.title")});var Mo={};Y(Mo,{mount:()=>Ci,render:()=>Ti,title:()=>Ai});function qi(e){try{let a=JSON.parse(sessionStorage.getItem("bm_last_order")||"null");return a&&a.id===e?a:null}catch{return null}}async function Ti(e){let a=e.params.id,s=qi(a);if(!s&&d.me)try{s=(await h.get(`/api/me/orders/${encodeURIComponent(a)}`)).order}catch{}if(!s)return r`<div class="card t-center">
    ...
    <div class="card t-center">
      ...
      <div class="row center row-wrap mt">
        ...
        <span class="badge-pill bp-accent">${C(s.total)}</span>
      </div>
    ...
    </div>`}function Ci(e){return L(e),null}var Ai,Lo=O(()=>{H();_();K();z();oe();Ai=()=>t("checkout.successTitle")});var No={};Y(No,{mount:()=>Pi,render:()=>Di,title:()=>Mi});async function Di(e){let a=e.params.id,s=null;try{s=(await h.get(`/api/me/orders/${encodeURIComponent(a)}`)).order}catch{}if(!s)return P({icon:"alert",title:t("err.notFound"),action:{href:"#/account/orders",label:t("acc.orders")}});if(s.payment?.status==="paid")return r`<div class="card t-center">
      <span class="empty-ic">${c("check-circle")}</span>
    ...
    <div class="card" >
      <div class="t-center">
        ...
        <div class="buy-price center"><span class="buy-now">${C(n)}</span></div>
    ...
    </div>`}function Pi(e){return L(e),null}var Mi,Io=O(()=>{H();_();K();z();oe();X();ee();ie();g("pay-sim",async(e,a)=>{let s=a.dataset.ok==="1";await A(a,async()=>{try{let n=await h.post(`/api/payments/simulate/${a.dataset.id}`,{success:s});await Ge(),await Te(),s?($(t("checkout.paymentSuccess")),le(`#/checkout/done/${a.dataset.id}`)):(y({code:"payment_failed",message:t("checkout.paymentFailed"),details:"Payment failed"}),le("#/account/orders"))}catch(n){y(n)}})});Mi=()=>t("common.payment")});var Ro={};Y(Ro,{mount:()=>Ni,render:()=>Li,title:()=>Ii});async function Li(){let e=d.compare.slice(0,4);if(!e.length)return P({icon:"scale",title:t("compare.empty"),text:t("compare.emptyText"),action:{href:"#/products",label:t("cart.goShopping")}});let a=(await Promise.all(e.map(o=>h.get(`/api/products/${encodeURIComponent(o)}`).catch(()=>null)))).filter(Boolean).map(o=>o.product);if(!a.length)return P({icon:"scale",title:t("compare.empty")});let s=[...new Set(a.flatMap(o=>Object.keys(o.specs||{})))],n=(o,i)=>r`<tr><th class="t-start">${o}</th>${i.map(l=>r`<td>${l}</td>`)}</tr>`;return r`
    ...
    <div class="table-wrap">
      <table class="table">
        ...
        <tbody>
          ${n(t("common.price"),a.map(o=>me(C(o.price))))}
    ...
    </div>`}function Ni(e){return L(e),null}var Ii,Bo=O(()=>{H();_();K();z();oe();Ii=()=>t("compare.title")});var Ho={};Y(Ho,{render:()=>Ri,title:()=>Bi});async function Ri(){let e=null;try{e=await h.get("/api/lotteries")}catch(n){return F({title:n?.message||t("err.generic")})}let a=(e.items||[]).filter(n=>n.status==="active"),s=(e.items||[]).filter(n=>n.status!=="active");return a.length?r`
    ...
    <div class="cart-grid">
      ...
      </div>`}var Bi,Fo=O(()=>{H();_();K();X();ie();z();g("lot-join",async(e,a)=>{if(!d.me){j(t("nav.login"));return}await A(a,async()=>{try{await h.post(`/api/lotteries/${a.dataset.id}/join`,{}),$(t("lot.joinDone")),Promise.resolve().then(()=>(ee(),ct)).then(s=>s.refresh(!0))}catch(s){y(s)}})});Bi=()=>k()?"\u0642\u0631\u0639\u0647\u200C\u06A9\u0634\u06CC":"Lottery"});var Wo={};Y(Wo,{mount:()=>Oi,render:()=>Hi,title:()=>ji});async function Hi(){return r`
    <div class="section-head">
    ...
    <div class="big">${C(a.price,{withUnit:!1})}</div>
    <div class="cur">${t("common.toman")}</div>
    ${a.oldPrice>a.price?r`<p class="pc-old">${C(a.oldPrice)}</p>`:""}
    ...
    <a class="btn btn-primary mt" href="#/product/${a.id}">${t("common.details")} ${c("chevron-left")}</a>`}async function mn(e,a){let s=a.querySelector("[data-result]");try{let n=await h.post("/api/scan",{code:String(e).trim()});if(n.found&&n.product)return ss(s,n.product),Fi(a,n.product),n.product;ss(s,null,{error:t("priceCheck.notFound")})}catch(n){n?.status===404?ss(s,null,{error:t("priceCheck.notFound")}):ss(s,null,{error:t("err.generic")})}return null}function Fi(e,a){as.unshift({id:a.id,name:ue(a),price:a.price,at:new Date().toISOString()}),as.length>8&&as.pop();let s=e.querySelector("[data-hlist]");s&&(s.innerHTML=as.map(n=>r`<div class="row row-between small"><span class="nowrap">${n.name}</span><span class="b">${b(n.price)}</span></div>`).join(""))}function Oi(e){L(e),document.body.classList.add("kiosk-page");let a=e.querySelector("[data-wedge]"),s="",n=0;return a.addEventListener("keydown",o=>{let i=Date.now();if(i-n>120&&(s=""),n=i,o.key==="Enter"){o.preventDefault();let l=s.trim();s="",l&&mn(l,e);return}o.key.length===1&&(s+=o.key)}),a.focus(),g("pc-lookup",(o,i)=>{o.preventDefault(),mn(i.querySelector("[name=code]").value,e)}),g("pc-fullscreen",()=>{document.fullscreenElement?document.exitFullscreen().catch(()=>{}):document.documentElement.requestFullscreen?.().catch(()=>re(t("misc.printBlocked")))}),g("pc-camera",async(o,i)=>{let l=e.querySelector("[data-frame]"),m=l.querySelector("video");if(!("BarcodeDetector"in window)&&!navigator.mediaDevices?.getUserMedia){j(t("priceCheck.cameraUnsupported"));return}try{if(Jt=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"}}),m.srcObject=Jt,await m.play(),l.hidden=!1,i.hidden=!0,e.querySelector('[data-act="pc-camera-stop"]').hidden=!1,"BarcodeDetector"in window){Oo=new window.BarcodeDetector({formats:["ean_13","ean_8","code_128","code_39","upc_a","upc_e"]});let u=async()=>{if(Jt){try{let f=await Oo.detect(m);if(f?.length){let v=f[0].rawValue;mn(v,e);let x=e.querySelector("[name=code]");x&&(x.value=v)}}catch{}Uo=setTimeout(u,700)}};u()}}catch{j(t("priceCheck.cameraDenied"))}}),g("pc-camera-stop",(o,i)=>{jo(e),i.hidden=!0,e.querySelector('[data-act="pc-camera"]').hidden=!1}),()=>{jo(e),document.body.classList.remove("kiosk-page")}}function jo(e){if(clearTimeout(Uo),Jt){for(let s of Jt.getTracks())s.stop();Jt=null}let a=e?.querySelector("[data-frame]");a&&(a.hidden=!0)}var Jt,Oo,Uo,as,ji,_o=O(()=>{H();_();K();z();X();ie();Jt=null,Oo=null,Uo=0,as=[];ji=()=>t("priceCheck.title")});var un={};Y(un,{mount:()=>Wi,render:()=>Ui,title:()=>_i});async function ns(e){let a=e?.querySelector?.("[data-captcha]");if(!a||a.hidden||(a.dataset.verifying&&await new Promise(o=>{let i=Date.now(),l=setInterval(()=>{(!a.dataset.verifying||Date.now()-i>2500)&&(clearInterval(l),o())},60)}),String(a.querySelector("[data-ctok]")?.value||"").trim()))return!0;let s=a.querySelector("[name=captchaBox]"),n=a.querySelector("[data-cch]");return s&&(s.checked=!0),n&&(n.hidden=!1),a.dataset.cid||Bt(a),a.querySelector("[name=captchaAnswer]")?.focus(),re(t("captcha.required"),{type:"error",timeout:4500}),!1}function Ea(e){let a=e&&!e.startsWith("auth")?`#/${e.replace(/^#|^\/|#$/g,"")}`:"#/";Ne().then(()=>Te()).then(()=>zs()).then(()=>le(a))}async function Ui(e){let a=e.query.get("next")||"",s=e.query.get("ref")||"",n=e.params.mode==="register"||!!s,o=e.params.mode==="forgot";return r`
    <div class="auth-wrap">
      <div class="card auth-card">
        ...
        <div class="tab-panel" data-ap="login" ${n||o?"hidden":""}>
          ...
          <form data-act="login-pass" data-apf="password">
            ...
            <div class="mb">${Yt({label:r`${t("auth.acceptTerms")} <a class="section-link" href="#/pages/terms">${t("consent.readTerms")}</a>`,name:"acceptTerms",checked:!0})}</div>
            ${ka()}
    ...
    </div>`}function Wi(e,a){L(e),e.querySelectorAll("[data-captcha]").forEach(m=>Bt(m));let s=a.query.get("next")||"",n=a.query.get("ref")||"";if(n){let m=e.querySelector("[name=referralCode]");m&&(m.value=n,setTimeout(()=>e.querySelector('[data-at="register"]')?.click(),50))}let o={login:e.querySelector('[data-ap="login"]'),register:e.querySelector('[data-ap="register"]'),forgot:e.querySelector('[data-ap="forgot"]')};e.querySelectorAll("[data-at]").forEach(m=>m.addEventListener("click",()=>{e.querySelectorAll("[data-at]").forEach(u=>u.classList.toggle("active",u===m));for(let[u,f]of Object.entries(o))f.hidden=u!==m.dataset.at})),e.querySelectorAll("[data-goto]").forEach(m=>m.addEventListener("click",()=>e.querySelector(`[data-at="${m.dataset.goto}"]`).click()));let i=e.querySelector("[data-method]");i.addEventListener("click",m=>{let u=m.target.closest("[data-m]");if(!u)return;i.querySelectorAll("[data-m]").forEach(v=>v.classList.toggle("active",v===u));let f=u.dataset.m;o.login.querySelectorAll("[data-apf]").forEach(v=>{v.hidden=v.dataset.apf!==f})});let l=e.querySelector("[data-regmode]");return l.addEventListener("click",m=>{let u=m.target.closest("[data-m]");u&&(l.querySelectorAll("[data-m]").forEach(f=>f.classList.toggle("active",f===u)),te.regMode=u.dataset.m,e.querySelector("[data-reg-username]").hidden=te.regMode!=="username",e.querySelector("[data-reg-extra]").hidden=te.regMode!=="username",e.querySelector("[data-reg-target-phone]").hidden=te.regMode!=="phone",e.querySelector("[data-reg-target-email]").hidden=te.regMode!=="email",e.querySelector("[data-reg-code]").hidden=te.regMode==="username")}),e.querySelector("[data-reg-send]").addEventListener("click",async m=>{let u=e.querySelector('[data-act="register"]'),f=te.regMode==="phone"?"phone":"email",v=f==="phone"?u.querySelector("[name=phoneTarget]").value:u.querySelector("[name=emailTarget]").value;try{let x=await h.post("/api/auth/otp/send",{channel:f,target:v,purpose:"register",captchaToken:u.querySelector("[data-ctok]")?.value||void 0});te.demoCode=x.demoCode||"";let w=e.querySelector("[data-reg-demo]");w.hidden=!x.demoCode,x.demoCode&&(w.querySelector("span").textContent=t("auth.demoCode",{code:x.demoCode})),$(t("auth.codeSentTo",{target:x.target})),pn(e,"[data-reg-send]")}catch(x){x?.code==="captcha_required"&&Xt(u),y(x)}}),g("login-pass",async(m,u)=>{if(m.preventDefault(),Ka(u),!await ns(u))return;let f=new FormData(u);await A(u.querySelector("button[type=submit]"),async()=>{try{let v=await h.post("/api/auth/login",{identifier:f.get("identifier"),password:f.get("password"),remember:f.get("remember")==="on",captchaToken:f.get("captchaToken")||void 0});v.twoFactor?(te.challenge=v.challengeToken,te.methods=v.methods||["totp"],te.sent=v.sent||null,zo(e,v)):(d.me=v.me,$(t("auth.loginDone")),Ea(s))}catch(v){(v?.code==="captcha_required"||v?.details?.captchaRequired)&&Xt(u),y(v)}})}),g("otp-send",async(m,u)=>{if(m.preventDefault(),!await ns(u))return;let f=new FormData(u),v=u.dataset.apf==="email"?"email":"phone";te.channel=v,te.target=String(f.get("target")||"").trim(),await A(u.querySelector("button[type=submit]"),async()=>{try{let x=await h.post("/api/auth/otp/send",{channel:v,target:te.target,purpose:"login",captchaToken:f.get("captchaToken")||void 0});te.demoCode=x.demoCode||"";let w=o.login.querySelector('[data-apf="code"]');o.login.querySelectorAll("[data-apf]").forEach(M=>{M.hidden=M!==w}),w.querySelector("[data-sentto]").textContent=t("auth.codeSentTo",{target:x.target});let E=w.querySelector("[data-democode]");E.hidden=!x.demoCode,x.demoCode&&(E.querySelector("span").textContent=t("auth.demoCode",{code:x.demoCode})),$(t("auth.codeSent")),pn(e,"[data-resend]"),w.querySelector("[name=code]").focus()}catch(x){x?.code==="captcha_required"&&Xt(u),y(x)}})}),g("otp-login",async(m,u)=>{m.preventDefault();let f=new FormData(u);await A(u.querySelector("button[type=submit]"),async()=>{try{let v=await h.post("/api/auth/login/otp",{channel:te.channel,target:te.target,code:f.get("code")});if(v.twoFactor){te.challenge=v.challengeToken,te.methods=v.methods||["totp"],zo(e,v);return}d.me=v.me,$(t("auth.loginDone")),Ea(s)}catch(v){y(v)}})}),e.querySelector("[data-resend]")?.addEventListener("click",async()=>{try{let m=await h.post("/api/auth/otp/send",{channel:te.channel,target:te.target,purpose:"login"});te.demoCode=m.demoCode||"";let u=o.login.querySelector("[data-democode]");u.hidden=!m.demoCode,m.demoCode&&(u.querySelector("span").textContent=t("auth.demoCode",{code:m.demoCode})),$(t("auth.codeSent")),pn(e,"[data-resend]")}catch(m){y(m)}}),g("login-2fa",async(m,u)=>{m.preventDefault();let f=new FormData(u),v=u.querySelector("[data-2fam].active")?.dataset["2fam"]||"totp";await A(u.querySelector("button[type=submit]"),async()=>{try{let x=await h.post("/api/auth/login/2fa",{challengeToken:te.challenge,code:f.get("code"),type:v});d.me=x.me,$(t("auth.loginDone")),Ea(s)}catch(x){y(x)}})}),g("register",async(m,u)=>{if(m.preventDefault(),Ka(u),!await ns(u))return;let f=new FormData(u),v={mode:te.regMode,name:f.get("name"),password:f.get("password"),acceptTerms:f.get("acceptTerms")==="on",referralCode:f.get("referralCode")||"",hearAboutUs:f.get("hearAboutUs")||"",captchaToken:f.get("captchaToken")||void 0};te.regMode==="username"?(v.username=f.get("username"),v.phone=f.get("phone")||"",v.email=f.get("email")||""):te.regMode==="phone"?(v.target=f.get("phoneTarget"),v.code=f.get("code"),v.email=f.get("email")||""):(v.target=f.get("emailTarget"),v.code=f.get("code"),v.phone=f.get("phone")||""),await A(u.querySelector("button[type=submit]"),async()=>{try{let x=await h.post("/api/auth/register",v);d.me=x.me,$(t("auth.registerDone")),Ea(s||"")}catch(x){x?.code==="captcha_required"&&Xt(u),y(x)}})}),g("forgot-send",async(m,u)=>{if(m.preventDefault(),!await ns(u))return;let f=new FormData(u),v=u.querySelector("[data-fch] .active").dataset.m;te.channel=v,te.target=String(f.get("target")||"").trim(),await A(u.querySelector("button[type=submit]"),async()=>{try{let x=await h.post("/api/auth/password/forgot",{channel:v,target:te.target,captchaToken:f.get("captchaToken")||void 0}),w=o.forgot.querySelector('[data-act="forgot-reset"]');o.forgot.querySelector('[data-act="forgot-send"]').hidden=!0,w.hidden=!1,w.querySelector("[data-fsent]").textContent=t("auth.codeSentTo",{target:x.target});let E=w.querySelector("[data-fdemo]");E.hidden=!x.demoCode,x.demoCode&&(E.querySelector("span").textContent=t("auth.demoCode",{code:x.demoCode})),$(t("auth.codeSent"))}catch(x){x?.code==="captcha_required"&&Xt(u),y(x)}})}),g("forgot-reset",async(m,u)=>{m.preventDefault();let f=new FormData(u);await A(u.querySelector("button[type=submit]"),async()=>{try{let v=await h.post("/api/auth/password/reset",{channel:te.channel,target:te.target,code:f.get("code"),password:f.get("password")});d.me=v.me,$(t("auth.resetDone")),Ea("")}catch(v){y(v)}})}),null}function zo(e,a){let s=e.querySelector('[data-ap="login"]');s.querySelectorAll("[data-apf]").forEach(m=>{m.hidden=m.dataset.apf!=="2fa"});let n=s.querySelector('[data-act="login-2fa"]'),o=n.querySelector("[data-2fa-method]"),i=te.methods,l={totp:t("auth.2faTotp"),sms:t("auth.2faSms"),email:t("auth.2faEmail"),backup:t("auth.2faBackup")};o.innerHTML=i.map((m,u)=>r`<button type="button" class="btn ${u===0?"active":""}" data-2fam="${m}">${l[m]||m}</button>`).join(""),o.addEventListener("click",m=>{let u=m.target.closest("[data-2fam]");u&&o.querySelectorAll("[data-2fam]").forEach(f=>f.classList.toggle("active",f===u))}),a.sent?.demoCode&&re(t("auth.demoCode",{code:a.sent.demoCode}),{title:t("auth.2faTitle"),timeout:12e3}),n.querySelector("[name=code]").focus()}function pn(e,a){let s=60,n=e.querySelector(a),o=setInterval(()=>{s-=1,n&&(n.textContent=s>0?t("auth.resendIn",{s:b(s)}):t("auth.resend")),s<=0&&clearInterval(o)},1e3)}var te,_i,bn=O(()=>{H();_();K();z();oe();X();ie();ee();te={challenge:null,methods:[],sent:null,channel:"phone",target:"",demoCode:"",mode:"login",regMode:"username"};_i=()=>t("auth.title")});async function rs(){return(await h.get("/api/support/messages")).items||[]}function cs(e){return e.length?e.map(fn).join(""):r`<div class="msg them">${t("acc.chatWelcome")}</div>`}function is(e){requestAnimationFrame(()=>{e.scrollTop=e.scrollHeight})}async function zi(e){return await h.post("/api/support/messages",{body:e})}function os(){if(!Vi())return;if(!d.me){re(t("chat.loginFirst")),location.hash="#/auth?next="+encodeURIComponent("account/support");return}if(et){Vo();return}let e=document.getElementById("chatRoot");et=We("div",{class:"chat-win",role:"dialog","aria-label":t("chat.title")}),et.innerHTML=r`
    <header class="chat-h">
    ...
    </form>`,e.appendChild(et),ht=et.querySelector("[data-thread]"),et.querySelector("[data-cx]").addEventListener("click",Vo);let a=et.querySelector(".chat-h .stat-ic");a&&(a.style.width="34px",a.style.height="34px",a.style.borderRadius="11px"),rs().then(s=>{ht.innerHTML=cs(s),is(ht)}).catch(()=>{ht.innerHTML=r`<div class="msg them">${t("err.network")}</div>`}),et.querySelector("input[name=body]").focus()}function Vo(){et?.remove(),et=null,ht=null}function Yo(e){let a=[];ht&&a.push(ht),document.querySelectorAll("[data-thread-page]").forEach(s=>a.push(s));for(let s of a){if(s.querySelector(`[data-id="${e.id}"]`))continue;let n=s.querySelector(".msg");n&&!n.dataset.id&&s.children.length===1&&n.classList.contains("them")&&n.textContent===t("acc.chatWelcome")&&(s.innerHTML=""),s.insertAdjacentHTML("beforeend",fn(e)),is(s)}}function Ko(){document.getElementById("fabSupport")?.addEventListener("click",os),document.getElementById("btnSupportTop")?.addEventListener("click",os),Le("sse:support",e=>{!d.me||e?.userId!==d.me.id||rs().then(a=>{let s=a.find(o=>o.id===e.id);s&&s.from==="staff"&&(Go()?Yo(s):(gn+=1,hn(),re(s.body,{title:t("chat.title"),timeout:6e3,action:{label:t("common.view"),onClick:os}})));let n=document.querySelector("[data-thread-page]");n&&!Go()&&(n.innerHTML=cs(a),is(n))}).catch(()=>{})}),Le("me",()=>hn())}function hn(){let e=document.getElementById("fabSupport");if(!e)return;let a=e.querySelector(".fab-dot");gn>0?a||(a=We("span",{class:"fab-dot"}),e.appendChild(a)):a?.remove()}function Qo(){gn=0,hn()}function Vi(){return d.settings?.features?.liveSupport!==!1}var et,ht,gn,fn,Go,vn=O(()=>{z();_();K();H();X();ie();et=null,ht=null,gn=0,fn=e=>r`
  <div class="msg ${e.from==="user"?"me":"them"}" data-id="${e.id||""}">
    ${p(e.body)}
    <span class="tm">${fe(e.at)}</span>
  </div>`;Go=()=>!!et;g("chat-open",()=>os());g("chat-send",async(e,a)=>{let s=a.querySelector("input[name=body], textarea[name=body]"),n=String(s?.value||"").trim();if(!n)return;s.value="";let o={id:"tmp",from:"user",body:n,at:new Date().toISOString()},i=[];ht&&i.push(ht),document.querySelectorAll("[data-thread-page]").forEach(l=>i.push(l));for(let l of i)l.insertAdjacentHTML("beforeend",fn(o)),is(l);try{let l=await zi(n),m=l.message;re(t("chat.sent"),{timeout:1600});for(let u of i){let f=u.querySelector(".msg.me:not([data-id])");f&&(f.dataset.id=m.id,f.querySelector(".tm").textContent=fe(m.at))}l.botMessage&&Yo(l.botMessage)}catch(l){y(l);for(let m of i)m.lastElementChild?.remove();s.value=n}})});var wn={};Y(wn,{mount:()=>ul,render:()=>Yi,title:()=>bl});async function Yi(e){let a=e.params.section||"",s=Gi.filter(o=>!o.feat||I(o.feat)),n=await Ki(a,e);return r`
    <div class="section-head"><div>
    ...
    <div class="stats-grid mb">
      ...
      ${I("wallet")?r`<div class="stat-card"><span class="stat-ic">${c("wallet")}</span><div><div class="stat-val">${b(d.me?.wallet?.balance||0)}</div><div class="stat-lbl">${t("common.balance")}</div></div></div>`:""}
    ...
    ${Ve()?r`<div class="notice notice-success mb">${c("sparkles")}<span>${t("acc.plusActive",{date:B(d.me?.plus?.until,{time:!1})})}</span></div>`:I("plus")?r`<div class="notice notice-info mb">${c("sparkles")}<span>${t("acc.plusInactive")} — <a class="section-link" href="#/account/plus">${t("acc.plusSubscribe")}</a></span></div>`:""}
    ${e.length?r`
      ...
      ${Jo(a)}`:P({icon:"cart",title:t("acc.noOrders"),text:t("acc.noOrdersText"),action:{href:"#/products",label:t("cart.goShopping")}})}
    ${d.me?.referralCode&&I("referrals")?r`
      <div class="card mt">
      ...
      </div>`:""}`}function Jo(e){return ne([{label:t("acc.orderCode")},{label:t("acc.orderDate")},{label:t("common.status")},{label:t("acc.orderTotal"),cls:"num"},{label:t("common.actions"),cls:"num"}],e.map(a=>r`
      <tr>
      ...
      </tr>`))}async function Ji(){let e=[];try{e=(await h.get("/api/me/orders")).items||[]}catch{}return e.length?Jo(e):P({icon:"package-check",title:t("acc.noOrders"),text:t("acc.noOrdersText"),action:{href:"#/products",label:t("cart.goShopping")}})}async function Xi(){if(!d.wishlist.length)return P({icon:"heart",title:t("acc.wishlistEmpty"),text:t("acc.wishlistEmptyText"),action:{href:"#/products",label:t("cart.goShopping")}});let e=await h.get("/api/products?limit=96").catch(()=>null),a=d.wishlist.map(s=>e?.items?.find(n=>n.id===s)).filter(Boolean);return Ie(a)}async function Zi(){if(!I("wallet"))return P({icon:"wallet",title:t("err.notFound")});let e={balance:0,transactions:[]};try{e=await h.get("/api/me/wallet")}catch{}return r`
    <div class="card mb">
      <div class="row row-between row-wrap">
        <div><div class="muted small">${t("common.balance")}</div><div class="buy-now">${C(e.balance)}</div></div>
    ...
    ${ne([{label:t("common.date")},{label:t("common.type")},{label:t("common.amount"),cls:"num"},{label:t("common.note")}],(e.transactions||[]).map(a=>r`
        <tr>
        ...
        </tr>`),{emptyText:t("acc.walletEmpty")})}`}function el(){if(!I("plus"))return P({icon:"sparkles",title:t("err.notFound")});let e=ga(),a=Ve();return r`
    <div class="card mb t-center">
      ...
      <p class="buy-price center"><span class="buy-now">${C(e.price)}</span><span class="buy-cur">/ ${b(e.durationDays)} ${t("common.day")}</span></p>
      <div class="row center row-wrap">
        <button class="btn btn-primary" data-act="plus-buy" data-method="wallet" ${I("wallet")?"":"hidden"}>${c("wallet")} ${t("acc.plusPayWallet")}</button>
    ...
    ${e.length?r`<div class="pwa-grid">${e.map(a=>r`
      <div class="card">
        ...
        <p class="muted small mt-s">${p(a.receiver||"")} · ${se(a.phone||"")}<br>${p(a.street||"")}${a.city?`\u060C ${p(a.city)}`:""}${a.postal?`<br>${t("common.postal")}: ${p(a.postal)}`:""}</p>
      ...
      </div>`)}</div>`:P({icon:"pin",title:t("acc.noAddress")})}`}function Xo(e=null){return ce({title:e?t("acc.editAddress"):t("acc.addAddress"),body:r`
    ...
    ${e.length?r`<div class="col">${e.map(a=>r`
      ...
      </div>`)}</div>`:P({icon:"bell",title:t("acc.notifEmpty")})}`}function sl(e){return{order:"package-check",restock:"box",ticket:"ticket",support:"headset",review:"star",plus:"sparkles",wallet:"wallet",account:"user",feedback:"flag",admin_alert:"alert",offer:"percent",welcome:"heart"}[e]||"bell"}async function nl(){let e=[];try{e=(await h.get("/api/tickets")).items||[]}catch{}return r`
    <div class="row row-between mb">
    ...
    ${e.length?ne([{label:t("acc.orderCode")},{label:t("acc.ticketSubject")},{label:t("common.status")},{label:t("common.priority")},{label:t("common.date")},{label:""}],e.map(a=>r`
        <tr>
        ...
        </tr>`)):P({icon:"ticket",title:t("acc.noTickets")})}`}async function ol(){if(!I("liveSupport"))return P({icon:"headset",title:t("err.notFound")});let e=[];try{e=await rs()}catch{}return Qo(),r`
    <div class="card">
      <div class="row row-between mb-s">
    ...
    </div>`}async function $n(){return(await h.get("/api/me/export")).data}async function rl(){let e=null;try{e=await $n()}catch{}let a=e?.reviews||[];return a.length?r`<div class="col">${a.map(s=>r`
    <div class="card">
      <div class="row row-between">
    ...
    </div>`)}</div>`:P({icon:"star",title:t("acc.reviewEmpty")})}async function cl(){let e=null;try{e=await $n()}catch{}let a=e?.feedback||[];return r`
    <div class="row row-between mb">
    ...
    ${a.length?r`<div class="col">${a.map(s=>r`
      ...
      </div>`)}</div>`:P({icon:"flag",title:t("acc.noFeedback")})}`}function il(){let e=d.me;return r`
    ...
    <div class="card">
      ...
      ${ne([{label:t("acc.current")},{label:"IP"},{label:t("common.date")},{label:""}],a.map(s=>r`
          <tr>
    ...
    <div class="card mb">
      ...
      <div class="form-grid mt">
        ${U({label:t("acc.prefTheme"),name:"theme",value:e.theme,options:[{value:"dark",label:t("theme.dark")},{value:"light",label:t("theme.light")},{value:"auto",label:t("theme.auto")}]})}
        ${U({label:t("acc.prefLang"),name:"locale",value:e.locale,options:[{value:"fa",label:"\u0641\u0627\u0631\u0633\u06CC"},{value:"en",label:"English"}]})}
        ${U({label:t("acc.prefDensity"),name:"density",value:e.density,options:[{value:"compact",label:"Compact"},{value:"normal",label:"Normal"},{value:"comfy",label:"Comfy"}]})}
      </div>
  ...
  `}var Gi,yn,Zo,er,bl,kn=O(()=>{H();_();K();z();oe();X();ie();ee();vn();Gi=[{id:"",icon:"home",label:()=>t("acc.dashboard")},{id:"orders",icon:"package-check",label:()=>t("acc.orders")},{id:"wishlist",icon:"heart",label:()=>t("acc.wishlist"),feat:"wishlist"},{id:"wallet",icon:"wallet",label:()=>t("acc.wallet"),feat:"wallet"},{id:"plus",icon:"sparkles",label:()=>t("acc.plus"),feat:"plus"},{id:"addresses",icon:"pin",label:()=>t("acc.addresses")},{id:"notifications",icon:"bell",label:()=>t("acc.notifications")},{id:"tickets",icon:"ticket",label:()=>t("acc.tickets"),feat:"tickets"},{id:"support",icon:"headset",label:()=>t("acc.support"),feat:"liveSupport"},{id:"reviews",icon:"star",label:()=>t("acc.reviews")},{id:"feedback",icon:"flag",label:()=>t("acc.feedback")},{id:"referrals",icon:"users",label:()=>"\u062F\u0639\u0648\u062A \u0627\u0632 \u062F\u0648\u0633\u062A\u0627\u0646"},{id:"profile",icon:"user",label:()=>t("acc.profile")},{id:"kyc",icon:"shield-check",label:()=>"\u0627\u062D\u0631\u0627\u0632 \u0647\u0648\u06CC\u062A (KYC)"},{id:"security",icon:"shield",label:()=>t("acc.security")},{id:"prefs",icon:"settings",label:()=>t("acc.prefs")},{id:"data",icon:"download",label:()=>t("acc.data")}];g("wallet-deposit",()=>{let e=ce({title:t("acc.walletDeposit"),size:"sm",body:r`
      ...
      </form>`,onMount:(a,s)=>{a.querySelectorAll("[data-amt]").forEach(n=>n.addEventListener("click",()=>{a.querySelector("[name=amount]").value=n.dataset.amt}))}})});g("wallet-deposit-do",async(e,a)=>{e.preventDefault();let s=Number(new FormData(a).get("amount")||0);await A(a.querySelector("button[type=submit]"),async()=>{try{await h.post("/api/me/wallet/deposit",{amount:s}),await Ge(),$(t("acc.walletDeposited")),T(!0)}catch(n){y(n)}})});g("plus-buy",async(e,a)=>{await A(a,async()=>{try{await h.post("/api/me/plus/subscribe",{method:a.dataset.method}),await Ge(),$(t("acc.plusSubscribed")),T(!0)}catch(s){y(s)}})});yn=null;g("addr-new",()=>{yn=Xo(null)});g("addr-edit",(e,a)=>{let s=(d.me?.addresses||[]).find(n=>n.id===a.dataset.id);s&&(yn=Xo(s))});g("addr-del",async(e,a)=>{if(await Oe())try{let n=await h.del(`/api/me/addresses/${a.dataset.id}`);d.me&&(d.me.addresses=n.addresses),$(t("acc.addrDeleted")),T(!0)}catch(n){y(n)}});g("addr-default",async(e,a)=>{let s=(d.me?.addresses||[]).find(n=>n.id===a.dataset.id);try{let n=await h.patch(`/api/me/addresses/${a.dataset.id}`,{...s,isDefault:!0});d.me&&(d.me.addresses=n.addresses),$(t("acc.addrSaved")),T(!0)}catch(n){y(n)}});g("addr-save2",async(e,a)=>{e.preventDefault();let s=new FormData(a),n=Object.fromEntries(s.entries());n.isDefault=s.get("isDefault")==="on";let o=a.dataset.id;try{let i=o?await h.patch(`/api/me/addresses/${o}`,n):await h.post("/api/me/addresses",n);d.me&&(d.me.addresses=i.addresses),$(t("acc.addrSaved")),yn?.close(),T(!0)}catch(i){y(i)}});g("notif-read-all",async()=>{await Ga([],!0),T(!0)});g("notif-read",async(e,a)=>{await Ga([a.dataset.id]),T(!0)});g("notif-del",async(e,a)=>{await Vs(a.dataset.id),T(!0)});Zo=null;g("ticket-new",()=>{let e=d.ticketCategories||[],a=d.ticketPriorities||[];Zo=ce({title:t("acc.ticketNew"),body:r`
      <form data-act="ticket-create">
        ${S({label:t("acc.ticketSubject"),name:"subject",required:!0})}
        <div class="form-grid">
          ${U({label:t("acc.ticketCategory"),name:"category",required:!0,options:e.map(s=>({value:s.id||s,label:t(`tc.${s.id||s}`)}))})}
          ${U({label:t("acc.ticketPriority"),name:"priority",options:a.map(s=>({value:s.id||s,label:t(`tp.${s.id||s}`)})),value:"normal"})}
        </div>
        ${G({label:t("acc.ticketBody"),name:"body",required:!0,rows:5})}
        <div class="mb">${Yt({label:r`${t("acc.ticketRules")} <a class="section-link" href="#/pages/ticketRules">${t("acc.ticketViewRules")}</a>`,name:"rules",required:!0})}</div>
        <button class="btn btn-primary btn-block" type="submit">${t("common.submit")}</button>
      </form>`})});g("ticket-create",async(e,a)=>{e.preventDefault();let s=new FormData(a);if(s.get("rules")!=="on"){j(t("form.rulesRequired"));return}await A(a.querySelector("button[type=submit]"),async()=>{try{let n=await h.post("/api/tickets",{subject:s.get("subject"),category:s.get("category"),priority:s.get("priority"),body:s.get("body"),rulesAccepted:!0});$(t("acc.ticketCreated",{code:n.ticket?.code||""})),Zo?.close(),le(`#/account/tickets/${n.ticket?.id||""}`)}catch(n){y(n)}})});er=null;g("feedback-new",()=>{er=ce({title:t("acc.feedbackNew"),body:r`
      <form data-act="feedback-send">
        ${U({label:t("acc.feedbackType"),name:"type",options:["suggestion","complaint","bug"].map(e=>({value:e,label:t(`ft.${e}`)})),value:"suggestion"})}
        ...
        ${d.me?"":ka()}
        <button class="btn btn-primary btn-block" type="submit">${t("common.submit")}</button>
      </form>`})});g("feedback-send",async(e,a)=>{e.preventDefault();let s=new FormData(a);await A(a.querySelector("button[type=submit]"),async()=>{try{await h.post("/api/feedback",{type:s.get("type"),title:s.get("title"),body:s.get("body"),contact:s.get("contact")||"",captchaToken:s.get("captchaToken")||void 0}),$(t("acc.feedbackSent")),er?.close(),T(!0)}catch(n){if(n?.code==="captcha_required"){let o=a.querySelector("[data-captcha]");o&&(o.hidden=!1)}y(n)}})});g("profile-save",async(e,a)=>{e.preventDefault();let s=new FormData(a);await A(a.querySelector("button[type=submit]"),async()=>{try{let n=await h.patch("/api/me",{name:s.get("name"),nameEn:s.get("nameEn"),phone:s.get("phone"),email:s.get("email")});d.me=n.me,$(t("acc.profileSaved")),T(!0)}catch(n){y(n)}})});g("pass-change",async(e,a)=>{e.preventDefault();let s=new FormData(a);if(s.get("next")!==s.get("confirm")){j(ve()==="fa"?"\u062A\u06A9\u0631\u0627\u0631 \u0631\u0645\u0632 \u06CC\u06A9\u0633\u0627\u0646 \u0646\u06CC\u0633\u062A.":"Passwords do not match.");return}await A(a.querySelector("button[type=submit]"),async()=>{try{await h.post("/api/me/password",{current:s.get("current"),next:s.get("next")}),$(t("acc.passwordChanged")),a.reset()}catch(n){y(n)}})});g("2fa-setup",async()=>{try{let e=await h.get("/api/me/2fa");ce({title:t("acc.2faEnable"),body:r`
        <div data-2fa-setup>
        ...
        </div>`,onMount:async a=>{try{let n=(await dl())(0,"M");n.addData(e.otpauth),n.make();let o=a.querySelector("[data-qr]"),i=n.createSvgTag({cellSize:4,margin:2});o.innerHTML=i;let l=o.querySelector("svg");l&&(l.setAttribute("width","180"),l.setAttribute("height","180"),l.classList.add("qr-img"))}catch{a.querySelector("[data-qr]").innerHTML=r`<code class="tag mono">${e.otpauth}</code>`}a.querySelector("[data-methods]").addEventListener("click",s=>{let n=s.target.closest("[data-mm]");n&&(a.querySelectorAll("[data-mm]").forEach(o=>o.classList.toggle("active",o===n)),a.querySelector("[name=code]").closest(".field").hidden=n.dataset.mm!=="totp")})}})}catch(e){y(e)}});g("2fa-enable",async(e,a)=>{let s=a.closest("[data-2fa-setup]").querySelector("[data-mm].active")?.dataset.mm||"totp",n=new FormData(a).get("code")||"";await A(a.querySelector("button[type=submit]"),async()=>{try{let o=await h.post("/api/me/2fa/enable",{method:s,code:n});await Ge(),$(t("acc.2faEnabled")),o.backupCodes?.length&&ce({title:t("acc.2faBackup"),size:"sm",body:r`<p class="hint">${t("acc.2faBackupHint")}</p><div class="row row-wrap mt-s">${o.backupCodes.map(i=>r`<code class="tag mono b">${i}</code>`)}</div>`}),T(!0)}catch(o){y(o)}})});g("2fa-disable",async()=>{let e=await ot({title:t("acc.2faDisable"),label:t("common.password"),type:"password",required:!0});if(e!==null)try{await h.post("/api/me/2fa/disable",{password:e}),await Ge(),$(t("acc.2faDisabled")),T(!0)}catch(a){y(a)}});g("sessions-revoke",async()=>{if(await ge({text:t("acc.revokeAll"),danger:!0}))try{await h.post("/api/me/sessions/revoke",{allOthers:!0}),$(t("acc.revokeDone")),T(!0)}catch(a){y(a)}});g("session-revoke",async(e,a)=>{try{await h.post("/api/me/sessions/revoke",{id:a.dataset.id}),$(t("acc.revokeDone")),T(!0)}catch(s){y(s)}});g("notif-prefs",async(e,a)=>{e.preventDefault();let s=new FormData(a);try{let n=await h.patch("/api/me",{notificationsPrefs:{marketing:s.get("marketing")==="on",orders:s.get("orders")==="on",restock:s.get("restock")==="on",support:s.get("support")==="on"}});d.me=n.me,$(t("misc.saved"))}catch(n){y(n)}});g("data-export",async(e,a)=>{await A(a,async()=>{try{let s=await $n(),n=new Blob([JSON.stringify(s,null,2)],{type:"application/json"}),o=URL.createObjectURL(n),i=document.createElement("a");i.href=o,i.download=`bander-mobile-data-${new Date().toISOString().slice(0,10)}.json`,i.click(),setTimeout(()=>URL.revokeObjectURL(o),4e3),$(t("common.download"))}catch(s){y(s)}})});g("data-delete",async()=>{if(!await ge({title:t("acc.deleteAccount"),text:t("acc.deleteWarn"),danger:!0,okText:t("common.delete")}))return;let a=await ot({title:t("acc.deleteConfirm"),label:t("common.password"),type:"password",required:!0});if(a!==null)try{await h.post("/api/me/delete",{password:a}),d.me=null,le("#/"),T()}catch(s){y(s)}});bl=e=>t("acc.title")});var tr={};Y(tr,{mount:()=>yl,render:()=>vl});async function vl(e){let a=e.params.id,s=null;try{s=await h.get(`/api/me/orders/${a}`)}catch(i){return i?.status===404?P({icon:"package-check",title:t("acc.noOrders"),action:{href:"#/account/orders",label:t("acc.orders")}}):F({title:t("err.generic")})}let n=s.order,o=new Set(s.canReviewIds||[]);return r`
    ...
    <div class="cart-grid">
      <div class="col">
        <div class="card">
          <div class="row row-between row-wrap">
            ...
            <div class="row row-wrap">
              ...
              ${n.payment?.status==="unpaid"?r`<a class="btn btn-primary btn-sm" href="#/pay/${n.id}">${c("card")} ${t("common.payable")} ${C(n.payable)}</a>`:""}
        ...
        <div class="card mt">
          ...
          ${ne([{label:""},{label:t("common.product")},{label:t("common.price"),cls:"num"},{label:t("common.count"),cls:"num"},{label:t("common.total"),cls:"num"},{label:""}],(n.items||[]).map(i=>r`
              <tr>
                ...
                <td class="num">${C(i.price)}</td>
                <td class="num">${b(i.qty)}</td>
                <td class="num b">${C(i.price*i.qty)}</td>
      ...
      <aside class="col">
        <div class="card summary">
          <strong>${t("cart.summary")}</strong>
          <div class="sum-row"><span>${t("common.subtotal")}</span><span class="v">${C(n.subtotal)}</span></div>
          ${n.plusDiscount>0?r`<div class="sum-row discount"><span>${t("acc.plus")}</span><span class="v">−${C(n.plusDiscount)}</span></div>`:""}
          ${n.couponDiscount>0?r`<div class="sum-row discount"><span>${t("common.discountCode")}: ${n.couponCode}</span><span class="v">−${C(n.couponDiscount)}</span></div>`:""}
          <div class="sum-row"><span>${t("common.shipping")}${n.shippingLabel?r` <span class="muted tiny">(${p(n.shippingLabel)})</span>`:""}</span><span class="v">${n.shipping===0?t("common.free"):C(n.shipping)}</span></div>
          ${n.insured?r`<div class="sum-row"><span>${t("common.insurance")}</span><span class="v">${n.insuranceFee===0?t("common.free"):C(n.insuranceFee)}</span></div>`:""}
          <div class="sum-row"><span>${t("common.total")}</span><span class="v">${C(n.total)}</span></div>
          ${n.walletUsed>0?r`<div class="sum-row discount"><span>${t("common.wallet")}</span><span class="v">−${C(n.walletUsed)}</span></div>`:""}
          <div class="sum-row total"><span>${t("common.payable")}</span><span class="v">${C(n.payable)}</span></div>
          ...
          ${n.refund?r`<p class="notice notice-success mt-s">${c("wallet")}<span>${C(n.refund.amount)} ${t("acc.tx.refund")} — ${B(n.refund.at)}</span></p>`:""}
        </div>
        ...
        <div class="card mt">
          ...
          ${n.delivery==="pickup"?r`
            ...
            ${n.address?r`
              <p class="small mt-s"><strong>${p(n.address.receiver||"")}</strong> · ${se(n.address.phone||"")}</p>
          ...
          ${n.insured?r`<p class="small mt-s"><span class="badge-pill bp-success">${c("shield")} ${t("common.insurance")} ${C(n.insuranceFee)}</span></p>`:""}
          ${n.note?r`<p class="hint mt-s">${c("edit")} ${p(n.note)}</p>`:""}
          ${n.couponCode?r`<p class="hint mt-s">${c("percent")} ${n.couponCode}</p>`:""}
        </div>
      </aside>
    </div>`}function yl(e,a){return L(e),null}var fl,ar=O(()=>{H();_();K();z();oe();X();ie();ee();z();fl=e=>{let a=(pt().zones||[]).find(s=>s.id===e);return a?k()?a.name:a.nameEn||a.name:e||""};g("od-cancel",async(e,a)=>{let s=await ot({title:t("acc.cancelOrder"),text:t("acc.cancelReason"),label:t("acc.cancelReason"),rows:3,okText:t("acc.cancelOrder")});if(s!==null)try{await h.post(`/api/me/orders/${a.dataset.id}/cancel`,{reason:s||""}),$(t("acc.orderCancelled")),T(!0)}catch(n){y(n)}});g("od-reorder",async(e,a)=>{await A(a,async()=>{try{let{order:s}=await h.get(`/api/me/orders/${a.dataset.id}`),n=0;for(let o of s.items||[])try{await h.post("/api/cart/add",{productId:o.productId,qty:o.qty||1}),n+=1}catch{}if(await Te(),!n){y({code:"out_of_stock",message:k()?"\u0647\u06CC\u0686\u200C\u06A9\u062F\u0627\u0645 \u0627\u0632 \u0627\u0642\u0644\u0627\u0645 \u062F\u0631 \u0627\u0646\u0628\u0627\u0631 \u0646\u06CC\u0633\u062A.":"None of the items are in stock."});return}$(t("card.added")),le("#/cart")}catch(s){y(s)}})});g("od-invoice",async(e,a)=>{let{order:s}=await h.get(`/api/me/orders/${a.dataset.id}`),n=d.settings?.store||{};ce({title:t("acc.invoice"),body:r`
      <div class="invoice-print" dir="rtl">
        <div class="inv-head">
          <div>
            <strong>${p(n.name||"Green Apple")}</strong>
            <div class="tiny">${p(n.address||"")}</div>
            <div class="tiny">${se(n.phone||"")}</div>
          </div>
          <div class="t-center">
      ...
      </div>`})});g("od-review",(e,a)=>{let s=a.dataset.id,n=a.dataset.name||"",o=ce({title:`${t("pdp.writeReview")} \u2014 ${n}`,body:r`
      <form data-act="od-review-send" data-id="${s}">
        ...
        <button class="btn btn-primary btn-block" type="submit">${t("common.submit")}</button>
      </form>`})});g("od-review-send",async(e,a)=>{e.preventDefault();let s=new FormData(a);await A(a.querySelector("button[type=submit]"),async()=>{try{await h.post("/api/reviews",{productId:a.dataset.id,type:"review",rating:Number(s.get("rating")||5),title:s.get("title"),body:s.get("body")}),$(t("pdp.reviewSubmitted")),a.closest(".overlay")?.remove()}catch(n){y(n)}})})});var nr={};Y(nr,{mount:()=>Sl,render:()=>kl});async function kl(e){let a=null;try{a=(await h.get(`/api/tickets/${e.params.id}`)).ticket}catch(o){return o?.status===404?P({icon:"ticket",title:t("acc.noTickets"),action:{href:"#/account/tickets",label:t("acc.tickets")}}):F({title:t("err.generic")})}Ht=[];let s=(d.ticketPriorities||[]).find(o=>o.id===a.priority)?.slaHours||24,n=a.status==="closed";return r`
    <div class="breadcrumb mb-s">
      <a href="#/account">${t("acc.title")}</a> <span>/</span>
    ...
    </div>`}function sr(e){let a=e.from==="user",s=e.from==="system"?"them sys":a?"me":"them";return r`
    <div class="msg ${s}">
    ...
    </div>`}function Sn(e){let a=e.querySelector("[data-attach-preview]");a&&(a.innerHTML=Ht.map((s,n)=>r`
    <span class="att-chip">
    ...
    </span>`).join(""))}function Sl(e,a){L(e);let s=e.querySelector("[data-attach-input]");s&&s.addEventListener("change",o=>{rr("tk-attach-pick")?.(o,o.target)});let n=e.querySelector("[data-tk-thread]");return n&&(n.scrollTop=n.scrollHeight),null}var $l,wl,Ht,or=O(()=>{H();_();K();z();oe();X();ie();ee();$l={open:"bp-warn",answered:"bp-success",closed:"bp-muted",in_progress:"bp-info",new:"bp-info"},wl={critical:"bp-danger",high:"bp-warn",normal:"bp-info",low:"bp-muted"},Ht=[];g("tk-att-open",(e,a)=>{let n=[...document.querySelectorAll("[data-tk-thread] .tk-att")].map(o=>o.getAttribute("src"));Mt(n.length?n:[a.getAttribute("src")],Math.max(0,n.indexOf(a.getAttribute("src"))))});g("tk-attach-pick",async(e,a)=>{let s=a.closest("form"),n=[...a.files||[]].slice(0,4-Ht.length);a.value="";for(let o of n){if(o.size>4*1024*1024){j(t("err.tooLarge"));continue}try{let i=await At(o),l=await h.upload(i);Ht.push({url:l.url,name:o.name})}catch(i){y(i)}}Sn(s)});g("tk-att-del",(e,a)=>{Ht.splice(Number(a.dataset.i),1),Sn(a.closest("form"))});g("tk-reply",async(e,a)=>{e.preventDefault();let s=String(new FormData(a).get("body")||"").trim();if(s.length<2){j(t("acc.ticketBodyShort"));return}let n=a.querySelector("button[type=submit]");await A(n,async()=>{try{let o=await h.post(`/api/tickets/${a.dataset.id}/messages`,{body:s,attachments:Ht.map(l=>l.url)});Ht=[];let i=a.closest(".card").querySelector("[data-tk-thread]");i&&(i.innerHTML=(o.ticket?.messages||[]).map(sr).join(""),i.scrollTop=i.scrollHeight),a.reset(),Sn(a),$(t("common.sent")),ut(!0)}catch(o){y(o)}})});g("tk-close",async(e,a)=>{await ge({text:t("acc.ticketCloseConfirm"),okText:t("acc.ticketClose")})&&await A(a,async()=>{try{await h.post(`/api/tickets/${a.dataset.id}/close`,{}),$(t("common.done")),T(!0)}catch(n){y(n)}})})});var cr={};Y(cr,{render:()=>xl});async function xl(){let e=null;try{e=await h.get("/api/stats/public")}catch{}if(!e)return r`<div class="empty"><h4>${t("err.network")}</h4></div>`;let a=e.stats||{},s=e.chart||[],n=e.topProducts||[],o=Math.max(1,...s.map(l=>l.visits)),i=s.map(l=>{let m=Math.min(12,Math.max(1,Math.round(l.visits/o*12)));return r`<div class="ch-col" title="${l.date}: ${Xe(l.visits)}">
      <i class="hb-${m}"></i>
  ...
  `}var ir=O(()=>{H();_();z();K();oe()});var dr={};Y(dr,{mount:()=>Nl,render:()=>El,title:()=>Il});function ta(e,a=""){return e?.hero?r`
    <div class="page-hero mb">
      ...
      ${a}
    </div>`:""}function xn(e){return e?.length?e.map(a=>r`
    <div class="card mt">
    ...
    ${xn(e.sections)}`}function Dl(e){return r`
    ${ta(e)}
    ...
    </form>`}function Ml(e){let a=ze(),s=a.socials||{},n=[{key:"instagram",icon:"camera",url:_e(s.instagram)},{key:"telegram",icon:"send",url:_e(s.telegram)},{key:"eitaa",icon:"message",url:_e(s.eitaa)},{key:"whatsapp",icon:"chat",url:a.whatsapp?`https://wa.me/${String(a.whatsapp).replace(/\D/g,"")}`:""}].filter(o=>o.url);return r`
    ${ta(e)}
    <div class="acc-grid">
      <div class="col">
        <div class="card">
          ...
          <div class="contact-list mt">
            ${a.phone?r`<div class="row"><span class="muted small">${t("contact.phone")}</span><a class="mono" href="tel:${a.phone}">${se(a.phone)}</a></div>`:""}
            ${a.phone2?r`<div class="row"><span class="muted small">${t("contact.mobile")}</span><a class="mono" href="tel:${a.phone2}">${se(a.phone2)}</a></div>`:""}
            ${a.phone3?r`<div class="row"><span class="muted small">${t("contact.phone3")}</span><a class="mono" href="tel:${a.phone3}">${se(a.phone3)}</a></div>`:""}
            ${a.whatsapp?r`<div class="row"><span class="muted small">${t("contact.whatsapp")}</span><span class="mono">${se(a.whatsapp)}</span></div>`:""}
      ...
      <aside class="col">
        ...
        <div class="card">
          ...
          <a class="btn btn-primary btn-sm mt-s" href="${p(_e(s.telegram))}" target="_blank" rel="noopener">${c("send")} ${t("contact.tgBotBtn")}</a>
        </div>`:""}

        <div class="card ${_e(s.telegram)?"mt":""}">
        ...
        <div class="card mt">
          ...
          <div class="row row-wrap mt-s">
            ...
            ${I("tickets")?r`<a class="btn btn-ghost btn-sm" href="#/account/tickets">${c("ticket")} ${t("common.ticket")}</a>`:""}
          </div>
        </div>`:""}
    ...
    <div class="card mt t-center" data-faq-empty hidden>
      ...
      <div class="row center row-wrap mt-s">
        ${d.me&&I("liveSupport")?r`<button class="btn btn-primary btn-sm" data-act="chat-open">${c("headset")} ${t("acc.chatTitle")}</button>`:""}
        ${I("tickets")?r`<a class="btn btn-ghost btn-sm" href="#/account/tickets">${c("ticket")} ${t("acc.ticketNew")}</a>`:""}
      </div>
    </div>`}function lr(){let e=document.querySelector("[data-faq-list]");if(!e)return;let a=(document.querySelector("[data-faq-q]")?.value||"").trim().toLowerCase(),s=document.querySelector("[data-faq-cats] .chip.active")?.dataset.cat||"",n=0;e.querySelectorAll(".acc-item").forEach(l=>{let m=!s||l.dataset.cat===s,u=!a||(l.dataset.text||"").includes(a),f=m&&u;l.hidden=!f,f&&(n+=1)});let o=document.querySelector("[data-faq-count]");o&&(o.textContent=t("faq.results",{n:b(n)}));let i=document.querySelector("[data-faq-empty]");i&&(i.hidden=n!==0)}function Nl(e,a){L(e),tn(e);let s=e.querySelector("[data-faq-q]");if(s){let n=0;s.addEventListener("input",()=>{clearTimeout(n),n=setTimeout(lr,160)})}return null}var it,Zt,ea,Il,mr=O(()=>{H();_();K();z();oe();X();ie();it=(e,a)=>k()?e?.[a]??"":e?.[`${a}En`]??e?.[a]??"",Zt=(e,a)=>k()?e?.[a]||[]:e?.[`${a}En`]||e?.[a]||[];ea=(e,a="dot-list")=>e?.length?r`<ul class="${a}">${e.map(s=>r`<li>${typeof s=="string"?p(s):p(it(s,"fa")||s.title||"")}</li>`)}</ul>`:"";g("page-feedback",async(e,a)=>{e.preventDefault();let s=new FormData(a);await A(a.querySelector("button[type=submit]"),async()=>{try{await h.post("/api/feedback",{type:s.get("type")||"suggestion",title:s.get("title"),body:s.get("body"),contact:s.get("contact")||""}),$(t("acc.feedbackSent")),a.reset()}catch(n){y(n)}})});g("faq-cat",(e,a)=>{a.closest("[data-faq-cats]").querySelectorAll(".chip").forEach(n=>n.classList.toggle("active",n===a)),lr()});Il=()=>t("common.page")});var pr={};Y(pr,{mount:()=>Hl,render:()=>Rl});async function Rl(){let e=null;try{e=await h.get("/api/admin/overview")}catch(n){return F({title:n?.message||t("err.generic")})}let a=e.stats||{},s=(e.chart||[]).map(n=>({label:n.date,short:n.date.slice(8),value:n.visits||0}));return V("users.view")&&Bl(),r`
    <div class="kpi-grid">
      ${De({label:t("adm.kpi.ordersToday"),value:b(e.today?.orders||0),sub:C(e.today?.revenue||0)})}
      ${De({label:t("adm.kpi.visits"),value:b(e.today?.visits||0),sub:`${t("stats.visitsTotal")}: ${b(a.visitsTotal||0)}`})}
      ${De({label:t("adm.kpi.revenueTotal"),value:C(e.totals?.revenue||0),sub:`${b(e.totals?.orders||0)} ${t("common.orders")}`})}
    ...
    <div class="kpi-grid">
      ${V("reviews.moderate")?qa("star",t("adm.awaiting.reviews"),e.awaiting?.reviews,"#/admin/reviews"):""}
      ${V("tickets.manage")?qa("ticket",t("adm.awaiting.tickets"),e.awaiting?.tickets,"#/admin/tickets"):""}
      ${V("orders.view")?qa("package-check",t("adm.awaiting.orders"),e.awaiting?.orders,"#/admin/orders"):""}
      ${V("feedback.manage")?qa("flag",t("adm.awaiting.feedback"),e.awaiting?.feedback,"#/admin/feedback"):""}
      ${V("tickets.manage")?qa("headset",t("adm.awaiting.chat"),e.awaiting?.support,"#/admin/support"):""}
    </div>
    ...
    <div class="acc-grid acc-grid-eq mt">
      <div class="card">
        ...
        ${ne([{label:""},{label:t("adm.pName")},{label:t("pdp.sold"),cls:"num"},{label:t("common.stock"),cls:"num"},{label:t("common.price"),cls:"num"}],(e.topSelling||[]).map(n=>r`
            <tr>
              ...
              <td class="num">${C(n.price)}</td>
            </tr>`),{emptyText:t("common.noData")})}
      </div>
      <div class="card">
        <strong>${c("box")} ${t("adm.lowStockList")}</strong>
        ${ne([{label:t("adm.pName")},{label:t("common.available"),cls:"num"},{label:""}],(e.lowStock||[]).map(n=>r`
            <tr>
    ...
    ${V("users.view")||V("settings.edit")?r`
    <div class="acc-grid acc-grid-eq mt">
      ${V("users.view")?r`
    ...
    <div class="card mt">
      ...
      ${ne([{label:t("common.date")},{label:t("adm.auditActor")},{label:t("adm.auditAction")},{label:t("adm.auditTarget")}],(e.recentAudit||[]).map(n=>r`
          <tr>
    ...
    </a>`}async function qn(){if(!document.getElementById("secLiveCard")){++En>=3&&aa&&(clearInterval(aa),aa=0);return}En=0;let a;try{a=await h.get("/api/admin/system/load")}catch{return}let s=document.getElementById("secKpis");s&&(s.innerHTML=[`<div class="kpi"><div class="l">${t("adm.secInflight")}</div><div class="v">${b(a.inflight)}</div></div>`,`<div class="kpi"><div class="l">${t("adm.secRps")}</div><div class="v">${b(a.rps)}</div></div>`,`<div class="kpi"><div class="l">${t("adm.secQueued")}</div><div class="v ${a.queued>0?"hot":""}">${b(a.queued)}</div></div>`,`<div class="kpi"><div class="l">${t("adm.secAutoBans")}</div><div class="v">${b((a.autoBans||[]).length)}</div></div>`].join(""));let n=document.getElementById("secTop");n&&(n.innerHTML=(a.top||[]).length?`<div class="muted tiny">${t("adm.secTop")}</div><div class="table-wrap"><table class="table"><thead><tr><th>IP</th><th class="num">${t("adm.secPerMin")}</th></tr></thead><tbody>${a.top.map(l=>`<tr><td class="mono tiny">${p(l.ip)}</td><td class="num tiny">${b(l.perMin)}</td></tr>`).join("")}</tbody></table></div>`:`<p class="muted tiny">${t("adm.secTopEmpty")}</p>`);let o=document.getElementById("secState");if(o){let l=a.queued>0||a.inflight>(a.sec?.maxConcurrent||80)||a.rps>(a.sec?.triggerRps||40);o.textContent=l?t("adm.secBusy"):t("adm.secNormal"),o.className=`badge-pill tiny ${l?"bp-warn":"bp-success"}`}let i=document.getElementById("secForm");if(i&&!i.dataset.filled){i.dataset.filled="1";for(let m of["maxConcurrent","triggerRps","passTtlMin","pollSec","floodBanPerMin","floodBanMin"]){let u=i.elements[m];u&&a.sec?.[m]!=null&&(u.value=a.sec[m])}let l=i.elements.queueEnabled;l&&(l.checked=!!a.sec?.queueEnabled)}}function Bl(){aa&&clearInterval(aa),En=0,setTimeout(qn,400),aa=setInterval(qn,5e3)}function Hl(){return null}var aa,En,ur=O(()=>{H();_();K();ie();z();oe();X();aa=0,En=0;g("adm-sec-save",async(e,a)=>{e.preventDefault();let s={queueEnabled:a.elements.queueEnabled?.checked??!0,maxConcurrent:Number(a.elements.maxConcurrent?.value)||80,triggerRps:Number(a.elements.triggerRps?.value)||40,passTtlMin:Number(a.elements.passTtlMin?.value)||30,pollSec:Number(a.elements.pollSec?.value)||4,floodBanPerMin:Number(a.elements.floodBanPerMin?.value)||2500,floodBanMin:Number(a.elements.floodBanMin?.value)||15};await A(a.querySelector("button[type=submit]"),async()=>{try{await h.patch("/api/admin/settings/security",{value:s}),$(t("adm.secSaved"));let n=document.getElementById("secForm");n&&delete n.dataset.filled,qn()}catch(n){y(n)}})});g("adm-sys-restart",async(e,a)=>{await ge({text:t("adm.sysRestartWarn"),danger:!0})&&await A(a,async()=>{try{await h.post("/api/admin/system/restart",{}),$(t("adm.sysRestarting")),setTimeout(()=>location.reload(),6e3)}catch(n){y(n)}})});g("adm-sys-reset",async(e,a)=>{let s=a.dataset.what;await ge({text:t(`adm.resetWarn.${s}`),danger:!0})&&await A(a,async()=>{try{await h.post("/api/admin/system/reset",{what:s}),$(t("adm.resetDone"))}catch(o){y(o)}})})});var gr={};Y(gr,{mount:()=>Wl,render:()=>Fl});async function Fl(e){let a=e.params.id;if(a==="new")return br(null);if(a){let s=null;try{s=await h.get(`/api/admin/products/${a}`)}catch(n){return F({title:n?.message||t("err.notFound")})}return br(s.product)}return Ol()}async function Ol(){let e=null;try{e=await h.get(h.url("/api/admin/products",{q:Ce.q,cat:Ce.cat,brand:Ce.brand,status:Ce.status,page:Ce.page,limit:Ce.limit}))}catch(n){return F({title:n?.message||t("err.generic")})}let a=e.items||[],s=n=>`#/admin/products?page=${n}`;return r`
    <div class="row row-between row-wrap mb">
      ...
      ${V("products.create")?r`<a class="btn btn-primary btn-sm" href="#/admin/products/new">${c("plus")} ${t("adm.productNew")}</a>`:""}
    </div>
    ...
    <form class="card mb adm-filter" data-act="adm-p-filter">
      <div class="form-grid">
        ...
        ${U({label:t("adm.pCat"),name:"cat",value:Ce.cat,options:[{value:"",label:t("common.all")},...d.categories.map(n=>({value:n.id,label:ke(n)}))]})}
        ${U({label:t("adm.pBrand"),name:"brand",value:Ce.brand,options:[{value:"",label:t("common.all")},...d.brands.map(n=>({value:n.id,label:Fe(n)}))]})}
        ${U({label:t("common.status"),name:"status",value:Ce.status,options:[{value:"",label:t("common.all")},{value:"active",label:t("common.active")},{value:"inactive",label:t("common.inactive")},{value:"low",label:t("adm.kpi.lowStock")},{value:"out",label:t("card.outOfStock")}]})}
      </div>
      <div class="row row-wrap mt-s">
    ...
    ${a.length?ne([{label:""},{label:t("adm.pName")},{label:t("adm.pCat")},{label:t("common.price"),cls:"num"},{label:t("common.stock"),cls:"num"},{label:t("pdp.sold"),cls:"num"},{label:t("common.status")},{label:t("common.actions"),cls:"num"}],a.map(n=>r`
        <tr>
          ...
          <td>
            <div class="act">
              ...
              ${V("products.delete")?r`<button class="btn btn-ghost btn-xs" data-act="adm-p-del" data-id="${n.id}" data-name="${p(n.name)}">${c("trash")}</button>`:""}
            </div>
          </td>
        </tr>`)):P({icon:"box",title:t("common.noResult"),action:V("products.create")?{href:"#/admin/products/new",label:t("adm.productNew")}:null})}

    <div class="mt" data-page="${e.page}" data-pages="${e.pages}">${rt(e.page||1,e.pages||1,s)}</div>`}function br(e){let a=!e;return be.images=[...e?.images||[]],be.specs=Object.entries(e?.specs||{}).map(([s,n])=>({key:s,value:n})),be.tags=[...e?.tags||[]],r`
    <div class="row row-between row-wrap mb">
    ...
    <form data-act="adm-p-save" data-id="${e?.id||""}">
      <div class="card">
        <div class="form-grid">
          ...
          ${U({label:t("adm.pCat"),name:"categoryId",value:e?.categoryId||"",options:d.categories.map(s=>({value:s.id,label:ke(s)}))})}
          ${U({label:t("adm.pBrand"),name:"brandId",value:e?.brandId||"",options:d.brands.map(s=>({value:s.id,label:Fe(s)}))})}
          ...
          ${U({label:t("adm.pAuth"),name:"authenticity",value:e?.authenticity||"generic",options:["original","highcopy","generic"].map(s=>({value:s,label:t(`auth.${s}`)}))})}
        </div>
        ${!a&&V("barcode.print")?r`
          <div class="row row-wrap mt-s">
      ...
      <div class="card mt">
        <div class="row row-between row-wrap">
          ...
          <div class="row row-wrap">
            ${V("products.create")?r`<button type="button" class="btn btn-ghost btn-sm" data-act="adm-p-find" data-name="${p(e?.nameEn||e?.name||"")}">${c("search")} ${t("adm.pFindImage")}</button>`:""}
...
`),rows:2,hint:t("adm.pVideosHint")})}
      ...
      <div class="card mt">
        ...
        <div class="mt-s" data-spec-list>${Tn()}</div>
      </div>

      <div class="card mt">
        <strong>${c("tag")} ${t("adm.pTags")}</strong>
        <div class="mt-s" data-tag-list>${Cn()}</div>
        <div class="row mt-s">
    ...
    </span>`).join(""):r`<p class="muted small">${t("adm.pFindEmpty")}</p>`}function Tn(){return be.specs.length?be.specs.map((e,a)=>r`
    <div class="spec-row">
    ...
    </div>`).join(""):r`<p class="muted small">${t("common.empty")}</p>`}function Cn(){return be.tags.length?r`<div class="row row-wrap">${be.tags.map((e,a)=>r`
    <span class="chip">${p(e)}<button type="button" data-act="adm-tag-del" data-i="${a}" aria-label="${t("common.delete")}">${c("close")}</button></span>`)}</div>`:r`<p class="muted small">${t("common.empty")}</p>`}function Et(e,a,s){let n=(e||document).querySelector(a);n&&(n.innerHTML=s),L(n||document)}function jl(e){let a=ze(),s=k()?e.name:e.nameEn||e.name,n=f=>Number(f||0).toLocaleString(k()?"fa-IR":"en-US"),o=Number(e.oldPrice||0),i=Math.max(0,(e.stock||0)-(e.reserved||0)),l=`${location.origin}/#/product/${e.id}`,m=String(k()?e.description||"":e.descriptionEn||e.description||"").split(`
`)[0].trim().slice(0,160);return(k()?[`\u2728 ${s} \u2728`,m,"",`\u{1F4B0} \u0642\u06CC\u0645\u062A: ${n(e.price)} \u062A\u0648\u0645\u0627\u0646${o>e.price?` (\u0628\u0647\u200C\u062C\u0627\u06CC ${n(o)} \u2014 ${b(e.discountPct||0)}\u066A \u062A\u062E\u0641\u06CC\u0641)`:""}`,i>0?"\u{1F4E6} \u0645\u0648\u062C\u0648\u062F \u062F\u0631 \u0627\u0646\u0628\u0627\u0631 \u2014 \u0647\u0645\u06CC\u0646 \u062D\u0627\u0644\u0627 \u0633\u0641\u0627\u0631\u0634 \u0628\u062F\u0647":"\u{1F4E6} \u0641\u0639\u0644\u0627\u064B \u0646\u0627\u0645\u0648\u062C\u0648\u062F\u061B \u067E\u06CC\u0627\u0645 \u0628\u062F\u0647 \u062A\u0627 \u0645\u0648\u062C\u0648\u062F \u0634\u062F \u062E\u0628\u0631\u062A \u06A9\u0646\u06CC\u0645","\u{1F6E1} \u0636\u0645\u0627\u0646\u062A \u0627\u0635\u0627\u0644\u062A \u06A9\u0627\u0644\u0627 + \u0645\u0647\u0644\u062A \u062A\u0633\u062A \u0648 \u0645\u0631\u062C\u0648\u0639 \u062A\u0627 \u06F7 \u0631\u0648\u0632","\u{1F69A} \u0627\u0631\u0633\u0627\u0644 \u0627\u0632 \u0628\u0646\u062F\u0631 \u0628\u0648\u0634\u0647\u0631 \u0628\u0647 \u0633\u0631\u0627\u0633\u0631 \u0627\u06CC\u0631\u0627\u0646","",`\u{1F517} \u0633\u0641\u0627\u0631\u0634 \u0622\u0646\u0644\u0627\u06CC\u0646: ${l}`,`\u{1F4DE} \u062A\u0644\u0641\u0646: ${a.phone||""} \xB7 \u{1F34F} \u0627\u06CC\u0646\u0633\u062A\u0627\u06AF\u0631\u0627\u0645: @jam.greenapple`]:[`\u2728 ${s} \u2728`,m,"",`\u{1F4B0} Price: ${n(e.price)} Toman${o>e.price?` (was ${n(o)})`:""}`,"\u{1F6E1} Authenticity guarantee + 7-day return",`\u{1F517} Order: ${l}`,`\u{1F4DE} ${a.phone||""}`]).filter((f,v,x)=>!(f===""&&(x[v-1]===""||v===0))).join(`
`)}function Ul(e){let a=k()?["\u06AF\u0631\u06CC\u0646_\u0627\u067E\u0644","\u0644\u0648\u0627\u0632\u0645_\u062C\u0627\u0646\u0628\u06CC_\u0645\u0648\u0628\u0627\u06CC\u0644","\u06AF\u062C\u062A","\u0628\u0648\u0634\u0647\u0631","\u062C\u0645","\u062E\u0631\u06CC\u062F_\u0622\u0646\u0644\u0627\u06CC\u0646"]:["GreenApple","MobileAccessories","Gadget","Bushehr","OnlineShopping"],s=[e.brandName,e.categoryName].filter(Boolean).map(n=>String(n).trim().replace(/\s+/g,"_"));return[...new Set([...a,...s])].map(n=>`#${n}`).join(" ")}async function hr(e,a,s){e&&(e.innerHTML=ya(t("adm.pFindSearching")));try{let o=(await h.post("/api/admin/find-image",{query:a,lang:s})).items||[];e&&(e.innerHTML=o.length?r`<div class="find-grid">${o.map((i,l)=>r`
        <div class="find-item">
        ...
        </div>`).join("")}</div>`:P({icon:"image",title:t("adm.pFindEmpty")}))}catch(n){e&&(e.innerHTML=r`<p class="notice notice-danger">${c("alert")}<span>${p(n?.message||t("err.network"))}</span></p>`)}}function Wl(e){L(e);let a=e.querySelector("[data-img-input]");a&&a.addEventListener("change",async()=>{let n=[...a.files||[]].slice(0,8-be.images.length);a.value="";for(let o of n){if(o.size>4*1024*1024){re(`${t("err.tooLarge")}: ${o.name}`,{type:"warn"});continue}try{let i=await At(o),l=await h.upload(i);l.url&&be.images.push(l.url)}catch(i){y(i)}}Et(e,"[data-img-list]",Ta())});let s=e.querySelector("[data-tag-input]");return s&&s.addEventListener("keydown",n=>{n.key==="Enter"&&(n.preventDefault(),document.querySelector('[data-act="adm-p-tag-add"]')?.click())}),e.querySelectorAll(".pagination .pg").forEach(n=>{n.addEventListener("click",o=>{let i=/page=(\d+)/.exec(n.getAttribute("href")||"");if(!i)return;o.preventDefault();let l=Number(i[1]);l>=1&&(Ce.page=l,T(!0))})}),null}var Ce,be,fr=O(()=>{H();_();K();z();oe();X();ie();ee();Ce={q:"",cat:"",brand:"",status:"",page:1,limit:25},be={images:[],specs:[],tags:[]};g("adm-p-filter",(e,a)=>{e.preventDefault();let s=new FormData(a);Ce.q=String(s.get("q")||"").trim(),Ce.cat=String(s.get("cat")||""),Ce.brand=String(s.get("brand")||""),Ce.status=String(s.get("status")||""),Ce.page=1,T(!0)});g("adm-p-clear",()=>{Object.assign(Ce,{q:"",cat:"",brand:"",status:"",page:1}),T(!0)});g("adm-p-del",async(e,a)=>{if(await Oe(a.dataset.name))try{await h.del(`/api/admin/products/${a.dataset.id}`),$(t("adm.pDeleted")),T(!0)}catch(n){y(n)}});g("adm-img-del",(e,a)=>{be.images.splice(Number(a.dataset.i),1),Et(null,"[data-img-list]",Ta())});g("adm-img-up",(e,a)=>{let s=Number(a.dataset.i),[n]=be.images.splice(s,1);be.images.splice(s-1,0,n),Et(null,"[data-img-list]",Ta())});g("adm-p-spec-add",()=>{be.specs.push({key:"",value:""}),Et(null,"[data-spec-list]",Tn())});g("adm-spec-del",(e,a)=>{be.specs.splice(Number(a.dataset.i),1),Et(null,"[data-spec-list]",Tn())});g("adm-p-tag-add",()=>{let e=document.querySelector("[data-tag-input]"),a=String(e?.value||"").trim();a&&(!be.tags.includes(a)&&be.tags.length<20&&be.tags.push(a),e&&(e.value=""),Et(null,"[data-tag-list]",Cn()))});g("adm-tag-del",(e,a)=>{be.tags.splice(Number(a.dataset.i),1),Et(null,"[data-tag-list]",Cn())});g("adm-p-barcode",async(e,a)=>{await A(a,async()=>{try{let s=await h.post("/api/admin/barcode/generate",{productId:a.dataset.id,count:1}),n=s.codes?.[0]?.barcode||s.codes?.[0]||"";if(n){let o=document.querySelector("[name=barcode]");o&&(o.value=n),$(t("adm.bGenerated"))}}catch(s){y(s)}})});g("adm-p-igpack",async(e,a)=>{let s=null;try{s=(await h.get(`/api/admin/products/${a.dataset.id}`)).product}catch(o){y(o);return}let n=(s.images||[])[0]||"";ce({title:`${c("camera")} ${t("adm.igPack")}`,subtitle:k()?s.name:s.nameEn||s.name,body:r`
      ${n?r`
        <div class="row row-wrap mb">
          <img class="igpack-img" src="${p(n)}" alt="">
          <div class="grow">
            <p class="small muted">${t("adm.igImgHint")}</p>
            <a class="btn btn-ghost btn-sm mt-s" href="${p(n)}" download="greenapple-${p(s.sku||s.id)}.jpg" target="_blank" rel="noopener">${c("download")} ${t("adm.igDl")}</a>
          </div>
...
${o}`:n;try{await Ls(i),$(t("common.copied"),{timeout:1800})}catch{y(new Error(t("err.generic")))}});g("adm-p-save",async(e,a)=>{e.preventDefault();let s=new FormData(a),n={};a.querySelectorAll("[data-spec-k]").forEach(l=>{let m=l.dataset.specK,u=a.querySelector(`[data-spec-v="${m}"]`),f=String(l.value||"").trim();f&&(n[f]=String(u?.value||"").trim())});let o=a.dataset.id,i={name:s.get("name"),nameEn:s.get("nameEn")||"",categoryId:s.get("categoryId")||"",brandId:s.get("brandId")||"",sku:s.get("sku")||"",barcode:s.get("barcode")||"",price:Number(s.get("price")||0),oldPrice:Number(s.get("oldPrice")||0),cost:Number(s.get("cost")||0),stock:Number(s.get("stock")||0),weight:Number(s.get("weight")||0),warrantyMonths:Number(s.get("warrantyMonths")||0),authenticity:s.get("authenticity")||"generic",description:s.get("description")||"",descriptionEn:s.get("descriptionEn")||"",images:be.images.slice(0,8),videos:String(a.videos?.value||"").split(/\n+/).map(l=>l.trim()).filter(Boolean).slice(0,4),specs:n,tags:be.tags.slice(0,20),featured:s.get("featured")==="on",active:s.get("active")==="on"};await A(a.querySelector("button[type=submit]"),async()=>{try{if(o)await h.patch(`/api/admin/products/${o}`,i),$(t("adm.pSaved"));else{let l=await h.post("/api/admin/products",i);if($(t("adm.pCreated")),l.product?.id){le(`#/admin/products/${l.product.id}`);return}}T(!0)}catch(l){y(l)}})});g("adm-p-find",(e,a)=>{let s=ce({title:t("adm.pFindImage"),size:"lg",body:r`
      ...
      <div data-find-results>${ya(t("adm.pFindSearching"))}</div>`,onMount:n=>{n.querySelector("[name=query]")?.focus(),n.dataset.findBox="1";let o=a.dataset.name||"";o&&hr(n.querySelector("[data-find-results]"),o,"en")}})});g("adm-find-run",(e,a)=>{e.preventDefault();let s=new FormData(a),n=a.closest(".modal");hr(n?.querySelector("[data-find-results]"),String(s.get("query")||""),String(s.get("lang")||"en"))});g("adm-find-use",async(e,a)=>{await A(a,async()=>{try{let s=await h.post("/api/admin/fetch-image",{url:a.dataset.url});s.url&&!be.images.includes(s.url)&&be.images.length<8&&be.images.push(s.url),Et(null,"[data-img-list]",Ta()),$(t("adm.pSaved")),a.closest(".overlay")?.querySelector("[data-lx]")?.click()}catch(s){y(s)}})})});var $r={};Y($r,{mount:()=>Vl,render:()=>_l});async function _l(){let e=null;try{e=await h.get("/api/admin/categories")}catch(a){return F({title:a?.message||t("err.generic")})}return Ft=e.items||[],ls=e.brands||[],r`
    <div class="row row-between row-wrap mb">
    ...
    <div class="card">
      ...
      ${ne([{label:t("adm.catGlyph")},{label:t("adm.catName")},{label:t("adm.catParent")},{label:t("adm.catOrder"),cls:"num"},{label:t("common.count"),cls:"num"},{label:t("common.status")},{label:"",cls:"num"}],Ft.map(a=>r`
          <tr>
    ...
    <div class="card mt">
      ...
      ${ne([{label:t("adm.brandName")},{label:t("adm.brandNameEn")},{label:t("common.count"),cls:"num"},{label:t("common.status")},{label:"",cls:"num"}],ls.map(a=>r`
          <tr>
    ...
    </div>`}function vr(e){return ce({title:e?t("common.edit"):t("common.add"),body:r`
      <form class="form-grid" data-act="adm-cat-save" data-id="${e?.id||""}" data-isnew="${e?"":"1"}">
        ...
        ${U({label:t("adm.catGlyph"),name:"glyph",value:e?.glyph||"box",options:zl.map(a=>({value:a,label:a}))})}
        ${U({label:t("adm.catParent"),name:"parentId",value:e?.parentId||"",options:[{value:"",label:t("adm.catNoParent")},...Ft.filter(a=>a.id!==e?.id).map(a=>({value:a.id,label:a.name}))]})}
        ...
        <div class="span-2">${G({label:An("\u062A\u0648\u0636\u06CC\u062D\u0627\u062A \u0627\u0646\u06AF\u0644\u06CC\u0633\u06CC","Description (EN)"),name:"descriptionEn",value:e?.descriptionEn||"",rows:2})}</div>
        <div class="span-2">${he({label:t("common.active"),name:"active",checked:e?e.active!==!1:!0})}</div>
        <button class="btn btn-primary span-2" type="submit">${t("common.save")}</button>
      </form>`})}function yr(e){return ce({title:e?t("common.edit"):t("common.add"),size:"sm",body:r`
      <form data-act="adm-brand-save" data-id="${e?.id||""}" data-isnew="${e?"":"1"}">
        ${e?"":S({label:"id",name:"id",hint:An("\u062E\u0627\u0644\u06CC \u0628\u06AF\u0630\u0627\u0631\u06CC \u062E\u0648\u062F\u06A9\u0627\u0631 \u0633\u0627\u062E\u062A\u0647 \u0645\u06CC\u200C\u0634\u0648\u062F","Auto if empty")})}
        ${S({label:t("adm.brandName"),name:"name",required:!0,value:e?.name||""})}
        ${S({label:t("adm.brandNameEn"),name:"nameEn",value:e?.nameEn||""})}
        ${S({label:An("\u06A9\u0634\u0648\u0631","Country"),name:"country",value:e?.country||""})}
      ...
      </form>`})}function Vl(e){return L(e),null}var Ft,ls,zl,An,Dn,Pn,wr=O(()=>{H();_();K();z();oe();X();ie();ee();Ft=[],ls=[];zl=["box","cable","plug","battery","speaker","watch","glasses","mic","camera","phone","card","zap","image","headset","anchor","palm","wave","globe","layers","tag"];An=(e,a)=>k()?e:a,Dn=null;g("adm-cat-new",()=>{Dn=vr(null)});g("adm-cat-edit",(e,a)=>{Dn=vr(Ft.find(s=>s.id===a.dataset.id))});g("adm-cat-del",async(e,a)=>{if(await Oe(a.dataset.name))try{await h.del(`/api/admin/categories/${a.dataset.id}`),$(t("misc.deleted")),await Ne({silent:!0}),T(!0)}catch(s){y(s)}});g("adm-cat-save",async(e,a)=>{e.preventDefault();let s=new FormData(a),n=a.dataset.isnew==="1",o={name:s.get("name"),nameEn:s.get("nameEn")||"",glyph:s.get("glyph")||"box",parentId:s.get("parentId")||"",order:Number(s.get("order")||0),description:s.get("description")||"",descriptionEn:s.get("descriptionEn")||"",active:s.get("active")==="on"};n&&s.get("id")&&(o.id=s.get("id")),await A(a.querySelector("button[type=submit]"),async()=>{try{n?await h.post("/api/admin/categories",o):await h.patch(`/api/admin/categories/${a.dataset.id}`,o),$(t("misc.saved")),Dn?.close(),await Ne({silent:!0}),T(!0)}catch(i){y(i)}})});Pn=null;g("adm-brand-new",()=>{Pn=yr(null)});g("adm-brand-edit",(e,a)=>{Pn=yr(ls.find(s=>s.id===a.dataset.id))});g("adm-brand-del",async(e,a)=>{if(await Oe(a.dataset.name))try{await h.del(`/api/admin/brands/${a.dataset.id}`),$(t("misc.deleted")),await Ne({silent:!0}),T(!0)}catch(s){y(s)}});g("adm-brand-save",async(e,a)=>{e.preventDefault();let s=new FormData(a),n=a.dataset.isnew==="1",o={name:s.get("name"),nameEn:s.get("nameEn")||"",country:s.get("country")||"",active:s.get("active")==="on"};n&&s.get("id")&&(o.id=s.get("id")),await A(a.querySelector("button[type=submit]"),async()=>{try{n?await h.post("/api/admin/brands",o):await h.patch(`/api/admin/brands/${a.dataset.id}`,o),$(t("misc.saved")),Pn?.close(),await Ne({silent:!0}),T(!0)}catch(i){y(i)}})})});var xr={};Y(xr,{mount:()=>Ql,render:()=>Gl});async function Gl(e){return e.params.id?Kl(e.params.id):Yl()}async function Yl(){let e=null;try{e=await h.get(h.url("/api/admin/orders",{q:Re.q,status:Re.status,delivery:Re.delivery,page:Re.page,limit:Re.limit}))}catch(s){return F({title:s?.message||t("err.generic")})}kr=e.statuses||[];let a=e.items||[];return r`
    <div class="row row-between row-wrap mb">
      <div>
    ...
    <form class="card mb adm-filter" data-act="adm-o-filter">
      <div class="form-grid">
        ...
        ${U({label:t("common.status"),name:"status",value:Re.status,options:[{value:"",label:t("common.all")},...kr.map(s=>({value:s.id,label:t(`st.${s.id}`)}))]})}
        ${U({label:t("adm.oDelivery"),name:"delivery",value:Re.delivery,options:[{value:"",label:t("common.all")},{value:"pickup",label:t("dl.pickup")},{value:"courier",label:t("dl.courier")}]})}
      </div>
      <div class="row row-wrap mt-s">
        <button class="btn btn-primary btn-sm" type="submit">${c("filter")} ${t("common.apply")}</button>
    ...
    ${a.length?ne([{label:t("acc.orderCode")},{label:t("adm.oCustomer")},{label:t("common.date")},{label:t("adm.oDelivery")},{label:t("common.total"),cls:"num"},{label:t("adm.oPayment")},{label:t("common.status")},{label:"",cls:"num"}],a.map(s=>r`
        <tr>
          <td class="mono b nowrap">${s.code}</td>
          <td class="nowrap">${p(s.userName||"")}<div class="tiny muted mono">${se(s.userPhone||"")}</div></td>
    ...
    <div class="cart-grid">
      <div class="col">
        <div class="card">
          <div class="row row-between row-wrap">
            <div>
              ...
              <p class="muted small">${B(e.createdAt)} · ${p(e.userName||"")} · <span class="mono">${se(e.userPhone||"")}</span></p>
            </div>
            <div class="row row-wrap">${bt(e.status)}${Rt(e.payment)}</div>
          </div>
          ${s?r`
            <form class="form-grid mt" data-act="adm-o-save" data-id="${e.id}">
              ${U({label:t("adm.oStatus"),name:"status",value:e.status,options:(a.length?a:[]).map(n=>({value:n.id,label:t(`st.${n.id}`)}))})}
        ...
        <div class="card mt">
          ...
          ${ne([{label:""},{label:t("common.product")},{label:t("common.price"),cls:"num"},{label:t("common.count"),cls:"num"},{label:t("common.total"),cls:"num"}],(e.items||[]).map(n=>r`
              <tr>
                ...
                <td class="num b">${C(n.price*n.qty)}</td>
              </tr>`))}
        </div>
      ...
      <aside class="col">
        <div class="card summary">
          <strong>${t("cart.summary")}</strong>
          <div class="sum-row"><span>${t("common.subtotal")}</span><span class="v">${C(e.subtotal)}</span></div>
          ${e.plusDiscount>0?r`<div class="sum-row discount"><span>${t("acc.plus")}</span><span class="v">−${C(e.plusDiscount)}</span></div>`:""}
          ${e.couponDiscount>0?r`<div class="sum-row discount"><span>${e.couponCode}</span><span class="v">−${C(e.couponDiscount)}</span></div>`:""}
          <div class="sum-row"><span>${t("common.shipping")}${e.shippingLabel?r` <span class="muted tiny">(${p(e.shippingLabel)})</span>`:""}</span><span class="v">${C(e.shipping)}</span></div>
          ${e.insured?r`<div class="sum-row"><span>${t("common.insurance")}</span><span class="v">${C(e.insuranceFee)}</span></div>`:""}
          <div class="sum-row"><span>${t("common.total")}</span><span class="v">${C(e.total)}</span></div>
          ${e.walletUsed>0?r`<div class="sum-row discount"><span>${t("common.wallet")}</span><span class="v">−${C(e.walletUsed)}</span></div>`:""}
          <div class="sum-row total"><span>${t("common.payable")}</span><span class="v">${C(e.payable)}</span></div>
          <p class="hint mt-s">${t("adm.oPayment")}: ${t(`pm.${e.payment?.method||"cod"}`)}${e.payment?.ref?` \xB7 ${p(e.payment.ref)}`:""}</p>
          ${e.refund?r`<p class="notice notice-success mt-s">${c("wallet")}<span>${C(e.refund.amount)} — ${B(e.refund.at)}</span></p>`:""}
        </div>

        <div class="card mt">
          <strong>${c("truck")} ${t(e.delivery==="pickup"?"dl.pickup":"dl.courier")}</strong>
          ${e.address?r`
            <p class="small mt-s"><strong>${p(e.address.receiver||"")}</strong> · <span class="mono">${se(e.address.phone||"")}</span></p>
    ...
    </div>`}function Ql(e){return L(e),e.querySelectorAll(".pagination .pg").forEach(a=>{a.addEventListener("click",s=>{let n=/page=(\d+)/.exec(a.getAttribute("href")||"");n&&(s.preventDefault(),Re.page=Number(n[1]),T(!0))})}),null}var Re,kr,Er=O(()=>{H();_();K();z();oe();X();ie();ee();Re={q:"",status:"",delivery:"",page:1,limit:25},kr=[];g("adm-o-filter",(e,a)=>{e.preventDefault();let s=new FormData(a);Re.q=String(s.get("q")||"").trim(),Re.status=String(s.get("status")||""),Re.delivery=String(s.get("delivery")||""),Re.page=1,T(!0)});g("adm-o-clear",()=>{Object.assign(Re,{q:"",status:"",delivery:"",page:1}),T(!0)});g("adm-o-save",async(e,a)=>{e.preventDefault();let s=new FormData(a);await A(a.querySelector("button[type=submit]"),async()=>{try{await h.patch(`/api/admin/orders/${a.dataset.id}`,{status:s.get("status"),tracking:s.get("tracking")||"",note:s.get("note")||""}),$(t("adm.oSaved")),T(!0)}catch(n){y(n)}})})});var qr={};Y(qr,{mount:()=>ed,render:()=>Jl});async function Jl(){let e=null;try{e=await h.get(h.url("/api/admin/reviews",{status:Ye.status,type:Ye.type}))}catch(n){return F({title:n?.message||t("err.generic")})}ds=e.items||[],sa=e.counts||sa;let a=Math.max(1,Math.ceil(ds.length/Mn));Ye.page>a&&(Ye.page=a);let s=ds.slice((Ye.page-1)*Mn,Ye.page*Mn);return r`
    <div class="row row-between row-wrap mb">
    ...
    <form class="card mb adm-filter" data-act="adm-rev-filter">
      <div class="form-grid">
        ${U({label:t("common.status"),name:"status",value:Ye.status,options:[{value:"pending",label:`${t("adm.revPending")} (${b(sa.pending||0)})`},{value:"approved",label:t("adm.revApproved")},{value:"rejected",label:t("adm.revRejected")},{value:"",label:t("common.all")}]})}
        ${U({label:t("common.type"),name:"type",value:Ye.type,options:[{value:"",label:t("common.all")},{value:"review",label:t("common.review")},{value:"question",label:t("common.question")}]})}
      </div>
      <div class="row row-wrap mt-s">
        <button class="btn btn-primary btn-sm" type="submit">${c("filter")} ${t("common.apply")}</button>
      </div>
    ...
    ${s.length?r`
      ...
      ${a>1?rt(Ye.page,a,n=>`#/admin/reviews?p=${n}`):""}
    `:P({icon:"star",title:t("adm.revEmpty"),text:t("adm.revEmptyHint")})}`}function Xl(e){let a=e.type==="question";return r`
    <article class="card rev-card" data-id="${e.id}">
      ...
      <div class="row row-wrap mt-s">
        ...
        ${V("reviews.reply")?r`<button class="btn btn-ghost btn-xs" data-act="adm-rev-reply" data-id="${e.id}">${c("send")} ${t("adm.revReply")}</button>`:""}
    ...
    </article>`}function Zl(e){let a={pending:["bp-warn",t("adm.revPending")],approved:["bp-success",t("adm.revApproved")],rejected:["bp-danger",t("adm.revRejected")]},[s,n]=a[e]||["bp-muted",e];return r`<span class="badge-pill ${s}">${n}</span>`}function ed(e){return L(e),null}var Ye,Mn,ds,sa,Tr=O(()=>{H();_();K();z();oe();X();ie();ee();Ye={status:"pending",type:"",page:1},Mn=12,ds=[],sa={pending:0,approved:0,rejected:0};g("adm-rev-filter",(e,a)=>{e.preventDefault();let s=new FormData(a);Ye.status=String(s.get("status")||""),Ye.type=String(s.get("type")||""),Ye.page=1,T(!0)});g("adm-rev-status",async(e,a)=>{try{await h.patch(`/api/admin/reviews/${a.dataset.id}`,{status:a.dataset.status}),$(t("misc.saved")),T(!0)}catch(s){y(s)}});g("adm-rev-reply",async(e,a)=>{let s=ds.find(o=>o.id===a.dataset.id),n=await ot({title:t("adm.revReply"),text:s?.body?.slice(0,140)||"",label:t("rev.shopReply"),value:s?.reply||"",rows:4});if(n!==null)try{await h.patch(`/api/admin/reviews/${a.dataset.id}`,{reply:String(n)}),$(t("misc.saved")),T(!0)}catch(o){y(o)}});g("adm-rev-del",async(e,a)=>{if(await Oe(a.dataset.name||a.dataset.id))try{await h.del(`/api/admin/reviews/${a.dataset.id}`),$(t("misc.deleted")),T(!0)}catch(s){y(s)}})});var In={};Y(In,{mount:()=>od,render:()=>td});async function td(e){return e.params.section==="support"?nd(e.params.id):e.params.id?sd(e.params.id):ad()}async function ad(){let e=null;try{e=await h.get(h.url("/api/admin/tickets",{status:Ln.status}))}catch(n){return F({title:n?.message||t("err.generic")})}let a=e.items||[],s=e.counts||{};return r`
    <div class="row row-between row-wrap mb">
      <div>
      ...
      <form class="row" data-act="adm-tk-filter" data-live>
        ${U({label:t("common.status"),name:"status",value:Ln.status,options:[{value:"",label:t("common.all")},{value:"open",label:t("tk.open")},{value:"answered",label:t("tk.answered")},{value:"closed",label:t("tk.closed")}]})}
      </form>
    </div>

    ${ne([{label:t("acc.ticketSubject")},{label:t("acc.ticketCategory")},{label:t("common.priority")},{label:t("common.user")},{label:t("common.messages"),cls:"num"},{label:t("common.status")},{label:t("common.updated"),cls:"num"},{label:"",cls:"num"}],a.map(n=>r`
        <tr class="${n.unread?"row-new":""}">
          ...
          <td><span class="badge-pill ${Ar[n.priority]||"bp-info"}">${t(`tp.${n.priority}`)}</span></td>
          <td class="tiny">${p(n.userName||"")}<div class="tiny muted mono">${se(n.userPhone||"")}</div></td>
          <td class="num">${b(n.messageCount||0)}</td>
          <td><span class="badge-pill ${Cr[n.status]||"bp-muted"}">${t(`tk.${n.status}`)}</span></td>
        ...
        </tr>`),{emptyText:t("acc.noTickets")})}`}async function sd(e){let a=null;try{a=(await h.get(`/api/admin/tickets/${e}`)).ticket}catch(n){return n?.status===404?P({icon:"ticket",title:t("acc.noTickets"),action:{href:"#/admin/tickets",label:t("adm.tickets")}}):F({title:n?.message||t("err.generic")})}let s=a.user;return r`
    <div class="breadcrumb mb-s">
    ...
    <div class="cart-grid">
      <div class="col">
        <div class="card">
          <div class="row row-between row-wrap">
            ...
            <div class="row row-wrap">
              <span class="badge-pill ${Cr[a.status]||"bp-muted"}">${t(`tk.${a.status}`)}</span>
              <span class="badge-pill ${Ar[a.priority]||"bp-info"}">${t(`tp.${a.priority}`)}</span>
            </div>
          </div>
        </div>
      ...
      <aside class="col">
        <div class="card">
          ...
          <div class="mt-s">
            <div class="sum-row"><span>${t("common.phone")}</span><span class="v mono">${se(s?.phone||a.userPhone||"")}</span></div>
    ...
    </div>`}function Nn(e){let a=e.from==="staff",s=e.from==="system"?"them sys":a?"me":"them",n=a?e.staffName?`${t("common.support")} \xB7 ${e.staffName}`:t("common.support"):e.name||t("common.user");return r`
    <div class="msg ${s}">
      <div class="msg-bubble">
        <div class="row row-between">
    ...
    </div>`}async function nd(e){let a=null;try{a=await h.get("/api/admin/support")}catch(n){return F({title:n?.message||t("err.generic")})}na=a.items||[];let s=na.find(n=>n.userId===e)||null;return r`
    <div class="row row-between row-wrap mb">
    ...
    <div class="sup-grid">
      ...
      <div class="card sup-chat">
        ...
        `:P({icon:"chat",title:t("adm.supSelect"),text:t("adm.supSelectHint")})}
      </div>
    </div>`}function od(e,a){if(L(e),a?.params?.section==="support"&&a.params.id){let s=e.querySelector("[data-thread]");s&&(s.scrollTop=s.scrollHeight)}return null}var tt,Cr,Ar,Ln,na,Rn=O(()=>{H();_();K();z();oe();X();ie();ee();tt=(e,a)=>k()?e:a,Cr={open:"bp-warn",answered:"bp-success",closed:"bp-muted"},Ar={critical:"bp-danger",high:"bp-warn",normal:"bp-info",low:"bp-muted"},Ln={status:""};g("adm-tk-filter",(e,a)=>{e.preventDefault(),Ln.status=String(new FormData(a).get("status")||""),T(!0)});g("adm-att-open",(e,a)=>{e.preventDefault(),Mt([a.dataset.url],0,t("common.image"))});g("adm-tk-reply",async(e,a)=>{e.preventDefault();let s=new FormData(a),n=String(s.get("body")||"").trim();n.length<1||await A(a.querySelector("button[type=submit]"),async()=>{try{await h.patch(`/api/admin/tickets/${a.dataset.id}`,{body:n,status:s.get("status")||"answered"}),$(t("misc.sent")),T(!0)}catch(o){y(o)}})});g("adm-tk-meta",async(e,a)=>{e.preventDefault();try{await h.patch(`/api/admin/tickets/${a.dataset.id}`,{priority:new FormData(a).get("priority")}),$(t("misc.saved")),T(!0)}catch(s){y(s)}});g("adm-tk-status",async(e,a)=>{try{await h.patch(`/api/admin/tickets/${a.dataset.id}`,{status:a.dataset.status}),$(t("misc.saved")),T(!0)}catch(s){y(s)}});na=[];g("adm-sup-send",async(e,a)=>{e.preventDefault();let s=a.querySelector("[name=body]"),n=String(s.value||"").trim();if(n){s.value="";try{await h.post(`/api/admin/support/${a.dataset.id}`,{body:n});let o=a.closest(".sup-chat")?.querySelector("[data-thread]");if(o){let l=document.createElement("div");l.innerHTML=Nn({from:"staff",staffName:d.me?.name||"",body:n,at:new Date().toISOString()}).trim(),l.firstElementChild&&o.appendChild(l.firstElementChild),o.scrollTop=o.scrollHeight}let i=na.find(l=>l.userId===a.dataset.id);i&&(i.last={body:n,at:new Date().toISOString(),from:"staff"},i.unread=0),$(t("misc.sent"))}catch(o){y(o),s.value=n}}})});var Dr={};Y(Dr,{mount:()=>ld,render:()=>cd});async function cd(){let e=null;try{e=await h.get(h.url("/api/admin/feedback",{type:Ot.type}))}catch(s){return F({title:s?.message||t("err.generic")})}let a=e.items||[];return Ot.status&&(a=a.filter(s=>s.status===Ot.status)),r`
    <div class="row row-between row-wrap mb">
      <div>
    ...
    <form class="card mb adm-filter" data-act="adm-fb-filter">
      <div class="form-grid">
        ${U({label:t("common.type"),name:"type",value:Ot.type,options:[{value:"",label:t("common.all")},{value:"suggestion",label:t("feedback.suggestion")},{value:"complaint",label:t("feedback.complaint")},{value:"bug",label:t("feedback.bug")}]})}
        ${U({label:t("common.status"),name:"status",value:Ot.status,options:[{value:"",label:t("common.all")},...Object.entries(Bn).map(([s,[,n]])=>({value:s,label:n()}))]})}
      </div>
      <div class="row row-wrap mt-s">
        <button class="btn btn-primary btn-sm" type="submit">${c("filter")} ${t("common.apply")}</button>
      </div>
    ...
    ${a.length?r`<div class="rev-list">${a.map(id).join("")}</div>`:P({icon:"mail",title:t("common.noData"),text:t("adm.fbEmptyHint")})}`}function id(e){let a=rd[e.type]||{icon:"mail",cls:"bp-muted"},[s,n]=Bn[e.status]||["bp-muted",()=>e.status];return r`
    ...
    </article>`}function ld(e){return L(e),null}var oa,Ot,rd,Bn,Pr=O(()=>{H();_();K();oe();X();ie();ee();oa=(e,a)=>k()?e:a,Ot={type:"",status:""},rd={suggestion:{icon:"sparkles",cls:"bp-info"},complaint:{icon:"flag",cls:"bp-warn"},bug:{icon:"bug",cls:"bp-danger"}},Bn={new:["bp-info",()=>t("fb.new")],seen:["bp-muted",()=>t("fb.seen")],in_progress:["bp-warn",()=>t("fb.inProgress")],done:["bp-success",()=>t("fb.done")],rejected:["bp-danger",()=>t("fb.rejected")]};g("adm-fb-filter",(e,a)=>{e.preventDefault();let s=new FormData(a);Ot.type=String(s.get("type")||""),Ot.status=String(s.get("status")||""),T(!0)});g("adm-fb-save",async(e,a)=>{e.preventDefault();let s=new FormData(a);await A(a.querySelector("button[type=submit]"),async()=>{try{await h.patch(`/api/admin/feedback/${a.dataset.id}`,{status:s.get("status"),answer:String(s.get("answer")||"")}),$(t("misc.saved")),T(!0)}catch(n){y(n)}})})});var Rr={};Y(Rr,{mount:()=>ud,render:()=>dd});async function dd(e){return e.params.id?pd(e.params.id):md()}async function Lr(){let e=await h.get(h.url("/api/admin/users",{q:qt.q,role:qt.role}));return gt=e.items||[],Mr=e.permissions||[],e}async function md(){let e=await bd(),a=null;try{a=await Lr()}catch(s){return F({title:s?.message||t("err.generic")})}return r`
    <div class="row row-between row-wrap mb">
      <div>
    ...
    <form class="card mb adm-filter" data-act="adm-u-filter">
      <div class="form-grid">
        ...
        ${U({label:t("adm.uRole"),name:"role",value:qt.role,options:[{value:"",label:t("common.all")},{value:"user",label:t("common.user")},{value:"staff",label:lt("\u06A9\u0627\u0631\u0645\u0646\u062F","Staff")},{value:"owner",label:lt("\u0645\u0627\u0644\u06A9","Owner")}]})}
      </div>
      <div class="row row-wrap mt-s">
        <button class="btn btn-primary btn-sm" type="submit">${c("filter")} ${t("common.apply")}</button>
    ...
    ${ne([{label:t("common.user")},{label:t("common.phone")},{label:t("adm.uRole")},{label:t("common.balance"),cls:"num"},{label:t("acc.plus"),cls:"num"},{label:t("common.orders"),cls:"num"},{label:t("adm.uDevice")},{label:t("common.status")},{label:"",cls:"num"}],gt.map(s=>r`
        <tr>
          <td>
          ...
          <td class="mono tiny nowrap">${se(s.phone||"")}${s.email?r`<div class="tiny muted">${p(s.email)}</div>`:""}</td>
          <td>${Nr(s.role)}</td>
          <td>${Ir(s.kycStatus)}</td>
          ...
          <td class="num">${b(s.orders||0)}<div class="tiny muted">${C(s.spent||0)}</div></td>
          ...
          <td><div class="row row-end">
            ${V("users.manage")?r`<button class="btn ${s.banned?"btn-success":"btn-danger"} btn-xs" data-act="adm-u-ban-toggle" data-id="${s.id}" data-val="${p(s.phone||s.username)}" data-banned="${s.banned?"1":""}" title="${s.banned?t("adm.unban"):t("adm.ban")}">${c(s.banned?"check":"lock")}</button>`:""}
            ${V("users.manage")?r`<a class="btn btn-ghost btn-xs" href="#/admin/users/${s.id}">${c("edit")}</a>`:""}
          </div></td>
        </tr>`),{emptyText:t("common.noResult")})}`}function Nr(e){let a={owner:"bp-accent",staff:"bp-info",user:"bp-muted"},s={owner:lt("\u0645\u0627\u0644\u06A9","Owner"),staff:lt("\u06A9\u0627\u0631\u0645\u0646\u062F","Staff"),user:t("common.user")}[e]||e;return r`<span class="badge-pill ${a[e]||"bp-muted"}">${s}</span>`}async function pd(e){try{gt.length||await Lr()}catch(i){return F({title:i?.message||t("err.generic")})}let a=gt.find(i=>i.id===e);if(!a)return P({icon:"user",title:t("common.noResult"),action:{href:"#/admin/users",label:t("adm.users")}});let s=a.permissions||{},n=d.me?.id===a.id,o=V("users.permissions");return r`
    <div class="breadcrumb mb-s">
    ...
    <div class="card">
      <div class="row row-between row-wrap">
        <div>
          ...
          <p class="muted small mt-s">
            ${se(a.phone||"")}${a.email?` \xB7 ${p(a.email)}`:""} ·
      ...
      <div class="stats-grid mt">
        ...
        <div class="stat-card"><span class="stat-ic">${c("card")}</span><div><div class="stat-val">${C(a.spent||0)}</div><div class="stat-lbl">${lt("\u0645\u062C\u0645\u0648\u0639 \u062E\u0631\u06CC\u062F","Total spent")}</div></div></div>
      </div>
    </div>
    ...
    ${a.kycStatus&&a.kycStatus!=="none"?r`
      <div class="card mt box pad border-warning">
        ...
        <p class="muted">وضعیت فعلی: ${Ir(a.kycStatus)}</p>
        ${a.kycDocs?r`
    ...
    <form class="card mt" data-act="adm-u-save" data-id="${a.id}">
      <div class="form-grid">
        ${U({label:t("adm.uRole"),name:"role",value:a.role,options:[{value:"user",label:t("common.user")},{value:"staff",label:lt("\u06A9\u0627\u0631\u0645\u0646\u062F","Staff")},...o&&(d.me?.role==="owner"||a.role!=="owner")?[{value:"owner",label:lt("\u0645\u0627\u0644\u06A9","Owner")}]:[]]})}
        ${U({label:t("adm.uStatus"),name:"status",value:a.status||"active",options:[{value:"active",label:t("common.active")},{value:"blocked",label:t("adm.uBlocked")}]})}
    ...
    <div class="acc-grid acc-grid-eq mt">
      ...
      <form class="card" data-act="adm-u-wallet" data-id="${a.id}">
        ...
        <p class="muted small mt-s">${t("common.balance")}: ${C(a.wallet||0)}</p>
    ...
    </div>`}function ud(e){return L(e),null}async function bd(){if(!V("users.manage"))return"";let e={items:[]};try{e=await h.get("/api/admin/bans")}catch{return""}return r`
    <div class="card mb">
      <strong>${c("lock")} ${t("adm.bans")}</strong>
      <form class="form-grid mt-s" data-act="adm-ban-add">
        ${U({label:t("adm.banType"),name:"type",options:[{value:"ip",label:"IP"},{value:"phone",label:t("contact.mobile")},{value:"email",label:t("common.email")},{value:"username",label:t("common.username")}]})}
    ...
    </div>`}function Ir(e){return e==="approved"?r`<span class="${L("badge-pill bp-success")}">تأیید شده</span>`:e==="pending"?r`<span class="${L("badge-pill bp-warning")}">در انتظار</span>`:e==="rejected"?r`<span class="${L("badge-pill bp-danger")}">رد شده</span>`:r`<span class="${L("muted")}">—</span>`}var qt,Mr,gt,lt,Br=O(()=>{H();_();K();z();oe();X();ie();ee();qt={q:"",role:""},Mr=[],gt=[];lt=(e,a)=>k()?e:a;g("adm-u-filter",(e,a)=>{e.preventDefault();let s=new FormData(a);qt.q=String(s.get("q")||"").trim(),qt.role=String(s.get("role")||""),T(!0)});g("adm-u-clear",()=>{qt.q="",qt.role="",T(!0)});g("adm-perm-all",(e,a)=>{let s=a.dataset.v==="1";a.closest("form").querySelectorAll('input[name^="perm."]').forEach(n=>{n.checked=s})});g("adm-u-save",async(e,a)=>{e.preventDefault();let s=new FormData(a),n={role:s.get("role"),status:s.get("status"),points:Number(s.get("points")||0)},o={},i=!1;a.querySelectorAll('input[name^="perm."]').forEach(l=>{o[l.name.slice(5)]=l.checked,i=!0}),i&&(n.permissions=o),await A(a.querySelector("button[type=submit]"),async()=>{try{await h.patch(`/api/admin/users/${a.dataset.id}`,n),$(t("adm.uSaved")),gt=[],T(!0)}catch(l){y(l)}})});g("adm-u-wallet",async(e,a)=>{e.preventDefault();let s=new FormData(a),n=Number(s.get("walletAdjust")||0);n&&await A(a.querySelector("button[type=submit]"),async()=>{try{await h.patch(`/api/admin/users/${a.dataset.id}`,{walletAdjust:n,walletReason:s.get("walletReason")||"\u062A\u0646\u0638\u06CC\u0645 \u062A\u0648\u0633\u0637 \u0645\u062F\u06CC\u0631"}),$(t("adm.uSaved")),gt=[],T(!0)}catch(o){y(o)}})});g("adm-u-plus",async(e,a)=>{e.preventDefault();let s=Number(new FormData(a).get("plusDays")||0);s&&await A(a.querySelector("button[type=submit]"),async()=>{try{await h.patch(`/api/admin/users/${a.dataset.id}`,{plusDays:s}),$(t("adm.uSaved")),gt=[],T(!0)}catch(n){y(n)}})});g("adm-u-plus-off",async(e,a)=>{if(await ge({text:lt("\u0627\u0634\u062A\u0631\u0627\u06A9 \u067E\u0644\u0627\u0633 \u0627\u06CC\u0646 \u06A9\u0627\u0631\u0628\u0631 \u063A\u06CC\u0631\u0641\u0639\u0627\u0644 \u0634\u0648\u062F\u061F","Disable Plus for this user?")}))try{await h.patch(`/api/admin/users/${a.dataset.id}`,{plusDays:-365}),$(t("adm.uSaved")),gt=[],T(!0)}catch(n){y(n)}});g("adm-u-pass",async(e,a)=>{e.preventDefault();let s=String(new FormData(a).get("resetPassword")||"");if(s.length<8){y({code:"weak_password",message:t("auth.passwordRules")});return}await A(a.querySelector("button[type=submit]"),async()=>{try{await h.patch(`/api/admin/users/${a.dataset.id}`,{resetPassword:s}),$(t("adm.uSaved")),a.reset()}catch(n){y(n)}})});g("adm-ban-add",async(e,a)=>{e.preventDefault();try{await h.post("/api/admin/bans",{type:a.type.value,value:a.value.value,reason:a.reason?.value||"",minutes:Number(a.minutes?.value)||0}),$(t("adm.banDone")),T(!0)}catch(s){y(s)}});g("adm-ban-del",async(e,a)=>{await A(a,async()=>{try{await h.del(`/api/admin/bans/${a.dataset.id}`),$(t("adm.unbanDone")),T(!0)}catch(s){y(s)}})});g("adm-u-ban-toggle",async(e,a)=>{if(a.dataset.banned==="1"){let i=((await h.get("/api/admin/bans")).items||[]).find(l=>l.value===String(a.dataset.val||"").toLowerCase());if(!i){toastError(t("err.generic"));return}try{await h.del(`/api/admin/bans/${i.id}`),$(t("adm.unbanDone")),T(!0)}catch(l){y(l)}return}let n=/^09\d{9}$/.test(a.dataset.val||"")?"phone":(a.dataset.val||"").includes("@")?"email":"username";try{await h.post("/api/admin/bans",{type:n,value:a.dataset.val,reason:t("adm.banByAdmin")}),$(t("adm.banDone")),T(!0)}catch(o){y(o)}})});var Ca={};Y(Ca,{mount:()=>wd,render:()=>hd});async function hd(e){let a=e.params.section;return a==="stats"?vd():a==="visitors"?kd():a==="data"?$d():gd()}async function gd(){let e=null;try{e=await h.get(h.url("/api/admin/audit",{q:Be.q,action:Be.action,page:Be.page,limit:Be.limit}))}catch(s){return F({title:s?.message||t("err.generic")})}let a=e.items||[];for(let s of a){let n=String(s.action||"").split(".")[0];n&&!Hn.includes(n)&&Hn.push(n)}return r`
    <div class="row row-between row-wrap mb">
      <div>
    ...
    <form class="card mb adm-filter" data-act="adm-aud-filter">
      <div class="form-grid">
        <label class="field"><span class="label">${t("common.search")}</span>
          <input class="input" name="q" value="${p(Be.q)}" placeholder="${Pe("\u06A9\u0627\u0631\u0628\u0631\u060C \u0631\u0648\u06CC\u062F\u0627\u062F\u060C \u0647\u062F\u0641\u2026","actor, action, target\u2026")}">
        </label>
        ${U({label:t("adm.audAction"),name:"action",value:Be.action,options:[{value:"",label:t("common.all")},...Hn.sort().map(s=>({value:s,label:s}))]})}
      </div>
      <div class="row row-wrap mt-s">
        <button class="btn btn-primary btn-sm" type="submit">${c("filter")} ${t("common.apply")}</button>
    ...
    ${ne([{label:t("common.date")},{label:t("adm.audActor")},{label:t("adm.audAction")},{label:t("adm.audTarget")},{label:t("adm.audMeta")}],a.map(s=>r`
        <tr>
    ...
    <div class="kpi-grid mb">
      ...
      ${De({icon:"wallet",label:t("adm.stRevenue"),value:C(s.revenue||0),sub:`${Pe("\u062F\u0631 \u0627\u06CC\u0646 \u0628\u0627\u0632\u0647","in range")}: ${C(u.revenue)}`})}
      ${De({icon:"users",label:t("adm.stUsers"),value:b(s.users||0),sub:`${Pe("\u0628\u0627\u0632\u062F\u06CC\u062F \u06CC\u06A9\u062A\u0627","unique visits")}: ${b(u.unique)}`})}
      ${De({icon:"box",label:t("adm.stProducts"),value:b(s.products||0),sub:`${Pe("\u0627\u0631\u0632\u0634 \u0645\u0648\u062C\u0648\u062F\u06CC","stock value")}: ${C(s.stockValue||0)}`})}
      ${De({icon:"scale",label:t("adm.stAvg"),value:C(s.avgOrder||0),sub:`${Pe("\u0645\u06CC\u0627\u0646\u06AF\u06CC\u0646 \u0633\u0628\u062F","average basket")}`})}
    ...
    <div class="cart-grid mt">
      <div class="col card">
        ...
        ${ne([{label:t("common.category")},{label:t("common.products"),cls:"num"},{label:t("pdp.sold"),cls:"num"},{label:t("common.stock"),cls:"num"},{label:t("adm.stRevenue"),cls:"num"}],n.map(([f,v])=>r`
            <tr>
              <td class="b">${p(f)}</td>
              <td class="num">${b(v.products)}</td>
              <td class="num">${b(v.sold)}</td>
              <td class="num">${b(v.stock)}</td>
              <td class="num">${C(v.revenue)}</td>
            </tr>`),{emptyText:t("common.noData")})}
      </div>
    ...
    <div class="card mt">
      ...
      ${i.length?ne([{label:k()?"\u0639\u0628\u0627\u0631\u062A \u062C\u0633\u062A\u062C\u0648 \u0634\u062F\u0647":"Query"},{label:k()?"\u062F\u0641\u0639\u0627\u062A \u062C\u0633\u062A\u062C\u0648":"Count",cls:"num"}],i.map(f=>r`
            <tr>
              <td>${p(f.q)}</td>
    ...
    </div>`}function wd(e,a){if(L(e),a?.params?.section==="audit"){let s=new URLSearchParams(location.hash.split("?")[1]||""),n=Number(s.get("p")||0);n&&n!==Be.page&&(Be.page=n,T(!0))}return null}async function kd(){let e={items:[],total:0};try{e=await h.get(h.url("/api/admin/visitors",{q:Fn.q||""}))}catch(a){return F({title:a?.message||t("err.generic")})}return r`
    <div class="row row-between row-wrap mb">
      ...
      <form class="row" data-act="adm-vis-filter">
        <input class="input" name="q" value="${p(Fn.q||"")}" placeholder="${t("common.search")}">
    ...
    <div class="card">
      ${e.items?.length?r`<div class="table-wrap"><table class="table">
        ...
        </tr>`)}</tbody></table></div>`:P({icon:"users",title:t("common.noResult")})}
    </div>`}var Pe,Be,ra,Hn,yd,Fn,Aa=O(()=>{H();_();K();z();oe();X();ie();ee();Pe=(e,a)=>k()?e:a,Be={q:"",action:"",page:1,limit:50},ra={days:30,metric:"orders"},Hn=[];g("adm-aud-filter",(e,a)=>{e.preventDefault();let s=new FormData(a);Be.q=String(s.get("q")||"").trim(),Be.action=String(s.get("action")||""),Be.page=1,T(!0)});g("adm-aud-clear",()=>{Be.q="",Be.action="",Be.page=1,T(!0)});g("adm-st-filter",(e,a)=>{e.preventDefault();let s=new FormData(a);ra.days=Number(s.get("days")||30),ra.metric=String(s.get("metric")||"orders"),T(!0)});yd=[{id:"products",icon:"box",label:()=>t("common.products")},{id:"orders",icon:"package-check",label:()=>t("common.orders")},{id:"users",icon:"users",label:()=>t("common.users")},{id:"reviews",icon:"star",label:()=>t("adm.reviews")},{id:"tickets",icon:"ticket",label:()=>t("adm.tickets")},{id:"audit",icon:"history",label:()=>t("adm.audit")},{id:"all",icon:"download",label:()=>Pe("\u0647\u0645\u0647\u0654 \u062F\u0627\u062F\u0647\u200C\u0647\u0627","Everything")}];g("adm-d-backup",async(e,a)=>{await A(a,async()=>{try{let s=await h.post("/api/admin/backup",{});$(`${t("adm.dBackup")}: ${s.file} (${b(s.sizeKb||0)} KB)`)}catch(s){y(s)}})});g("adm-d-cleanup",async(e,a)=>{await ge({text:Pe("\u0631\u0648\u06CC\u062F\u0627\u062F\u0647\u0627\u06CC \u0642\u062F\u06CC\u0645\u06CC\u200C\u062A\u0631 \u0627\u0632 \u06F9\u06F0 \u0631\u0648\u0632 \u0648 \u0646\u0634\u0633\u062A\u200C\u0647\u0627\u06CC \u0645\u0646\u0642\u0636\u06CC \u067E\u0627\u06A9 \u0634\u0648\u0646\u062F\u061F","Remove audit entries older than 90 days and expired sessions?"),danger:!0})&&await A(a,async()=>{try{let n=await h.post("/api/admin/maintenance/cleanup",{});$(`${Pe("\u0631\u0648\u06CC\u062F\u0627\u062F","audit")}: ${b(n.auditRemoved||0)} \xB7 ${Pe("\u0646\u0634\u0633\u062A","sessions")}: ${b(n.sessionsRemoved||0)}`)}catch(n){y(n)}})});Fn={q:""};g("adm-vis-filter",(e,a)=>{e.preventDefault(),Fn.q=a.q.value,T(!0)})});var ia={};Y(ia,{mount:()=>Td,render:()=>Sd});async function Sd(e){let a=e.params.section;return a==="ads"?Ed():a==="notifications"?qd():a==="telegram"?Cd():a==="lottery"?Ad():xd()}async function xd(){try{ca=(await h.get("/api/admin/coupons")).items||[]}catch(a){return F({title:a?.message||t("err.generic")})}let e=ca.filter(a=>a.active!==!1&&new Date(a.endAt)>new Date).length;return r`
    <div class="row row-between row-wrap mb">
      <div>
        <h2 class="section-title">${c("percent")} ${t("adm.coupons")}</h2>
        <p class="muted small">${b(ca.length)} ${de("\u06A9\u062F","codes")} · ${b(e)} ${de("\u0641\u0639\u0627\u0644","active")}</p>
      </div>
      <button class="btn btn-primary btn-sm" data-act="adm-cp-new">${c("plus")} ${t("common.add")}</button>
    </div>

    ${ne([{label:t("cart.coupon")},{label:t("common.type")},{label:t("adm.cpValue"),cls:"num"},{label:t("adm.cpUsage"),cls:"num"},{label:t("adm.cpDates")},{label:t("common.status")},{label:"",cls:"num"}],ca.map(a=>{let s=new Date(a.endAt)<new Date;return r`
        <tr>
          ...
          <td class="num">${a.type==="percent"?`${b(a.value)}\u066A`:C(a.value)}
            ${a.maxDiscount?r`<div class="tiny muted">${de("\u0633\u0642\u0641","max")} ${C(a.maxDiscount)}</div>`:""}
            ${a.minOrder?r`<div class="tiny muted">${de("\u062D\u062F\u0627\u0642\u0644 \u0633\u0641\u0627\u0631\u0634","min order")} ${C(a.minOrder)}</div>`:""}</td>
          <td class="num">${b(a.used||0)} / ${b(a.usageLimit||0)}<div class="tiny muted">${de("\u0647\u0631 \u06A9\u0627\u0631\u0628\u0631","per user")}: ${b(a.perUser||1)}</div></td>
        ...
        </tr>`}),{emptyText:t("common.noData")})}`}function Hr(e){return ce({title:e?t("common.edit"):t("adm.cpNew"),body:r`
      <form class="form-grid" data-act="adm-cp-save" data-id="${e?.id||""}" data-isnew="${e?"":"1"}">
        ${S({label:t("cart.coupon"),name:"code",required:!e,value:e?.code||"",attrs:e?"readonly":"",hint:de("\u062D\u0631\u0648\u0641 \u0628\u0632\u0631\u06AF \u0627\u0646\u06AF\u0644\u06CC\u0633\u06CC \u0648 \u0639\u062F\u062F","Uppercase letters and digits")})}
        ${U({label:t("common.type"),name:"type",value:e?.type||"percent",options:[{value:"percent",label:t("adm.cpPercent")},{value:"amount",label:t("adm.cpAmount")}]})}
        ${S({label:t("adm.cpValue"),name:"value",type:"number",required:!0,value:e?.value??10,attrs:'min="1" max="100000000"'})}
        ${S({label:de("\u0633\u0642\u0641 \u062A\u062E\u0641\u06CC\u0641","Max discount"),name:"maxDiscount",type:"number",value:e?.maxDiscount??0,attrs:'min="0" max="100000000"'})}
        ${S({label:de("\u062D\u062F\u0627\u0642\u0644 \u0645\u0628\u0644\u063A \u0633\u0641\u0627\u0631\u0634","Minimum order"),name:"minOrder",type:"number",value:e?.minOrder??0,attrs:'min="0" max="100000000"'})}
        ${S({label:de("\u0633\u0642\u0641 \u0627\u0633\u062A\u0641\u0627\u062F\u0647\u0654 \u06A9\u0644","Total usage limit"),name:"usageLimit",type:"number",value:e?.usageLimit??100,attrs:'min="1" max="100000"'})}
        ${S({label:de("\u0633\u0642\u0641 \u0647\u0631 \u06A9\u0627\u0631\u0628\u0631","Per user"),name:"perUser",type:"number",value:e?.perUser??1,attrs:'min="1" max="100"'})}
    ...
    ${Da.length?Da.map(e=>{let a=ms.filter(s=>s.slot===e.id);return r`
            ...
            ${a.map(s=>r`
              <div class="ad-row ${s.active===!1?"off":""}">
                ...
                <div class="grow">
                  ...
                  <span class="tiny muted nowrap">${de("\u0627\u0632","From")} ${B(s.startAt,{time:!1})} ${de("\u062A\u0627","to")} ${B(s.endAt,{time:!1})}${s.link?` \xB7 ${p(s.link)}`:""}</span>
                </div>
                <div class="act">
      ...
      </div>`}).join(""):P({icon:"image",title:t("common.noData")})}`}function Fr(e){return ce({title:e?t("common.edit"):t("adm.adNew"),body:r`
      <form class="form-grid" data-act="adm-ad-save" data-id="${e?.id||""}" data-isnew="${e?"":"1"}">
        <div class="span-2">${U({label:t("adm.adSlot"),name:"slot",value:e?.slot||Da[0]?.id||"home_hero",options:Da.map(a=>({value:a.id,label:k()?a.fa:a.en||a.fa}))})}</div>
        ${S({label:t("common.title"),name:"title",required:!0,value:e?.title||""})}
        ${S({label:de("\u0639\u0646\u0648\u0627\u0646 (\u0627\u0646\u06AF\u0644\u06CC\u0633\u06CC)","Title (EN)"),name:"titleEn",value:e?.titleEn||""})}
        <div class="span-2">${G({label:t("common.text"),name:"text",value:e?.text||"",rows:2})}</div>
        <div class="span-2">${G({label:de("\u0645\u062A\u0646 (\u0627\u0646\u06AF\u0644\u06CC\u0633\u06CC)","Text (EN)"),name:"textEn",value:e?.textEn||"",rows:2})}</div>
        ...
        ${S({label:de("\u0645\u062A\u0646 \u062F\u06A9\u0645\u0647","CTA label"),name:"cta",value:e?.cta||""})}
        ${S({label:de("\u0645\u062A\u0646 \u062F\u06A9\u0645\u0647 (\u0627\u0646\u06AF\u0644\u06CC\u0633\u06CC)","CTA (EN)"),name:"ctaEn",value:e?.ctaEn||""})}
        ${S({label:de("\u0634\u0631\u0648\u0639","Start"),name:"startAt",type:"datetime-local",value:ps(e?.startAt)})}
        ${S({label:de("\u067E\u0627\u06CC\u0627\u0646","End"),name:"endAt",type:"datetime-local",value:ps(e?.endAt)})}
        <div class="span-2">${he({label:t("common.active"),name:"active",checked:e?e.active!==!1:!0})}</div>
        <button class="btn btn-primary span-2" type="submit">${t("common.save")}</button>
      </form>`})}async function qd(){let e=null;try{e=await h.get("/api/admin/notifications")}catch(n){return F({title:n?.message||t("err.generic")})}let a=e.items||[],s=e.outbox||[];return r`
    <div class="row row-between row-wrap mb">
      <div>
      ...
      <div class="col">
        <form class="card" data-act="adm-notif-send">
          ...
          <div class="form-grid mt-s">
            ...
            ${S({label:de("\u0639\u0646\u0648\u0627\u0646 (\u0627\u0646\u06AF\u0644\u06CC\u0633\u06CC)","Title (EN)"),name:"titleEn",attrs:'maxlength="120"'})}
            <div class="span-2">${G({label:t("common.text"),name:"body",rows:3,attrs:'maxlength="600"'})}</div>
            <div class="span-2">${G({label:de("\u0645\u062A\u0646 (\u0627\u0646\u06AF\u0644\u06CC\u0633\u06CC)","Text (EN)"),name:"bodyEn",rows:2})}</div>
            ${U({label:t("adm.notifLevel"),name:"level",value:"info",options:[{value:"info",label:t("notif.level.info")},{value:"success",label:t("notif.level.success")},{value:"warning",label:t("notif.level.warning")},{value:"error",label:t("notif.level.error")}]})}
            ${U({label:t("common.type"),name:"type",value:"announcement",options:[{value:"announcement",label:t("notif.type.announcement")},{value:"news",label:t("notif.type.news")},{value:"offer",label:t("notif.type.offer")},{value:"system",label:t("notif.type.system")}]})}
            ${S({label:t("common.link"),name:"link",hint:"#/products"})}
            ${S({label:de("\u0634\u0646\u0627\u0633\u0647\u0654 \u06A9\u0627\u0631\u0628\u0631 (\u062E\u0627\u0644\u06CC = \u0647\u0645\u0647)","User id (empty = everyone)"),name:"userId"})}
            <div class="span-2">
          ...
          <div class="notif-list mt-s">
            ${a.length?a.slice(0,40).map(n=>r`
              <div class="notif-item lv-${p(n.level||"info")}">
                ...
                <span class="tiny muted mono">${n.userId?p(n.userId):de("\u0647\u0645\u0647\u0654 \u06A9\u0627\u0631\u0628\u0631\u0627\u0646","All users")}${n.link?` \xB7 ${p(n.link)}`:""}</span>
              </div>`).join(""):r`<p class="muted small">${t("common.noData")}</p>`}
          </div>
        </div>
        ${s.length?r`
        <div class="card mt">
          <strong>${c("mail")} ${de("\u0635\u0641 \u0627\u0631\u0633\u0627\u0644 \u067E\u06CC\u0627\u0645\u06A9/\u0627\u06CC\u0645\u06CC\u0644","SMS / email outbox")} (${b(s.length)})</strong>
          <div class="mt-s">
    ...
    </div>`}function Td(e){return L(e),null}async function Cd(){let e=null;try{e=await h.get("/api/admin/telegram")}catch(a){return F({title:a?.message||t("err.generic")})}return r`
    <div class="cart-grid">
      <div class="col">
        ...
        <div class="card">
          ...
          ${e.enabled?r`
            <p class="tiny muted mt-s">
              ${de("\u0648\u0636\u0639\u06CC\u062A \u0627\u062A\u0635\u0627\u0644 \u0631\u0628\u0627\u062A:","bot link:")}
              ${e.lastError?r`<span class="c-danger">${de("\u062E\u0637\u0627","error")}: ${p(String(e.lastError).slice(0,120))}</span>`:r`<span class="c-success">${de("\u0633\u0627\u0644\u0645","healthy")}</span>`}
              · ${de("\u062D\u0627\u0644\u062A \u0627\u062A\u0635\u0627\u0644:","mode:")} ${e.webhook?.ok?de("\u0648\u0628\u200C\u0647\u0648\u06A9 \u2714","webhook \u2714"):de("\u067E\u0648\u0644\u06CC\u0646\u06AF","polling")}
              ${e.lastPoll?`\xB7 ${de("\u0622\u062E\u0631\u06CC\u0646 \u0628\u0631\u0631\u0633\u06CC:","last poll:")} ${fe(e.lastPoll)}`:""}
            </p>`:""}
          <div class="notif-list mt-s">
    ...
    </div>`}async function Ad(){let e=null;try{e=await h.get("/api/admin/lotteries")}catch(a){return F({title:a?.message||t("err.generic")})}return r`
    <div class="cart-grid">
      <div class="col">
        <form class="card" data-act="adm-lot-create">
          ...
          <div class="form-grid mt-s">
            ...
            <div class="span-2">${U({label:t("adm.lotMode"),name:"entryMode",options:[{value:"orders",label:t("adm.lotModeOrders")},{value:"manual",label:t("adm.lotModeManual")}]})}</div>
          </div>
    ...
    </div>`}var de,ca,ms,Da,On,jn,la=O(()=>{H();_();K();oe();X();ie();ee();de=(e,a)=>k()?e:a,ca=[],ms=[],Da=[];On=null;g("adm-cp-new",()=>{On=Hr(null)});g("adm-cp-edit",(e,a)=>{On=Hr(ca.find(s=>s.id===a.dataset.id))});g("adm-cp-toggle",async(e,a)=>{let s=ca.find(n=>n.id===a.dataset.id);if(s)try{await h.patch(`/api/admin/coupons/${s.id}`,{active:s.active===!1}),T(!0)}catch(n){y(n)}});g("adm-cp-copy",async(e,a)=>{try{await navigator.clipboard.writeText(a.dataset.code),$(t("misc.copied"))}catch{$(a.dataset.code)}});g("adm-cp-del",async(e,a)=>{if(await Oe(a.dataset.name))try{await h.del(`/api/admin/coupons/${a.dataset.id}`),$(t("misc.deleted")),T(!0)}catch(s){y(s)}});g("adm-cp-save",async(e,a)=>{e.preventDefault();let s=new FormData(a),n=a.dataset.isnew==="1",o={type:s.get("type"),value:Number(s.get("value")||0),maxDiscount:Number(s.get("maxDiscount")||0),minOrder:Number(s.get("minOrder")||0),usageLimit:Number(s.get("usageLimit")||100),perUser:Number(s.get("perUser")||1),active:s.get("active")==="on",note:s.get("note")||""};s.get("startAt")&&(o.startAt=new Date(s.get("startAt")).toISOString()),s.get("endAt")&&(o.endAt=new Date(s.get("endAt")).toISOString()),n&&(o.code=String(s.get("code")||"").toUpperCase()),await A(a.querySelector("button[type=submit]"),async()=>{try{n?await h.post("/api/admin/coupons",o):await h.patch(`/api/admin/coupons/${a.dataset.id}`,o),$(t("misc.saved")),On?.close(),T(!0)}catch(i){y(i)}})});jn=null;g("adm-ad-new",()=>{jn=Fr(null)});g("adm-ad-edit",(e,a)=>{jn=Fr(ms.find(s=>s.id===a.dataset.id))});g("adm-ad-toggle",async(e,a)=>{let s=ms.find(n=>n.id===a.dataset.id);if(s)try{await h.patch(`/api/admin/ads/${s.id}`,{active:s.active===!1}),T(!0)}catch(n){y(n)}});g("adm-ad-del",async(e,a)=>{if(await Oe(a.dataset.name))try{await h.del(`/api/admin/ads/${a.dataset.id}`),$(t("misc.deleted")),T(!0)}catch(s){y(s)}});g("adm-ad-save",async(e,a)=>{e.preventDefault();let s=new FormData(a),n=a.dataset.isnew==="1",o={slot:s.get("slot"),title:s.get("title"),titleEn:s.get("titleEn")||"",text:s.get("text")||"",textEn:s.get("textEn")||"",link:s.get("link")||"",image:s.get("image")||"",cta:s.get("cta")||"",ctaEn:s.get("ctaEn")||"",active:s.get("active")==="on"};s.get("startAt")&&(o.startAt=new Date(s.get("startAt")).toISOString()),s.get("endAt")&&(o.endAt=new Date(s.get("endAt")).toISOString()),await A(a.querySelector("button[type=submit]"),async()=>{try{n?await h.post("/api/admin/ads",o):await h.patch(`/api/admin/ads/${a.dataset.id}`,o),$(t("misc.saved")),jn?.close(),T(!0)}catch(i){y(i)}})});g("adm-notif-send",async(e,a)=>{e.preventDefault();let s=new FormData(a),n={title:String(s.get("title")||"").trim(),titleEn:String(s.get("titleEn")||"").trim(),body:String(s.get("body")||"").trim(),bodyEn:String(s.get("bodyEn")||"").trim(),level:s.get("level"),type:s.get("type"),link:String(s.get("link")||"").trim(),userId:String(s.get("userId")||"").trim(),channels:["site","telegram","email","sms"].filter(o=>s.get(`ch_${o}`))};n.title.length<3||await A(a.querySelector("button[type=submit]"),async()=>{try{let i=(await h.post("/api/admin/notifications",n)).results||{},l=Object.entries(i).map(([m,u])=>`${m}: ${u.error?"\u2717":`\u2713${u.ok??""}`}`).join(" ");$(l?`${t("misc.sent")} \u2014 ${l}`:t("misc.sent"),{timeout:4200}),T(!0)}catch(o){y(o)}})});g("adm-tg-save",async(e,a)=>{e.preventDefault();let s={enabled:!!a.enabled?.checked};a.token?.value&&(s.token=a.token.value),a.welcome!==void 0&&(s.welcome=a.welcome.value),await A(a.querySelector("button[type=submit]"),async()=>{try{await h.post("/api/admin/telegram",s),$(t("common.saved")),T(!0)}catch(n){y(n)}})});g("adm-tg-test",async(e,a)=>{e.preventDefault();try{await h.post("/api/admin/telegram/test",{chatId:a.chatId.value}),$(t("misc.sent"))}catch(s){y(s)}});g("adm-tg-reply",async(e,a)=>{e.preventDefault();try{await h.post("/api/admin/telegram/reply",{chatId:a.dataset.chat,text:a.text.value}),$(t("misc.sent")),a.text.value=""}catch(s){y(s)}});g("adm-lot-create",async(e,a)=>{e.preventDefault();let s=new Date(a.endsAt.value).toISOString();await A(a.querySelector("button[type=submit]"),async()=>{try{await h.post("/api/admin/lotteries",{title:a.title.value,prize:a.prize.value,endsAt:s,winnersCount:Number(a.winnersCount.value||1),entryMode:a.entryMode.value}),$(t("common.saved")),T(!0)}catch(n){y(n)}})});g("adm-lot-run",async(e,a)=>{await ge({text:t("adm.lotRunWarn"),danger:!0})&&await A(a,async()=>{try{let n=await h.post(`/api/admin/lotteries/${a.dataset.id}/run`,{});$(`${t("adm.lotDone")}: ${(n.lottery?.winners||[]).map(o=>o.name).join("\u060C ")}`,{timeout:6e3}),T(!0)}catch(n){y(n)}})});g("adm-lot-close",async(e,a)=>{await A(a,async()=>{try{await h.post(`/api/admin/lotteries/${a.dataset.id}/close`,{}),$(t("adm.lotClosed")),T(!0)}catch(s){y(s)}})})});var Pa={};Y(Pa,{mount:()=>Rd,render:()=>Dd});async function Dd(e){let a=["settings","theme","features"].includes(e.params.section)?e.params.section:"settings",s=Or[a].filter(i=>a==="theme"?V("theme.edit"):!0);if(!s.length)return P({icon:"lock",title:t("adm.noPermission")});let n=s.find(i=>i.id===e.params.id)||s[0];try{us=await h.get("/api/admin/settings")}catch(i){return F({title:i?.message||t("err.generic")})}let o=us.settings?.[n.id]||{};return r`
    <div class="row row-between row-wrap mb">
      <h2 class="section-title">${c(n.icon)} ${n.label()}</h2>
      <span class="badge-pill bp-info">${t("adm.liveView")}</span>
    </div>
    <div class="tabs mb" data-tabs>
      ${Or[a].filter(i=>a==="theme"?V("theme.edit"):!0).map(i=>r`
        <a class="tab ${i.id===n.id?"active":""}" href="#/admin/${a}/${i.id}">${c(i.icon)} ${i.label()}</a>`)}
    </div>
    ${n.id==="features"?Ld(us.settings?.features||{}):n.id==="backups"?me("<div data-backups-panel></div>"):n.id==="partners"?Nd(us.settings?.partners?.items||[]):Pd(n.id,o)}
    <p class="hint mt">${D("\u062A\u063A\u06CC\u06CC\u0631\u0647\u0627 \u0628\u0644\u0627\u0641\u0627\u0635\u0644\u0647 \u0631\u0648\u06CC \u0633\u0627\u06CC\u062A \u0627\u0639\u0645\u0627\u0644 \u0645\u06CC\u200C\u0634\u0648\u062F\u061B \u0628\u0631\u0627\u06CC \u062F\u06CC\u062F\u0646 \u0646\u062A\u06CC\u062C\u0647 \u0635\u0641\u062D\u0647 \u0631\u0627 \u062A\u0627\u0632\u0647 \u06A9\u0646.","Changes apply to the site immediately; refresh the page to see them.")}</p>`}function Pd(e,a){let s=Ur[e]||[];return r`
    <form class="card" data-act="adm-set-save" data-section="${e}">
      ...
      <div class="row row-wrap mt">
    ...
    </form>`}function Md(e,a){let s=e.label();switch(e.type){case"bool":return r`<div class="span-2">${he({label:s,desc:e.hint?e.hint():"",name:e.k,checked:a!==!1})}</div>`;case"select":return U({label:s,name:e.k,value:a??"",options:e.options().map(([n,o])=>({value:n,label:o}))});case"number":return S({label:s,name:e.k,type:"number",value:a??"",attrs:`min="${e.min??0}" max="${e.max??999999999}" step="${e.step??1}"`});case"textarea":return r`<div class="span-2">${G({label:s,name:e.k,value:a??"",rows:3})}</div>`;case"color":return r`
        <label class="field"><span class="label">${s}</span>
          <span class="row color-row">
            <input type="color" class="color-pick" name="${e.k}-pick" value="${p(a||"#31afd4")}" data-color-for="${e.k}">
            <input class="input mono" name="${e.k}" value="${p(a||"#31afd4")}" maxlength="7" data-fkey="${e.k}">
          </span>
        ...
        <div class="span-2">
          ...
          <div data-rows="${e.k}">
            ${(Array.isArray(a)?a:[]).map(n=>jr(e,n)).join("")}
          </div>
          <template data-row-tpl="${e.k}">${jr(e,null)}</template>
        </div>`;default:return S({label:s,name:e.k,value:a??""})}}function jr(e,a){return r`
      ...
      <div class="card page-nav">
        ${La.map(s=>r`
          <a class="pg-item ${s.key===a?"active":""}" href="#/admin/pages/${s.key}">
            ${c(s.icon)}<span class="grow">${Kr(s.key)}</span>
          </a>`).join("")}
      </div>
      <div>${a?Hd(La.find(s=>s.key===a)):P({icon:"file",title:t("adm.pagesPick"),text:t("adm.pagesPickHint")})}</div>
    </div>`}function Kr(e){return{about:t("footer.about"),guide:t("footer.guide"),service:t("footer.service"),faq:t("footer.faq"),terms:t("footer.terms"),privacy:t("footer.privacy"),insurance:t("footer.insurance"),ticketRules:t("acc.ticketRules"),bugReport:t("feedback.bug"),contact:t("footer.contact")}[e]||e}function Hd(e){let a=Yr[e.key]||(e.key==="faq"?[]:{});return r`
    <form class="card" data-act="adm-pg-save" data-key="${e.key}">
      <div class="row row-between row-wrap mb-s">
        <strong>${c(e.icon)} ${Kr(e.key)}</strong>
...
`))}</textarea></label>
    ...
    <fieldset class="pg-block">
      ...
      <div data-blocks="sections">
        ${e.map((a,s)=>zr(a,s)).join("")}
      </div>
      <template data-tpl="sections">${zr(jd(),0)}</template>
    </fieldset>`}function zr(e,a){let s=Array.isArray(e.list)&&e.list.some(n=>n&&typeof n=="object");return r`
    <div class="pg-item" data-block="sections" data-objlist="${s?"1":""}">
      ...
      <div class="span-2">
        ...
        <div data-li>${(e.list||[]).map(o=>Vr(o)).join("")}</div>
        <template data-li-tpl>${Vr({icon:"check",fa:"",en:""})}</template>
...
`).map(f=>f.trim()).filter(Boolean))}return l})}return s}function zd(e){return L(e),null}var W,La,Yr,jd,fs,vs,Jr=O(()=>{H();_();K();oe();X();ie();ee();W=(e,a)=>k()?e:a,La=[{key:"about",icon:"store",blocks:["hero","sections","stats"]},{key:"guide",icon:"info",blocks:["hero","steps","tips"]},{key:"service",icon:"headset",blocks:["hero","items"]},{key:"faq",icon:"help",blocks:["faq"]},{key:"terms",icon:"file",blocks:["hero","intro","notice","sections"]},{key:"privacy",icon:"shield",blocks:["hero","intro","sections"]},{key:"insurance",icon:"package-check",blocks:["hero","body","rules"]},{key:"ticketRules",icon:"ticket",blocks:["hero","rules"]},{key:"bugReport",icon:"bug",blocks:["hero","body","hints"]},{key:"contact",icon:"phone",blocks:["hero"]}],Yr={};jd=()=>({title:"",titleEn:"",body:"",bodyEn:"",list:[],listEn:[]});fs=()=>r`
  ...
  <button type="button" class="btn btn-ghost btn-icon btn-xs" data-act="adm-pg-down" aria-label="down">${c("chevron-down")}</button>`,vs=()=>r`<button type="button" class="btn btn-ghost btn-icon btn-xs" data-act="adm-pg-del" aria-label="delete">${c("trash")}</button>`;g("adm-pg-save",async(e,a)=>{e.preventDefault();let s=a.dataset.key,n=La.find(i=>i.key===s),o=_d(a,n);await A(a.querySelector("button[type=submit]"),async()=>{try{await h.patch(`/api/admin/pages/${s}`,{value:o}),$(t("misc.saved")),T(!0)}catch(i){y(i)}})});g("adm-pg-add",(e,a)=>{let s=a.dataset.kind,n=a.closest("form"),o=n.querySelector(`[data-tpl="${s}"]`),i=n.querySelector(`[data-blocks="${s}"]`);if(!o||!i)return;let l=document.createElement("div");l.innerHTML=o.innerHTML.trim();let m=l.firstElementChild;if(!m)return;m.querySelectorAll("input, textarea").forEach(v=>{v.value=""});let u=i.children.length+1,f=m.querySelector(".row strong");f&&(f.textContent=`${s==="faq"?k()?"\u0633\u0624\u0627\u0644":"Q":k()?"\u0645\u0648\u0631\u062F":"Item"} ${u}`),i.appendChild(m),m.scrollIntoView({behavior:"smooth",block:"center"})});g("adm-pg-del",(e,a)=>{a.closest("[data-block]")?.remove()});g("adm-pg-up",(e,a)=>{let s=a.closest("[data-block]");s?.previousElementSibling&&s.parentNode.insertBefore(s,s.previousElementSibling)});g("adm-pg-down",(e,a)=>{let s=a.closest("[data-block]");s?.nextElementSibling&&s.parentNode.insertBefore(s.nextElementSibling,s)});g("adm-pg-li-add",(e,a)=>{let s=a.closest(".span-2"),n=s.querySelector("[data-li]"),o=s.querySelector("[data-li-tpl]");if(!n||!o)return;let i=document.createElement("div");i.innerHTML=o.innerHTML.trim(),i.firstElementChild&&n.appendChild(i.firstElementChild)});g("adm-pg-list-toggle",(e,a)=>{let s=a.closest(".span-2")?.querySelector("[data-listbox]");s&&(s.hidden=!s.hidden)});g("adm-pg-lidel",(e,a)=>{a.closest("[data-lir]")?.remove()})});var _n={};Y(_n,{mount:()=>Xd,render:()=>Vd});async function Vd(e){return e.params.section==="imageSearch"?Jd():Gd()}async function Gd(){try{let a=await h.get(h.url("/api/admin/barcode",{q:dt.q}));Tt=a.items||[],jt=a.labelSizes||[],!jt.find(s=>s.id===dt.size)&&jt.length&&(dt.size=jt[0].id)}catch(a){return F({title:a?.message||t("err.generic")})}let e=Tt.filter(a=>!a.barcode).length;return r`
    ...
    <div class="card mt">
      ...
      ${ne([{label:""},{label:t("common.product")},{label:t("pdp.barcode")},{label:t("common.price"),cls:"num"},{label:t("common.stock"),cls:"num"},{label:"",cls:"num"}],Tt.slice(0,100).map(a=>r`
          <tr>
    ...
    ${a.length?r`
      ...
      <div class="row row-between">
        ...
        <div class="t-end">
          <div class="price-now">${C(i.price)}</div>
      ...
      </div>`,$(t("adm.bFound"))}catch(o){n.innerHTML=r`<p class="muted small">${c("alert")} ${p(o?.message||t("adm.bNotFound"))}</p>`,o?.status!==404&&y(o)}finally{a.querySelector("[name=code]").value="",a.querySelector("[name=code]").focus()}});g("adm-ix-run",async(e,a)=>{let s=Number(a.dataset.count||0)>0,n=document.querySelector("[data-ix-progress]"),o=document.querySelector("[data-ix-bar]"),i=document.querySelector("[data-ix-status]"),l=[...document.querySelectorAll(".ix-item")];if(!l.length)return;let m=s?l.filter(w=>!w.classList.contains("on")):l;if(!m.length){$(t("adm.ixDone"));return}a.disabled=!0,n&&(n.hidden=!1);let u=0,f=0,v=[],x=async()=>{if(v.length)try{let w=await h.post("/api/admin/image-index",{entries:v.splice(0,v.length)});f+=w.indexed||0}catch(w){y(w)}};for(let w of m){let E=w.querySelector("img");if(E?.src)try{let M=E.src.startsWith("http")&&!E.src.startsWith(location.origin)?h.url("/api/admin/image-thumb",{url:E.src}):E.src,q=await ts(M),J=w.dataset.pid;J&&v.push({productId:J,dhash:q.dhash,hist:q.hist})}catch{}u++,o&&(o.style.width=`${Math.round(u/m.length*100)}%`),i&&(i.textContent=`${b(u)} / ${b(m.length)}`),v.length>=40&&await x()}await x(),a.disabled=!1,$(`${t("adm.ixDone")} \u2014 ${b(f)}`),T(!0)})});var $s={};Y($s,{allowedSections:()=>Vn,mount:()=>sm,render:()=>am,title:()=>nm});async function am(e){let a=e.params.section||"",s=Xr(a),n=Vn(),o="";if(!s)o=$a("warn",a?t("adm.noPermission"):t("err.forbidden"))+r`<div class="card mt"><strong>${t("adm.title")}</strong><p class="muted small mt-s">${t("adm.noPermission")}</p></div>`;else try{o=await(await s.mod()).render({...e,params:{...e.params,section:s.id},admNav:n})}catch(l){console.error("[admin] section render failed",l),o=$a("danger",`${t("err.generic")} (${p(l?.message||"")})`)}let i=[...new Set(n.map(l=>l.grp))];return r`
    <div class="row row-between row-wrap mb">
      <div class="row">
    ...
    <div class="adm-grid">
      <aside class="adm-side">
        ${i.map(l=>r`
          <div class="grp">${p(k()?em[l]:tm[l])}</div>
    ...
    </div>`}async function sm(e,a){L(e);let s=a.params.section||"",n=Xr(s);if(!n)return null;try{let o=await n.mod();if(typeof o.mount=="function")return o.mount(e.querySelector("[data-admbody]")||e,a)}catch(o){console.error("[admin] section mount failed",o)}return null}var Zd,em,tm,Vn,Xr,nm,ws=O(()=>{H();_();z();X();K();ie();ee();Zd=[{grp:"shop",id:"",perm:"dashboard.view",icon:"chart",label:()=>t("adm.dashboard"),mod:()=>Promise.resolve().then(()=>(ur(),pr))},{grp:"shop",id:"products",perm:"products.view",icon:"box",label:()=>t("adm.products"),mod:()=>Promise.resolve().then(()=>(fr(),gr))},{grp:"shop",id:"categories",perm:"categories.manage",icon:"layers",label:()=>t("adm.categories"),mod:()=>Promise.resolve().then(()=>(wr(),$r))},{grp:"shop",id:"orders",perm:"orders.view",icon:"package-check",label:()=>t("adm.orders"),mod:()=>Promise.resolve().then(()=>(Er(),xr))},{grp:"people",id:"reviews",perm:"reviews.moderate",icon:"star",label:()=>t("adm.reviews"),mod:()=>Promise.resolve().then(()=>(Tr(),qr))},{grp:"people",id:"tickets",perm:"tickets.manage",icon:"ticket",label:()=>t("adm.tickets"),mod:()=>Promise.resolve().then(()=>(Rn(),In)),feat:"tickets"},{grp:"people",id:"support",perm:"tickets.manage",icon:"headset",label:()=>t("adm.supportChat"),mod:()=>Promise.resolve().then(()=>(Rn(),In)),feat:"liveSupport"},{grp:"people",id:"feedback",perm:"feedback.manage",icon:"flag",label:()=>t("adm.feedback"),mod:()=>Promise.resolve().then(()=>(Pr(),Dr))},{grp:"people",id:"users",perm:"users.view",icon:"users",label:()=>t("adm.users"),mod:()=>Promise.resolve().then(()=>(Br(),Rr))},{grp:"people",id:"visitors",perm:"users.view",icon:"eye",label:()=>t("adm.visitors"),mod:()=>Promise.resolve().then(()=>(Aa(),Ca))},{grp:"growth",id:"coupons",perm:"coupons.manage",icon:"percent",label:()=>t("adm.coupons"),mod:()=>Promise.resolve().then(()=>(la(),ia)),feat:"coupons"},{grp:"growth",id:"settings/partners",perm:"settings.edit",icon:"store",label:()=>t("adm.sPartners"),mod:()=>Promise.resolve().then(()=>(Ma(),Pa)),feat:"partners"},{grp:"growth",id:"ads",perm:"ads.manage",icon:"tag",label:()=>t("adm.ads"),mod:()=>Promise.resolve().then(()=>(la(),ia)),feat:"ads"},{grp:"growth",id:"notifications",perm:"notifications.send",icon:"bell",label:()=>t("adm.notifications"),mod:()=>Promise.resolve().then(()=>(la(),ia)),feat:"announcements"},{grp:"growth",id:"lottery",perm:"settings.edit",icon:"gift2",label:()=>t("adm.lottery"),mod:()=>Promise.resolve().then(()=>(la(),ia)),feat:"lottery"},{grp:"system",id:"telegram",perm:"settings.edit",icon:"send",label:()=>t("adm.telegram"),mod:()=>Promise.resolve().then(()=>(la(),ia))},{grp:"system",id:"settings",perm:"settings.edit",icon:"settings",label:()=>t("adm.settings"),mod:()=>Promise.resolve().then(()=>(Ma(),Pa))},{grp:"system",id:"theme",perm:"theme.edit",icon:"sun",label:()=>t("adm.theme"),mod:()=>Promise.resolve().then(()=>(Ma(),Pa))},{grp:"system",id:"features",perm:"settings.edit",icon:"zap",label:()=>t("adm.features"),mod:()=>Promise.resolve().then(()=>(Ma(),Pa))},{grp:"system",id:"pages",perm:"pages.edit",icon:"file",label:()=>t("adm.pages"),mod:()=>Promise.resolve().then(()=>(Jr(),Qr))},{grp:"system",id:"barcode",perm:"barcode.print",icon:"barcode",label:()=>t("adm.barcode"),mod:()=>Promise.resolve().then(()=>(zn(),_n)),feat:"barcode"},{grp:"system",id:"imageSearch",perm:"imagesearch.index",icon:"camera",label:()=>t("adm.imageSearch"),mod:()=>Promise.resolve().then(()=>(zn(),_n)),feat:"imageSearch"},{grp:"system",id:"audit",perm:"audit.view",icon:"history",label:()=>t("adm.audit"),mod:()=>Promise.resolve().then(()=>(Aa(),Ca))},{grp:"system",id:"stats",perm:"stats.view",icon:"chart",label:()=>t("adm.stats"),mod:()=>Promise.resolve().then(()=>(Aa(),Ca))},{grp:"system",id:"data",perm:"data.export",icon:"download",label:()=>t("adm.export"),mod:()=>Promise.resolve().then(()=>(Aa(),Ca))}],em={shop:"\u0641\u0631\u0648\u0634\u06AF\u0627\u0647",people:"\u0645\u0634\u062A\u0631\u06CC\u200C\u0647\u0627",growth:"\u0631\u0634\u062F \u0648 \u062A\u0628\u0644\u06CC\u063A\u0627\u062A",system:"\u0633\u0627\u0645\u0627\u0646\u0647"},tm={shop:"Store",people:"Customers",growth:"Growth & ads",system:"System"},Vn=()=>Zd.filter(e=>(!e.perm||V(e.perm))&&(!e.feat||I(e.feat))),Xr=e=>Vn().find(a=>a.id===e)||null;nm=()=>t("adm.title");g("adm-sleep-toggle",async(e,a)=>{let s=!d.sleeping,n=0;if(s){let o=await ot({title:t("sys.turnOff"),text:t("sys.offConfirm"),label:t("sys.autoWakeMins"),value:"0",type:"number"});if(o===null)return;n=Math.max(0,Number(o)||0)}await A(a,async()=>{try{await h.post(s?"/api/system/sleep":"/api/system/wake",s?{minutes:n}:{}),await Ne({silent:!0}),document.dispatchEvent(new CustomEvent("sleep:changed")),$(s?n?t("sys.asleepTimed",{n}):t("sys.asleep"):t("sys.awake")),T(!0)}catch(o){y(o)}})})});var Zr={};Y(Zr,{mount:()=>rm,render:()=>om});async function om(){let e=decodeURIComponent((location.hash||"#/").slice(1));return r`
    <div class="center col mt-l nf-wrap">
      <div class="nf-code">۴۰۴</div>
      ${P({icon:"search",title:t("err.notFound"),text:`${t("err.notFoundText")} \u2014 ${e}`,action:{href:"#/",label:t("err.goHome")}})}
      <div class="row row-wrap center">
    ...
    </div>`}function rm(e){return L(e),null}var ec=O(()=>{H();_();z();oe()});var ct={};Y(ct,{currentRoute:()=>mm,href:()=>um,initRouter:()=>Gn,navigate:()=>le,parseHash:()=>ac,refresh:()=>T,render:()=>nc,routes:()=>tc,start:()=>da});function ac(e=location.hash){let a=String(e||"").replace(/^#/,"");if(!a||a==="/")return{path:"/",query:new URLSearchParams,hashStr:""};let s="",n=a.indexOf("#");n>=0&&(s=a.slice(n+1),a=a.slice(0,n));let o=a.indexOf("?"),i=new URLSearchParams(o>=0?a.slice(o+1):""),l=o>=0?a.slice(0,o):a;return l.startsWith("/")||(l=`/${l}`),l=l.replace(/\/{2,}/g,"/"),l.length>1&&l.endsWith("/")&&(l=l.slice(0,-1)),{path:l,query:i,hashStr:s}}function lm(e){let a=e.split("/").filter(s=>s!=="");for(let s of tc){let n=s.pattern.split("/").filter(l=>l!=="");if(n.length!==a.length)continue;let o={},i=!0;for(let l=0;l<n.length;l++)if(n[l].startsWith(":"))o[n[l].slice(1)]=decodeURIComponent(a[l]);else if(n[l]!==a[l]){i=!1;break}if(i)return{route:s,params:o}}return{route:im,params:{}}}function dm(e,a){if(!e)return null;if(e==="auth"){if(!d.me){let s=encodeURIComponent(a.full);return re(t("err.loginRequired")),`#/auth?next=${s}`}return null}if(e==="admin")return d.me?.isAdmin?null:(j(t("err.forbidden")),"#/");if(e.startsWith("perm:")){let s=e.slice(5),{can:n}=a.helpers;return n(s)?null:(j(t("adm.noPermission")),"#/admin")}if(e.startsWith("feature:")){let s=e.slice(8);return d.settings?.features?.[s]===!1?(re(t("err.notFound")),"#/"):null}return null}async function nc(e){let a=cm();if(!a)return;let s=++Na;if(ks){try{ks()}catch{}ks=null}wa(!0),a.innerHTML=e.skeleton||'<div class="sk sk-card"></div>';let n=null;try{n=await e.route.load()}catch(i){if(console.error("[router] load failed",i),s!==Na)return;a.innerHTML=`<div class="empty"><h4>${t("err.generic")}</h4><p>${t("err.network")}</p></div>`,wa(!1);return}if(s!==Na)return;let o="";try{o=await n.render(e)}catch(i){console.error("[router] render failed",i),o=`<div class="empty"><h4>${t("err.generic")}</h4><p>${String(i?.message||i)}</p></div>`}if(s===Na){a.innerHTML=o,L(a),setTimeout(()=>Promise.resolve().then(()=>(Kn(),Yn)).then(i=>i.maybeConsent&&i.maybeConsent()),300);try{let i=d.settings?.store?.[e.lang==="en"?"nameEn":"name"]||"\u06AF\u0631\u06CC\u0646 \u0627\u067E\u0644",l=typeof n.title=="function"?n.title(e):n.title||e.route.title?.(e)||"";document.title=l?`${l} \xB7 ${i}`:i}catch{}try{if(typeof n.mount=="function"){let i=n.mount(a,e);typeof i=="function"&&(ks=i)}}catch(i){console.error("[router] mount failed",i)}if(s===Na){wa(!1),document.dispatchEvent(new CustomEvent("view:rendered",{detail:e})),pm(e.path),e.keepScroll||(window.scrollTo(0,0),setTimeout(()=>window.scrollTo(0,0),50));try{a.closest("#view")?.focus({preventScroll:!0})}catch{}}}}function pm(e){document.querySelectorAll(".nav-link[data-nav-key]").forEach(a=>{a.classList.toggle("active",a.dataset.navKey===e||a.dataset.navKey!=="/"&&e.startsWith(a.dataset.navKey))}),document.querySelectorAll(".mobile-nav a[data-mn]").forEach(a=>{let s=a.dataset.mn,n=s==="home"&&e==="/"||s==="products"&&(e.startsWith("/products")||e.startsWith("/category")||e.startsWith("/product"))||s==="search"&&e.startsWith("/search")||s==="cart"&&e.startsWith("/cart")||s==="me"&&(e.startsWith("/account")||e.startsWith("/auth"));a.classList.toggle("active",n)})}function le(e,{replace:a=!1,keepScroll:s=!1}={}){let n=String(e||"#/"),o=n.startsWith("#")?n:`#${n}`;if(location.hash===o){da({keepScroll:s});return}a?history.replaceState(null,"",o):location.hash=o,a&&da({keepScroll:s})}function um(e,a){let n=(a instanceof URLSearchParams?a:new URLSearchParams(a||{})).toString();return`#${e.startsWith("/")?e:`/${e}`}${n?`?${n}`:""}`}function da(e={}){let{path:a,query:s,hashStr:n}=ac(),{route:o,params:i}=lm(a),l=`${a}${s.toString()?`?${s}`:""}`,m={path:a,params:i,query:s,hashStr:n,full:l,route:o,lang:document.documentElement.getAttribute("data-lang")||"fa",keepScroll:!!e.keepScroll,skeleton:o.skeleton||"",helpers:{}};sc=m;let u=dm(o.guard,m);if(u){if(u!==location.hash){location.replace(u);return}return}nc(m)}function Gn(){window.addEventListener("hashchange",()=>da()),da()}function T(e=!1){da({keepScroll:e})}var cm,tc,im,Na,sc,ks,mm,ee=O(()=>{H();_();z();X();cm=()=>N("#viewInner"),tc=[{pattern:"/",load:()=>Promise.resolve().then(()=>(yo(),vo)),title:()=>t("nav.home")},{pattern:"/products",load:()=>Promise.resolve().then(()=>(ln(),cn)),title:()=>t("catalog.title")},{pattern:"/category/:id",load:()=>Promise.resolve().then(()=>(ln(),cn)),title:()=>t("catalog.title")},{pattern:"/product/:id",load:()=>Promise.resolve().then(()=>(So(),ko)),title:e=>e.params.id},{pattern:"/search/image",load:()=>Promise.resolve().then(()=>(Eo(),xo)),title:()=>t("search.imageTitle"),guard:"feature:imageSearch"},{pattern:"/cart",load:()=>Promise.resolve().then(()=>(To(),qo)),title:()=>t("cart.title")},{pattern:"/checkout",load:()=>Promise.resolve().then(()=>(Po(),Do)),title:()=>t("checkout.title")},{pattern:"/checkout/done/:id",load:()=>Promise.resolve().then(()=>(Lo(),Mo)),title:()=>t("checkout.successTitle")},{pattern:"/pay/:id",load:()=>Promise.resolve().then(()=>(Io(),No)),title:()=>t("common.payment")},{pattern:"/compare",load:()=>Promise.resolve().then(()=>(Bo(),Ro)),title:()=>t("compare.title"),guard:"feature:compare"},{pattern:"/lottery",load:()=>Promise.resolve().then(()=>(Fo(),Ho)),title:()=>t("lot.title")},{pattern:"/price-check",load:()=>Promise.resolve().then(()=>(_o(),Wo)),title:()=>t("priceCheck.title"),guard:"feature:priceCheckDevice"},{pattern:"/auth",load:()=>Promise.resolve().then(()=>(bn(),un)),title:()=>t("auth.title")},{pattern:"/auth/:mode",load:()=>Promise.resolve().then(()=>(bn(),un)),title:()=>t("auth.title")},{pattern:"/account",load:()=>Promise.resolve().then(()=>(kn(),wn)),title:()=>t("acc.title"),guard:"auth"},{pattern:"/account/:section",load:()=>Promise.resolve().then(()=>(kn(),wn)),title:()=>t("acc.title"),guard:"auth"},{pattern:"/account/orders/:id",load:()=>Promise.resolve().then(()=>(ar(),tr)),title:()=>t("acc.trackOrder"),guard:"auth"},{pattern:"/account/tickets/:id",load:()=>Promise.resolve().then(()=>(or(),nr)),title:()=>t("common.ticket"),guard:"auth"},{pattern:"/stats",load:()=>Promise.resolve().then(()=>(ir(),cr)),title:()=>t("nav.stats"),guard:"feature:publicStats"},{pattern:"/pages/:key",load:()=>Promise.resolve().then(()=>(mr(),dr)),title:e=>e.params.key},{pattern:"/admin",load:()=>Promise.resolve().then(()=>(ws(),$s)),title:()=>t("adm.title"),guard:"admin"},{pattern:"/admin/:section",load:()=>Promise.resolve().then(()=>(ws(),$s)),title:()=>t("adm.title"),guard:"admin"},{pattern:"/admin/:section/:id",load:()=>Promise.resolve().then(()=>(ws(),$s)),title:()=>t("adm.title"),guard:"admin"}],im={pattern:"/404",load:()=>Promise.resolve().then(()=>(ec(),Zr)),title:()=>t("err.notFound")};Na=0,sc=null,ks=null,mm=()=>sc});function g(e,a){return Ut.set(e,a),a}function rr(e){return Ut.get(e)}async function Bt(e){if(!e)return;let a=e.querySelector("[data-cch]"),s=e.querySelector("[data-cimg]"),n=e.querySelector("[data-ctok]"),o=e.querySelector("[data-cst]"),i=e.querySelector("[name=captchaAnswer]");n&&(n.value=""),i&&(i.value="",i.disabled=!1);let l=e.querySelector("[name=captchaBox]");l&&(l.disabled=!1);try{let m=await h.get("/api/captcha");if(m.disabled){e.hidden=!0;return}e.hidden=!1,e.dataset.cid=m.id,s&&(s.innerHTML=m.svg||""),o&&(o.textContent=t("captcha.hint")),a&&(a.hidden=!l?.checked)}catch{}}function Xt(e){let a=e?.querySelector?.("[data-captcha]");a&&(a.hidden=!1,Bt(a))}function rc(){document.addEventListener("click",a=>{let s=a.target.closest("[data-act]");if(!s||s.tagName==="FORM")return;s.tagName==="A"&&a.preventDefault();let n=s.dataset.act,o=Ut.get(n);if(!o){console.warn("[actions] unknown:",n);return}try{let i=o(a,s);i&&typeof i.catch=="function"&&i.catch(l=>{console.error("[action]",n,l),l?.code&&y(l)})}catch(i){console.error("[action]",n,i)}}),document.addEventListener("submit",a=>{let s=a.target,n=s?.dataset?.act;if(!n)return;a.preventDefault();let o=Ut.get(n);if(!o){console.warn("[actions] unknown submit:",n);return}try{let i=o(a,s);i&&typeof i.catch=="function"&&i.catch(l=>{console.error("[action]",n,l),l?.code&&y(l)})}catch(i){console.error("[action]",n,i)}}),document.addEventListener("change",a=>{let s=a.target;if(s.matches?.(".qty input"))return;let n=s.dataset?.act?null:s.closest?.("form[data-act][data-live]");if(!s.dataset?.act&&!n)return;let o=s.dataset?.act?s:n,i=Ut.get(o.dataset.act);if(i)try{let l=i(a,o);l&&typeof l.catch=="function"&&l.catch(m=>console.error(m))}catch(l){console.error(l)}});let e=0;document.addEventListener("input",a=>{let s=a.target;s.matches?.("[data-act=captcha-check]")&&(clearTimeout(e),e=setTimeout(()=>{let n=Ut.get("captcha-check");n&&!s.disabled&&n(new Event("change"),s)},450))}),document.addEventListener("click",a=>{let s=a.target.closest(".qty [data-q]");if(!s)return;a.preventDefault(),Ut.get("qty-btn")(a,s)}),document.addEventListener("error",a=>{let s=a.target;if(s?.tagName!=="IMG"||s.dataset.fallbackDone)return;s.dataset.fallbackDone="1";let n=s.dataset.glyph||"misc";s.src=bm(n)},!0)}function bm(e){let s=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="300" height="300"><defs><linearGradient id="g" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#123a52"/><stop offset="1" stop-color="#0a2135"/></linearGradient></defs><rect width="100" height="100" fill="url(#g)"/><g fill="none" stroke="#7fd3ec" stroke-opacity=".8" stroke-width="3.4" stroke-linejoin="round" stroke-linecap="round"><path d="${oc[e]||oc.box}"/></g></svg>`;return`data:image/svg+xml;utf8,${encodeURIComponent(s)}`}var Ut,oc,ie=O(()=>{z();_();X();K();H();z();ee();Ut=new Map;g("add-cart",async(e,a)=>{let s=a.dataset.id,n=Number(a.dataset.qty||1)||1;await A(a,async()=>{try{await Wa(s,n),$(t("card.added"),{timeout:2600})}catch(o){y(o)}})});g("wish-toggle",async(e,a)=>{if(!d.me){le("#/auth?next="+encodeURIComponent(location.hash.slice(1)));return}try{let s=await js(a.dataset.id);re(s.in?t("card.wishlistAdd"):t("card.wishlistRemove"),{timeout:2e3})}catch(s){y(s)}});g("compare-toggle",async(e,a)=>{if(!d.me){le("#/auth?next="+encodeURIComponent(location.hash.slice(1)));return}try{(await Us(a.dataset.id)).in===!1?re(t("compare.remove"),{timeout:1800}):$(t("compare.add"),{timeout:1800})}catch(s){y(s)}});g("notify-me",async(e,a)=>{if(!d.me){le("#/auth?next="+encodeURIComponent(location.hash.slice(1)));return}try{let s=await Ws(a.dataset.id);$(s.on?t("common.notified"):t("common.notifyMe"),{timeout:2400}),document.querySelectorAll(`[data-act="notify-me"][data-id="${a.dataset.id}"]`).forEach(n=>{n.classList.toggle("active",s.on)})}catch(s){y(s)}});g("lightbox",(e,a)=>{let s=[];try{s=JSON.parse(a.dataset.imgs||"[]")}catch{s=[a.dataset.imgs||""]}Mt(s,Number(a.dataset.i||0),a.dataset.alt||"")});g("sound-toggle",()=>{let e=!d.prefs?.uiSound;wt("uiSound",e);let a=document.querySelector('[data-act="sound-toggle"]');a&&(a.setAttribute("aria-pressed",String(e)),a.innerHTML=r`${c(e?"volume":"volume-off")} ${t("misc.uiSound")} <span class="um-sw ${e?"on":""}" aria-hidden="true"></span>`),re(e?t("misc.uiSoundOn"):t("misc.uiSoundOff"),{timeout:1600}),e&&Qa(!0)});g("copy",async(e,a)=>{let{copyText:s}=await Promise.resolve().then(()=>(H(),Oa));try{await s(a.dataset.text||a.textContent.trim()),$(t("common.copied"),{timeout:1800})}catch{j(t("err.generic"))}});g("share",async(e,a)=>{let s=a.dataset.url||location.href,n=a.dataset.title||document.title;if(navigator.share)try{await navigator.share({title:n,url:s});return}catch{return}let{copyText:o}=await Promise.resolve().then(()=>(H(),Oa));try{await o(s),$(t("misc.shareDone"),{timeout:2e3})}catch{j(t("err.generic"))}});g("quick-view",async(e,a)=>{let s=a.dataset.id;try{let o=(await h.get(`/api/products/${encodeURIComponent(s)}`)).product;ce({title:ue(o),size:"md",body:r`
        <div class="row">
          ...
          <div class="grow">
            ...
            <div class="buy-price">
              ${o.oldPrice>o.price?r`<span class="pc-old">${C(o.oldPrice)}</span>`:""}
              <span class="buy-now">${C(o.price)}</span>
            </div>
      ...
      `})})});g("submit-lower-price",async(e,a)=>{e.preventDefault();let{withBusy:s,toastSuccess:n,toastApiError:o}=await Promise.resolve().then(()=>(X(),on));await s(a,async()=>{try{await h.post("/api/reports/lower-price",{productId:a.dataset.id,price:Number(a.price.value),url:a.url.value}),n("\u0628\u0627 \u062A\u0634\u06A9\u0631! \u06AF\u0632\u0627\u0631\u0634 \u0634\u0645\u0627 \u062B\u0628\u062A \u0634\u062F."),a.closest('[role="dialog"]')?.querySelector("[data-lx]")?.click()}catch(i){o(i)}})});g("accept-consent-now",async(e,a)=>{let{setConsent:s}=await Promise.resolve().then(()=>(z(),va));s({terms:!0,privacy:!0,marketing:!1}),$(isFa()?"\u0642\u0648\u0627\u0646\u06CC\u0646 \u0648 \u0645\u0642\u0631\u0631\u0627\u062A \u0628\u0627 \u0645\u0648\u0641\u0642\u06CC\u062A \u067E\u0630\u06CC\u0631\u0641\u062A\u0647 \u0634\u062F.":"Terms accepted."),sessionStorage.removeItem("consentDeferred");let{maybeConsent:n}=await Promise.resolve().then(()=>(Kn(),Yn));n(),Promise.resolve().then(()=>(ee(),ct)).then(o=>o.refresh())})});function hm(){let e=ze().mapCoords||{lat:28.9684,lng:50.8385};return{lat:Number(e.lat),lng:Number(e.lng)}}function gm(e,a){let s=`${e.lat},${e.lng}`,n=a?`${a.lat},${a.lng}`:"";return[{id:"neshan",label:t("contact.neshan"),icon:"map",href:a?`https://nshn.ir/maps?origin=${n}&destination=${s}&type=drive`:`https://nshn.ir/?lat=${e.lat}&lng=${e.lng}`},{id:"balad",label:t("contact.balad"),icon:"pin",href:a?`https://balad.ir/route/${n.replace(",",",")}/${s}`:`https://balad.ir/map?lat=${e.lat}&lng=${e.lng}`},{id:"osm",label:t("contact.osm"),icon:"globe",href:a?`https://www.openstreetmap.org/directions?from=${n.replace(",",";")}&to=${s.replace(",",";")}`:`https://www.openstreetmap.org/?mlat=${e.lat}&mlon=${e.lng}#map=17/${e.lat}/${e.lng}`},{id:"google",label:t("contact.google"),icon:"external",href:a?`https://www.google.com/maps/dir/?api=1&destination=${s}&origin=${n}`:`https://www.google.com/maps/search/?api=1&query=${s}`}]}function fm(){return new Promise(e=>{if(!("geolocation"in navigator))return e(null);let a=!1,s=o=>{a||(a=!0,e(o))},n=setTimeout(()=>s(null),7e3);navigator.geolocation.getCurrentPosition(o=>{clearTimeout(n),s({lat:o.coords.latitude,lng:o.coords.longitude})},()=>{clearTimeout(n),s(null)},{enableHighAccuracy:!1,timeout:6e3,maximumAge:12e4})})}function vm(){let e=hm(),a=null;return ce({title:t("contact.mapAsk"),size:"sm",body:r`
      ...
      <div class="col" data-maps></div>`,footer:r`<button type="button" class="btn btn-ghost" data-x>${t("common.close")}</button>`,onMount:(n,o)=>{let i=n.querySelector("[data-maps]"),l=()=>{i.innerHTML=gm(e,a).map(m=>r`
          <a class="btn btn-ghost btn-block" href="${m.href}" target="_blank" rel="noopener noreferrer">${c(m.icon)} ${m.label} ${c("external")}</a>`).join("")};l(),n.querySelector("[data-x]").addEventListener("click",()=>o.close()),fm().then(m=>{m&&(a=m,l(),$(t("contact.locationOn"),{timeout:2400}))})}})}var cc=O(()=>{_();z();X();H();ie();g("open-map",e=>{e.preventDefault?.(),vm()});g("install-app",async()=>{d.installPrompt?await fa()||Lt():Lt()})});var Yn={};Y(Yn,{ecoPaused:()=>_m,maybeConsent:()=>mc,updateBadges:()=>ma});async function ym(){setTimeout(ic,1e4),rc(),qm(),await Bs(),Wt(),pa(),ua(),Cm(),Dm(),Ko(),Xs(),Zs(),Nm(),Im(),Gn(),Om(),Bm(),Pm(),Mm(),Um(),zm(),Vm(),Fm(),Hm(),mc(),Rm(),ic(),wm(),km(),Sm(),document.getElementById("bootSplash")?.remove()}function ic(){let e=document.getElementById("welcomeScreen");if(!e)return;let a=Math.max(0,700-(performance.now()-$m));setTimeout(()=>{e.classList.add("gone"),setTimeout(()=>e.remove(),520)},a)}function wm(){let e=document.getElementById("btnRefresh");e&&e.addEventListener("click",()=>{location.reload()})}function km(){let e=()=>{for(let s of document.querySelectorAll('button[aria-label],a[aria-label],[role="button"][aria-label]'))s.title||(s.title=s.getAttribute("aria-label")||"")};e();let a=new MutationObserver(()=>{clearTimeout(a._t),a._t=setTimeout(e,350)});a.observe(document.body,{childList:!0,subtree:!0})}function Sm(){let e=new Set,a=(s,n,o)=>{let i=String(s).slice(0,120);if(!(e.has(i)||e.size>12)){e.add(i);try{let l=JSON.stringify({msg:String(s).slice(0,300),src:String(n||"").slice(0,200),line:o||0,path:location.hash.slice(0,120),build:window.__BM_BUILD||""});navigator.sendBeacon?navigator.sendBeacon("/api/client-error",new Blob([l],{type:"application/json"})):fetch("/api/client-error",{method:"POST",headers:{"Content-Type":"application/json"},body:l,keepalive:!0}).catch(()=>{})}catch{}}};window.addEventListener("error",s=>a(s.message,s.filename,s.lineno)),window.addEventListener("unhandledrejection",s=>a(`unhandledrejection: ${s.reason?.message||s.reason}`,location.href,0))}function Wt(){let e=ze(),a=Ze(),s=N("#topbar"),n=[];e.freeShipOver&&n.push(k()?`\u0627\u0631\u0633\u0627\u0644 \u0631\u0627\u06CC\u06AF\u0627\u0646 \u0633\u0641\u0627\u0631\u0634\u200C\u0647\u0627\u06CC \u0628\u0627\u0644\u0627\u06CC ${b(e.freeShipOver)} \u062A\u0648\u0645\u0627\u0646`:`Free shipping over ${b(e.freeShipOver)}`),n.push(k()?"\u0636\u0645\u0627\u0646\u062A \u0627\u0635\u0627\u0644\u062A \u06A9\u0627\u0644\u0627\u061B \u0645\u0631\u062C\u0648\u0639 \u062A\u0627 \u06F7 \u0631\u0648\u0632":"Authenticity guarantee; 7-day returns"),e.phone&&n.push(k()?`\u067E\u0634\u062A\u06CC\u0628\u0627\u0646\u06CC \u0647\u0631 \u0631\u0648\u0632 \u06F9 \u062A\u0627 \u06F2\u06F1 \u2014 ${se(e.phone)}`:`Support 9\u201321 daily \u2014 ${se(e.phone)}`),e.socials?.instagram&&n.push(k()?"\u062A\u0627\u0632\u0647\u200C\u0647\u0627\u06CC \u06AF\u062C\u062A \u0647\u0631 \u0647\u0641\u062A\u0647 \u062F\u0631 \u0627\u06CC\u0646\u0633\u062A\u0627\u06AF\u0631\u0627\u0645 \u06CC\u0627\u0633\u0627\u06CC\u06CC":"New gadgets weekly on Instagram");let o=d.ticker?.length?d.ticker:n;s.hidden=!1,s.classList.toggle("no-ticker",a.showTicker===!1);let i=o.map(u=>r`<span class="ticker-item">${c("sparkles")} ${u}</span>`).join("");N("#ticker").innerHTML=`<div class="ticker-track">${i}${i}</div>`;let l=N("#tb-phone");l.href=`tel:${e.phone||""}`,l.innerHTML=r`${c("phone")} ${se(e.phone||"")}`,N("#brandName").textContent=k()?e.name||t("app.name"):e.nameEn||e.name||"Yassaei Electronics",N("#brandTag").textContent=k()?e.tagline||"":e.taglineEn||"",N("#brandLink").setAttribute("aria-label",`${e.name||""} \u2014 ${t("nav.home")}`),xm(),Em(),xs(),ma();let m=N("#btnInstallApp");m&&(m.hidden=d.installed)}function xm(){let e=N("#navInner"),a=d.categories.filter(u=>!u.parentId).slice(0,10),n=[{key:"/",href:"#/",icon:"home",label:t("nav.home")},{key:"/products",href:"#/products",icon:"grid",label:t("nav.products")}].map(u=>r`<a class="nav-link" data-nav-key="${u.key}" href="${u.href}">${c(u.icon)} ${u.label}</a>`).join("");n+=r`
    <div class="nav-more">
      <a href="#/products" class="nav-link">${c("layers")} ${t("nav.allCategories")} ${c("chevron-down")}</a>
      <div class="nav-dd mega-menu hidden-default">
        <div class="mega-side">
          ${d.categories.filter(u=>!u.parentId).map(u=>r`<a href="#/category/${u.id}" class="mega-side-link" data-cat="${u.id}">${c(vt(u.glyph))} ${ke(u)}</a>`)}
        </div>
        <div class="mega-content">
          <div class="mega-empty muted small">${t("nav.allCategories")}</div>
        </div>
      </div>
    </div>`;let o=[{key:"/deals",href:"#/products?discount=1",icon:"percent",label:t("nav.deals"),show:I("coupons")},{key:"/new",href:"#/products?sort=newest",icon:"sparkles",label:t("nav.new"),show:!0},{key:"/pages/stats",href:"#/stats",icon:"chart",label:t("nav.stats"),show:I("publicStats")},{key:"/price-check",href:"#/price-check",icon:"barcode",label:t("priceCheck.title"),show:I("priceCheckDevice")},{key:"/lottery",href:"#/lottery",icon:"gift2",label:t("lot.nav"),show:!0},{key:"/pages/installments",href:"#/pages/installments",icon:"credit-card",label:k()?"\u062E\u0631\u06CC\u062F \u0627\u0642\u0633\u0627\u0637\u06CC":"Installments",show:!0},{key:"/pages/about",href:"#/pages/about",icon:"store",label:t("nav.about"),show:!0},{key:"/pages/contact",href:"#/pages/contact",icon:"map",label:t("nav.contact"),show:!0}].filter(u=>u.show);n+=o.map(u=>r`<a class="nav-link" data-nav-key="${u.key}" href="${u.href}">${c(u.icon)} ${u.label}</a>`).join("");let i=nt("ticker");i.length&&(n+=r`<span class="nav-link muted tiny">${i[0].title}</span>`),e.innerHTML=n;let l=e.querySelectorAll(".mega-side-link"),m=e.querySelector(".mega-content");l.length&&m&&l.forEach(u=>{u.addEventListener("mouseenter",()=>{l.forEach(E=>E.classList.remove("active")),u.classList.add("active");let f=u.dataset.cat,v=d.categories.filter(E=>E.parentId===f),x=d.brands.slice(0,10),w='<div class="mega-sub-grid">';v.length&&(w+='<div class="mega-sub-col"><h3>\u062F\u0633\u062A\u0647\u200C\u0628\u0646\u062F\u06CC\u200C\u0647\u0627\u06CC \u0632\u06CC\u0631\u0645\u062C\u0645\u0648\u0639\u0647</h3>',v.forEach(E=>{w+=`<a href="#/category/${E.id}">${ke(E)}</a>`}),w+="</div>"),w+='<div class="mega-sub-col"><h3>\u0628\u0631\u0646\u062F\u0647\u0627\u06CC \u067E\u0631\u0637\u0631\u0641\u062F\u0627\u0631</h3>',x.forEach(E=>{w+=`<a href="#/products?brand=${E.id}">${Fe(E)}</a>`}),w+="</div>",w+="</div>",m.innerHTML=w})})}function Em(){let e=ze();N("#fBrandName").textContent=k()?e.name||t("app.name"):e.nameEn||e.name||"",N("#fDesc").textContent=k()?e.description||"":e.descriptionEn||e.description||"",N("#fYear").textContent=k()?Xe(new Date().getFullYear()):String(new Date().getFullYear()),N("#fBadges").innerHTML=r`
    <span class="f-badge">${c("shield")}<span>${t("home.point1")}</span></span>
    <span class="f-badge">${c("package-check")}<span>${t("home.point2")}</span></span>
    ${I("insurance")?r`<span class="f-badge">${c("scale")}<span>${t("common.insurance")}</span></span>`:""}
    ${I("plus")?r`<span class="f-badge">${c("sparkles")}<span>${t("footer.plus")}</span></span>`:""}`;let a=e.socials||{},s=[["instagram",_e(a.instagram),"camera"],["telegram",_e(a.telegram),"send"],["whatsapp",a.whatsapp?`https://wa.me/${String(a.whatsapp).replace(/\D/g,"")}`:"","chat"],["eitaa",_e(a.eitaa),"globe"]].filter(n=>n[1]);N("#fSocial").innerHTML=s.length?s.map(([n,o,i])=>r`<a href="${o}" target="_blank" rel="noopener noreferrer" aria-label="${n}" title="${n}">${c(i)}</a>`).join(""):r`<span class="muted tiny">${t("footer.contactUs")}</span>`,N("#fContact").innerHTML=r`
    <li>${c("phone")}<span>${t("contact.phone")}: <a href="tel:${e.phone}">${se(e.phone||"")}</a></span></li>
    ...
    <li>${c("clock")}<span>${t("footer.workingHours")}: ${(e.workingHours||[]).map(n=>`<bdi>${k()?n.fa:n.en} ${k()?n.time:n.timeEn}</bdi>`).join(" \xB7 ")}</span></li>`,N("#fMinimap").innerHTML=Kt(),N("#fMinimap").setAttribute("title",t("contact.mapTitle"))}function xs(){let e=N("#userMenu"),a=N("#btnAuth");if(!d.me){e.hidden=!0,a.hidden=!1,a.innerHTML=r`${c("user")}<span data-i18n="nav.login">${t("nav.login")}</span>`;return}a.hidden=!0,e.hidden=!1;let s=d.me,n=(s.name||s.username||"?").trim().charAt(0);e.innerHTML=r`
    ...
    <div class="um-dd" data-umbox hidden>
      ...
      ${I("wallet")?r`<a href="#/account/wallet">${c("wallet")} ${t("acc.wallet")} <span class="um-count">${b(s.wallet?.balance||0)}</span></a>`:""}
      ${I("tickets")?r`<a href="#/account/tickets">${c("ticket")} ${t("acc.tickets")}</a>`:""}
      ...
      <button type="button" data-act="logout">${c("logout")} ${t("common.logout")}</button>
    </div>`;let o=e.querySelector("[data-um]"),i=e.querySelector("[data-umbox]");o.addEventListener("click",l=>{l.stopPropagation(),i.hidden=!i.hidden,o.setAttribute("aria-expanded",String(!i.hidden))}),document.addEventListener("click",l=>{!i.hidden&&!l.target.closest(".user-menu")&&(i.hidden=!0,o.setAttribute("aria-expanded","false"))})}function ma(){let e=(a,s)=>{let n=N(a);n&&(n.hidden=!s,n.textContent=b(s))};e("#cartBadge",d.cart?.count||0),e("#mnCart",d.cart?.count||0),e("#wishBadge",d.wishlist.length),e("#notifBadge",d.unread)}function qm(){N("#btnTheme")?.addEventListener("click",()=>{let n=(d.prefs.theme==="auto"?document.documentElement.getAttribute("data-mode")||"dark":d.prefs.theme)==="dark"?"light":"dark";wt("theme",n);let o=N("#btnTheme");o.innerHTML=c(n==="dark"?"moon":"sun")}),N("#btnLang")?.addEventListener("click",async()=>{let s=ve()==="fa"?"en":"fa";wt("locale",s),N("#langChip").textContent=s==="fa"?"EN":"\u0641\u0627",ua(),Wt(),ua(),T(!0)}),N("#btnMenu")?.addEventListener("click",()=>Tm());let e=N("#fabTop");e?.addEventListener("click",()=>window.scrollTo({top:0,behavior:"smooth"}));let a=!1;addEventListener("scroll",()=>{a||!e||(a=!0,requestAnimationFrame(()=>{e.hidden=scrollY<600,a=!1}))},{passive:!0}),N("#btnInstallApp")?.addEventListener("click",async()=>{d.installPrompt?await fa()||Lt():Lt()})}function Tm(){en({title:t("nav.menu"),body:r`
        <div class="col">
        ...
        </div>`})}function Cm(){let e=N("#searchForm"),a=N("#searchInput"),s=N("#suggestBox"),n=-1,o=()=>{s.hidden=!0,n=-1},i=Vt(async()=>{let l=a.value.trim();if(!l){if(!d.searches.length){o();return}s.hidden=!1,s.innerHTML=r`
      ...
      </div>`,document.body.appendChild(e);let n=e.querySelector("[data-ci]"),o=e.querySelector("[data-cl]");n.focus();let i=()=>[{icon:"home",label:t("nav.home"),href:"#/"},{icon:"grid",label:t("nav.products"),href:"#/products"},{icon:"percent",label:t("nav.deals"),href:"#/products?discount=1"},{icon:"cart",label:t("cart.title"),href:"#/cart"},...d.me?[{icon:"user",label:t("acc.dashboard"),href:"#/account"},{icon:"package-check",label:t("acc.orders"),href:"#/account/orders"},...I("wallet")?[{icon:"wallet",label:t("acc.wallet"),href:"#/account/wallet"}]:[]]:[{icon:"user",label:t("nav.login"),href:"#/auth"}],...d.me?.isAdmin?[{icon:"settings",label:t("adm.title"),href:"#/admin"}]:[],{icon:"moon",label:t("theme.toggle"),run:()=>N("#btnTheme").click()},{icon:"globe",label:"English / \u0641\u0627\u0631\u0633\u06CC",run:()=>N("#btnLang").click()},{icon:"chart",label:t("nav.stats"),href:"#/stats"},{icon:"map",label:t("nav.contact"),href:"#/pages/contact"}],l=async v=>{let x=i().filter(w=>!v||w.label.toLowerCase().includes(v.toLowerCase()));if(v)try{let w=await h.get(`/api/search?q=${encodeURIComponent(v)}&limit=6`);x=[...x,...w.products.map(E=>({icon:E.glyph||"box",label:ue(E),meta:b(E.price),href:`#/product/${E.id}`}))]}catch{}o.innerHTML=x.length?x.map((w,E)=>r`<div class="cmdk-item ${E===0?"active":""}" data-idx="${E}">${c(w.icon)}<span class="grow">${w.label}</span>${w.meta?r`<span class="muted tiny">${w.meta}</span>`:""}</div>`):r`<div class="cmdk-item muted">${t("common.noResult")}</div>`,o._items=x};await l(""),n.addEventListener("input",Vt(()=>l(n.value.trim()),200));let m=v=>{let x=o._items?.[v];x&&(a(),x.run?x.run():x.href&&(location.hash=x.href))};o.addEventListener("click",v=>{let x=v.target.closest("[data-idx]");x&&m(Number(x.dataset.idx))});let u=0,f=v=>{let x=o.querySelectorAll(".cmdk-item[data-idx]");v.key==="Escape"?(v.preventDefault(),a()):v.key==="ArrowDown"||v.key==="ArrowUp"?(v.preventDefault(),u=(u+(v.key==="ArrowDown"?1:-1)+x.length)%Math.max(1,x.length),x.forEach((w,E)=>w.classList.toggle("active",E===u)),x[u]?.scrollIntoView({block:"nearest"})):v.key==="Enter"&&(v.preventDefault(),m(u))};document.addEventListener("keydown",f,!0),e.addEventListener("click",v=>{v.target===e&&a()})};document.addEventListener("keydown",n=>{(n.ctrlKey||n.metaKey)&&String(n.key).toLowerCase()==="k"&&(n.preventDefault(),s())})}function Pm(){Le("cart",ma),Le("wishlist",()=>{ma(),xs()}),Le("notifications",ma),Le("me",()=>{xs(),ma()}),Le("settings",()=>{kt(),Wt(),ua(),pa()}),document.addEventListener("view:rendered",()=>pa()),document.addEventListener("sleep:changed",()=>{pa(),Wt()}),Le("install",()=>{let e=N("#btnInstallApp");e&&(e.hidden=!1)}),Le("installed",()=>{let e=N("#btnInstallApp");e&&(e.hidden=!0),$(t("home.appInstalled"))}),Le("online",e=>{e?$(t("err.online")):Lm()})}function Mm(){let e=async()=>{if(!document.documentElement.classList.contains("eco"))try{let a=await h.get("/api/system/status"),s=!!d.sleeping;d.sleeping=!!a.sleeping,d.sleepSince=a.since||null,s!==d.sleeping&&(pa(),Wt(),String(location.hash||"").startsWith("#/admin")&&T(!0))}catch{}};setInterval(e,45e3),document.addEventListener("visibilitychange",()=>{document.hidden||e()})}function pa(){let e=String(location.hash||"").startsWith("#/admin"),a=V("settings.edit");sn({sleeping:!!d.sleeping&&!(e&&a),canWake:a,since:d.sleepSince,onWake:async()=>{try{await h.post("/api/system/wake",{}),await Ne({silent:!0}),pa(),Wt(),$(t("sys.awake")),T(!0)}catch(s){y(s)}},onLogin:()=>le("#/auth?next="+encodeURIComponent(location.hash.slice(1)))})}function Lm(){Qn||(Qn=!0,j(t("err.offline"),{timeout:4200}))}function Nm(){window.addEventListener("online",()=>{Qn=!1})}function Im(){let e=N("#siteHeader"),a=N("#fabTop"),s=!1;window.addEventListener("scroll",()=>{s||(s=!0,requestAnimationFrame(()=>{e.classList.toggle("scrolled",window.scrollY>8),a.hidden=window.scrollY<420,s=!1}))},{passive:!0})}function dc(){if(I("consent")){if(sessionStorage.getItem("consentDeferred"))if(!location.hash.startsWith("#/pages/"))sessionStorage.removeItem("consentDeferred");else return;ce({title:t("consent.title"),dismissible:!1,closeBtn:!1,size:"md",body:r`
      ...
      </form>`,footer:r`<button type="button" class="btn btn-ghost" data-consent-min>${t("consent.rejectOptional")}</button><button type="button" class="btn btn-primary" data-consent-go>${t("consent.accept")}</button>`,onMount:(e,a)=>{let s=e.querySelector('[data-act="consent-form"]');e.querySelectorAll('a[href^="#/"]').forEach(o=>o.addEventListener("click",()=>{sessionStorage.setItem("consentDeferred","1"),a.close()}));let n=()=>{let o=s.querySelector("[name=terms]").checked,i=s.querySelector("[name=privacy]").checked,l=s.querySelector("[name=marketing]").checked;if(!o||!i){j(t("form.termsRequired"));return}Ya({terms:o,privacy:i,marketing:l}),d.me&&h.patch("/api/me",{notificationsPrefs:{marketing:l}}).catch(()=>{}),$(t("consent.thanks")),a.close()};e.closest(".modal").querySelector("[data-consent-go]").addEventListener("click",n),e.closest(".modal").querySelector("[data-consent-min]").addEventListener("click",()=>{Ya({terms:!0,privacy:!0,marketing:!1}),d.me&&h.patch("/api/me",{notificationsPrefs:{marketing:!1}}).catch(()=>{}),$(t("consent.thanks")),a.close()}),s.addEventListener("submit",o=>{o.preventDefault(),n()})}})}}function mc(){Qs()||dc()}function Rm(){if(d.me?.mustChangePassword){try{if(sessionStorage.getItem("bm_pwd_later"))return}catch{}Jn=ce({title:t("acc.passwordChange"),dismissible:!1,closeBtn:!1,size:"sm",body:r`
      ...
      </form>`})}}function Bm(){let e="bm_visit";try{if(sessionStorage.getItem(e))return;sessionStorage.setItem(e,"1")}catch{return}h.post("/api/visits",{path:location.hash||"/"}).catch(()=>{})}function Hm(){let e=String(location.href).match(/[?&]coupon=([A-Za-z0-9_-]{2,32})/);if(!e)return;let a=e[1];try{history.replaceState(null,"",String(location.href).replace(/[?&]coupon=[A-Za-z0-9_-]{2,32}/,"").replace(/\?$/,""))}catch{}setTimeout(async()=>{try{await h.post("/api/cart/coupon",{code:a}),await Te(),$(`${t("cart.couponApplied")}: ${a}`)}catch{}},700)}function Fm(){document.addEventListener("keydown",e=>{let a=String(e.target?.tagName||"").toLowerCase(),s=["input","textarea","select"].includes(a)||e.target?.isContentEditable;if(e.key==="/"&&!s&&!e.metaKey&&!e.ctrlKey&&!e.altKey){let n=N("#searchInput");n&&(e.preventDefault(),n.focus(),n.select?.())}if(e.key==="Escape"&&document.activeElement===N("#searchInput")){let n=N("#searchInput");n.value="",n.blur(),N("#suggestBox")&&(N("#suggestBox").hidden=!0)}})}function Om(){if(!("serviceWorker"in navigator)||Is().features?.offlineMode===!1)return;let e=async()=>{try{let a=await navigator.serviceWorker.register("/sw.js",{updateViaCache:"none"});setInterval(()=>{a.update().catch(()=>{})},36e5),document.addEventListener("visibilitychange",()=>{document.hidden||a.update().catch(()=>{})})}catch{}};document.readyState==="complete"?e():window.addEventListener("load",e,{once:!0})}function jm(){fetch("/api/system/status",{cache:"no-store"}).then(e=>e.ok?e.json():null).then(e=>{e?.build&&e.build!==Ns&&!sessionStorage.getItem("bm-upd-seen")&&(sessionStorage.setItem("bm-upd-seen","1"),re(t("update.available"),{timeout:0,action:{label:t("update.reload"),onClick:()=>location.reload()}}))}).catch(()=>{})}function Um(){if(!matchMedia("(pointer:fine)").matches)return;let e=N("#cursorHalo");if(!e)return;let a=innerWidth/2,s=innerHeight/2,n=a,o=s,i=0,l=()=>{n+=(a-n)*.22,o+=(s-o)*.22,e.style.left=`${n.toFixed(1)}px`,e.style.top=`${o.toFixed(1)}px`,i=requestAnimationFrame(l)};document.addEventListener("pointermove",m=>{if(document.documentElement.classList.contains("eco"))return;a=m.clientX,s=m.clientY,document.documentElement.classList.add("halo-on"),i||(i=requestAnimationFrame(l));let u=m.target.closest?.('a, button, [role="button"], .pcard, .gal-thumb');document.documentElement.classList.toggle("halo-hot",!!u)},{passive:!0}),document.addEventListener("pointerleave",()=>{document.documentElement.classList.remove("halo-on")})}function _m(){return document.documentElement.classList.contains("eco")}function zm(){let e=()=>{document.documentElement.classList.contains("eco")||(document.documentElement.classList.add("eco"),document.dispatchEvent(new CustomEvent("eco",{detail:{on:!0}})))},a=()=>{document.documentElement.classList.contains("eco")&&(document.documentElement.classList.remove("eco"),document.dispatchEvent(new CustomEvent("eco",{detail:{on:!1}})),Promise.resolve().then(()=>(z(),va)).then(n=>n.refreshBootstrap?.({silent:!0})).catch(()=>{}))},s=()=>{clearTimeout(lc),lc=setTimeout(e,Wm)};for(let n of["pointerdown","keydown","wheel","touchstart","pointermove"])document.addEventListener(n,()=>{document.documentElement.classList.contains("eco")&&a(),s()},{passive:!0,capture:!0});s()}function Vm(){try{if(sessionStorage.getItem("bm_vis"))return;sessionStorage.setItem("bm_vis","1");let e={screen:`${screen.width}x${screen.height}`,tz:Intl.DateTimeFormat().resolvedOptions().timeZone||"",lang:navigator.language||"",ref:document.referrer?document.referrer.slice(0,200):"",path:location.hash.replace("#","")||"/"};Promise.resolve().then(()=>(K(),so)).then(a=>a.api.post("/api/track",e)).catch(()=>{})}catch{}}var $m,Qn,Jn,Wm,lc,Kn=O(()=>{z();_();K();H();X();ie();ee();vn();cc();z();oe();$m=performance.now();g("logout",async()=>{if(await ge({text:t("common.logout")+"\u061F",okText:t("common.logout")}))try{await h.post("/api/auth/logout"),d.me=null,await Te(),Wt(),$(t("auth.logoutDone")),le("#/"),T()}catch{j(t("err.generic"))}});Qn=!1;g("consent-form",()=>{});g("consent-manage",()=>dc());g("reload",()=>location.reload());Jn=null;g("pwd-later",()=>{try{sessionStorage.setItem("bm_pwd_later","1")}catch{}Jn?.close(),re(t("auth.pwdLaterToast"))});g("force-pass",async(e,a)=>{let s=new FormData(a);if(s.get("next")!==s.get("confirm")){j(ve()==="fa"?"\u062A\u06A9\u0631\u0627\u0631 \u0631\u0645\u0632 \u06CC\u06A9\u0633\u0627\u0646 \u0646\u06CC\u0633\u062A.":"Passwords do not match.");return}try{await h.post("/api/me/password",{current:s.get("current"),next:s.get("next")}),await Ge(),xs(),$(t("acc.passwordChanged")),Jn?.close()}catch(n){j(n.message)}});Le("boot-slow",()=>document.body.classList.add("boot-slow"));Le("boot-failed",()=>{document.getElementById("welcomeScreen")?.remove();let e=N("#bootSplash");e&&(e.innerHTML=r`<div class="empty">
    <h4>${t("boot.failed")}</h4>
  ...
  </div>`)});ym().catch(e=>{console.error("[boot]",e),document.getElementById("welcomeScreen")?.remove();let a=N("#bootSplash");a&&(a.innerHTML=r`<div class="empty"><h4>${t("err.generic")}</h4><button class="btn btn-primary" data-act="reload">${t("common.retry")}</button></div>`)});setTimeout(jm,6e3);Wm=240*1e3,lc=0});Kn();export{_m as ecoPaused,mc as maybeConsent,ma as updateBadges};
