    ...
    <div class="catalog">
      <aside class="filters card" id="filtersBox" hidden>
        ...
        <div class="fgroup">
          ...
          <div class="acc-b fgroup-b">
            ${u.slice(0,20).map(q=>D("brand",q.id,Fe(q),l.brands?.[q.id],v.includes(q.id)))}
          </div>
        </div>
  ...
  `}var mr=O(()=>{B();W();_();Q();ce()});var ur={};G(ur,{mount:()=>Hl,render:()=>Cl,title:()=>Bl});function aa(e,a=""){return e?.hero?r`
    ...
    <form class="card mb adm-filter" data-act="adm-p-filter">
      <div class="form-grid">
        ...
        ${U({label:t("adm.pCat"),name:"cat",value:Ce.cat,options:[{value:"",label:t("common.all")},...d.categories.map(n=>({value:n.id,label:ye(n)}))]})}
