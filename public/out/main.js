        ...
        <div class="toolbar">
          ...
          <label class="row" >
            ...
            <select class="select" data-sort>
              ${ko.map(q=>r`<option value="${q}" ${q===S?"selected":""}>${t(`catalog.sort.${q}`)}</option>`)}
            </select>
          </label>
          <div class="btn-group">
