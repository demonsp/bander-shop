...
const fa = {
  ...
  'common.shipping': 'هزینهٔ ارسال',
  'common.insurance': 'بیمهٔ مرسوله',
  ...
  'boot.loading': 'در حال بارگذاری بندر موبایل…',
  'topbar.fastSend': 'ارسال از بندر بوشهر به سراسر ایران',
  'nav.home': 'خانه',
  'nav.products': 'همهٔ محصولات',
  'nav.deals': 'تخفیف‌ها',
  'nav.new': 'جدیدترین‌ها',
  'nav.stats': 'آمار زنده',
  ...
  'nav.allCategories': 'همهٔ دسته‌ها',
  ...
  'footer.allProducts': 'همهٔ محصولات',
  ...
  'home.heroText': 'کابل، شارژر، قاب و گلس آیفون و سامسونگ، پاوربانک، هندزفری، اسپیکر، ساعت و عینک هوشمند و هر چیزی که برای گوشی و تولید محتوا لازم داری — همه در یک مغازهٔ کوچک کنار خلیج فارس.',
  ...
  'home.bestSellersSub': 'انتخاب مشتریان بندر موبایل',
  ...
  'home.whyUs': 'چرا بندر موبایل؟',
  'home.whyUsSub': 'چیزهایی که ما را از بقیه جدا می‌کند',
  'home.reviews': 'نظر مشتریان',
  'home.reviewsSub': 'تجربهٔ واقعی خریداران',
  'home.visitStore': 'بازدید از فروشگاه',
  'home.visitStoreText': 'کنار اسکلهٔ بوشهر، پاساژ مروارید خلیج — نصب رایگان گلس و مشاورهٔ حضوری',
  'home.openMap': 'دیدن کروکی و نقشه',
  'home.statsTitle': 'فروشگاه در یک نگاه',
  'home.plusTitle': 'اشتراک پلاس بندر موبایل',
  'home.plusText': 'با پرداخت ماهانه، ارسال همهٔ سفارش‌ها رایگان، مرسوله‌ها خودکار بیمه و ۳٪ تخفیف دائمی می‌گیری.',
  'home.plusCta': 'دیدن مزایای پلاس',
  'home.appTitle': 'اپلیکیشن بندر موبایل',
  ...
  'home.liveStats': 'آمار زندهٔ فروشگاه',
  'home.newsletter': 'از تخفیف‌ها باخبر شو',
  'home.newsletterText': 'شمارهٔ موبایلت را بده تا فقط برای تخفیف‌های مهم و موجود شدن کالاهای لیستت پیام بفرستیم.',
  ...
  'catalog.f.clear': 'حذف همهٔ فیلترها',
  'catalog.count': 'کالا',
  ...
  'cart.clearConfirm': 'همهٔ کالاهای سبد حذف شوند؟',
  'cart.summary': 'خلاصهٔ سفارش',
  'cart.continue': 'ادامهٔ فرآیند خرید',
  ...
  'checkout.courierDesc': 'ارسال به آدرس ثبت‌شده با امکان بیمهٔ مرسوله.',
  'checkout.zone': 'منطقهٔ ارسال',
  'checkout.express': 'ارسال فوری (همان روز)',
  'checkout.insuranceOpt': 'بیمهٔ مرسوله',
  ...
  'checkout.concurrencyNote': 'موجودی در لحظهٔ ثبت سفارش قفل می‌شود؛ اگر کالایی هم‌زمان تمام شود، به تو اطلاع می‌دهیم و وجه باز می‌گردد.',
  ...
  'auth.recoveryText': 'شمارهٔ موبایل یا ایمیل ثبت‌شده را وارد کن تا کد بازیابی بفرستیم.',
  ...
  'auth.orContinue': 'یا',
  'auth.guestCheckout': 'ادامهٔ خرید بدون حساب کاربری',
  ...
  'acc.addrPhone': 'شمارهٔ تماس گیرنده',
  ...
  'acc.ticketCategory': 'دستهٔ درخواست',
  ...
  'page.statsTitle': 'آمار زندهٔ فروشگاه',
  ...
  'acc.ticketViewRules': 'مشاهدهٔ قوانین تیکت',
  ...
  'acc.revokeAll': 'خروج از همهٔ دستگاه‌ها',
  ...
  'acc.exportHint': 'همهٔ اطلاعات حساب، سفارش‌ها، نظرات و تیکت‌ها را به‌صورت JSON دانلود کن.',
  ...
  'chat.title': 'پشتیبانی آنلاین بندر موبایل',
  ...
  'notif.viewAll': 'مشاهدهٔ همهٔ اعلان‌ها',
  ...
  'consent.title': 'به بندر موبایل خوش آمدی',
  'consent.text': 'لطفاً پیش از ادامه، موارد زیر را بخوان و بپذیر. ما از حافظهٔ مرورگر برای بهتر کردن تجربهٔ خرید استفاده می‌کنیم و طبق حریم خصوصی، مراقب داده‌های شخصی تو هستیم.',
  ...
  'contact.mapHint': 'برای باز شدن در برنامهٔ نقشه کلیک کن',
  'contact.mapAsk': 'کدام نقشه باز شود؟',
  'contact.mapPermission': 'اگر اجازهٔ موقعیت بدهی، مسیر حرکت از جای فعلی‌ات تا مغازه را نشان می‌دهیم.',
  'contact.allowLocation': 'اجازهٔ دسترسی به موقعیت',
  ...
  'compare.title': 'مقایسهٔ کالاها',
  'compare.empty': 'کالایی برای مقایسه انتخاب نشده',
  'compare.emptyText': 'از دکمهٔ مقایسه روی کارت کالا استفاده کن (تا ۴ کالا).',
  ...
  'adm.awaiting.chat': 'پیام خوانده‌نشدهٔ چت',
  ...
  'adm.tPort': 'پوستهٔ بندری (موج، لنج و نخل در پس‌زمینه)',
  'adm.tPortHint': 'برای پس‌زمینهٔ ساده و خنثی، خاموشش کن.',
  'adm.tMode': 'پوستهٔ پیش‌فرض',
  ...
  'adm.bConnected': 'دستگاه متصل شد — آمادهٔ اسکن',
  ...
  'perm.dashboard.view': 'مشاهدهٔ داشبورد',
  'perm.products.view': 'مشاهدهٔ کالاها',
  ...
  'perm.orders.view': 'مشاهدهٔ سفارش‌ها',
  ...
  'perm.users.view': 'مشاهدهٔ کاربران',
  ...
  'misc.quickView': 'مشاهدهٔ سریع',
  'misc.addToHome': 'افزودن به صفحهٔ اصلی',
  'misc.installHint': 'در منوی مرورگر، گزینهٔ «Add to Home screen» یا «Install» را بزن.',
  'misc.printBlocked': 'پنجرهٔ چاپ باز نشد؛ لطفاً پاپ‌آپ را مجاز کن.',
  'misc.saved': 'ذخیره شد',
  'misc.deleted': 'حذف شد',
  ...
  'adm.notifHint': 'اعلان را برای همهٔ کاربران یا یک کاربر خاص بفرست.',
  'adm.notifLevel': 'سطح',
  ...
  'adm.ixReindex': 'ایندکس دوبارهٔ همه',
  ...
  'adm.dBackupHint': 'یک نسخهٔ کامل از پایگاه‌داده در پوشهٔ data ذخیره می‌شود.',
  ...
  'sys.sleepBanner': 'فروشگاه الان خاموش است. با دکمهٔ «روشن کردن فروشگاه» بالای همین صفحه دوباره روشنش کن.',
...
const en = {
  ...
  'boot.loading': 'Loading Bander Mobile…',
  ...
  'home.bestSellersSub': 'Chosen by Bander Mobile customers',
  ...
  'home.plusTitle': 'Bander Mobile Plus membership',
  ...
  'home.appTitle': 'The Bander Mobile app',
  ...
  'chat.title': 'Bander Mobile live support',
  ...
  'consent.title': 'Welcome to Bander Mobile',
...
/** ترجمهٔ المان‌هایی با data-i18n */
